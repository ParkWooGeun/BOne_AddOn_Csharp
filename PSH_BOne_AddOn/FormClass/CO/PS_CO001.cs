	...
	internal class PS_CO001 : PSH_BaseClass
	{
        ...
        private void PS_CO001_ComboBox_Setting()
        {
            ...
            try
            {
                ...
                dataHelpClass.GP_MatrixSetMatComboList(oMat01.Columns.Item("Closed"), sQry, "", ""); //마감여부
            }
            catch (Exception ex)
            {
                PSH_Globals.SBO_Application.StatusBar.SetText(System.Reflection.MethodBase.GetCurrentMethod().Name + "_Error : " + ex.Message, BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Error);
        ...
        private void PS_CO001_MTX01()
        {
            ...
            try
            {
                ...
                for (loopCount = 0; loopCount <= RecordSet01.RecordCount - 1; loopCount++)
                {
                    ...
                    oDS_PS_CO001L.SetValue("U_ColReg02", loopCount, RecordSet01.Fields.Item("Closed").Value); //마감여부
        ...
        private void PS_CO001_AddData()
        {
            ...
            try
            {
                ...
                for (int loopCount = 0; loopCount <= oMat01.RowCount - 1; loopCount++)
                {
                    ...
                    Closed = oDS_PS_CO001L.GetValue("U_ColReg02", loopCount).ToString().Trim();
