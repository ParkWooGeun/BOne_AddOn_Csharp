...
namespace PSH_BOne_AddOn
{
    ...
    /// 분말부자재비용분석
    /// </summary>
    internal class PS_CO530 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFromDocEntry01)
        {
            ...
            try
            {
                oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_CO530.srf");
                ...
                oFormUniqueID = "PS_CO530_" + SubMain.Get_TotalFormsCount();
                SubMain.Add_Forms(this, oFormUniqueID, "PS_CO530");
                ...
                oForm.Freeze(true);
                PS_CO530_CreateItems();
                PS_CO530_ComboBox_Setting();
            }
            catch (Exception ex)
            {
        ...
        /// 화면 Item 생성
        /// </summary>
        private void PS_CO530_CreateItems()
        {
            try
            {
                //사업장
        ...
        private void PS_CO530_ComboBox_Setting()
        {
            ...
            try
            {
                ...
                dataHelpClass.Set_ComboList(oForm.Items.Item("Gubun").Specific, "select '', '전체' union all select code, name from [@PSH_Quality] order by 1", "", false, false);
        ...
        private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
        {
            try
            {
                if (pVal.BeforeAction == true)
                {
                    ...
                    {
                        System.Threading.Thread thread = new System.Threading.Thread(PS_CO530_Print_Report01);
                ...
                else if ((pVal.BeforeAction == false))
                {
                    switch (pVal.MenuUID)
                    {
                        ...
                        case "1281":
                            //찾기
                            break;
                        ////Call PS_CO530_FormItemEnabled '//UDO방식
                        case "1282":
                            //추가
                            break;
                        ////Call PS_CO530_FormItemEnabled '//UDO방식
