    ...
    internal class PS_CO540 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFormDocEntry01)
        {
            ...
            try
            {
                ...
                PSH_Globals.ExecuteEventFilter(typeof(PS_CO540));
            }
            catch (Exception ex)
            {
        ...
        private void PS_CO540_MTX01()
        {
            ...
            try
            {
                ...
                ItmSort = oForm.Items.Item("ItmSort").Specific.Value.ToString().Trim(); //대분류
                ItmBsort = oForm.Items.Item("ItmBsort").Specific.Value.ToString().Trim(); //중분류
                Gubun = oForm.Items.Item("Gubun").Specific.Value.ToString().Trim(); //출력구분

                Query01 = "EXEC PS_CO540_01 '";
                Query01 += BPLID + "','";
                Query01 += YmFrom + "','";
                Query01 += YmTo + "','";
                Query01 += ItmSort + "','";
