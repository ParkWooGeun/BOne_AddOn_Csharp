    ...
    internal class PS_CO660 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFormDocEntry01)
        {
            ...
            try
            {
                ...
                PS_CO660_SetDocument(oFormDocEntry01);
                ...
                PSH_Globals.ExecuteEventFilter(typeof(PS_CO660));
            }
            catch (Exception ex)
            {
        ...
        private void PS_CO660_SetDocument(string oFormDocEntry01)
        {
            try
            {
            ...
            try
            {
                ...
                for (i = 0; i <= oRecordSet.RecordCount; i++)
                {
                    ...
                    if (i == oRecordSet.RecordCount) //마지막 빈행 추가
                    {
                        ...
                        oDS_PS_CO660L.SetValue("U_Expense", i, "0"); //금액
