...
namespace PSH_BOne_AddOn
{
	...
	internal class PS_CO665 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry01)
		{
			...
			try
            {
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_CO665.srf");
        ...
        /// 화면 Item 생성
        /// </summary>
        private void PS_CO665_CreateItems()
        {
            try
            {
                oForm.Freeze(true);
                ...
                oForm.DataSources.DataTables.Add("PS_CO665A");
                oGrid01.DataTable = oForm.DataSources.DataTables.Item("PS_CO665A");
                oDS_PS_CO665A = oForm.DataSources.DataTables.Item("PS_CO665A");
        ...
        /// 콤보박스에 기본값설정
        /// </summary>
        private void PS_CO665_ComboBox_Setting()
        {
            string sQry;
            ...
            try
            {
                ...
                //사업장
                sQry = "  SELECT    CONVERT(VARCHAR(1),BPLID) AS [BPLID],";
                sQry += "           BPLName AS [BPLName]";
                sQry += " FROM      OBPL";
                sQry += " UNION ALL";
                sQry += " SELECT   '%' AS [BPLID],";
                sQry += "          '전체' AS [BPLName]";
                sQry += " ORDER BY  BPLID";
        ...
        private void PS_CO665_MTX01()
        {
            ...
            try
            {
                ...
                oDS_PS_CO665A.ExecuteQuery(Query01);
        ...
        /// FormResize
        /// </summary>
        private void PS_CO665_FormResize()
        {
            try
            {
