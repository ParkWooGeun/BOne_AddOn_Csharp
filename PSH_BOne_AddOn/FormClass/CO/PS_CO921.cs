...
{
    /// <summary>
    /// 월별 작번별 수주금액 대비 공수 현황(기계)
    /// </summary>
    internal class PS_CO921 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFromDocEntry01)
        {
            ...
            try
            {
                oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_CO921.srf");
                ...
                oFormUniqueID = "PS_CO921_" + SubMain.Get_TotalFormsCount();
                SubMain.Add_Forms(this, oFormUniqueID, "PS_CO921");
        ...
        /// 화면 Item 생성
        /// </summary>
        private void PS_CO921_CreateItems()
        {
            try
            {
        ...
        /// Combobox 설정
        /// </summary>
        private void PS_CO921_ComboBox_Setting()
        {
        ...
        /// FormItemEnabled
        /// </summary>
        private void PS_CO921_FormItemEnabled()
        {
            try
            {
                oForm.Freeze(true);
                ...
                else if ((pVal.BeforeAction == false))
                {
                    switch (pVal.MenuUID)
                    {
                        ...
                        case "1281":
                            //찾기
                            break;
                        ////Call PS_CO921_FormItemEnabled '//UDO방식
                        case "1282":
                            //추가
                            break;
                        ////Call PS_CO921_FormItemEnabled '//UDO방식
