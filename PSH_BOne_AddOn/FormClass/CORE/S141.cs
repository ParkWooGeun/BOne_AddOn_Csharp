...
namespace PSH_BOne_AddOn.Core
{
	...
	internal class S141 : PSH_BaseClass
	{
        ...
        private void S141_EnableFormItem(bool Status)
        {
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        private bool S141_CheckDataValid()
        {
