...
namespace PSH_BOne_AddOn.Core
{
	...
	internal class S179 : PSH_BaseClass
	{
        ...
        private void S179_EnableFormItem(bool Status)
        {
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        private bool S179_CheckDataValid()
        {
            ...
            try
            {
                if (string.IsNullOrEmpty(oForm.Items.Item("2001").Specific.Value.ToString()))
                {
