            ...
            try
            {
                if (pVal.BeforeAction == true)
                {
                    if (pVal.ItemUID == "1")
                    {
                        ...
                        {
                            if (oMat01.Columns.Item(4).Cells.Item(i).Specific.Checked == true) // 권한 부여자 선택시 전역변수인 RegUserID 리스트에 값입력
                            {
                                regUserID.Add(oMat01.Columns.Item(1).Cells.Item(i).Specific.Value);
                            }
                        }
                    }
                }
