...
namespace PSH_BOne_AddOn.Core
{
    ...
    /// AR예약송장
    /// </summary>
    internal class S60091 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string formUID)
        {
            try
            {
                ...
                SubMain.Add_Forms(this, formUID, "S60091");

                S60091_CreateItems();
                S60091_EnableFormItem(false);
            }
            catch (Exception ex)
            {
        ...
        /// 화면 Item 생성
        /// </summary>
        private void S60091_CreateItems()
        {
        ...
        private void S60091_EnableFormItem(bool Status)
        {
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        private bool S60091_CheckDataValid()
        {
            ...
            try
            {
                ...
                if (pVal.BeforeAction == true)
                {
                    if (pVal.ItemUID == "1")
                    {
                        if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
                        {
                            if (S60091_CheckDataValid() == false)
                            {
                                BubbleEvent = false;
                                return;
                            }
