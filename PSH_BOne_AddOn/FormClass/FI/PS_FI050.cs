...
namespace PSH_BOne_AddOn
{
    ...
    /// 받을어음 추심의뢰서
    /// </summary>
    internal class PS_FI050 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFormDocEntry01)
        {
            ...
            try
            {
                oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_FI050.srf");
                ...
                oFormUniqueID = "PS_FI050_" + SubMain.Get_TotalFormsCount();
                SubMain.Add_Forms(this, oFormUniqueID, "PS_FI050");
                ...
                oForm.Freeze(true);
                PS_FI050_CreateItems();
                PS_FI050_ComboBox_Setting();
            }
            catch (Exception ex)
            {
        ...
        /// 화면 Item 생성
        /// </summary>
        private void PS_FI050_CreateItems()
        {
            try
            {
        ...
        /// Combobox 설정
        /// </summary>
        private void PS_FI050_ComboBox_Setting()
        {
        ...
        ///// FormItemEnabled
        ///// </summary>
        //private void PS_FI050_FormItemEnabled()
        //{
        //    try
        //    {
        //        oForm.Freeze(true);
        ...
        private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
        {
            try
            {
                if (pVal.BeforeAction == true)
                {
                    ...
                    {
                        System.Threading.Thread thread = new System.Threading.Thread(PS_FI050_Print_Report01);
                ...
                else if ((pVal.BeforeAction == false))
                {
                    switch (pVal.MenuUID)
                    {
                        ...
                        case "1281":
                            //찾기
                            break;
                        ////Call PS_FI050_FormItemEnabled '//UDO방식
                        case "1282":
                            //추가
                            break;
                        ////Call PS_FI050_FormItemEnabled '//UDO방식
        ...
        /// </summary>
        [STAThread]
        private void PS_FI050_Print_Report01()
        {
            ...
            try
            {
                ...
                WinTitle = "[PS_FI050] 받을어음 추심 의뢰서";
                ReportName = "PS_FI050_01.RPT";
