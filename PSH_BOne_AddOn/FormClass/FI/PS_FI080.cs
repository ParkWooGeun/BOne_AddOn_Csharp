...
namespace PSH_BOne_AddOn
{
    ...
    internal class PS_FI080 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFormDocEntry01)
        {
            ...
            try
            {
                oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_FI080.srf");
                ...
                oFormUniqueID = "PS_FI080_" + SubMain.Get_TotalFormsCount();
                SubMain.Add_Forms(this, oFormUniqueID, "PS_FI080");
                ...
                oForm.Freeze(true);
                PS_FI080_CreateItems();
                PS_FI080_ComboBox_Setting();
            }
            catch (Exception ex)
            {
        ...
        /// 화면 Item 생성
        /// </summary>
        private void PS_FI080_CreateItems()
        {
            try
            {
        ...
        ///// FormItemEnabled
        ///// </summary>
        //private void PS_FI080_FormItemEnabled()
        //{
        //    try
        //    {
        //        oForm.Freeze(true);
        ...
        private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
        {
            try
            {
                if (pVal.BeforeAction == true)
                {
                    ...
                    {
                        System.Threading.Thread thread = new System.Threading.Thread(PS_FI080_Print_Report01);
                ...
                else if ((pVal.BeforeAction == false))
                {
                    switch (pVal.MenuUID)
                    {
                        ...
                        case "1281":
                            //찾기
                            break;
                        ////Call PS_FI080_FormItemEnabled '//UDO방식
                        case "1282":
                            //추가
                            break;
                        ////Call PS_FI080_FormItemEnabled '//UDO방식
        ...
        private void PS_FI080_Print_Report01()
        {
            ...
            try
            {
                ...
                WinTitle = "[PS_FI080] 일계표";
                ReportName = "PS_FI080_01.RPT";
