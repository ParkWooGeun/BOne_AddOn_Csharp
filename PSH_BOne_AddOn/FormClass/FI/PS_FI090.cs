...
namespace PSH_BOne_AddOn
{
	...
	/// 월계표    PS_FI090
	/// </summary>
	internal class PS_FI090 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry01)
		{
			...
			try
			{
				oXmlDoc01.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_FI090.srf");
				...
				oFormUniqueID01 = "PS_FI090_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID01, "PS_FI090");                   // 폼추가
				...
				PSH_Globals.ExecuteEventFilter(typeof(PS_FI090));
			}
			catch (Exception ex)
			{
		...
		private void Print_Query()
		{
			...
			try
			{
				...
				// Crystal
				WinTitle = "[PS_FI090] 월계표";
				ReportName = "PS_FI090_01.RPT";
