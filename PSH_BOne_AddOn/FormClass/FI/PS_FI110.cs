...
namespace PSH_BOne_AddOn
{
	...
	/// 보조재료비현황 PS_FI110
	/// </summary>
	internal class PS_FI110 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc01.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_FI110.srf");
				...
				oFormUniqueID = "PS_FI110_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_FI110");
				...
				oForm.Freeze(true);
				PS_FI110_CreateItems();
				PS_FI110_SetComboBox();
		...
		/// CreateItems
		/// </summary>
		private void PS_FI110_CreateItems()
		{
			try
			{
		...
		/// ComboBox_Setting
		/// </summary>
		private void PS_FI110_SetComboBox()
		{
			string sQry;
		...
		/// </summary>
		/// <returns></returns>
		private bool PS_FI110_DelHeaderSpaceLine()
		{
		...
		/// </summary>
		[STAThread]
		private void PS_FI110_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string YYYYMM;
			...
			try
			{
				...
				WinTitle = "[PS_FI110] 보조재료비 현황";
				ReportName = "PS_FI110_01.rpt";
				//프로시저 : PS_FI110_01
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
                {
                    ...
                    {
                        if (PS_FI110_DelHeaderSpaceLine() == false)
                        {
                            BubbleEvent = false;
                            return;
                        }
                        ...
                        {
                            System.Threading.Thread thread = new System.Threading.Thread(PS_FI110_PrintReport);
