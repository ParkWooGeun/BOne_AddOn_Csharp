...
namespace PSH_BOne_AddOn
{
	...
	/// 제조경비현황 PS_FI130
	/// </summary>
	internal class PS_FI130 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry01)
		{
			...
			try
			{
				oXmlDoc01.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_FI130.srf");
				...
				oFormUniqueID01 = "PS_FI130_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID01, "PS_FI130");                   // 폼추가
				...
				PSH_Globals.ExecuteEventFilter(typeof(PS_FI130));
			}
			catch (Exception ex)
			{
		...
		private void Print_Query()
		{
			...
			try
			{
				...
				WinTitle = "[PS_FI130]  제조경비현황";
				ReportName = "PS_FI130_01.RPT";
