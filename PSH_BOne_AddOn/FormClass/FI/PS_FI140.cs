...
namespace PSH_BOne_AddOn
{
	...
	/// 판관비현황 PS_FI140
	/// </summary>
	internal class PS_FI140 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc01.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_FI140.srf");
				...
				oFormUniqueID = "PS_FI140_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_FI140");
				...
				oForm.Freeze(true);
				PS_FI140_CreateItems();
				PS_FI140_SetComboBox();
			...
			finally
			{
				...
				System.Runtime.InteropServices.Marshal.ReleaseComObject(oXmlDoc01);
			}
		}
		...
		/// PS_FI140_CreateItems
		/// </summary>
		private void PS_FI140_CreateItems()
		{
			try
			{
		...
		/// PS_FI140_SetComboBox
		/// </summary>
		private void PS_FI140_SetComboBox()
		{
			string sQry;
		...
		/// <summary>
		/// PS_FI140_DelHeaderSpaceLine
		/// </summary>
		/// <returns></returns>
		private bool PS_FI140_DelHeaderSpaceLine()
		{
		...
		/// <summary>
		/// PS_FI140_PrintReport
		/// </summary>
		[STAThread]
		private void PS_FI140_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string YYYYMM;
			...
			try
			{
				...
				WinTitle = "[PS_FI140] 판관비현황";
				ReportName = "PS_FI140_01.rpt";
				//프로시저 : PS_FI140_01
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
                    ...
                    else if (pVal.ItemUID == "Btn01")  //출력버튼
                    {
                        if (PS_FI140_DelHeaderSpaceLine() == false)
                        {
                            BubbleEvent = false;
                            return;
                        }
                        ...
                        {
                            System.Threading.Thread thread = new System.Threading.Thread(PS_FI140_PrintReport);
