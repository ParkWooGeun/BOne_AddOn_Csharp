...
namespace PSH_BOne_AddOn
{
	...
	/// 고정자산현황-IFRS
	/// </summary>
	internal class PS_FI904 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry01)
		{
			...
			try
			{
				oXmlDoc01.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_FI904.srf");
				...
				oFormUniqueID01 = "PS_FI904_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID01, "PS_FI904");                   // 폼추가
				...
				PSH_Globals.ExecuteEventFilter(typeof(PS_FI904));
			}
			catch (Exception ex)
			{
		...
		private void ComboBox_Setting()
		{
			...
			{
				// 사업장
				sQry = "SELECT Code, Name From [@ZFX_LARDIV] Order by Code";
				oRecordSet.DoQuery(sQry);
				oForm.Items.Item("BPLId").Specific.ValidValues.Add("0000", "전체사업장");
				...
				// 구분
				oForm.Items.Item("Section").Specific.ValidValues.Add("A", "고정자산현황-IFRS");
				oForm.Items.Item("Section").Specific.ValidValues.Add("B", "고정자산현황-IFRS집계");
				oForm.Items.Item("Section").Specific.ValidValues.Add("C", "감가상각명세서-IFRS");
		...
		private bool HeaderSpaceLineDel()
		{
			...
			catch (Exception ex)
			{
				if (ErrNum == 1)
				{
					PSH_Globals.SBO_Application.StatusBar.SetText("기준년월(YYYY-MM)은 필수사항입니다. 확인하여 주십시오.", BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Error);
				}
				else if (ErrNum == 2)
				{
					PSH_Globals.SBO_Application.StatusBar.SetText("기준년월의 자리수(YYYY-MM)를 확인하여 주십시오.", BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Error);
				}
				else
				{
					PSH_Globals.SBO_Application.StatusBar.SetText(System.Reflection.MethodBase.GetCurrentMethod().Name + "_Error : " + ex.Message, BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Error);
		...
		private void Print_Query()
		{
			...
			try
			{
				...
				if (Section == "A")
				{
					WinTitle = "[PS_FI904] 고정자산현황-IFRS";
					ReportName = "PS_FI904_01.RPT";
				}
				else if (Section == "B")
				{
					WinTitle = "[PS_FI904] 고정자산현황-IFRS집계";
					ReportName = "PS_FI904_02.RPT";
				}
				else if (Section == "C")
				{
					WinTitle = "[PS_FI904] 감가상각명세서-IFRS";
					ReportName = "PS_FI904_03.RPT";
				}
