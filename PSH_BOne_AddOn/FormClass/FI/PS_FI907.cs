...
namespace PSH_BOne_AddOn
{
    ...
    /// 부도어음현황
    /// </summary>
    internal class PS_FI907 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFormDocEntry01)
        {
            ...
            try
            {
                oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_FI907.srf");
                ...
                oFormUniqueID = "PS_FI907_" + SubMain.Get_TotalFormsCount();
                SubMain.Add_Forms(this, oFormUniqueID, "PS_FI907");
                ...
                oForm.Freeze(true);
                PS_FI907_CreateItems();
                PS_FI907_ComboBox_Setting();
            }
            catch (Exception ex)
            {
        ...
        /// 화면 Item 생성
        /// </summary>
        private void PS_FI907_CreateItems()
        {
            try
            {
        ...
        ///// FormItemEnabled
        ///// </summary>
        //private void PS_FI907_FormItemEnabled()
        //{
        //    try
        //    {
        //        oForm.Freeze(true);
        ...
        private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
        {
            try
            {
                if (pVal.BeforeAction == true)
                {
                    ...
                    {
                        System.Threading.Thread thread = new System.Threading.Thread(PS_FI907_Print_Report01);
                ...
                else if ((pVal.BeforeAction == false))
                {
                    switch (pVal.MenuUID)
                    {
                        ...
                        case "1281":
                            //찾기
                            break;
                        ////Call PS_FI907_FormItemEnabled '//UDO방식
                        case "1282":
                            //추가
                            break;
                        ////Call PS_FI907_FormItemEnabled '//UDO방식
