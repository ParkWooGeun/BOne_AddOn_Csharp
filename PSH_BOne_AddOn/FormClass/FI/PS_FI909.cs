...
namespace PSH_BOne_AddOn
{
	...
	/// 미수현황
	/// </summary>
	internal class PS_FI909 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry01)
		{
			...
			try
			{
				oXmlDoc01.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_FI909.srf");
				...
				oFormUniqueID01 = "PS_FI909_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID01, "PS_FI909");                   // 폼추가
				...
				PSH_Globals.ExecuteEventFilter(typeof(PS_FI909));
			}
			catch (Exception ex)
			{
		...
		private void Print_Query()
		{
			...
			try
			{
				...
				WinTitle = "[PS_FI909] 미수현황";
				ReportName = "PS_FI909_01.RPT";
