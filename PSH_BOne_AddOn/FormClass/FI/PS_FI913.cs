...
namespace PSH_BOne_AddOn
{
	...
	/// 사원별 접대비 명세서
	/// </summary>
	internal class PS_FI913 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry01)
		{
			...
			try
			{
				oXmlDoc01.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_FI913.srf");
				...
				oFormUniqueID01 = "PS_FI913_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID01, "PS_FI913");                   // 폼추가
				...
				PSH_Globals.ExecuteEventFilter(typeof(PS_FI913));
			}
			catch (Exception ex)
			{
		...
		private void Print_Query()
		{
			...
			try
			{
				...
				WinTitle = "[PS_FI913] 사원별 접대비명세서";
				ReportName = "PS_FI913_01.RPT";
