...
namespace PSH_BOne_AddOn
{
	...
	/// 재작업현황
	/// </summary>
	internal class PS_FI914 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_FI914.srf");
				...
				oFormUniqueID = "PS_FI914_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_FI914");
				...
				PS_FI914_CreateItems();
				PS_FI914_SetComboBox();
				PS_FI914_Initialize();
		...
		/// PS_FI914_CreateItems
		/// </summary>
		private void PS_FI914_CreateItems()
		{
			try
			{
		...
		/// PS_FI914_SetComboBox
		/// </summary>
		private void PS_FI914_SetComboBox()
		{
			string sQry;
		...
		/// PS_FI914_Initialize
		/// </summary>
		private void PS_FI914_Initialize()
		{
		...
		/// <summary>
		/// PS_FI914_PrintReport
		/// </summary>
		[STAThread]
		private void PS_FI914_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				WinTitle = "[PS_FI914_01] 멀티재작업현황";
				ReportName = "PS_FI914_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_FI914_PrintReport);
