	...
	internal class PS_FI961 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFromDocEntry01)
		{
			...
			try
			{
				...
				PS_FI961_CF_ChooseFromList();
				PS_FI961_EnableMenus();
				PS_FI961_SetDocument(oFromDocEntry01);
				PS_FI961_FormResize();
				...
				if ((pval.BeforeAction == true))
				{
					switch (pval.MenuUID)
					{
						...
						case "7169":							//엑셀 내보내기
							...
							{
								PS_FI961_AddMatrixRow1(oMat01.VisualRowCount);
							}
							else
							{
								PS_FI961_AddMatrixRow2(oMat02.VisualRowCount);
							}
							break;
					}
				}
			...
			try
			{
				if (pval.BeforeAction == true)
				{
					if (pval.ItemUID == "Btn01")
					{
						...
						{
							if (PS_FI961_DataValidCheck() == false)
							{
								BubbleEvent = false;
								return;
							}
		...
		/// PS_FI961_ComboBox_Setting
		/// </summary>
		public void PS_FI961_ComboBox_Setting()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
		...
		/// PS_FI961_Initial_Setting
		/// </summary>
		public void PS_FI961_Initial_Setting()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
		...
		/// 
		/// </summary>
		public void PS_FI961_CF_ChooseFromList()
		{
			try
			{
			}
		...
		/// PS_FI961_FormItemEnabled
		/// </summary>
		public void PS_FI961_FormItemEnabled()
		{
			try
			{
				oForm.Freeze(true);
		...
		public void PS_FI961_AddMatrixRow1(int oRow, bool RowIserted = false)
		{
			try
			{
				oForm.Freeze(true);
		...
		/// <param name="oRow"></param>
		/// <param name="RowIserted"></param>
		public void PS_FI961_AddMatrixRow2(int oRow, bool RowIserted = false)
		{
			try
			{
				oForm.Freeze(true);
		...
		/// 
		/// </summary>
		public void PS_FI961_FormClear()
		{
		...
		/// PS_FI961_EnableMenus
		/// </summary>
		private void PS_FI961_EnableMenus()
		{
			try
			{
			}
		...
		/// </summary>
		/// <param name="oFromDocEntry01"></param>
		private void PS_FI961_SetDocument(string oFromDocEntry01)
		{
			try
			{
		...
		/// <summary>
		/// PS_FI961_DataValidCheck
		/// </summary>
		/// <returns></returns>
		public bool PS_FI961_DataValidCheck()
		{
		...
		/// PS_FI961_FormResize
		/// </summary>
		private void PS_FI961_FormResize()
		{
			try
			{
			}
