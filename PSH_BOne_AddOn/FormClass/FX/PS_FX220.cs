...
namespace PSH_BOne_AddOn
{
	...
	/// 자본적지출현황
	/// </summary>
	internal class PS_FX220 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_FX220.srf");
				...
				oFormUniqueID = "PS_FX220_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_FX220");
				...
				oForm.Freeze(true);
				PS_FX220_CreateItems();
				PS_FX220_ComboBox_Setting();
			}
			catch (Exception ex)
			{
		...
		/// PS_FX220_CreateItems
		/// </summary>
		private void PS_FX220_CreateItems()
		{
			try
			{
		...
		/// /PS_FX220_ComboBox_Setting
		/// </summary>
		private void PS_FX220_ComboBox_Setting()
		{
		...
		/// <summary>
		/// PS_FX220_DataValidCheck
		/// </summary>
		/// <returns></returns>
		private bool PS_FX220_DataValidCheck()
		{
		...
		/// <summary>
		/// PS_FX220_Print_Report01
		/// </summary>
		[STAThread]
		private void PS_FX220_Print_Report01()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				WinTitle = "자본적지출현황 [PS_FX220_01]";
				ReportName = "PS_FX220_01.rpt";
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_FX220_DataValidCheck() == false)
							{
								BubbleEvent = false;
								return;
							}
						...
						if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
						{
							System.Threading.Thread thread = new System.Threading.Thread(PS_FX220_Print_Report01);
