...
namespace PSH_BOne_AddOn
{
	...
	/// 고정자산구입현황
	/// </summary>
	internal class PS_FX230 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_FX230.srf");
				...
				oFormUniqueID = "PS_FX230_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_FX230");
				...
				PS_FX230_CreateItems();
				PS_FX230_ComboBox_Setting();
			}
			catch (Exception ex)
			{
		...
		/// PS_FX230_CreateItems
		/// </summary>
		private void PS_FX230_CreateItems()
		{
			try
			{
		...
		/// PS_FX230_ComboBox_Setting
		/// </summary>
		private void PS_FX230_ComboBox_Setting()
		{
		...
		/// <summary>
		/// PS_FX230_DataValidCheck
		/// </summary>
		/// <returns></returns>
		private bool PS_FX230_DataValidCheck()
		{
		...
		/// <summary>
		/// PS_FX230_Print_Report01
		/// </summary>
		[STAThread]
		private void PS_FX230_Print_Report01()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				WinTitle = "고정자산구입현황 [PS_FX230]";
				ReportName = "PS_FX230_01.rpt";
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_FX230_DataValidCheck() == false)
							{
								BubbleEvent = false;
								return;
							}
						...
						if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
						{
							System.Threading.Thread thread = new System.Threading.Thread(PS_FX230_Print_Report01);
