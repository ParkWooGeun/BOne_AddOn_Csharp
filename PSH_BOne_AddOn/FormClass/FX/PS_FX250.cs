...
namespace PSH_BOne_AddOn
{
	...
	/// 고정자산이력현황(개별)
	/// </summary>
	internal class PS_FX250 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_FX250.srf");
				...
				oFormUniqueID = "PS_FX250_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_FX250");
				...
				oForm.Freeze(true);
				PS_FX250_CreateItems();
				PS_FX250_ComboBox_Setting();
			}
			catch (Exception ex)
			{
		...
		/// PS_FX250_CreateItems
		/// </summary>
		private void PS_FX250_CreateItems()
		{
			try
			{
		...
		/// PS_FX250_ComboBox_Setting
		/// </summary>
		private void PS_FX250_ComboBox_Setting()
		{
		...
		private bool PS_FX250_DataValidCheck()
		{
		...
		/// <summary>
		/// PS_FX250_Print_Report01
		/// </summary>
		[STAThread]
		private void PS_FX250_Print_Report01()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				WinTitle = "고정자산이력현황(개별) [PS_FX250_01]";
				ReportName = "PS_FX250_01.rpt";
				...
				dataPackFormula.Add(new PSH_DataPackClass("@Fix_Code", FixCode));
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_FX250_DataValidCheck() == false)
							{
								BubbleEvent = false;
								return;
							}
						...
						if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
						{
							System.Threading.Thread thread = new System.Threading.Thread(PS_FX250_Print_Report01);
