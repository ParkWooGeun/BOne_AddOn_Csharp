...
namespace PSH_BOne_AddOn
{
	...
	/// 실적 조회 및 출력
	/// </summary>
	internal class PS_GA033 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_GA033.srf");
				...
				oFormUniqueID = "PS_GA033_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_GA033");
				...
				oForm.Freeze(true);
				PS_GA033_CreateItems();
				PS_GA033_ComboBox_Setting();
		...
		/// PS_GA033_CreateItems
		/// </summary>
		private void PS_GA033_CreateItems()
		{
			try
			{
		...
		/// 콤보박스 set
		/// </summary>
		private void PS_GA033_ComboBox_Setting()
		{
		...
		/// <summary>
		/// PS_GA033_Print_Report01
		/// </summary>
		[STAThread]
		private void PS_GA033_Print_Report01()
		{
			string WinTitle;
			string ReportName;
			string BPLID;	//사업장
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					else if (pVal.ItemUID == "BtnPrint1")
					{
						if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
						{
							System.Threading.Thread thread = new System.Threading.Thread(PS_GA033_Print_Report01);
