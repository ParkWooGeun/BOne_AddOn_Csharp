...
namespace PSH_BOne_AddOn
{
	...
	/// 전문직정량평가현황
	/// </summary>
	internal class PS_HR423 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFromDocEntry01)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_HR423.srf");
				...
				oFormUniqueID = "PS_HR423_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_HR423");
        ...
        /// PS_HR423_CreateItems
        /// </summary>
        private void PS_HR423_CreateItems()
		{
			try
			{
        ...
        /// PS_HR423_ComboBox_Setting
        /// </summary>
        private void PS_HR423_ComboBox_Setting()
		{
			string sQry;
        ...
        /// <summary>
        /// PS_HR423_HeaderSpaceLineDel
        /// </summary>
        /// <returns></returns>
        private bool PS_HR423_HeaderSpaceLineDel()
		{
        ...
        /// <summary>
        /// PS_HR423_Print_Query
        /// </summary>
        [STAThread]
		private void PS_HR423_Print_Query()
		{
			string WinTitle;
			string ReportName;
			string Year;
        ...
        private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
        {
            try
            {
                if (pVal.BeforeAction == true)
                {
                    ...
                    {
                        if (PS_HR423_HeaderSpaceLineDel() == false)
                        {
                            BubbleEvent = false;
                            return;
                        }
                        ...
                        {
                            System.Threading.Thread thread = new System.Threading.Thread(PS_HR423_Print_Query);
