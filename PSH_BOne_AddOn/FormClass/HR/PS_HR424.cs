...
//****************************************************************************************************************
		...
		public SAPbouiCOM.Matrix oMat01;
			//등록헤더
		private SAPbouiCOM.DBDataSource oDS_PS_HR424H;
			//등록라인
		private SAPbouiCOM.DBDataSource oDS_PS_HR424L;
...
//****************************************************************************************************************
		...
		private void CreateItems()
		{
			...
			oForm01.DataSources.UserDataSources.Add("MSTCOD", SAPbouiCOM.BoDataType.dt_SHORT_TEXT, 10);
			//UPGRADE_WARNING: oForm01.Items().Specific.DataBind 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			oForm01.Items.Item("MSTCOD").Specific.DataBind.SetBound(true, "", "MSTCOD");

			oForm01.DataSources.UserDataSources.Add("FullName", SAPbouiCOM.BoDataType.dt_SHORT_TEXT, 20);
			//UPGRADE_WARNING: oForm01.Items().Specific.DataBind 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			oForm01.Items.Item("FullName").Specific.DataBind.SetBound(true, "", "FullName");

			oForm01.DataSources.UserDataSources.Add("PassWd", SAPbouiCOM.BoDataType.dt_SHORT_TEXT, 20);
			//UPGRADE_WARNING: oForm01.Items().Specific.DataBind 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			oForm01.Items.Item("PassWd").Specific.DataBind.SetBound(true, "", "PassWd");
			...
			oForm01.DataSources.UserDataSources.Item("FullName").Value = oRecordSet01.Fields.Item(0).Value;
...
//****************************************************************************************************************
					...
					case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED:
						...
						//출력버튼 클릭시
							...
							if (HeaderSpaceLineDel() == false) {
								...
								if (PasswordChk(ref pval) == false) {
									SubMain.Sbo_Application.SetStatusBarMessage("패스워드가 틀렸습니다. 확인바랍니다.", SAPbouiCOM.BoMessageTime.bmt_Short, true);
									oForm01.Items.Item("PassWd").Click(SAPbouiCOM.BoCellClickType.ct_Regular);
								} else {
									Print_Query();
								}
							}
		...
		private void Print_Query()
		{
			...
			//UPGRADE_WARNING: oForm01.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			MSTCOD = Strings.Trim(oForm01.Items.Item("MSTCOD").Specific.VALUE);
			...
			/// Procedure 실행"
			sQry = "EXEC [PS_HR424_01] '" + BPLID + "','" + Year_Renamed + "','" + Number + "','" + Group + "','" + MSTCOD + "'";
			oRecordSet.DoQuery(sQry);
...
//// 패스워드 Check
		public bool PasswordChk(ref SAPbouiCOM.ItemEvent pval)
		{
			bool functionReturnValue = false;
			 // ERROR: Not supported in C#: OnErrorStatement
			...
			MSTCOD = Strings.Trim(oForm01.Items.Item("MSTCOD").Specific.VALUE);
			//UPGRADE_WARNING: oForm01.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			PassWd = Strings.Trim(oForm01.Items.Item("PassWd").Specific.VALUE);

			if (string.IsNullOrEmpty(Strings.Trim(MSTCOD))) {
				MDC_Com.MDC_GF_Message(ref "사번이 없습니다. 입력바랍니다!", ref "E");
				functionReturnValue = false;
				return functionReturnValue;
			}

			//UPGRADE_WARNING: oForm01.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			sQry = "Select Count(*) From Z_PS_HRPASS Where MSTCOD = '" + Strings.Trim(oForm01.Items.Item("MSTCOD").Specific.VALUE) + "'";
			//UPGRADE_WARNING: oForm01.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			sQry = sQry + " And  BPLId = '" + oForm01.Items.Item("BPLId").Specific.VALUE + "' ";
			//UPGRADE_WARNING: oForm01.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			sQry = sQry + " And  PassWd = '" + oForm01.Items.Item("PassWd").Specific.VALUE + "' ";
			...
			//UPGRADE_NOTE: RecordSet01 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
			RecordSet01 = null;
			MDC_Com.MDC_GF_Message(ref "PasswordChk_Error:" + Err().Number + " - " + Err().Description, ref "E");
			return functionReturnValue;
		}
	}
}
