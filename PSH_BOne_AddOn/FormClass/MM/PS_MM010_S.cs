...
namespace PSH_BOne_AddOn
{
    ...
    /// 구매견적_청구내역조회SUB
    /// </summary>
    internal class PS_MM010_S : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFromDocEntry01)
        {
            ...
            try
            {
                oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_MM010_S.srf");
                ...
                oFormUniqueID = "PS_MM010_S_" + SubMain.Get_TotalFormsCount();
                SubMain.Add_Forms(this, oFormUniqueID, "PS_MM010_S");
