...
namespace PSH_BOne_AddOn
{
	...
	/// 통합구매미등록거래처조회
	/// </summary>
	internal class PS_MM017 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_MM017.srf");
				...
				oFormUniqueID = "PS_MM017_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_MM017");
				...
				PS_MM017_CreateItems();
				PS_MM017_ComboBox_Setting();
			}
			catch (Exception ex)
			{
		...
		/// PS_MM017_CreateItems
		/// </summary>
		private void PS_MM017_CreateItems()
		{
			try
			{
		...
		/// PS_MM017_ComboBox_Setting
		/// </summary>
		private void PS_MM017_ComboBox_Setting()
		{
			string sQry;
