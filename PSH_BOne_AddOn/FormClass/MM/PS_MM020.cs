...
namespace PSH_BOne_AddOn
{
	...
	/// 자재순환품조회
	/// </summary>
	internal class PS_MM020 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_MM020.srf");
				...
				oFormUniqueID = "PS_MM020_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_MM020");
				...
				oForm.Freeze(true);
				PS_MM020_CreateItems();
				PS_MM020_ComboBox_Setting();
			}
			catch (Exception ex)
			{
		...
		/// PS_MM020_CreateItems
		/// </summary>
		private void PS_MM020_CreateItems()
		{
			try
			{
				...
				oForm.DataSources.UserDataSources.Add("Year", SAPbouiCOM.BoDataType.dt_SHORT_TEXT, 100);
		...
		/// PS_MM020_ComboBox_Setting
		/// </summary>
		private void PS_MM020_ComboBox_Setting()
		{
			string sQry;
			...
			try
			{
				sQry = "select '%' as PrcCode , '전체' as PrcName union all Select PrcCode, PrcName From [OPRC] Where DimCode = '1' AND Active = 'Y' Order by PrcCode";
				...
				oForm.Items.Item("UseDept").Specific.Select(0, SAPbouiCOM.BoSearchKey.psk_Index);
		...
		private void PS_MM020_MTX01()
		{
			...
			try
			{
				...
				Param03 = oForm.Items.Item("CardCode").Specific.Value.ToString().Trim();
				Param04 = oForm.Items.Item("ItemCode").Specific.Value.ToString().Trim();
				Param05 = oForm.Items.Item("UseDept").Specific.Value.ToString().Trim();

				sQry = "EXEC PS_MM020_01 '" + Param01 + "', '" + Param02 + "', '" + Param03 + "', '" + Param04 + "', '" + Param05 + "'";
