...
namespace PSH_BOne_AddOn
{
    ...
    /// 품의승인조회
    /// </summary>
    internal class PS_MM041 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFromDocEntry01)
        {
            ...
            try
            {
                oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_MM041.srf");
                ...
                oFormUniqueID = "PS_MM041_" + SubMain.Get_TotalFormsCount();
                SubMain.Add_Forms(this, oFormUniqueID, "PS_MM041");
                ...
                oForm.Freeze(true);
                PS_MM041_CreateItems();
                PS_MM041_ComboBox_Setting();
                PS_MM041_Initialization();
        ...
        /// 화면 Item 생성
        /// </summary>
        private void PS_MM041_CreateItems()
        {
            try
            {
                ////디비데이터 소스 개체 할당
                ...
                oForm.DataSources.UserDataSources.Add("AdmDateFr", SAPbouiCOM.BoDataType.dt_DATE, 8);
                oForm.Items.Item("AdmDateFr").Specific.DataBind.SetBound(true, "", "AdmDateFr");

                oForm.DataSources.UserDataSources.Add("AdmDateTo", SAPbouiCOM.BoDataType.dt_DATE, 8);
                oForm.Items.Item("AdmDateTo").Specific.DataBind.SetBound(true, "", "AdmDateTo");
            }
            catch (Exception ex)
            {
                PSH_Globals.SBO_Application.MessageBox(System.Reflection.MethodBase.GetCurrentMethod().Name + "_Error : " + ex.Message);
        ...
        /// Combobox 설정
        /// </summary>
        private void PS_MM041_ComboBox_Setting()
        {
            string sQry;
        ...
        /// Initialization
        /// </summary>
        private void PS_MM041_Initialization()
        {
            PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
        ...
        /// </summary>
        /// <returns></returns>
        private bool PS_MM041_HeaderSpaceLineDel()
        {
        ...
        /// </summary>
        /// <returns></returns>
        private bool PS_MM041_MatrixSpaceLineDel()
        {
            bool functionReturnValue = false;
            string errMessage = string.Empty;
        ...
        /// </summary>
        /// <returns></returns>
        private bool PS_MM041_Display_MatrixData()
        {
            bool functionReturnValue = false;
            int sCnt;
            string sQry;
            ...
            try
            {
                ...
                DocType = "PS_MM041";
                AdmDateFr = oForm.Items.Item("AdmDateFr").Specific.Value.ToString().Trim();
                AdmDateTo = oForm.Items.Item("AdmDateTo").Specific.Value.ToString().Trim();
                ...
                sQry += "'" + DocDateTo + "', '" + DueDateFr + "', '" + DueDateTo + "', '" + Purchase + "', '" + POStatus + "','" + DocType + "','" + AdmDateFr + "','" + AdmDateTo + "' ,''";
                oRecordSet01.DoQuery(sQry);
        ...
        private void PS_MM041_FlushToItemValue(string oUID, int oRow, string oCol)
        {
            string sQry;
            PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
            SAPbobsCOM.Recordset oRecordSet01 = PSH_Globals.oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset);
        ...
        private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
        {
            try
            {
                ...
                else if (pVal.BeforeAction == false)
                {
                    ...
                    {
                        if (PS_MM041_HeaderSpaceLineDel() == false)
                        {
                            BubbleEvent = false;
                            return;
                        }
                        PS_MM041_Display_MatrixData();
                    }
                }
            }
            catch (Exception ex)
            ...
            try
            {
                ...
                else if (pVal.Before_Action == false)
                {
                    if (pVal.ItemChanged == true)
                    {
                        if (pVal.ItemUID == "CardCode")
                        {
                            PS_MM041_FlushToItemValue(pVal.ItemUID, 0, "");
                        }
