...
namespace PSH_BOne_AddOn
{
	...
	/// 지체상금현황
	/// </summary>
	internal class PS_MM173 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_MM173.srf");
				...
				oFormUniqueID = "PS_MM173_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_MM173");
				...
				oForm.Freeze(true);
				PS_MM173_CreateItems();
				PS_MM173_ComboBox_Setting();
		...
		/// PS_MM173_CreateItems
		/// </summary>
		private void PS_MM173_CreateItems()
		{
			try
			{
		...
		/// PS_MM173_ComboBox_Setting
		/// </summary>
		private void PS_MM173_ComboBox_Setting()
		{
			string sQry;
			...
			try
			{
				...
				//출력구분
				oForm.Items.Item("Gbn01").Specific.ValidValues.Add("1", "지체상금대상현황");
				oForm.Items.Item("Gbn01").Specific.ValidValues.Add("2", "지체상금처리현황");
				oForm.Items.Item("Gbn01").Specific.Select("0", SAPbouiCOM.BoSearchKey.psk_Index);
		...
		/// <summary>
		/// PS_MM173_Print_Query 리포트 출력
		/// </summary>
		[STAThread]
		private void PS_MM173_Print_Query()
		{
			...
			try
			{
				...
				Gbn01 = oForm.Items.Item("Gbn01").Specific.Selected.Value.ToString().Trim();
				...
				if (Gbn01 == "1")
				{
					WinTitle = "지체상금대상현황[PS_MM173_01]";
					ReportName = "PS_MM173_01.RPT";
				}
				else if (Gbn01 == "2")
				{
					WinTitle = "지체상금처리현황[PS_MM173_02]";
					ReportName = "PS_MM173_02.RPT";
				}
				...
				dataPackFormula.Add(new PSH_DataPackClass("@DocDateFr", StrDate.Substring(0, 4) + "-" + StrDate.Substring(4, 2) + "-" + StrDate.Substring(6, 2)));
				dataPackFormula.Add(new PSH_DataPackClass("@DocDateTo", EndDate.Substring(0, 4) + "-" + EndDate.Substring(4, 2) + "-" + EndDate.Substring(6, 2)));
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_MM173_Print_Query);
