...
namespace PSH_BOne_AddOn
{
	...
	/// 외주가공비용현황
	/// </summary>
	internal class PS_MM190 : PSH_BaseClass
{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_MM190.srf");
				...
				oFormUniqueID = "PS_MM190_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_MM190");
				...
				oForm.Freeze(true);
				PS_MM190_CreateItems();
				PS_MM190_ComboBox_Setting();
		...
		/// PS_MM190_CreateItems
		/// </summary>
		private void PS_MM190_CreateItems()
		{
			try
			{
		...
		/// PS_MM190_ComboBox_Setting
		/// </summary>
		private void PS_MM190_ComboBox_Setting()
		{
			string sQry;
		...
		/// <summary>
		/// PS_MM190_Print_Query 리포트 출력
		/// </summary>
		[STAThread]
		private void PS_MM190_Print_Query()
		{
			string WinTitle;
			...
			try
			{
				...
				WinTitle = "[PS_MM190] 외주가공비용현황";

				if (RadioBtn == "A")
				{
					ReportName = "PS_MM190_01.RPT";
				}
				else if (RadioBtn == "B")
				{
					ReportName = "PS_MM190_02.RPT";
				}
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_MM190_Print_Query);
