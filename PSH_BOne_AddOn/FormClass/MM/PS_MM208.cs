...
namespace PSH_BOne_AddOn
{
	...
	/// 스크랩회수운송지출내역서
	/// </summary>
	internal class PS_MM208 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_MM208.srf");
				...
				oFormUniqueID = "PS_MM208_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_MM208");
				...
				oForm.Freeze(true);
				PS_MM208_CreateItems();
				PS_MM208_ComboBox_Setting();
		...
		/// PS_MM208_CreateItems
		/// </summary>
		private void PS_MM208_CreateItems()
		{
			try
			{
		...
		/// PS_MM208_ComboBox_Setting
		/// </summary>
		private void PS_MM208_ComboBox_Setting()
		{
			string sQry;
		...
		/// <summary>
		/// PS_MM208_Print_Query
		/// </summary>
		[STAThread]
		private void PS_MM208_Print_Query()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				WinTitle = "스크랩회수운송지출내역서 [PS_MM208]";
				ReportName = "PS_MM208_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_MM208_Print_Query);
