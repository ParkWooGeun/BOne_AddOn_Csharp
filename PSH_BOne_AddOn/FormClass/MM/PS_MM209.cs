...
namespace PSH_BOne_AddOn
{
	...
	/// 수불명세서
	/// </summary>
	internal class PS_MM209 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_MM209.srf");
				...
				oFormUniqueID = "PS_MM209_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_MM209");
				...
				oForm.Freeze(true);
				PS_MM209_CreateItems();
				PS_MM209_ComboBox_Setting();
		...
		/// PS_MM209_CreateItems
		/// </summary>
		private void PS_MM209_CreateItems()
		{
			try
			{
		...
		/// PS_MM209_ComboBox_Setting
		/// </summary>
		private void PS_MM209_ComboBox_Setting()
		{
			string sQry;
			...
			try
			{
				...
				oForm.Items.Item("BPLId").Specific.ValidValues.Add(Convert.ToString(6), "안강+울산사업장");
		...
		/// <summary>
		/// PS_MM209_HeaderSpaceLineDel
		/// </summary>
		/// <returns></returns>
		private bool PS_MM209_HeaderSpaceLineDel()
		{
		...
		/// <summary>
		/// PS_MM209_Print_Query
		/// </summary>
		[STAThread]
		private void PS_MM209_Print_Query()
		{
			...
			try
			{
				...
				if (Gubun == "1")
				{
					if (ChkBox02 == "Y")
					{
						WinTitle = "[PS_MM209_01] 수불명세서";
						ReportName = "PS_MM209_01.RPT";
					}
					else
                    {
						WinTitle = "[PS_MM209_02] 수불명세서";
						ReportName = "PS_MM209_02.RPT";
					}
				}
				else if (Gubun == "2")
				{
					WinTitle = "[PS_MM209_04] 수불명세서(집계)";
				...
				if (BPLId == "6")
				{
					dataPackFormula.Add(new PSH_DataPackClass("@BPLId", "안강+울산 사업장"));
				}
				else
				{
				...
				if ((Gubun == "1" && ChkBox02 == "N") || Gubun == "2")
                {
					dataPackParameter.Add(new PSH_DataPackClass("@Class", "PS_MM209"));
				}
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						if (PS_MM209_HeaderSpaceLineDel() == false)
						{
							BubbleEvent = false;
							return;
						}
						...
						{
							System.Threading.Thread thread = new System.Threading.Thread(PS_MM209_Print_Query);
