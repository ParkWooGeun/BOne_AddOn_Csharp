...
namespace PSH_BOne_AddOn
{
	...
	/// 외주스크랩수불부
	/// </summary>
	internal class PS_MM220 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_MM220.srf");
				...
				oFormUniqueID = "PS_MM220_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_MM220");
		...
		/// PS_MM220_CreateItems
		/// </summary>
		private void PS_MM220_CreateItems()
		{
			try
			{
		...
		/// <summary>
		/// PS_MM220_DataValidCheck
		/// </summary>
		/// <returns></returns>
		private bool PS_MM220_DataValidCheck()
		{
		...
		/// <summary>
		/// PS_MM220_Print_Report01
		/// </summary>
		[STAThread]
		private void PS_MM220_Print_Report01()
		{
			string WinTitle;
			string ReportName;
			string DocDateFr;
			...
			try
			{
				...
				WinTitle = "외주 스크랩 수불부 [PS_MM220]";
				ReportName = "PS_MM220_01.rpt";
			    ...
			    {
					dataPackFormula.Add(new PSH_DataPackClass("@CardName", "전체"));
				}
				else
				{
					dataPackFormula.Add(new PSH_DataPackClass("@CardName", CardName));
				}

				//Parameter
				dataPackParameter.Add(new PSH_DataPackClass("@StrDate", DateTime.ParseExact(DocDateFr, "yyyyMMdd", null)));
				dataPackParameter.Add(new PSH_DataPackClass("@EndDate", DateTime.ParseExact(DocDateTo, "yyyyMMdd", null)));
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						if (PS_MM220_DataValidCheck() == false)
						{
							BubbleEvent = false;
							return;
						}
						...
						{
							System.Threading.Thread thread = new System.Threading.Thread(PS_MM220_Print_Report01);
