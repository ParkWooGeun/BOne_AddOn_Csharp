...
namespace PSH_BOne_AddOn
{
	...
	/// 부품일자별외주수불현황
	/// </summary>
	internal class PS_MM240 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_MM240.srf");
				...
				oFormUniqueID = "PS_MM240_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_MM240");
				...
				oForm.Freeze(true);
				PS_MM240_CreateItems();
				PS_MM240_ComboBox_Setting();
		...
		/// PS_MM240_CreateItems
		/// </summary>
		private void PS_MM240_CreateItems()
		{
			try
			{
		...
		/// PS_MM240_ComboBox_Setting
		/// </summary>
		private void PS_MM240_ComboBox_Setting()
		{
			string sQry;
		...
		/// <summary>
		/// PS_MM240_FlushToItemValue
		/// </summary>
		/// <param name="oUID"></param>
		private void PS_MM240_FlushToItemValue(string oUID)
		{
			string sQry;
			SAPbobsCOM.Recordset oRecordSet = PSH_Globals.oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset);
		...
		/// <summary>
		/// PS_MM240_HeaderSpaceLineDel
		/// </summary>
		/// <returns></returns>
		private bool PS_MM240_HeaderSpaceLineDel()
		{
			...
			try
			{
				...
				{
					errMessage = "제품코드는 필수사항입니다. 확인하여 주십시오.";
					throw new Exception();
				}
		...
		/// <summary>
		/// PS_MM240_Print_Query
		/// </summary>
		[STAThread]
		private void PS_MM240_Print_Query()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				WinTitle = "[PS_MM240_01] 부품일자별외주수불현황";
				ReportName = "PS_MM240_01.RPT";
				...
				dataPackFormula.Add(new PSH_DataPackClass("@ItemCode", ItemCode));
				dataPackFormula.Add(new PSH_DataPackClass("@ItemName", ItemName));

				//Parameter
				dataPackParameter.Add(new PSH_DataPackClass("@BPLId", BPLId));
				dataPackParameter.Add(new PSH_DataPackClass("@DocDateTo", DocDate));
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						if (PS_MM240_HeaderSpaceLineDel() == false)
						{
							BubbleEvent = false;
							return;
						}
						...
						{
							System.Threading.Thread thread = new System.Threading.Thread(PS_MM240_Print_Query);
		...
		private void Raise_EVENT_VALIDATE(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				...
				if (pVal.BeforeAction == true)
				{
					...
					{
						PS_MM240_FlushToItemValue(pVal.ItemUID);
					}
