...
namespace PSH_BOne_AddOn
{
	...
	/// 임가공원재료입고현황
	/// </summary>
	internal class PS_MM243 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_MM243.srf");
				...
				oFormUniqueID = "PS_MM243_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_MM243");
				...
				oForm.Freeze(true);
				PS_MM243_CreateItems();
				PS_MM243_ComboBox_Setting();
		...
		/// PS_MM243_CreateItems
		/// </summary>
		private void PS_MM243_CreateItems()
		{
			try
			{
		...
		/// PS_MM243_ComboBox_Setting
		/// </summary>
		private void PS_MM243_ComboBox_Setting()
		{
			string sQry;
			...
			try
			{
				...
				oForm.Items.Item("Location").Specific.Select(dataHelpClass.User_BPLID(), SAPbouiCOM.BoSearchKey.psk_ByValue);
			}
			catch (Exception ex)
			{
				PSH_Globals.SBO_Application.MessageBox(System.Reflection.MethodBase.GetCurrentMethod().Name + "_Error : " + ex.Message);
		...
		/// <summary>
		/// PS_MM243_FlushToItemValue
		/// </summary>
		/// <param name="oUID"></param>
		private void PS_MM243_FlushToItemValue(string oUID)
		{
			string sQry;
			SAPbobsCOM.Recordset oRecordSet = PSH_Globals.oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset);
		...
		/// <summary>
		/// PS_MM243_Print_Query 리포트 출력
		/// </summary>
		[STAThread]
		private void PS_MM243_Print_Query()
		{
			string WinTitle;
			string ReportName;
			string Location;
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_MM243_Print_Query);
			...
			try
			{
				...
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemChanged == true)
					{
						...
						{
							PS_MM243_FlushToItemValue(pVal.ItemUID);
						}
