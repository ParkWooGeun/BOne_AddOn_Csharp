...
namespace PSH_BOne_AddOn
{
	...
	/// 구매실적가격현황
	/// </summary>
	internal class PS_MM250 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_MM250.srf");
				...
				oFormUniqueID = "PS_MM250_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_MM250");
				...
				oForm.Freeze(true);
				PS_MM250_CreateItems();
				PS_MM250_ComboBox_Setting();
			}
			catch (Exception ex)
			{
		...
		/// PS_MM250_CreateItems
		/// </summary>
		private void PS_MM250_CreateItems()
		{
			try
			{
				...
				oForm.DataSources.UserDataSources.Add("OrdType", SAPbouiCOM.BoDataType.dt_SHORT_TEXT, 100);
		...
		/// PS_MM250_ComboBox_Setting
		/// </summary>
		private void PS_MM250_ComboBox_Setting()
		{
			string sQry;
		...
		/// <summary>
		/// PS_MM250_DataValidCheck
		/// </summary>
		/// <returns></returns>
		private bool PS_MM250_DataValidCheck()
		{
		...
		/// <summary>
		/// PS_MM250_Print_Report01 리포트 출력
		/// </summary>
		[STAThread]
		private void PS_MM250_Print_Report01()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				WinTitle = "[PS_MM250] 레포트";
				ReportName = "PS_MM250_01.rpt";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						if (PS_MM250_DataValidCheck() == false)
						{
							BubbleEvent = false;
							return;
						}

						System.Threading.Thread thread = new System.Threading.Thread(PS_MM250_Print_Report01);
