...
namespace PSH_BOne_AddOn
{
	...
	/// 외주 미입고 현황
	/// </summary>
	internal class PS_MM270 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_MM270.srf");
				...
				oFormUniqueID = "PS_MM270_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_MM270");
				...
				oForm.Freeze(true);
				PS_MM270_CreateItems();
				PS_MM270_ComboBox_Setting();
				PS_MM270_FormItemEnabled();
		...
		/// PS_MM270_CreateItems
		/// </summary>
		private void PS_MM270_CreateItems()
		{
		...
		/// PS_MM270_ComboBox_Setting
		/// </summary>
		private void PS_MM270_ComboBox_Setting()
		{
			string sQry;
			SAPbobsCOM.Recordset oRecordSet = PSH_Globals.oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset);
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
		...
		/// </summary>
		private void PS_MM270_FormItemEnabled()
		{
			string sQry;
			SAPbobsCOM.Recordset oRecordSet = PSH_Globals.oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset);
			try
			{
				//업체계정은 다른업체 검색불가능하도록 False처리.
		...
		/// <summary>
		/// PS_MM270_HeaderSpaceLineDel
		/// </summary>
		/// <returns></returns>
		private bool PS_MM270_HeaderSpaceLineDel()
		{
			...
			try
			{
				...
				{
					errMessage = "기준일자는 필수사항입니다. 입력하여 주십시오.";
					throw new Exception();
				}
		...
		/// <summary>
		/// PS_MM270_Print_Query
		/// </summary>
		[STAThread]
		private void PS_MM270_Print_Query()
		{
			string WinTitle;
			string ReportName;
			string DocDateFr;
			...
			try
			{
				...
				WinTitle = "[PS_MM270] 외주 미입고 현황";
				
				if(BPLId=="1")
                {
					ReportName = "PS_MM270_01.RPT";
					//Formula List
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						if (PS_MM270_HeaderSpaceLineDel() == false)
						{
							BubbleEvent = false;
							return;
						}
						...
						{
							System.Threading.Thread thread = new System.Threading.Thread(PS_MM270_Print_Query);
