...
namespace PSH_BOne_AddOn
{
	...
	/// 기간별SCRAP반납내역(멀티)
	/// </summary>
	internal class PS_MM280 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_MM280.srf");
				...
				oFormUniqueID = "PS_MM280_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_MM280");
				...
				oForm.Freeze(true);
				PS_MM280_CreateItems();
				PS_MM280_ComboBox_Setting();
		...
		/// PS_MM280_CreateItems
		/// </summary>
		private void PS_MM280_CreateItems()
		{
			try
			{
		...
		/// PS_MM280_ComboBox_Setting
		/// </summary>
		private void PS_MM280_ComboBox_Setting()
		{
			string sQry;
		...
		/// <summary>
		/// PS_MM210_PS_MM280_Print_Query
		/// </summary>
		[STAThread]
		private void PS_MM280_Print_Query()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				WinTitle = "기간별SCRAP반납내역(멀티)[PS_MM280]";
				ReportName = "PS_MM280_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_MM280_Print_Query);
