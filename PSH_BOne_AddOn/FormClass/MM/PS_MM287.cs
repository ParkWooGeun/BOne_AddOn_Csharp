...
namespace PSH_BOne_AddOn
{
	...
	/// 개인별작업시간현황 MM286_SUB
	/// </summary>
	internal class PS_MM287 : PSH_BaseClass
	{
		...
		public void LoadForm(string prmItemCode, string prmItemName, string prmFrDt, string prmToDt)
		{
			int i;
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_MM287.srf");
				...
				oFormUniqueID = "PS_MM287_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_MM287");
				...
				oForm.Freeze(true);
				PS_MM287_CreateItems();
				PS_MM287_MTX01(prmItemCode, prmItemName, prmFrDt, prmToDt);
			}
			catch (Exception ex)
			{
		...
		/// PS_MM287_CreateItems
		/// </summary>
		private void PS_MM287_CreateItems()
		{
			try
			{
		...
		/// <param name="prmFrDt"></param>
		/// <param name="prmToDt"></param>
		private void PS_MM287_MTX01(string prmItemCode, string prmItemName, string prmFrDt, string prmToDt)
		{
			string sQry;
			...
			{
				oForm.Freeze(true);
				oForm.Items.Item("ItemCode").Specific.Value = prmItemCode;
				oForm.Items.Item("ItemName").Specific.Value = prmItemName;

				ProgressBar01.Text = "조회시작!";

				sQry = "    EXEC PS_MM287_01 '";
				sQry += prmItemCode + "','";
				sQry += prmFrDt + "','";
				sQry += prmToDt + "'";
