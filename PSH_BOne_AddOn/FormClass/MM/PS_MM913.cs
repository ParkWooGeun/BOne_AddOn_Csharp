...
namespace PSH_BOne_AddOn
{
	...
	/// 수불현황(중분류별집계)
	/// </summary>
	internal class PS_MM913 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_MM913.srf");
				...
				oFormUniqueID = "PS_MM913_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_MM913");
				...
				oForm.Freeze(true);
				PS_MM913_CreateItems();
				PS_MM913_ComboBox_Setting();
		...
		/// PS_MM913_CreateItems
		/// </summary>
		private void PS_MM913_CreateItems()
		{
			try
			{
		...
		/// PS_MM913_ComboBox_Setting
		/// </summary>
		private void PS_MM913_ComboBox_Setting()
		{
			string sQry;
		...
		/// <summary>
		/// PS_MM913_HeaderSpaceLineDel
		/// </summary>
		/// <returns></returns>
		private bool PS_MM913_HeaderSpaceLineDel()
		{
		...
		/// <summary>
		/// PS_MM913_Print_Query
		/// </summary>
		[STAThread]
		private void PS_MM913_Print_Query()
		{
			string WinTitle;
			string ReportName;
			string ItmBsort;
			...
			try
			{
				...
				WinTitle = "[PS_MM913] 수불현황(중분류별집계)";
				ReportName = "PS_MM913_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						if (PS_MM913_HeaderSpaceLineDel() == false)
						{
							BubbleEvent = false;
							return;
						}
						...
						{
							System.Threading.Thread thread = new System.Threading.Thread(PS_MM913_Print_Query);
