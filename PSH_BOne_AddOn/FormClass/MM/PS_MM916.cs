...
namespace PSH_BOne_AddOn
{
	...
	/// 외주가공스크랩발생현황
	/// </summary>
	internal class PS_MM916 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_MM916.srf");
				...
				oFormUniqueID = "PS_MM916_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_MM916");
				...
				oForm.Freeze(true);
				PS_MM916_CreateItems();
				PS_MM916_ComboBox_Setting();
			}
			catch (Exception ex)
			{
		...
		/// PS_MM916_CreateItems
		/// </summary>
		private void PS_MM916_CreateItems()
		{
			try
			{
		...
		/// PS_MM916_ComboBox_Setting
		/// </summary>
		private void PS_MM916_ComboBox_Setting()
		{
			string sQry;
		...
		/// <summary>
		/// PS_MM916_DataValidCheck
		/// </summary>
		/// <returns></returns>
		public bool PS_MM916_DataValidCheck()
		{
		...
		/// <summary>
		/// PS_MM916_Print_Report01
		/// </summary>
		[STAThread]
		private void PS_MM916_Print_Report01()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				WinTitle = "외주가공스크랩발생현황[PS_MM916]";
				ReportName = "PS_MM916_01.rpt";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						if (PS_MM916_DataValidCheck() == false)
						{
							BubbleEvent = false;
							return;
						}
						...
						{
							System.Threading.Thread thread = new System.Threading.Thread(PS_MM916_Print_Report01);
