...
namespace PSH_BOne_AddOn
{
	...
	/// 원재료(부품)입고현황
	/// </summary>
	internal class PS_MM917 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_MM917.srf");
				...
				oFormUniqueID = "PS_MM917_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_MM917");
				...
				oForm.Freeze(true);
				PS_MM917_CreateItems();
				PS_MM917_ComboBox_Setting();
		...
		/// PS_MM917_CreateItems
		/// </summary>
		private void PS_MM917_CreateItems()
		{
			try
			{
		...
		/// PS_MM917_ComboBox_Setting
		/// </summary>
		private void PS_MM917_ComboBox_Setting()
		{
			string sQry;
		...
		/// <summary>
		/// PS_MM917_Print_Query 리포트 출력
		/// </summary>
		[STAThread]
		private void PS_MM917_Print_Query()
		{
			string WinTitle;
			string ReportName;
			string StrDate;
			...
			try
			{
				...
				WinTitle = "[PS_MM917] 원재료 입고현황";
				ReportName = "PS_MM917_01.RPT";
				...
				if (ItmBSort == "%" || string.IsNullOrEmpty(ItmBSort))
				{
					dataPackFormula.Add(new PSH_DataPackClass("@BName", "전체"));
				}
				else
				{
					dataPackFormula.Add(new PSH_DataPackClass("@BName", dataHelpClass.Get_ReData("Name", "Code", "[@PSH_ITMBSORT]", ItmBSort, "")));
				}
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_MM917_Print_Query);
				...
				else if (pVal.BeforeAction == false)
				{
					if (pVal.ItemChanged == true)
					{
						...
						if (pVal.ItemUID == "ItmBsort")
						{
							...
							oRecordSet.DoQuery(sQry);
							oForm.Items.Item("BsortName").Specific.Value = oRecordSet.Fields.Item(0).Value.ToString().Trim();
						}
