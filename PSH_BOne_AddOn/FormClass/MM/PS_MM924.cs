...
namespace PSH_BOne_AddOn
{
	...
	/// 제품반품현황
	/// </summary>
	internal class PS_MM924 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_MM924.srf");
				...
				oFormUniqueID = "PS_MM924_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_MM924");
				...
				oForm.Freeze(true);
				PS_MM924_CreateItems();
				PS_MM924_ComboBox_Setting();
		...
		/// PS_MM924_CreateItems
		/// </summary>
		private void PS_MM924_CreateItems()
		{
			try
			{
		...
		/// PS_MM924_ComboBox_Setting
		/// </summary>
		private void PS_MM924_ComboBox_Setting()
		{
			string sQry;
		...
		/// <summary>
		/// PS_MM924_Print_Query 리포트 출력
		/// </summary>
		[STAThread]
		private void PS_MM924_Print_Query()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				WinTitle = "[PS_MM924_01] 제품반품현황";
				ReportName = "PS_MM924_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_MM924_Print_Query);
