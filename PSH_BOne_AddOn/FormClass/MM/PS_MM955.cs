...
namespace PSH_BOne_AddOn
{
	...
	/// 외주수불부
	/// </summary>
	internal class PS_MM955 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_MM955.srf");
				...
				oFormUniqueID = "PS_MM955_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_MM955");
				...
				PS_MM955_CreateItems();
				PS_MM955_ComboBox_Setting();
				PS_MM955_Initial_Setting();
			}
			catch (Exception ex)
			{
		...
		/// PS_MM955_CreateItems
		/// </summary>
		private void PS_MM955_CreateItems()
		{
			try
			{
		...
		/// PS_MM955_ComboBox_Setting
		/// </summary>
		private void PS_MM955_ComboBox_Setting()
		{
		...
		/// PS_MM955_Initial_Setting
		/// </summary>
		private void PS_MM955_Initial_Setting()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
		...
		/// <summary>
		/// PS_MM955_DataValidCheck
		/// </summary>
		/// <returns></returns>
		private bool PS_MM955_DataValidCheck()
		{
		...
		/// <summary>
		/// PS_MM955_Print_Report01
		/// </summary>
		[STAThread]
		private void PS_MM955_Print_Report01()
		{
			string WinTitle;
			string ReportName;
			string sQry;
			...
			try
			{
				...
				WinTitle = "외주수불부 [PS_MM955]";

				if (oForm.Items.Item("Rad01").Specific.Selected == true)
				{
					ReportName = "PS_MM955_01.rpt";
				}
				else
				{
					ReportName = "PS_MM955_02.rpt";
				}
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_MM955_DataValidCheck() == false)
							{
								BubbleEvent = false;
								return;
							}
						...
						if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
						{
							System.Threading.Thread thread = new System.Threading.Thread(PS_MM955_Print_Report01);
