...
namespace PSH_BOne_AddOn
{
	...
	internal class PS_MM955 : PSH_BaseClass
	{
		...
		/// PS_MM955_SetComboBox
		/// </summary>
		private void PS_MM955_SetComboBox()
		{
		...
		/// PS_MM955_Initialize
		/// </summary>
		private void PS_MM955_Initialize()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
		...
		/// <summary>
		/// PS_MM955_CheckDataValid
		/// </summary>
		/// <returns></returns>
		private bool PS_MM955_CheckDataValid()
		{
		...
		/// <summary>
		/// PS_MM955_PrintReport
		/// </summary>
		[STAThread]
		private void PS_MM955_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string sQry;
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_MM955_CheckDataValid() == false)
							{
								BubbleEvent = false;
								return;
							}
							...
							{
								System.Threading.Thread thread = new System.Threading.Thread(PS_MM955_PrintReport);
