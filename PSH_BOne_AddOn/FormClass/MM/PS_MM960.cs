...
namespace PSH_BOne_AddOn
{
	...
	/// 외주입고현황
	/// </summary>
	internal class PS_MM960 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_MM960.srf");
				...
				oFormUniqueID = "PS_MM960_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_MM960");
				...
				PS_MM960_CreateItems();
				PS_MM960_ComboBox_Setting();
				PS_MM960_Initial_Setting();
			}
			catch (Exception ex)
			{
		...
		/// PS_MM960_CreateItems
		/// </summary>
		private void PS_MM960_CreateItems()
		{
			try
			{
		...
		/// PS_MM960_ComboBox_Setting
		/// </summary>
		private void PS_MM960_ComboBox_Setting()
		{
		...
		/// PS_MM960_Initial_Setting
		/// </summary>
		private void PS_MM960_Initial_Setting()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
		...
		/// <summary>
		/// PS_MM960_DataValidCheck
		/// </summary>
		/// <returns></returns>
		private bool PS_MM960_DataValidCheck()
		{
			...
			try
			{
				...
				if (string.IsNullOrEmpty(oForm.Items.Item("DocDateFr").Specific.Value.ToString().Trim()))
				{
					...
					errMessage = "작업일자 From은 필수입니다. 필수입니다.";
					throw new Exception();
				}
		...
		/// <summary>
		/// PS_MM960_Print_Report01
		/// </summary>
		[STAThread]
		private void PS_MM960_Print_Report01()
		{
			string WinTitle;
			string ReportName;
			string sQry;
			...
			try
			{
				...
				WinTitle = "외주입고현황 [PS_MM960]";

				if (Div == "1")
				{
					ReportName = "PS_MM960_01.rpt";
				}
				else
				{
					ReportName = "PS_MM960_02.rpt";
				}
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_MM960_DataValidCheck() == false)
							{
								BubbleEvent = false;
								return;
							}
						...
						if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
						{
							System.Threading.Thread thread = new System.Threading.Thread(PS_MM960_Print_Report01);
