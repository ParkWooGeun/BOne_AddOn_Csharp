...
namespace PSH_BOne_AddOn
{
    ...
    internal class PS_PP032 : PSH_BaseClass
    {
        ...
        private SAPbouiCOM.DBDataSource oDS_PS_PP032H; //등록헤더
        private SAPbouiCOM.DBDataSource oDS_PS_PP032L; //등록라인
        ...
        public override void LoadForm(string oFromDocEntry01)
        {
            ...
            try
            {
                oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP032.srf");
                ...
                oFormUniqueID = "PS_PP032_" + SubMain.Get_TotalFormsCount();
                SubMain.Add_Forms(this, oFormUniqueID, "PS_PP032");
                ...
                oForm.Freeze(true);
                PS_PP032_CreateItems();
                PS_PP032_EnableMenus();
                PS_PP032_SetDocument(oFromDocEntry01);
            }
            catch (Exception ex)
            {
        ...
        /// 화면 Item 생성
        /// </summary>
        private void PS_PP032_CreateItems()
        {
            try
            {
                oDS_PS_PP032H = oForm.DataSources.DBDataSources.Item("@PS_PP032H");
                oDS_PS_PP032L = oForm.DataSources.DBDataSources.Item("@PS_PP032L");
        ...
        /// EnableMenus
        /// </summary>
        private void PS_PP032_EnableMenus()
        {
        ...
        private void PS_PP032_SetDocument(string oFromDocEntry01)
        {
            try
            {
                if (string.IsNullOrEmpty(oFromDocEntry01))
                {
                    PS_PP032_FormItemEnabled();
                    PS_PP032_AddMatrixRow(0, true);
                }
                else
                {
                }
        ...
        /// 모드에 따른 아이템 설정
        /// </summary>
        private void PS_PP032_FormItemEnabled()
        {
            try
            {
                oForm.Freeze(true);
        ...
        /// <summary>
        /// PS_PP032_AddMatrixRow
        /// </summary>
        /// <param name="oRow">행 번호</param>
        /// <param name="RowIserted">행 추가 여부</param>
        private void PS_PP032_AddMatrixRow(int oRow, bool RowIserted)
        {
            try
            {
                oForm.Freeze(true);
                ...
                oMat01.AddRow();
                oDS_PS_PP032L.Offset = oRow;
                oDS_PS_PP032L.SetValue("U_LineNum", oRow, Convert.ToString(oRow + 1));
        ...
        private void PS_PP032_MTX01()
        {
            ...
            try
            {
                ...
                for (i = 0; i <= oRecordSet01.RecordCount - 1; i++)
                {
                    if (i != 0)
                    {
                        oDS_PS_PP032L.InsertRecord(i);
                    }
                    oDS_PS_PP032L.Offset = i;
                    oDS_PS_PP032L.SetValue("U_COL01", i, oRecordSet01.Fields.Item(0).Value);
                    oDS_PS_PP032L.SetValue("U_COL02", i, oRecordSet01.Fields.Item(1).Value);
        ...
        /// DocEntry 초기화
        /// </summary>
        private void PS_PP032_FormClear()
        {
            string DocEntry;
            PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
            ...
            try
            {
                if (pVal.BeforeAction == true)
                {
                    if (pVal.ItemUID == "1")
                    {
                        if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
                        {
                            if (PS_PP032_DataValidCheck() == false)
                            {
                                BubbleEvent = false;
                                return;
                            }
            ...
            try
            {
                if (pVal.Before_Action == true)
                {
                    if (pVal.ItemUID == "Mat01")
                    {
                        ...
                        {
                            dataHelpClass.ActiveUserDefineValueAlways(ref oForm, ref pVal, ref BubbleEvent, "Mat01", "CpBCode");
                        }
        ...
        private void Raise_EVENT_MATRIX_LOAD(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
        {
            try
            {
                ...
                {
                    PS_PP032_FormItemEnabled();
                    PS_PP032_AddMatrixRow(oMat01.VisualRowCount, false);
                }
            }
            catch (Exception ex)
            {
        ...
        private void Raise_EVENT_FORM_UNLOAD(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
        {
            try
            {
                ...
                else if (pVal.Before_Action == false)
                {
                    ...
                    System.Runtime.InteropServices.Marshal.ReleaseComObject(oDS_PS_PP032H);
                    System.Runtime.InteropServices.Marshal.ReleaseComObject(oDS_PS_PP032L);
                }
            }
            catch (Exception ex)
            {
        ...
        private void Raise_EVENT_ROW_DELETE(string FormUID, SAPbouiCOM.IMenuEvent pVal, bool BubbleEvent)
        {
            ...
            try
            {
                ...
                else if (pVal.BeforeAction == false)
                {
                    ...
                    {
                        PS_PP032_AddMatrixRow(0, false);
                    }
                    else
                    {
                        if (!string.IsNullOrEmpty(oDS_PS_PP032L.GetValue("U_CpBCode", oMat01.RowCount - 1).ToString().Trim()))
                        {
                            PS_PP032_AddMatrixRow(oMat01.RowCount, false);
                        }
                    }
                }
            }
