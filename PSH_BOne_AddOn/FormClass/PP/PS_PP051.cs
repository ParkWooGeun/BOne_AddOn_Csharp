...
namespace PSH_BOne_AddOn
{
	...
	/// M/G생산작업지시발행현황
	/// </summary>
	internal class PS_PP051 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP051.srf");
				...
				oFormUniqueID = "PS_PP051_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP051");
				...
				oForm.Freeze(true);
				PS_PP051_CreateItems();
				PS_PP051_SetComboBox();
				PS_PP051_Initialize();
		...
		/// PS_PP051_CreateItems
		/// </summary>
		private void PS_PP051_CreateItems()
		{
			try
			{
		...
		/// PS_PP051_SetComboBox
		/// </summary>
		private void PS_PP051_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP051_Initialize
		/// </summary>
		private void PS_PP051_Initialize()
		{
		...
		/// <summary>
		/// PS_PP051_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP051_PrintReport()
		{
			string sQry;
			string WinTitle;
			string ReportName;
			...
			try
			{
				...
				{
					WinTitle = "[PS_PP051_01] M/G생산작업지시발행현황";
					ReportName = "PS_PP051_01.RPT";
				}
				else
				{
					WinTitle = "[PS_PP051_02] M/G생산작업지시발행현황";
					ReportName = "PS_PP051_02.RPT";
				}
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP051_PrintReport);
