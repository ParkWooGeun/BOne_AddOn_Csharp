...
namespace PSH_BOne_AddOn
{
	...
	/// 설비별가동율현황
	/// </summary>
	internal class PS_PP065 : PSH_BaseClass
	{
		private string oFormUniqueID;
		private SAPbouiCOM.Grid oGrid;

		private SAPbouiCOM.DataTable oDS_PS_PP065A;
		...
		public override void LoadForm(string oFormDocEntry01)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP065.srf");
				...
				oFormUniqueID = "PS_PP065_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP065");
				...
				PS_PP065_CreateItems();
				PS_PP065_ComboBox_Setting();
			}
			catch (Exception ex)
			{
		...
		/// PS_PP065_CreateItems
		/// </summary>
		private void PS_PP065_CreateItems()
		{
			try
			{
				oForm.Freeze(true);
				...
				oForm.DataSources.DataTables.Add("PS_PP065A");
				oGrid.DataTable = oForm.DataSources.DataTables.Item("PS_PP065A");
				oDS_PS_PP065A = oForm.DataSources.DataTables.Item("PS_PP065A");
				...
				//설비명
				oForm.DataSources.UserDataSources.Add("MachName", SAPbouiCOM.BoDataType.dt_SHORT_TEXT, 50);
		...
		/// PS_PP065_ComboBox_Setting
		/// </summary>
		private void PS_PP065_ComboBox_Setting()
		{
			string sQry;
		...
		/// <summary>
		/// PS_PP065_FlushToItemValue
		/// </summary>
		/// <param name="oUID"></param>
		/// <param name="oRow"></param>
		/// <param name="oCol"></param>
		private void PS_PP065_FlushToItemValue(string oUID, int oRow, string oCol)
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
		...
		private void PS_PP065_MTX01()
		{
			...
			try
			{
				...
				oDS_PS_PP065A.ExecuteQuery(sQry);
		...
		private void Raise_EVENT_COMBO_SELECT(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				...
				{
					PS_PP065_FlushToItemValue(pVal.ItemUID, pVal.Row, pVal.ColUID);
				}
			}
			catch (Exception ex)
			{
		...
		private void Raise_EVENT_FORM_UNLOAD(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				...
				else if (pVal.BeforeAction == false)
				{
					...
					System.Runtime.InteropServices.Marshal.ReleaseComObject(oDS_PS_PP065A);
				}
			}
			catch (Exception ex)
			{
