...
namespace PSH_BOne_AddOn
{
	...
	internal class PS_PP075 : PSH_BaseClass
	{
		...
		private void Matrix_AddRow(int MChk, int oRow, bool Insert_YN)
		{
			try
			{
				switch (MChk)
		...
		/// <returns></returns>
		private bool UpDate_PP070(string A_B)
		{
			bool functionReturnValue = false;
