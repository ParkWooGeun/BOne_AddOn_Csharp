    ...
    internal class PS_PP090 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFormDocEntry)
        {
            ...
            try
            {
                ...
                PS_PP090_SetDocument(oFormDocEntry);
            }
            catch (Exception ex)
            {
        ...
        private void PS_PP090_SetDocument(string oFormDocEntry)
        {
            try
            {
                    ...
                    if (pVal.ItemChanged == true)
                    {
                        if (pVal.ItemUID == "Mat01")
                        {
                            if (pVal.ColUID == "LotNo")
                            {
                                ...
                                Query01 += " Where Quantity > 0 And BatchNum = '" + oMat01.Columns.Item(pVal.ColUID).Cells.Item(pVal.Row).Specific.Value + "'";
                                oRecordSet01.DoQuery(Query01);
