...
namespace PSH_BOne_AddOn
{
	...
	///  출고계획
	/// </summary>
	internal class PS_PP096 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFromDocEntry01)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP096.srf");
				...
				oFormUniqueID = "PS_PP096_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP096");
				...
				PS_PP096_CreateItems();
				PS_PP096_ComboBox_Setting();
				PS_PP096_Initial_Setting();
			}
			catch (Exception ex)
			{
		...
		/// PS_PP096_CreateItems
		/// </summary>
		private void PS_PP096_CreateItems()
		{
			try
			{
		...
		/// PS_PP096_ComboBox_Setting
		/// </summary>
		private void PS_PP096_ComboBox_Setting()
		{
		...
		/// PS_PP096_Initial_Setting
		/// </summary>
		private void PS_PP096_Initial_Setting()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
		...
		/// <summary>
		/// PS_PP096_DataValidCheck
		/// </summary>
		/// <returns></returns>
		private bool PS_PP096_DataValidCheck()
		{
		...
		/// <summary>
		/// PS_PP096_Print_Report01
		/// </summary>
		/// [STAThread]
		private void PS_PP096_Print_Report01()
		{
			string WinTitle;
			string ReportName;
			string sQry;
			...
			try
			{
				...
				Msg_Renamed = oForm.Items.Item("MSG").Specific.Value.ToString().Trim();

				if (oForm.Items.Item("Rad01").Specific.Selected == true)
				{
					Div = "1";
				}
				if (oForm.Items.Item("Rad02").Specific.Selected == true)
				{
					Div = "2";
				}
				...
				WinTitle = "M/G출고계획 [PS_PP096]";
				ReportName = "PS_PP096_01.rpt";
				...
				dataPackParameter.Add(new PSH_DataPackClass("@msg", Msg_Renamed));
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_PP096_DataValidCheck() == false)
							{
								BubbleEvent = false;
								return;
							}
						...
						if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
						{
							System.Threading.Thread thread = new System.Threading.Thread(PS_PP096_Print_Report01);
