...
namespace PSH_BOne_AddOn
{
    ...
    internal class PS_PP120 : PSH_BaseClass
    {
        ...
        /// Initialization
        /// </summary>
        private void PS_PP120_Initialization()
        {
            PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
        ...
        /// </summary>
        /// <returns></returns>
        private bool PS_PP120_HeaderSpaceLineDel()
        {
        ...
        /// </summary>
        /// <returns></returns>
        private bool PS_PP120_MatrixSpaceLineDel()
        {
            bool functionReturnValue = false;
            int i;
            string errMessage = string.Empty;
        ...
        /// Delete_EmptyRow
        /// </summary>
        private void PS_PP120_Delete_EmptyRow()
        {
            int i;
            string errMessage = string.Empty;
        ...
        /// ChooseFromList
        /// </summary>
        private void PS_PP120_CF_ChooseFromList()
        {
            try
            {
            }
        ...
        /// FormResize
        /// </summary>
        private void PS_PP120_FormResize()
        {
            try
            {
            }
        ...
        /// PS_PP120_etBaseForm
        /// </summary>
        private void PS_PP120_SetBaseForm()
        {
            string errMessage = string.Empty;
            try
            {
        ...
        private void PS_PP120_FlushToItemValue(string oUID, int oRow, string oCol)
        {
            SAPbobsCOM.Recordset oRecordSet01 = PSH_Globals.oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset);
            PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
