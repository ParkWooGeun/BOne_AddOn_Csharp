...
namespace PSH_BOne_AddOn
{
	...
	/// 공정별 진행(재공)현황(기초)
	/// </summary>
	internal class PS_PP151 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP151.srf");
				...
				oFormUniqueID = "PS_PP151_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP151");
				...
				oForm.Freeze(true);
				PS_PP151_CreateItems();
				PS_PP151_SetComboBox();
				PS_PP151_Initialize();
		...
		/// PS_PP151_CreateItems
		/// </summary>
		private void PS_PP151_CreateItems()
		{
			try
			{
		...
		/// PS_PP151_SetComboBox
		/// </summary>
		private void PS_PP151_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP151_Initialize
		/// </summary>
		private void PS_PP151_Initialize()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
		...
		/// <summary>
		/// PS_PP151_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP151_PrintReport()
		{
			...
			try
			{
				...
				if (Gbn01 == "1")
				{
					WinTitle = "[PS_PP151_01] 공정별 진행(재공)현황";
					ReportName = "PS_PP151_01.RPT";
				}
				else if (Gbn01 == "2")
				{
					WinTitle = "[PS_PP151_02] 공정별 재공 집계";
					ReportName = "PS_PP151_02.RPT";
				}
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP151_PrintReport);
