...
namespace PSH_BOne_AddOn
{
	...
	/// 분말금속 공정별 진행(재공)현황
	/// </summary>
	internal class PS_PP155 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP155.srf");
				...
				oFormUniqueID = "PS_PP155_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP155");
				...
				oForm.Freeze(true);
				PS_PP155_CreateItems();
				PS_PP155_SetComboBox();
				PS_PP155_Initialize();
		...
		/// PS_PP155_CreateItems
		/// </summary>
		private void PS_PP155_CreateItems()
		{
			try
			{
				...
				oForm.DataSources.UserDataSources.Item("DocDateFr").Value = "'20150101";
		...
		/// PS_PP155_SetComboBox
		/// </summary>
		private void PS_PP155_SetComboBox()
		{
			string sQry;
			...
			try
			{
				...
				sQry = "SELECT Code, Name From [@PSH_ItmBsort] Where Code in ('111','601')";
				oRecordSet.DoQuery(sQry);
				while (!oRecordSet.EoF)
				{
				...
				oForm.Items.Item("ItMBsort").Specific.Select("601", SAPbouiCOM.BoSearchKey.psk_ByValue);
		...
		/// PS_PP155_Initialize
		/// </summary>
		private void PS_PP155_Initialize()
		{
		...
		/// <summary>
		/// PS_PP155_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP155_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				WinTitle = "[PS_PP155_01] 공정별 진행(재공)현황";
				ReportName = "PS_PP155_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP155_PrintReport);
