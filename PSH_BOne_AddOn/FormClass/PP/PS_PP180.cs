...
namespace PSH_BOne_AddOn
{
	...
	/// 본사휘팅 출하대기현황
	/// </summary>
	internal class PS_PP180 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP180.srf");
				...
				oFormUniqueID = "PS_PP180_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP180");
		...
		/// PS_PP180_CreateItems
		/// </summary>
		private void PS_PP180_CreateItems()
		{
			try
			{
		...
		/// <summary>
		/// PS_PP180_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP180_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string DocDate;
			...
			try
			{
				...
				WinTitle = "[PS_PP180_01] 본사휘팅 출하대기현황";
				ReportName = "PS_PP180_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP180_PrintReport);
