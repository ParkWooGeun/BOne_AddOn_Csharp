...
namespace PSH_BOne_AddOn
{
	...
	/// 포장공정packing list
	/// </summary>
	internal class PS_PP200 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP200.srf");
				...
				oFormUniqueID = "PS_PP200_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP200");
				...
				PS_PP200_CreateItems();
				PS_PP200_SetComboBox();
				PS_PP200_Initialize();
		...
		/// PS_PP200_CreateItems
		/// </summary>
		private void PS_PP200_CreateItems()
		{
			try
			{
		...
		/// PS_PP200_SetComboBox
		/// </summary>
		private void PS_PP200_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP200_Initialize
		/// </summary>
		private void PS_PP200_Initialize()
		{
		...
		/// <summary>
		/// PS_PP200_FlushToItemValue
		/// </summary>
		/// <param name="oUID"></param>
		/// <param name="oRow"></param>
		/// <param name="oCol"></param>
		private void PS_PP200_FlushToItemValue(string oUID, int oRow, string oCol)
		{
			string sQry;
			SAPbobsCOM.Recordset oRecordSet = PSH_Globals.oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset);
		...
		/// <summary>
		/// PS_PP200_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP200_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string sQry;
			...
			try
			{
				...
				WinTitle = "[PS_PP200_01] 포장공정packing list";
				ReportName = "PS_PP200_01.RPT";
				...
				dataPackFormula.Add(new PSH_DataPackClass("@Div", DivName));
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP200_PrintReport);
			...
			try
			{
				...
				else if (pVal.Before_Action == false)
				{
					if (pVal.ItemChanged == true)
					{
						if (pVal.ItemUID == "ItemCode")
						{
							PS_PP200_FlushToItemValue(pVal.ItemUID, pVal.Row, pVal.ColUID);
						}
					}
				}
			}
