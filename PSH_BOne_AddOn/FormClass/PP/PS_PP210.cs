...
namespace PSH_BOne_AddOn
{
	...
	/// 패킹번호별재고대장
	/// </summary>
	internal class PS_PP210 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP210.srf");
				...
				oFormUniqueID = "PS_PP210_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP210");
				...
				PS_PP210_CreateItems();
				PS_PP210_SetComboBox();
				PS_PP210_Initialize();
		...
		/// PS_PP210_CreateItems
		/// </summary>
		private void PS_PP210_CreateItems()
		{
			try
			{
		...
		/// PS_PP210_SetComboBox
		/// </summary>
		private void PS_PP210_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP210_Initialize
		/// </summary>
		private void PS_PP210_Initialize()
		{
		...
		/// <summary>
		/// PS_PP210_FlushToItemValue
		/// </summary>
		/// <param name="oUID"></param>
		/// <param name="oRow"></param>
		/// <param name="oCol"></param>
		private void PS_PP210_FlushToItemValue(string oUID, int oRow, string oCol)
		{
			string sQry;
			SAPbobsCOM.Recordset oRecordSet = PSH_Globals.oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset);
		...
		/// <summary>
		/// PS_PP210_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP210_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string sQry;
			...
			try
			{
				...
				{
					WinTitle = "[PS_PP210_01] 패킹번호별재고대장(LOT-NO별)";
					ReportName = "PS_PP210_01.RPT";
				}
				else
				{
					WinTitle = "[PS_PP210_02] 패킹번호별재고대장(집계)";
					ReportName = "PS_PP210_02.RPT";
				}
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP210_PrintReport);
			...
			try
			{
				...
				else if (pVal.Before_Action == false)
				{
					if (pVal.ItemChanged == true)
					{
						if (pVal.ItemUID == "ItemCode")
						{
							PS_PP210_FlushToItemValue(pVal.ItemUID, pVal.Row, pVal.ColUID);
						}
					}
				}
			}
