	...
	internal class PS_PP220 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				...
				oForm.Freeze(true);
				PS_PP220_CreateItems();
				PS_PP220_SetComboBox();
		...
		/// PS_PP220_CreateItems
		/// </summary>
		private void PS_PP220_CreateItems()
		{
			try
			{
		...
		/// PS_PP220_SetComboBox
		/// </summary>
		private void PS_PP220_SetComboBox()
		{
			string sQry;
		...
		/// <summary>
		/// PS_PP220_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP220_PrintReport()
		{
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP220_PrintReport);
