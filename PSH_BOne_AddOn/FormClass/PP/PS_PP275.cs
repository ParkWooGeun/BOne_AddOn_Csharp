...
namespace PSH_BOne_AddOn
{
	...
	/// 연간담당별전력사용현황
	/// </summary>
	internal class PS_PP275 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP275.srf");
				...
				oFormUniqueID = "PS_PP275_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP275");
				...
				oForm.Freeze(true);
				PS_PP275_CreateItems();
				PS_PP275_SetComboBox();
            }
			catch (Exception ex)
			{
		...
		/// PS_PP275_CreateItems
		/// </summary>
		private void PS_PP275_CreateItems()
		{
			try
			{
		...
		/// PS_PP275_SetComboBox
		/// </summary>
		private void PS_PP275_SetComboBox()
		{
			string sQry;
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP275_PrintReport);
