...
namespace PSH_BOne_AddOn
{
	...
	/// 생산일보 개인작업시간현황
	/// </summary>
	internal class PS_PP351 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP351.srf");
				...
				oFormUniqueID = "PS_PP351_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP351");
				...
				oForm.Freeze(true);
				PS_PP351_CreateItems();
				PS_PP351_SetComboBox();
				PS_PP351_Initialize();
		...
		/// PS_PP351_CreateItems
		/// </summary>
		private void PS_PP351_CreateItems()
		{
			try
			{
				//기간Fr
		...
		/// PS_PP351_SetComboBox
		/// </summary>
		private void PS_PP351_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP351_Initialize
		/// </summary>
		private void PS_PP351_Initialize()
		{
		...
		/// <summary>
		/// PS_PP351_FlushToItemValue
		/// </summary>
		/// <param name="oUID"></param>
		/// <param name="oRow"></param>
		/// <param name="oCol"></param>
		private void PS_PP351_FlushToItemValue(string oUID, int oRow, string oCol)
		{
			string sQry;
			SAPbobsCOM.Recordset oRecordSet = PSH_Globals.oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset);
		...
		/// <summary>
		/// PS_PP351_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP351_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string BPLName;
			...
			try
			{
				...
				WinTitle = "생산일보 개인작업시간현황 [PS_PP351_01]";
				ReportName = "PS_PP351_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP351_PrintReport);
		...
		private void Raise_EVENT_VALIDATE(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				...
				if (pVal.BeforeAction == true)
				{
					...
					{
						if (pVal.ItemUID == "ItmBsort" || pVal.ItemUID == "ItemCode")
						{
							PS_PP351_FlushToItemValue(pVal.ItemUID, pVal.Row, pVal.ColUID);
						}
					}
				}
				else if (pVal.BeforeAction == false)
