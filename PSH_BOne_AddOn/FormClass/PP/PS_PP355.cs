...
namespace PSH_BOne_AddOn
{
	...
	internal class PS_PP355 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP355.srf");
				...
				oFormUniqueID = "PS_PP355_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP355");
				...
				oForm.Freeze(true);
				PS_PP355_CreateItems();
				PS_PP355_SetComboBox();
				PS_PP355_Initialize();
		...
		/// PS_PP355_CreateItems
		/// </summary>
		private void PS_PP355_CreateItems()
		{
			try
			{
				//기간Fr
		...
		/// PS_PP355_SetComboBox
		/// </summary>
		private void PS_PP355_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP355_Initialize
		/// </summary>
		private void PS_PP355_Initialize()
		{
		...
		/// <summary>
		/// PS_PP355_FlushToItemValue
		/// </summary>
		/// <param name="oUID"></param>
		/// <param name="oRow"></param>
		/// <param name="oCol"></param>
		private void PS_PP355_FlushToItemValue(string oUID, int oRow, string oCol)
		{
			string sQry;
			SAPbobsCOM.Recordset oRecordSet = PSH_Globals.oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset);
		...
		/// <summary>
		/// PS_PP355_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP355_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string BPLName;
			...
			try
			{
				...
				{
					ReportName = "PS_PP355_01.RPT";
				}
				else
				{
					ReportName = "PS_PP355_02.RPT";
				}
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP355_PrintReport);
		...
		private void Raise_EVENT_VALIDATE(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				...
				if (pVal.BeforeAction == true)
				{
					...
					{
						if (pVal.ItemUID == "ItemCode" || pVal.ItemUID == "CpCode")
						{
							PS_PP355_FlushToItemValue(pVal.ItemUID, pVal.Row, pVal.ColUID);
						}
					}
				}
				else if (pVal.BeforeAction == false)
