...
namespace PSH_BOne_AddOn
{
	...
	/// 작업지시서미발행내역대장
	/// </summary>
	internal class PS_PP380 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP380.srf");
				...
				oFormUniqueID = "PS_PP380_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP380");
		...
		/// PS_PP380_SetComboBox
		/// </summary>
		private void PS_PP380_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP380_Initialize
		/// </summary>
		private void PS_PP380_Initialize()
		{
		...
		/// <summary>
		/// PS_PP380_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP380_PrintReport()
		{
			string sQry;
			string WinTitle;
			string ReportName;
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP380_PrintReport);
				...
				else if (pVal.BeforeAction == false)
				{
					if (pVal.ItemChanged == true)
					{
						if (pVal.ItemUID == "ItmBSort")
						{
							...
							dataHelpClass.SetReDataCombo(oForm, sQry, oForm.Items.Item("ItmMSort").Specific, "Y");
						}
					}
				}
			}
