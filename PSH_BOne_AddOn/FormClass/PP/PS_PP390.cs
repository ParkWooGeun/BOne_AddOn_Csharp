	...
	internal class PS_PP390 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				...
				oForm.Freeze(true);
				PS_PP390_CreateItems();
				PS_PP390_SetComboBox();
				PS_PP390_Initialize();
		...
		/// PS_PP390_CreateItems
		/// </summary>
		private void PS_PP390_CreateItems()
		{
			try
			{
		...
		/// PS_PP390_SetComboBox
		/// </summary>
		private void PS_PP390_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP390_Initialize
		/// </summary>
		private void PS_PP390_Initialize()
		{
		...
		/// <summary>
		/// PS_PP390_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP390_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP390_PrintReport);
