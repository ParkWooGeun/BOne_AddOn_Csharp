...
namespace PSH_BOne_AddOn
{
	...
	/// 지원공수 현황(마이크로텍)
	/// </summary>
	internal class PS_PP410 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP410.srf");
				...
				oFormUniqueID = "PS_PP410_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP410");
		...
		/// PS_PP410_CreateItems
		/// </summary>
		private void PS_PP410_CreateItems()
		{
			try
			{
		...
		/// <summary>
		/// PS_PP410_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP410_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string DocDateFr;
			...
			try
			{
				...
				WinTitle = "[PS_PP410_01] 지원공수 현황(마이크로텍)";
				ReportName = "PS_PP410_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP410_PrintReport);
