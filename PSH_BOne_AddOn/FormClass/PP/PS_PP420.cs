	...
	internal class PS_PP420 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				...
				oForm.Freeze(true);
				PS_PP420_CreateItems();
				PS_PP420_SetgComboBox();
				PS_PP420_Initialize();
		...
		/// PS_PP420_CreateItems
		/// </summary>
		private void PS_PP420_CreateItems()
		{
			try
			{
		...
		/// PS_PP420_SetgComboBox
		/// </summary>
		private void PS_PP420_SetgComboBox()
		{
			string sQry;
		...
		/// PS_PP420_Initialize
		/// </summary>
		private void PS_PP420_Initialize()
		{
		...
		/// <summary>
		/// PS_PP420_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP420_PrintReport()
		{
			string sQry;
			string BPLName;
			string WinTitle;
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP420_PrintReport);
