...
namespace PSH_BOne_AddOn
{
	...
	internal class PS_PP530 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP530.srf");
				...
				oFormUniqueID = "PS_PP530_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP530");
		...
		/// PS_PP530_CreateItems
		/// </summary>
		private void PS_PP530_CreateItems()
		{
			try
			{
		...
		private void PS_PP530_SetComboBox()
		{
			...
			try
			{
				...
				oForm.Items.Item("Div").Specific.ValidValues.Add("1", "원재료,생산,납품일자 체크");
				oForm.Items.Item("Div").Specific.ValidValues.Add("2", "공정수량,중량 체크");
		...
		private void PS_PP530_MTX01()
		{
			...
			try
			{
				...
				if (Div == "1")
				{
					sQry = "EXEC PS_PP530_01 '" + BPLID + "','" + DocDateFr + "','" + DocDateTo + "'";
				}
				else if (Div == "2")
				{
					sQry = "EXEC PS_PP530_02 '" + BPLID + "','" + DocDateFr + "','" + DocDateTo + "'";
				}
