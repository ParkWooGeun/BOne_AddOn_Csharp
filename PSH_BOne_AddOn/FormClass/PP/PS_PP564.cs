...
namespace PSH_BOne_AddOn
{
	...
	internal class PS_PP564 : PSH_BaseClass
	{
		...
		/// PS_PP564_SetComboBox
		/// </summary>
		private void PS_PP564_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP564_ResizeForm
		/// </summary>
		private void PS_PP564_ResizeForm()
		{
			try
			{
				oMat.AutoResizeColumns();
		...
		/// <summary>
		/// PS_PP564_AddMatrixRow
		/// </summary>
		/// <param name="oRow"></param>
		/// <param name="RowIserted"></param>
		private void PS_PP564_AddMatrixRow(int oRow, bool RowIserted)
		{
			try
			{
				if (RowIserted == false)
		...
		/// <summary>
		/// PS_PP564_DelHeaderSpaceLine
		/// </summary>
		/// <returns></returns>
		private bool PS_PP564_DelHeaderSpaceLine()
		{
		...
		/// PS_PP564_ResetForm
		/// </summary>
		private void PS_PP564_ResetForm()
		{
			try
			{
				oForm.Freeze(true);
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "BtnAdd")
					{
						if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
						{
							if (PS_PP564_DelHeaderSpaceLine() == false)
							{
								BubbleEvent = false;
								return;
							}
				...
				if (pVal.BeforeAction == true)
				{
					switch (pVal.MenuUID)
					{
						...
						case "7169": //엑셀 내보내기
							...
							oForm.Freeze(true);
							PS_PP564_AddMatrixRow(oMat.VisualRowCount, false);
							oForm.Freeze(false);
							break;
					}
				}
