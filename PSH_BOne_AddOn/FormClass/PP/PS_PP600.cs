...
namespace PSH_BOne_AddOn
{
	...
	/// 재공현황(포장)
	/// </summary>
	internal class PS_PP600 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP600.srf");
				...
				oFormUniqueID = "PS_PP600_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP600");
				...
				PS_PP600_CreateItems();
				PS_PP600_SetComboBox();
				PS_PP600_Initialize();
		...
		/// PS_PP600_CreateItems
		/// </summary>
		private void PS_PP600_CreateItems()
		{
			try
			{
		...
		/// PS_PP600_SetComboBox
		/// </summary>
		private void PS_PP600_SetComboBox()
		{
			string sQry;
			...
			try
			{
				...
				oForm.Items.Item("ItMBsort").Specific.Select("0", SAPbouiCOM.BoSearchKey.psk_ByValue);
		...
		/// PS_PP600_Initialize
		/// </summary>
		private void PS_PP600_Initialize()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
		...
		/// <summary>
		/// PS_PP600_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP600_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string sQry;
			...
			try
			{
				...
				WinTitle = "[PS_PP600_01] 재공현황(포장)";
				ReportName = "PS_PP600_01.RPT";

				//Div  1.공정별진행(재공)현황, 2.공정별재공집계     
				//2번 집계는 에러남 레포트는 없고 PROC에는 에러 있음(JEGONGW)
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP600_PrintReport);
