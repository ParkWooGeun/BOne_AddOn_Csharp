...
namespace PSH_BOne_AddOn
{
	...
	/// 포장 소요량대비원재료불출현황
	/// </summary>
	internal class PS_PP601 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP601.srf");
				...
				oFormUniqueID = "PS_PP601_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP601");
		...
		/// PS_PP601_CreateItems
		/// </summary>
		private void PS_PP601_CreateItems()
		{
			try
			{
		...
		/// <summary>
		/// PS_PP601_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP601_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string DocDateFr;
			...
			try
			{
				...
				WinTitle = "[PS_PP601_01] 소요량대비원재료불출현황";
				ReportName = "PS_PP601_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP601_PrintReport);
