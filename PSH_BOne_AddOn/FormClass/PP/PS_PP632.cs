...
namespace PSH_BOne_AddOn
{
	...
	/// 제품재고 LIST
	/// </summary>
	internal class PS_PP632 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP632.srf");
				...
				oFormUniqueID = "PS_PP632_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP632");
				...
				oForm.Freeze(true);
				PS_PP632_CreateItems();
				PS_PP632_SetComboBox();
				PS_PP632_Initialize();
		...
		/// PS_PP632_CreateItems
		/// </summary>
		private void PS_PP632_CreateItems()
		{
			try
			{
		...
		/// PS_PP632_SetComboBox
		/// </summary>
		private void PS_PP632_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP632_Initialize
		/// </summary>
		private void PS_PP632_Initialize()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();

			try
			{
				oForm.Items.Item("Location").Specific.Select(dataHelpClass.User_BPLID(), SAPbouiCOM.BoSearchKey.psk_ByValue); //아이디별 사업장 세팅
			}
			catch (Exception ex)
			{
				PSH_Globals.SBO_Application.StatusBar.SetText(System.Reflection.MethodBase.GetCurrentMethod().Name + "_Error : " + ex.Message, BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Error);
		...
		/// <summary>
		/// PS_PP632_FlushToItemValue
		/// </summary>
		/// <param name="oUID"></param>
		/// <param name="oRow"></param>
		/// <param name="oCol"></param>
		private void PS_PP632_FlushToItemValue(string oUID, int oRow, string oCol)
		{
			string sQry;
			SAPbobsCOM.Recordset oRecordSet = PSH_Globals.oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset);
		...
		/// <summary>
		/// PS_PP632_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP632_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string ItemCode;
			...
			try
			{
				...
				{
					WinTitle = "[PS_PP633_01] 제품재고 LIST(세부내역)";
					ReportName = "PS_PP633_01.RPT";
				}
				else
				{
					WinTitle = "[PS_PP632_01] 제품재고 LIST";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP632_PrintReport);
			...
			try
			{
				...
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemChanged == true)
					{
						...
						{
							PS_PP632_FlushToItemValue(pVal.ItemUID, pVal.Row, pVal.ColUID);
						}
					}
				}
				else if (pVal.BeforeAction == false)
