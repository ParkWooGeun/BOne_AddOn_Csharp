...
namespace PSH_BOne_AddOn
{
	...
	/// </summary>
	internal class PS_PP634 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP634.srf");
				...
				oFormUniqueID = "PS_PP634_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP634");
				...
				oForm.Freeze(true);
				PS_PP634_CreateItems();
				PS_PP634_SetComboBox();
				PS_PP634_Initialize();
		...
		/// PS_PP634_CreateItems
		/// </summary>
		private void PS_PP634_CreateItems()
		{
			try
			{
		...
		/// PS_PP634_SetComboBox
		/// </summary>
		private void PS_PP634_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP634_Initialize
		/// </summary>
		private void PS_PP634_Initialize()
		{
		...
		/// <summary>
		/// PS_PP634_FlushToItemValue
		/// </summary>
		/// <param name="oUID"></param>
		/// <param name="oRow"></param>
		/// <param name="oCol"></param>
		private void PS_PP634_FlushToItemValue(string oUID, int oRow, string oCol)
		{
			string sQry;
			SAPbobsCOM.Recordset oRecordSet = PSH_Globals.oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset);
		...
		/// <summary>
		/// PS_PP634_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP634_PrintReport()
		{
			string sQry;
			...
			try
			{
				...
				{
					WinTitle = "[PS_PP634_01] 출고현황(품목별)";
					ReportName = "PS_PP634_01.RPT";
				}
				else if (oForm.Items.Item("Rad02").Specific.Selected == true)
				{
					WinTitle = "[PS_PP635_01] 출고현황(세부내역)";
					ReportName = "PS_PP635_01.RPT";
				}
				else if (oForm.Items.Item("Rad03").Specific.Selected == true)
				{
					WinTitle = "[PS_PP634_02] 거래선별 출고현황";
					ReportName = "PS_PP634_02.RPT";
				}
				else if (oForm.Items.Item("Rad04").Specific.Selected == true)
				{
					WinTitle = "[PS_PP634_03] 포장비 지출 내역";
					ReportName = "PS_PP634_03.RPT";
				}
				...
				// Parameter
				if (oForm.Items.Item("Rad04").Specific.Selected == true)
				{
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP634_PrintReport);
			...
			try
			{
				...
				else if (pVal.BeforeAction == false)
				{
					if (pVal.ItemChanged == true)
					{
						...
						{
							PS_PP634_FlushToItemValue(pVal.ItemUID, pVal.Row, pVal.ColUID);
						}
					}
				}
			}
