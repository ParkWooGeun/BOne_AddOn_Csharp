...
namespace PSH_BOne_AddOn
{
	...
	/// 원재료 입고현황(월별,일자별)
	/// </summary>
	internal class PS_PP636 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP636.srf");
				...
				oFormUniqueID = "PS_PP636_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP636");
				...
				oForm.Freeze(true);
				PS_PP636_CreateItems();
				PS_PP636_SetComboBox();
				PS_PP636_Initialize();
		...
		/// PS_PP636_CreateItems
		/// </summary>
		private void PS_PP636_CreateItems()
		{
			try
			{
		...
		/// PS_PP636_SetComboBox
		/// </summary>
		private void PS_PP636_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP636_Initialize
		/// </summary>
		private void PS_PP636_Initialize()
		{
		...
		/// <summary>
		/// PS_PP636_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP636_PrintReport()
		{
			...
			try
			{
				...
				dataPackParameter.Add(new PSH_DataPackClass("@DocDatFr", DocDateFr));
				dataPackParameter.Add(new PSH_DataPackClass("@DocDatTo", DocDateTo));
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP636_PrintReport);
