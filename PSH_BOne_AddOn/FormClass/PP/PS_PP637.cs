...
namespace PSH_BOne_AddOn
{
	...
	/// 재공품 내역서(제품기준)
	/// </summary>
	internal class PS_PP637 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP637.srf");
				...
				oFormUniqueID = "PS_PP637_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP637");
				...
				oForm.Freeze(true);
				PS_PP637_CreateItems();
				PS_PP637_SetComboBox();
				PS_PP637_Initialize();
		...
		/// PS_PP637_CreateItems
		/// </summary>
		private void PS_PP637_CreateItems()
		{
			try
			{
		...
		/// PS_PP637_SetComboBox
		/// </summary>
		private void PS_PP637_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP637_Initialize
		/// </summary>
		private void PS_PP637_Initialize()
		{
		...
		/// <summary>
		/// PS_PP637_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP637_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				{
					WinTitle = "[PS_PP637_01] 재공품 내역서(제품기준)";
					ReportName = "PS_PP637_01.RPT";
				}
				else
				{
					WinTitle = "[PS_PP689_01] 재공품 내역서 집계 (제품별)";
					ReportName = "PS_PP689_01.RPT";
				}
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP637_PrintReport);
