...
namespace PSH_BOne_AddOn
{
	...
	/// 생산현황(집계표)
	/// </summary>
	internal class PS_PP638 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP638.srf");
				...
				oFormUniqueID = "PS_PP638_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP638");
				...
				oForm.Freeze(true);
				PS_PP638_CreateItems();
				PS_PP638_SetComboBox();
				PS_PP638_Initialize();
		...
		/// PS_PP638_CreateItems
		/// </summary>
		private void PS_PP638_CreateItems()
		{
			try
			{
		...
		/// PS_PP638_SetComboBox
		/// </summary>
		private void PS_PP638_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP638_Initialize
		/// </summary>
		private void PS_PP638_Initialize()
		{
		...
		/// <summary>
		/// PS_PP638_FlushToItemValue
		/// </summary>
		/// <param name="oUID"></param>
		/// <param name="oRow"></param>
		/// <param name="oCol"></param>
		private void PS_PP638_FlushToItemValue(string oUID, int oRow, string oCol)
		{
			string sQry;
			SAPbobsCOM.Recordset oRecordSet = PSH_Globals.oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset);
		...
		/// <summary>
		/// PS_PP638_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP638_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				WinTitle = "[PS_PP638_01] 생산현황(집계표)";
				ReportName = "PS_PP638_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP638_PrintReport);
			...
			try
			{
				...
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemChanged == true)
					{
						...
						{
							PS_PP638_FlushToItemValue(pVal.ItemUID, pVal.Row, pVal.ColUID);
						}
					}
				}
				else if (pVal.BeforeAction == false)
