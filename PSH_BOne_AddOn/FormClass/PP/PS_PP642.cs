...
namespace PSH_BOne_AddOn
{
	...
	/// M/G생산기간별생산실적현황
	/// </summary>
	internal class PS_PP642 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP642.srf");
				...
				oFormUniqueID = "PS_PP642_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP642");
				...
				PS_PP642_CreateItems();
				PS_PP642_SetComboBox();
				PS_PP642_Initialize();
		...
		/// PS_PP642_CreateItems
		/// </summary>
		private void PS_PP642_CreateItems()
		{
			try
			{
		...
		/// PS_PP642_SetComboBox
		/// </summary>
		private void PS_PP642_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP642_Initialize
		/// </summary>
		private void PS_PP642_Initialize()
		{
		...
		/// <summary>
		/// PS_PP642_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP642_PrintReport()
		{
			string sQry;
			string WinTitle;
			string ReportName;
			...
			try
			{
				...
				WinTitle = "[PS_PP642_01] M/G생산기간별생산실적현황";
				ReportName = "PS_PP642_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP642_PrintReport);
