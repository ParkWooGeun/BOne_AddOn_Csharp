	...
	internal class PS_PP643 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				...
				PS_PP643_CreateItems();
				PS_PP643_SetComboBox();
				PS_PP643_Initialize();
		...
		/// PS_PP643_CreateItems
		/// </summary>
		private void PS_PP643_CreateItems()
		{
			try
			{
		...
		/// PS_PP643_SetComboBox
		/// </summary>
		private void PS_PP643_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP643_Initialize
		/// </summary>
		private void PS_PP643_Initialize()
		{
		...
		/// <summary>
		/// PS_PP643_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP643_PrintReport()
		{
			string sQry;
			string WinTitle;
			string ReportName;
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP643_PrintReport);
