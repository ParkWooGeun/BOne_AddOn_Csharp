...
namespace PSH_BOne_AddOn
{
	...
	/// 원재료 재고 List (멀티)
	/// </summary>
	internal class PS_PP644 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP644.srf");
				...
				oFormUniqueID = "PS_PP644_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP644");
				...
				oForm.Freeze(true);
				PS_PP644_CreateItems();
				PS_PP644_SetComboBox();
				PS_PP644_Initialize();
		...
		/// PS_PP644_CreateItems
		/// </summary>
		private void PS_PP644_CreateItems()
		{
			try
			{
		...
		/// PS_PP644_SetComboBox
		/// </summary>
		private void PS_PP644_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP644_Initialize
		/// </summary>
		private void PS_PP644_Initialize()
		{
		...
		/// <summary>
		/// PS_PP644_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP644_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string BPLID;
			...
			try
			{
				...
				{
					WinTitle = "[PS_PP644_01] 재고 LIST-세부";
					ReportName = "PS_PP644_01.RPT";
				}
				else
				{
					WinTitle = "[PS_PP644_02] 재고 LIST-집계";
					ReportName = "PS_PP644_02.RPT";
				}
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP644_PrintReport);
