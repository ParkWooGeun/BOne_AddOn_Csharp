...
namespace PSH_BOne_AddOn
{
	...
	/// 출고현황(품목별 및 세부내역) - 안강
	/// </summary>
	internal class PS_PP645 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP645.srf");
				...
				oFormUniqueID = "PS_PP645_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP645");
				...
				oForm.Freeze(true);
				PS_PP645_CreateItems();
				PS_PP645_SetComboBox();
				PS_PP645_Initialize();
		...
		/// PS_PP645_CreateItems
		/// </summary>
		private void PS_PP645_CreateItems()
		{
			try
			{
		...
		/// PS_PP645_SetComboBox
		/// </summary>
		private void PS_PP645_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP645_Initialize
		/// </summary>
		private void PS_PP645_Initialize()
		{
		...
		/// <summary>
		/// PS_PP645_FlushToItemValue
		/// </summary>
		/// <param name="oUID"></param>
		/// <param name="oRow"></param>
		/// <param name="oCol"></param>
		private void PS_PP645_FlushToItemValue(string oUID, int oRow, string oCol)
		{
			string sQry;
			SAPbobsCOM.Recordset oRecordSet = PSH_Globals.oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset);
		...
		/// <summary>
		/// PS_PP645_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP645_PrintReport()
		{
			...
			try
			{
				...
				{
					WinTitle = "[PS_PP645_01] 출고내역 집계";
					ReportName = "PS_PP645_01.RPT";
				}
				else if (oForm.DataSources.UserDataSources.Item("RadioBtn").Value == "B")
				{
					WinTitle = "[PS_PP645_02] 출고내역 상세";
					ReportName = "PS_PP645_02.RPT";
				}
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP645_PrintReport);
		...
		private void Raise_EVENT_VALIDATE(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				...
				if (pVal.BeforeAction == true)
				{
					...
					{
						if (pVal.ItemUID == "ItmbSort" || pVal.ItemUID == "CardCode" || pVal.ItemUID == "ItemCode")
						{
							PS_PP645_FlushToItemValue(pVal.ItemUID, pVal.Row, pVal.ColUID);
						}
					}
				}
				else if (pVal.BeforeAction == false)
