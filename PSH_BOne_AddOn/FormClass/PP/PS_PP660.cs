...
namespace PSH_BOne_AddOn
{
	...
	/// 제품별 불량현황(멀티)
	/// </summary>
	internal class PS_PP660 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP660.srf");
				...
				oFormUniqueID = "PS_PP660_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP660");
				...
				oForm.Freeze(true);
				PS_PP660_CreateItems();
				PS_PP660_SetComboBox();
				PS_PP660_Initialize();
		...
		/// PS_PP660_CreateItems
		/// </summary>
		private void PS_PP660_CreateItems()
		{
			try
			{
		...
		/// PS_PP660_SetComboBox
		/// </summary>
		private void PS_PP660_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP660_Initialize
		/// </summary>
		private void PS_PP660_Initialize()
		{
		...
		/// <summary>
		/// PS_PP660_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP660_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				{
					WinTitle = "[PS_PP660_01] 제품별 불량현황(멀티)";
					ReportName = "PS_PP660_01.RPT";
				}
				else
				{
					WinTitle = "[PS_PP661_01] 제품별 불량현황(세부내역)-멀티";
					ReportName = "PS_PP661_01.RPT";
				}
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP660_PrintReport);
