...
namespace PSH_BOne_AddOn
{
	...
	/// 공정별 불량현황 (멀티)
	/// </summary>
	internal class PS_PP664 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP664.srf");
				...
				oFormUniqueID = "PS_PP664_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP664");
				...
				oForm.Freeze(true);
				PS_PP664_CreateItems();
				PS_PP664_SetComboBox();
				PS_PP664_Initialize();
		...
		/// PS_PP664_CreateItems
		/// </summary>
		private void PS_PP664_CreateItems()
		{
			try
			{
		...
		/// PS_PP664_SetComboBox
		/// </summary>
		private void PS_PP664_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP664_Initialize
		/// </summary>
		private void PS_PP664_Initialize()
		{
		...
		/// <summary>
		/// PS_PP664_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP664_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				{
					WinTitle = "[PS_PP664_01] 공정별 불량현황 (멀티)";
					ReportName = "PS_PP664_01.RPT";
				}
				else
				{
					WinTitle = "[PS_PP665_01] 불량 Coil List-(멀티)";
					ReportName = "PS_PP665_01.RPT";
				}
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP664_PrintReport);
				...
				else if (pVal.BeforeAction == false)
				{
					if (pVal.ItemChanged == true)
					{
						if (pVal.ItemUID == "CpCode")
						{
							...
							oRecordSet.DoQuery(sQry);
							oForm.Items.Item("CodeName").Specific.String = oRecordSet.Fields.Item("U_CpName").Value.ToString().Trim();
						}
					}
				}
			}
