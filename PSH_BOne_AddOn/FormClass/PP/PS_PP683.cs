...
namespace PSH_BOne_AddOn
{
	...
	/// 개인별 공정 생산량 현황
	/// </summary>
	internal class PS_PP683 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP683.srf");
				...
				oFormUniqueID = "PS_PP683_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP683");
				...
				oForm.Freeze(true);
				PS_PP683_CreateItems();
				PS_PP683_SetComboBox();
				PS_PP683_Initialize();
		...
		/// PS_PP683_CreateItems
		/// </summary>
		private void PS_PP683_CreateItems()
		{
			try
			{
		...
		/// PS_PP683_SetComboBox
		/// </summary>
		private void PS_PP683_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP683_Initialize
		/// </summary>
		private void PS_PP683_Initialize()
		{
		...
		/// <summary>
		/// PS_PP683_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP683_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				WinTitle = "[PS_PP683_01] 개인별 공정 생산량 현황";

				if (oForm.Items.Item("Opt01").Specific.Selected == true)
				{
					ReportName = "PS_PP683_01.RPT";
				}
				else
				{
					ReportName = "PS_PP683_02.RPT";
				}
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP683_PrintReport);
