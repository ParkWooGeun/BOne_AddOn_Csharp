...
namespace PSH_BOne_AddOn
{
	...
	/// 공정별 개인 생산량 현황
	/// </summary>
	internal class PS_PP684 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP684.srf");
				...
				oFormUniqueID = "PS_PP684_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP684");
				...
				oForm.Freeze(true);
				PS_PP684_CreateItems();
				PS_PP684_SetComboBox();
				PS_PP684_Initialize();
		...
		/// PS_PP684_CreateItems
		/// </summary>
		private void PS_PP684_CreateItems()
		{
			try
			{
		...
		/// PS_PP684_SetComboBox
		/// </summary>
		private void PS_PP684_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP684_Initialize
		/// </summary>
		private void PS_PP684_Initialize()
		{
		...
		/// <summary>
		/// PS_PP684_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP684_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				WinTitle = "[PS_PP684_01] 공정별 개인 생산량 현황";
				ReportName = "PS_PP684_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP684_PrintReport);
