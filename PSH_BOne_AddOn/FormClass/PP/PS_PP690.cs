...
namespace PSH_BOne_AddOn
{
	...
	/// 재공품 내역서(공정기준)
	/// </summary>
	internal class PS_PP690 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP690.srf");
				...
				oFormUniqueID = "PS_PP690_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP690");
				...
				oForm.Freeze(true);
				PS_PP690_CreateItems();
				PS_PP690_SetComboBox();
				PS_PP690_Initialize();
		...
		/// PS_PP690_CreateItems
		/// </summary>
		private void PS_PP690_CreateItems()
		{
			try
			{
		...
		/// PS_PP690_SetComboBox
		/// </summary>
		private void PS_PP690_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP690_Initialize
		/// </summary>
		private void PS_PP690_Initialize()
		{
		...
		/// <summary>
		/// PS_PP690_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP690_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				{
					WinTitle = "[PS_PP690_01] 재공품 내역서(공정기준)";
					ReportName = "PS_PP690_01.RPT";
				}
				else
				{
					WinTitle = "[PS_PP685_01] 재공품 내역서 집계 (공정별)";
					ReportName = "PS_PP685_01.RPT";
				}
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP690_PrintReport);
