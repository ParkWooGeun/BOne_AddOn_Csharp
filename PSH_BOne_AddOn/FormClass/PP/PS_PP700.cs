...
namespace PSH_BOne_AddOn
{
	...
	/// 월별 생산의뢰 접수현황
	/// </summary>
	internal class PS_PP700 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP700.srf");
				...
				oFormUniqueID = "PS_PP700_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP700");
				...
				oForm.Freeze(true);
				PS_PP700_CreateItems();
				PS_PP700_SetComboBox();
				PS_PP700_Initialize();
		...
		/// PS_PP700_CreateItems
		/// </summary>
		private void PS_PP700_CreateItems()
		{
			try
			{
		...
		/// PS_PP700_SetComboBox
		/// </summary>
		private void PS_PP700_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP700_Initialize
		/// </summary>
		private void PS_PP700_Initialize()
		{
		...
		/// <summary>
		/// PS_PP700_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP700_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string BPLID;
			...
			try
			{
				...
				WinTitle = "[PS_PP700_01] 월별 생산의뢰 접수현황";
				ReportName = "PS_PP700_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP700_PrintReport);
