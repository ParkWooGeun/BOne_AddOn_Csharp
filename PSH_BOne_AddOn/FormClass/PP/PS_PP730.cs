...
namespace PSH_BOne_AddOn
{
    ...
    /// 분말일자별작업조회
    /// </summary>
    internal class PS_PP730 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFormDocEntry)
        {
            ...
            try
            {
                oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP730.srf");
                ...
                oFormUniqueID = "PS_PP730_" + SubMain.Get_TotalFormsCount();
                SubMain.Add_Forms(this, oFormUniqueID, "PS_PP730");
        ...
        /// 화면 Item 생성
        /// </summary>
        private void PS_PP730_CreateItems()
        {
            try
            {
                oGrid01 = oForm.Items.Item("Grid01").Specific;

                oForm.DataSources.DataTables.Add("PS_PP730");
                oGrid01.DataTable = oForm.DataSources.DataTables.Item("PS_PP730");
        ...
        private void PS_PP730_MTX01()
        {
            ...
            try
            {
                ...
                Query01 = "EXEC [PS_PP730_01] '" + BPLID + "', '" + YM + "', '" + Gubun + "'";
        ...
        /// </summary>
        [STAThread]
        private void PS_PP730_Print_Report01()
        {
            string WinTitle;
            string ReportName;
            string BPLID;
            ...
            try
            {
                ...
                WinTitle = "분말일자별작업조회[PS_PP730_01]";
                ReportName = "PS_PP730_01.rpt";

                List<PSH_DataPackClass> dataPackParameter = new List<PSH_DataPackClass>(); //Parameter List
                List<PSH_DataPackClass> dataPackFormula = new List<PSH_DataPackClass>(); //Formula List

                //Formula
                dataPackFormula.Add(new PSH_DataPackClass("@BPLId", dataHelpClass.Get_ReData("U_CodeNm", "U_Code", "[@PS_HR200L]", BPLID, "and Code = 'P144' AND U_UseYN= 'Y'"))); //년도
        ...
        /// </summary>
        private void PS_PP730_Initial_Setting()
        {
            PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
            try
            {
        ...
        private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
        {
            try
            {
                if (pVal.BeforeAction == true)
                {
                    ...
                    {
                        System.Threading.Thread thread = new System.Threading.Thread(PS_PP730_Print_Report01);
