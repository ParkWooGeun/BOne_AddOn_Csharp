...
namespace PSH_BOne_AddOn
{
	...
	/// M/G스크랩발생현황
	/// </summary>
	internal class PS_PP755 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP755.srf");
				...
				oFormUniqueID = "PS_PP755_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP755");
				...
				PS_PP755_CreateItems();
				PS_PP755_SetComboBox();
				PS_PP755_Initialize();
		...
		/// PS_PP755_CreateItems
		/// </summary>
		private void PS_PP755_CreateItems()
		{
			try
			{
		...
		/// PS_PP755_SetComboBox
		/// </summary>
		private void PS_PP755_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP755_Initialize
		/// </summary>
		private void PS_PP755_Initialize()
		{
		...
		/// <summary>
		/// PS_PP755_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP755_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string DocDateFr;
			...
			try
			{
				...
				WinTitle = "[PS_PP755_01] M/G S&D작업일보현황";
				ReportName = "PS_PP755_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP755_PrintReport);
