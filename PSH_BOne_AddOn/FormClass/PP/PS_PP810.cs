...
namespace PSH_BOne_AddOn
{
	...
	/// TOOL사용실적
	/// </summary>
	internal class PS_PP810 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP810.srf");
                ...
                oFormUniqueID = "PS_PP810_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP810");
				...
				PS_PP810_CreateItems();
				PS_PP810_SetComboBox();
				PS_PP810_Initialize();
		...
		/// PS_PP810_CreateItems
		/// </summary>
		private void PS_PP810_CreateItems()
		{
			try
			{
		...
		/// PS_PP810_SetComboBox
		/// </summary>
		private void PS_PP810_SetComboBox()
		{
			string sQry;
			...
			try
			{
				...
				oForm.Items.Item("Gbn01").Specific.ValidValues.Add("3", "V금형");
				oForm.Items.Item("Gbn01").Specific.ValidValues.Add("4", "FINAL압연");
				oForm.Items.Item("Gbn01").Specific.Select("%", SAPbouiCOM.BoSearchKey.psk_ByValue);
			}
			catch (Exception ex)
			{
				PSH_Globals.SBO_Application.StatusBar.SetText(System.Reflection.MethodBase.GetCurrentMethod().Name + "_Error : " + ex.Message, BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Error);
		...
		/// PS_PP810_Initialize
		/// </summary>
		private void PS_PP810_Initialize()
		{
		...
		/// <summary>
		/// PS_PP810_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP810_PrintReport()
		{
			string WinTitle;
			string ReportName;
			...
			try
			{
				...
				WinTitle = "TOOL사용실적[PS_PP810_01]";
				ReportName = "PS_PP810_01.RPT";
				...
				dataPackParameter.Add(new PSH_DataPackClass("@ToolType", Gbn01));
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP810_PrintReport);
