...
namespace PSH_BOne_AddOn
{
	...
	/// 판매목표대비실적현황
	/// </summary>
	internal class PS_PP820 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP820.srf");
				...
				oFormUniqueID = "PS_PP820_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP820");
				...
				oForm.Freeze(true);
				PS_PP820_CreateItems();
				PS_PP820_SetComboBox();
				PS_PP820_Initialize();
		...
		/// PS_PP820_CreateItems
		/// </summary>
		private void PS_PP820_CreateItems()
		{
			try
			{
		...
		/// PS_PP820_SetComboBox
		/// </summary>
		private void PS_PP820_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP820_Initialize
		/// </summary>
		private void PS_PP820_Initialize()
		{
		...
		/// <summary>
		/// PS_PP820_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP820_PrintReport()
		{
			string sQry;
			string BPLName;
			string BsortName;
			...
			try
			{
				...
				WinTitle = "판매목표대비실적현황 [PS_PP820_01]";
				ReportName = "PS_PP820_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP820_PrintReport);
