	...
	internal class PS_PP835 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				...
				PS_PP835_CreateItems();
				PS_PP835_SetComboBox();
				PS_PP835_Initialize();
		...
		/// PS_PP835_CreateItems
		/// </summary>
		private void PS_PP835_CreateItems()
		{
			try
			{
		...
		/// PS_PP835_SetComboBox
		/// </summary>
		private void PS_PP835_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP835_Initialize
		/// </summary>
		private void PS_PP835_Initialize()
		{
		...
		/// <summary>
		/// PS_PP835_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP835_PrintReport()
		{
			string sQry;
			string WinTitle;
			string ReportName;
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP835_PrintReport);
