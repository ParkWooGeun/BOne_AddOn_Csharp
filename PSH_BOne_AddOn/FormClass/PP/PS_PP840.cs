...
namespace PSH_BOne_AddOn
{
	...
	/// M/G원재료 반품현황
	/// </summary>
	internal class PS_PP840 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP840.srf");
				...
				oFormUniqueID = "PS_PP840_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP840");
				...
				PS_PP840_CreateItems();
				PS_PP840_SetComboBox();
				PS_PP840_Initialize();
		...
		/// PS_PP840_CreateItems
		/// </summary>
		private void PS_PP840_CreateItems()
		{
			try
			{
		...
		/// PS_PP840_SetComboBox
		/// </summary>
		private void PS_PP840_SetComboBox()
		{
		...
		/// PS_PP840_Initialize
		/// </summary>
		private void PS_PP840_Initialize()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
		...
		/// <summary>
		/// PS_PP840_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP840_PrintReport()
		{
			string sQry;
			string WinTitle;
			string ReportName;
			...
			try
			{
				...
				{
					WinTitle = " M/G원재료 반품현황[PS_PP840_01]";
					ReportName = "PS_PP840_01.rpt";
				}
				else
				{
					WinTitle = " M/G원재료 반품세부현황[PS_PP840_02]";
					ReportName = "PS_PP840_02.rpt";
				}
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP840_PrintReport);
