...
namespace PSH_BOne_AddOn
{
	...
	/// M/G생산원재료기타출고현황
	/// </summary>
	internal class PS_PP845 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP845.srf");
				...
				oFormUniqueID = "PS_PP845_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP845");
		...
		/// PS_PP845_CreateItems
		/// </summary>
		private void PS_PP845_CreateItems()
		{
			try
			{
		...
		/// PS_PP845_SetComboBox
		/// </summary>
		private void PS_PP845_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP845_Initialize
		/// </summary>
		private void PS_PP845_Initialize()
		{
		...
		/// <summary>
		/// PS_PP845_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP845_PrintReport()
		{
			string sQry;
			string WinTitle;
			string ReportName;
