...
namespace PSH_BOne_AddOn
{
	...
	internal class PS_PP870 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP870.srf");
				...
				oFormUniqueID = "PS_PP870_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP870");
				...
				PS_PP870_CreateItems();
				PS_PP870_SetComboBox();
				PS_PP870_Initialize();
		...
		/// PS_PP870_CreateItems
		/// </summary>
		private void PS_PP870_CreateItems()
		{
			try
			{
		...
		/// PS_PP870_SetComboBox
		/// </summary>
		private void PS_PP870_SetComboBox()
		{
			string sQry;
			...
			try
			{
				...
				//출력구분
				oForm.Items.Item("Div").Specific.ValidValues.Add("1", "공정장비별가동분석현황");
				oForm.Items.Item("Div").Specific.ValidValues.Add("2", "공정별가동분석현황");
		...
		/// PS_PP870_Initialize
		/// </summary>
		private void PS_PP870_Initialize()
		{
		...
		/// <summary>
		/// PS_PP870_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP870_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string BPLName;
			...
			try
			{
				...
				WinTitle = "[PS_PP870_01] 가동분석현황";
				if (Div == "1")
				{
					ReportName = "PS_PP870_01.RPT";
				}
				else
				{
					ReportName = "PS_PP870_02.RPT";
				}
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP870_PrintReport);
