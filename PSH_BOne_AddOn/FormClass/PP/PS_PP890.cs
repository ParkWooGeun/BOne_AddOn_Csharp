...
namespace PSH_BOne_AddOn
{
	...
	/// 외주가공목표대비실적현황
	/// </summary>
	internal class PS_PP890 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP890.srf");
				...
				oFormUniqueID = "PS_PP890_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP890");
				...
				oForm.Freeze(true);
				PS_PP890_CreateItems();
				PS_PP890_SetComboBox();
				PS_PP890_Initialize();
		...
		/// PS_PP890_CreateItems
		/// </summary>
		private void PS_PP890_CreateItems()
		{
			try
			{
		...
		/// PS_PP890_SetComboBox
		/// </summary>
		private void PS_PP890_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP890_Initialize
		/// </summary>
		private void PS_PP890_Initialize()
		{
		...
		/// <summary>
		/// PS_PP890_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP890_PrintReport()
		{
			string sQry;
			string BPLName;
			string BsortName;
			...
			try
			{
				...
				WinTitle = "외주가공목표대비실적현황 [PS_PP890_01]";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP890_PrintReport);
