...
namespace PSH_BOne_AddOn
{
	...
	/// 담당별생산/판매현황
	/// </summary>
	internal class PS_PP910 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP910.srf");
				...
				oFormUniqueID = "PS_PP910_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP910");
				...
				oForm.Freeze(true);
				PS_PP910_CreateItems();
				PS_PP910_SetComboBox();
				PS_PP910_Initialize();
		...
		/// PS_PP910_CreateItems
		/// </summary>
		private void PS_PP910_CreateItems()
		{
			try
			{
		...
		/// PS_PP910_SetComboBox
		/// </summary>
		private void PS_PP910_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP910_Initialize
		/// </summary>
		private void PS_PP910_Initialize()
		{
			...
			try
			{
				...
				oForm.Items.Item("DocDateFr").Specific.Value = DateTime.Now.ToString("yyyyMM"); //시작년월
			}
			catch (Exception ex)
			{
				PSH_Globals.SBO_Application.StatusBar.SetText(System.Reflection.MethodBase.GetCurrentMethod().Name + "_Error : " + ex.Message, BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Error);
		...
		/// <summary>
		/// PS_PP910_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP910_PrintReport()
		{
			string sQry;
			string BPLName;
			string BsortName;
			...
			try
			{
				...
				WinTitle = "담당별생산/판매현황 [PS_PP910_01]";
				ReportName = "PS_PP910_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP910_PrintReport);
