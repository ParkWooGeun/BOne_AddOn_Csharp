...
namespace PSH_BOne_AddOn
{
	...
	/// 공정장비별가동율현황
	/// </summary>
	internal class PS_PP914 : PSH_BaseClass
	{
		private string oFormUniqueID;
		private SAPbouiCOM.Grid oGrid;
		private SAPbouiCOM.DataTable oDS_PS_PP914A;
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP914.srf");
				...
				oFormUniqueID = "PS_PP914_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP914");
				...
				PS_PP914_CreateItems();
				PS_PP914_SetComboBox();
				PS_PP914_Initialize();
		...
		/// PS_PP914_CreateItems
		/// </summary>
		private void PS_PP914_CreateItems()
		{
			try
			{
				...
				oForm.DataSources.DataTables.Add("PS_PP914A");
				oGrid.DataTable = oForm.DataSources.DataTables.Item("PS_PP914A");
				oDS_PS_PP914A = oForm.DataSources.DataTables.Item("PS_PP914A");
		...
		/// PS_PP914_SetComboBox
		/// </summary>
		private void PS_PP914_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP914_Initialize
		/// </summary>
		private void PS_PP914_Initialize()
		{
		...
		private void PS_PP914_MTX01()
		{
			...
			try
			{
				...
				{
					sQry = "EXEC [PS_PP914_51] '" + BPLId + "', '" + Part + "', '" + DocDateFr + "', '" + DocDateTo + "'";
				}
				else if (oForm.DataSources.UserDataSources.Item("RadioBtn").Value == "B")
				{
					sQry = "EXEC [PS_PP914_52] '" + BPLId + "', '" + Part + "', '" + DocDateFr + "', '" + DocDateTo + "'";
				}
				else if (oForm.DataSources.UserDataSources.Item("RadioBtn").Value == "C")
				{
					sQry = "EXEC [PS_PP914_53] '" + BPLId + "', '" + Part + "', '" + DocDateFr + "', '" + DocDateTo + "'";
				}

				oGrid.DataTable.Clear();
				oDS_PS_PP914A.ExecuteQuery(sQry);
		...
		/// <summary>
		/// PS_PP914_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP914_PrintReport()
		{
			...
			try
			{
				...
				dataPackParameter.Add(new PSH_DataPackClass("@Part", Part));
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP914_PrintReport);
		...
		private void Raise_EVENT_FORM_UNLOAD(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				...
				else if (pVal.BeforeAction == false)
				{
					...
					System.Runtime.InteropServices.Marshal.ReleaseComObject(oDS_PS_PP914A);
				}
			}
			catch (Exception ex)
			{
