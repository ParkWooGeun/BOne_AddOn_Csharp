...
namespace PSH_BOne_AddOn
{
	...
	/// 부문별 공정별 생산현황
	/// </summary>
	internal class PS_PP919 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP919.srf");
				...
				oFormUniqueID = "PS_PP919_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP919");
				...
				oForm.Freeze(true);
				PS_PP919_CreateItems();
				PS_PP919_SetComboBox();
				PS_PP919_Initialize();
		...
		/// PS_PP919_CreateItems
		/// </summary>
		private void PS_PP919_CreateItems()
		{
			try
			{
		...
		/// PS_PP919_SetComboBox
		/// </summary>
		private void PS_PP919_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP919_Initialize
		/// </summary>
		private void PS_PP919_Initialize()
		{
		...
		/// <summary>
		/// PS_PP919_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP919_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string BPLID;
			...
			try
			{
				...
				WinTitle = "[PS_PP919_01] 부문별 공정별 생산현황";
				ReportName = "PS_PP919_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP919_PrintReport);
