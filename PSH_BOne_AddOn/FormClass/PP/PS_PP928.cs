	...
	internal class PS_PP928 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				...
				PS_PP928_CreateItems();
				PS_PP928_SetComboBox();
				PS_PP928_Initialize();
		...
		/// PS_PP928_CreateItems
		/// </summary>
		private void PS_PP928_CreateItems()
		{
			try
			{
		...
		/// PS_PP928_SetComboBox
		/// </summary>
		private void PS_PP928_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP928_Initialize
		/// </summary>
		private void PS_PP928_Initialize()
		{
		...
		/// <summary>
		/// PS_PP928_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP928_PrintReport()
		{
			string WinTitle;
			string ReportName;
			string BPLID;
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP928_PrintReport);
