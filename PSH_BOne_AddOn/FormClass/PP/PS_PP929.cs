	...
	internal class PS_PP929 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				...
				oForm.Freeze(true);
				PS_PP929_CreateItems();
				PS_PP929_SetComboBox();
				PS_PP929_Initialize();
		...
		/// PS_PP929_CreateItems
		/// </summary>
		private void PS_PP929_CreateItems()
		{
			try
			{
		...
		/// PS_PP929_SetComboBox
		/// </summary>
		private void PS_PP929_SetComboBox()
		{
			string sQry;
		...
		/// PS_PP929_Initialize
		/// </summary>
		private void PS_PP929_Initialize()
		{
		...
		/// <summary>
		/// PS_PP929_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP929_PrintReport()
		{
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP929_PrintReport);
