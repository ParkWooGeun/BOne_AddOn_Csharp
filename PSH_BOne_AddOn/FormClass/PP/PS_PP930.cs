	...
	internal class PS_PP930 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				...
				PS_PP930_SetComboBox();
				PS_PP930_AddMatrixRow(0, true);
		...
		/// PS_PP930_SetComboBox
		/// </summary>
		private void PS_PP930_SetComboBox()
		{
		...
		/// <summary>
		/// PS_PP930_AddMatrixRow
		/// </summary>
		/// <param name="oRow"></param>
		/// <param name="RowIserted"></param>
		private void PS_PP930_AddMatrixRow(int oRow, bool RowIserted)
		{
			try
			{
				if (RowIserted == false)
		...
		/// PS_PP930_LoadData
		/// </summary>
		private void PS_PP930_LoadData()
		{
			int i;
			string sQry;
		...
		/// <summary>
		/// PS_PP930_CalcData  일일생산량 계산
		/// </summary>
		private void PS_PP930_CalcData()
		{
			int i;
			int Lastdd;
		...
		/// <returns></returns>
		private bool PS_PP930_AddData(ref SAPbouiCOM.ItemEvent pVal)
		{
		...
		/// <summary>
		/// PS_PP930_DelHeaderSpaceLine
		/// </summary>
		/// <returns></returns>
		private bool PS_PP930_DelHeaderSpaceLine()
		{
			bool returnValue = false;
			string errMessage = string.Empty;
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn_save")
					{
						...
						{
							if (PS_PP930_DelHeaderSpaceLine() == false)
							{
								BubbleEvent = false;
								return;
							}

							if (PS_PP930_AddData(ref pVal) == false)
							{
								BubbleEvent = false;
								return;
							}
