...
namespace PSH_BOne_AddOn
{
	...
	/// 원재료 불량반납내역(임가공)
	/// </summary>
	internal class PS_PP933 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP933.srf");
				...
				oFormUniqueID = "PS_PP933_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP933");
				...
				PS_PP933_CreateItems();
				PS_PP933_SetComboBox();
				PS_PP933_Initialization();
		...
		/// PS_PP933_CreateItems
		/// </summary>
		private void PS_PP933_CreateItems()
		{
			try
			{
		...
		/// PS_PP933_SetComboBox
		/// </summary>
		private void PS_PP933_SetComboBox()
		{
			...
			try
			{
				...
				dataHelpClass.Set_ComboList(oForm.Items.Item("ItmBsort").Specific, "SELECT Code, Name FROM [@PSH_ITMBSORT] WHERE LEFT(Code, 1) = '3' Order by Code", "", false, false);
		...
		/// PS_PP933_Initialization
		/// </summary>
		private void PS_PP933_Initialization()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
		...
		/// <summary>
		/// PS_PP933_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP933_PrintReport()
		{
			string sQry;
			string BPLName;
			string BsortName;
			...
			try
			{
				...
				{
					WinTitle = "임가공원재료 반납현황 [PS_PP933]";
					ReportName = "PS_PP933_01.rpt";
				}
				else
				{
					WinTitle = "임가공원재료 불량반납내역 [PS_PP933]";
					ReportName = "PS_PP933_02.rpt";
				}
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP933_PrintReport);
