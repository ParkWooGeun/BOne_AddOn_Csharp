...
namespace PSH_BOne_AddOn
{
    ...
    internal class PS_PP960 : PSH_BaseClass
    {
        ...
        private void PS_PP960_CreateItems()
        {
            ...
            {
                PSH_Globals.SBO_Application.SetStatusBarMessage("PS_PP960_CreateItems_Error:" + ex.Message, SAPbouiCOM.BoMessageTime.bmt_Short, true);
            }
        }

        /// <summary>
        /// PS_PP960_Print_Report01 리포트 조회
        /// </summary>
        [STAThread]
        private void PS_PP960_Print_Report01()
        {
            string WinTitle;
            string ReportName;
            ...
            {
                PSH_Globals.SBO_Application.StatusBar.SetText("PS_PP960_Print_Report01_Error : " + ex.Message, BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Error);
            }
        }

        /// <summary>
        /// PS_PP960_DataValidCheck
        /// </summary>
        /// <returns></returns>
        private bool PS_PP960_DataValidCheck()
        {
            ...
            try
            {
                if (pVal.BeforeAction == true)
                {
                    if (pVal.ItemUID == "Btn01")
                    {
                        ...
                        {
                            if (PS_PP960_DataValidCheck() == false)
                            {
                                BubbleEvent = false;
                                return;
                            }
                            ...
                            {
                                System.Threading.Thread thread = new System.Threading.Thread(PS_PP960_Print_Report01);
