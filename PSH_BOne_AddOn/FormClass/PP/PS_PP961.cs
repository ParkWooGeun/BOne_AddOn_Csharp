...
namespace PSH_BOne_AddOn
{
	...
	/// 쇼링생산현황
	/// </summary>
	internal class PS_PP961 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP961.srf");
				...
				oFormUniqueID = "PS_PP961_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_PP961");
				...
				oForm.Freeze(true);
				PS_PP961_CreateItems();
				PS_PP961_SetComboBox();
				PS_PP961_Initialize();
		...
		/// PS_PP961_CreateItems
		/// </summary>
		private void PS_PP961_CreateItems()
		{
			try
			{
		...
		/// PS_PP961_SetComboBox
		/// </summary>
		private void PS_PP961_SetComboBox()
		{
		...
		/// PS_PP961_Initialize
		/// </summary>
		private void PS_PP961_Initialize()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
		...
		/// <summary>
		/// PS_PP961_PrintReport
		/// </summary>
		[STAThread]
		private void PS_PP961_PrintReport()
		{
			string sQry;
			string BPLName;
			string WinTitle;
			...
			try
			{
				...
				WinTitle = "쇼링생산현황 [PS_PP961]";
				ReportName = "PS_PP961_01.rpt";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_PP961_PrintReport);
