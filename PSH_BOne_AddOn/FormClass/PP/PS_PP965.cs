...
namespace PSH_BOne_AddOn
{
    ...
    /// 부품일자별판매현황
    /// </summary>
    internal class PS_PP965 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFormDocEntry01)
        {
            ...
            try
            {
                oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_PP965.srf");
                ...
                oFormUniqueID01 = "PS_PP965_" + SubMain.Get_TotalFormsCount();
                SubMain.Add_Forms(this, oFormUniqueID01, "PS_PP965");
        ...
        /// </summary>
        /// <returns></returns>
        private void PS_PP965_CreateItems()
        {
            try
            {
            ...
            {
                PSH_Globals.SBO_Application.SetStatusBarMessage("PS_PP965_CreateItems_Error:" + ex.Message, SAPbouiCOM.BoMessageTime.bmt_Short, true);
            }
        }

        /// <summary>
        /// PS_PP965_Print_Report01 리포트 조회
        /// </summary>
        [STAThread]
        private void PS_PP965_Print_Report01()
        {
            string WinTitle;
            string ReportName;
            ...
            try
            {
                ...
                {
                    WinTitle = "부품일자별판매현황 [PS_PP965]";
                    ReportName = "PS_PP965_01.rpt";
                }
                else
                {
                    WinTitle = "부품일자별판매현황 [PS_PP965]";
                    ReportName = "PS_PP965_02.rpt";
                }
                ...
                //Parameter
                dataPackParameter.Add(new PSH_DataPackClass("@Fym", Fym)); //사업장
            ...
            {
                PSH_Globals.SBO_Application.StatusBar.SetText("PS_PP965_Print_Report01_Error : " + ex.Message, BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Error);
            }
        }

        /// <summary>
        /// PS_PP965_DataValidCheck
        /// </summary>
        /// <returns></returns>
        private bool PS_PP965_DataValidCheck()
        {
            ...
            try
            {
                if (pVal.BeforeAction == true)
                {
                    if (pVal.ItemUID == "Btn01")
                    {
                        ...
                        {
                            if (PS_PP965_DataValidCheck() == false)
                            {
                                BubbleEvent = false;
                                return;
                            }
                            ...
                            {
                                System.Threading.Thread thread = new System.Threading.Thread(PS_PP965_Print_Report01);
