...
namespace PSH_BOne_AddOn
{
    ...
    internal class PS_PP970 : PSH_BaseClass
    {
        ...
        /// PS_PP970_ComboBox_Setting
        /// </summary>
        private void PS_PP970_ComboBox_Setting()
        {
            string sQry;
        ...
        /// Initialize
        /// </summary>
        private void PS_PP970_Initialize()
        {
        ...
        /// <summary>
        /// PS_PP970_PrintReport 리포트 조회
        /// </summary>
        [STAThread]
        private void PS_PP970_PrintReport()
        {
            string sQry;
        ...
        private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
        {
            try
            {
                if (pVal.BeforeAction == true)
                {
                    ...
                    {
                        System.Threading.Thread thread = new System.Threading.Thread(PS_PP970_PrintReport);
