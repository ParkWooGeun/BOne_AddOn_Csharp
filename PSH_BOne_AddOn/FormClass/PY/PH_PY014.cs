...
namespace PSH_BOne_AddOn
{
    ...
    internal class PH_PY014 : PSH_BaseClass
    {
        ...
        public SAPbouiCOM.DataTable oDS_PH_PY014;
        ...
        /// 화면의 아이템 Enable 설정
        /// </summary>
        public void PH_PY014_FormItemEnabled()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public bool PH_PY014_DataValidCheck()
        {
...
//			oXmlDoc.load(MDC_Globals.SP_Path + "\\" + MDC_Globals.SP_Screen + "\\PH_PY014.srf");
...
//			SubMain.AddForms(this, oFormUniqueID, "PH_PY014");
...
//			oForm.Freeze(true);
//			PH_PY014_CreateItems();
//			PH_PY014_EnableMenus();
//			PH_PY014_SetDocument(oFromDocEntry01);
...
//		private bool PH_PY014_CreateItems()
//		{
//			bool functionReturnValue = false;
...
//			oRecordSet = null;
//			oForm.Freeze(false);
//			PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY014_CreateItems_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}

//		private void PH_PY014_EnableMenus()
//		{
...
//			PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY014_EnableMenus_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		private void PH_PY014_SetDocument(string oFromDocEntry01)
//		{
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY014_SetDocument_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//			oForm.Freeze(false);
//			PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY014_FormItemEnabled_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//									switch (oForm.Items.Item("CLTCOD").Specific.VALUE) {
//										case "1":
//											if (oDS_PH_PY014.Columns.Item("DangerNu").Cells.Item(pVal.Row).Value != 0 & oDS_PH_PY014.Columns.Item("DangerNu").Cells.Item(pVal.Row).Value != 1) {
//												oDS_PH_PY014.Columns.Item("DangerNu").Cells.Item(pVal.Row).Value = 0;
//												PSH_Globals.SBO_Application.SetStatusBarMessage("0 또는 1만 입력 가능합니다.", SAPbouiCOM.BoMessageTime.bmt_Short, true);
//											}
//											oDS_PH_PY014.Columns.Item("DangerCD").Cells.Item(pVal.Row).Value = "";
//											break;
//										case "2":
//											if (oDS_PH_PY014.Columns.Item("DangerNu").Cells.Item(pVal.Row).Value != 0.5 & oDS_PH_PY014.Columns.Item("DangerNu").Cells.Item(pVal.Row).Value != 1) {
//												oDS_PH_PY014.Columns.Item("DangerNu").Cells.Item(pVal.Row).Value = 0;
//												oDS_PH_PY014.Columns.Item("DangerCD").Cells.Item(pVal.Row).Value = "";
//												PSH_Globals.SBO_Application.SetStatusBarMessage("0.5 또는 1 만 입력 가능합니다.", SAPbouiCOM.BoMessageTime.bmt_Short, true);
//											} else {
//												if (oDS_PH_PY014.Columns.Item("DangerNu").Cells.Item(pVal.Row).Value >= 0.5) {
//													oDS_PH_PY014.Columns.Item("DangerCD").Cells.Item(pVal.Row).Value = "56";
//													//// '// 위해등급 6급
//												} else {
//													oDS_PH_PY014.Columns.Item("DangerCD").Cells.Item(pVal.Row).Value = "";
...
//						//UPGRADE_NOTE: oForm 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//						oForm = null;
//						//UPGRADE_NOTE: oDS_PH_PY014 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//						oDS_PH_PY014 = null;
...
//		public void PH_PY014_FormClear()
//		{
//			 // ERROR: Not supported in C#: OnErrorStatement

//			string DocEntry = null;
//			//UPGRADE_WARNING: MDC_GetData.Get_ReData() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			DocEntry = MDC_GetData.Get_ReData(ref "AutoKey", ref "ObjectCode", ref "ONNM", ref "'PH_PY014'", ref "");
...
//			PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY014_FormClear_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//			oRecordSet = null;
//			functionReturnValue = false;
//			PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY014_DataValidCheck_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}


//		public bool PH_PY014_Validate(string ValidateType)
//		{
//			bool functionReturnValue = false;
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			//UPGRADE_WARNING: MDC_Company_Common.GetValue(SELECT Canceled FROM [PH_PY014A] WHERE DocEntry = ' & oForm.Items(DocEntry).Specific.VALUE & ', 0, 1) 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			if (MDC_Company_Common.GetValue("SELECT Canceled FROM [@PH_PY014A] WHERE DocEntry = '" + oForm.Items.Item("DocEntry").Specific.VALUE + "'", 0, 1) == "Y") {
...
//			functionReturnValue = false;
//			PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY014_Validate_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}
...
//			PH_PY014_TitleSetting(ref iRow);
...
//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY014_DataFind_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//					sQry = sQry + " DangerCD = '" + oDS_PH_PY014.Columns.Item("DangerCD").Cells.Item(i).Value + "'";
//					sQry = sQry + " WHERE CLTCOD = '" + CLTCOD + "'";
//					sQry = sQry + " And PosDate = '" + oDS_PH_PY014.Columns.Item("PosDate").Cells.Item(i).Value + "'";
//					sQry = sQry + " And MSTCOD = '" + oDS_PH_PY014.Columns.Item("MSTCOD").Cells.Item(i).Value + "'";
//					oRecordSet.DoQuery(sQry);
...
//				}
//				PSH_Globals.SBO_Application.SetStatusBarMessage("위해일수(등급)가 변경되었습니다.", SAPbouiCOM.BoMessageTime.bmt_Short, false);
//				functionReturnValue = true;
//			} else {
...
//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY014_DataSave_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}

//		private void PH_PY014_TitleSetting(ref int iRow)
//		{
//			int i = 0;
//			int j = 0;
//			string sQry = null;
...
//			//UPGRADE_NOTE: oColumn 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oColumn = null;
//			PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY014_TitleSetting Error : " + Strings.Space(10) + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
//	}
//}
