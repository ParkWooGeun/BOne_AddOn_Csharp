    ...
    public override void LoadForm(string oFormDocEntry01)
        {
            ...
            try
            {
                ...
                PSH_Globals.ExecuteEventFilter(typeof(PH_PY034));
            }
            catch (Exception ex)
            {
            ...
            try
            {
                ...
                if (oMat01.VisualRowCount > 0)
                {
                    if (!string.IsNullOrEmpty(oDS_PH_PY034B.GetValue("U_DocNo", oRow - 1).ToString().Trim()))
                    {
                        ...
                        oDS_PH_PY034B.SetValue("U_Debit", oRow, "0");
                        oDS_PH_PY034B.SetValue("U_Credit", oRow, "0");
                    ...
                    else
                    {
                        ...
                        oDS_PH_PY034B.SetValue("U_Debit", oRow - 1, "0");
                        oDS_PH_PY034B.SetValue("U_Credit", oRow - 1, "0");
