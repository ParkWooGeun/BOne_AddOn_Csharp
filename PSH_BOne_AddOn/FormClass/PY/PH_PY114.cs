    ...
    internal class PH_PY114 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFromDocEntry01)
        {
            ...
            try
            {
                ...
                PH_PY114_SetDocument(oFromDocEntry01);
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <param name="oFromDocEntry01"></param>
        private void PH_PY114_SetDocument(string oFromDocEntry01)
        {
            PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        public bool PH_PY114_DataValidCheck()
        {
            ...
            try
            {
                ...
                //switch (true)
                //{
                //    case string.IsNullOrEmpty(oDS_PH_PY114A.GetValue("Code", 0))):
                //        functionReturnValue = false;
                //        MDC_Globals.Sbo_Application.StatusBar.SetText("코드는 필수입니다. 입력하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Success);
                //        return functionReturnValue;
                //    case string.IsNullOrEmpty(oDS_PH_PY114A.GetValue("U_FIXTYP", 0)):
                //        functionReturnValue = false;
                //        MDC_Globals.Sbo_Application.StatusBar.SetText("평균임금 산정방법은 필수입니다. 입력하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Success);
                //        return functionReturnValue;
                //    case Strings.Left(oDS_PH_PY114A.GetValue("U_FIXTYP", 0), 1) == "D" & string.IsNullOrEmpty(oDS_PH_PY114A.GetValue("U_ROUNDT", 0))):
                //        functionReturnValue = false;
                //        MDC_Globals.Sbo_Application.StatusBar.SetText("일할 끝전처리방법을 선택하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
                //        return functionReturnValue;
                //    case Strings.Left(oDS_PH_PY114A.GetValue("U_FIXTYP", 0), 1) == "D" & string.IsNullOrEmpty(oDS_PH_PY114A.GetValue("U_LENGTH", 0).ToString().Trim()):
                //        functionReturnValue = false;
                //        MDC_Globals.Sbo_Application.StatusBar.SetText("일할 단위를 선택하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
                //        return functionReturnValue;
                //}
        ...
        /// 매트릭스 행 추가
        /// </summary>
        public void PH_PY114_AddMatrixRow()
        {
            int oRow = 0;
            try
            {
                ...
                if (oMat2.VisualRowCount > 0)
                {
                    if (!string.IsNullOrEmpty(oDS_PH_PY114C.GetValue("U_MSTSTP", oRow - 1).ToString().Trim()))
                    {
                        ...
                        oDS_PH_PY114C.SetValue("U_ADDRAT", oRow, Convert.ToString(0));
                        oMat2.LoadFromDataSource();
                    }
                    else
                    {
                        ...
                        oDS_PH_PY114C.SetValue("U_ADDRAT", oRow - 1, Convert.ToString(0));
                        oMat2.LoadFromDataSource();
                    }
                }
        ...
        {
            string CSUACC = string.Empty;
            string BH1ACC = string.Empty;
            string KUKACC = string.Empty;
            string MEDACC = string.Empty;
            string JUNACC = string.Empty;
            string BH2ACC = string.Empty;
            string GONACC = string.Empty;
            PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
...
//        private string[] CSUNAM = new string[10];
//        //UPGRADE_WARNING: SILCOD 배열의 하한이 1에서 0(으)로 변경되었습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="0F1C9BE1-AF9D-476E-83B1-17D43BECFF20"'
//        private string[] SILCOD = new string[28];
//        //UPGRADE_WARNING: SILCUN 배열의 하한이 1에서 0(으)로 변경되었습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="0F1C9BE1-AF9D-476E-83B1-17D43BECFF20"'
//        private string[] SILCUN = new string[28];
...
//            oXmlDoc.load(MDC_Globals.SP_Path + "\\" + MDC_Globals.SP_Screen + "\\PH_PY114.srf");
...
//            SubMain.AddForms(this, oFormUniqueID, "PH_PY114");
...
//        private bool PH_PY114_CreateItems()
//        {
//            bool functionReturnValue = false;
...
//            oDS_PH_PY114A = oForm.DataSources.DBDataSources("@PH_PY114A");
//            ////헤더
//            oDS_PH_PY114B = oForm.DataSources.DBDataSources("@PH_PY114B");
//            ////라인
//            oDS_PH_PY114C = oForm.DataSources.DBDataSources("@PH_PY114C");
//            ////라인
...
//            oEdit = oForm.Items.Item("MEDNAM").Specific;
//            oEdit.DataBind.SetBound(true, "", "MEDNAM");
//            oEdit = oForm.Items.Item("KUKNAM").Specific;
//            oEdit.DataBind.SetBound(true, "", "KUKNAM");
//            oEdit = oForm.Items.Item("JUNNAM").Specific;
//            oEdit.DataBind.SetBound(true, "", "JUNNAM");
//            oEdit = oForm.Items.Item("BH1NAM").Specific;
//            oEdit.DataBind.SetBound(true, "", "BH1NAM");
//            oEdit = oForm.Items.Item("BH2NAM").Specific;
//            oEdit.DataBind.SetBound(true, "", "BH2NAM");
//            oEdit = oForm.Items.Item("CSUNAM").Specific;
//            oEdit.DataBind.SetBound(true, "", "CSUNAM");
//            oEdit = oForm.Items.Item("GONNAM").Specific;
//            oEdit.DataBind.SetBound(true, "", "GONNAM");


//            //// 1.평균임금산정방법
//            oCombo = oForm.Items.Item("FIXTYP").Specific;
...
//            //    End If
//            //// 2.일할 끝전처리
//            oCombo = oForm.Items.Item("ROUNDT").Specific;
...
//            //// 5.단위
//            oCombo = oForm.Items.Item("LENGTH").Specific;
...
//            //// 4.옵션버튼(비정기상여포함여부)
//            oOption = oForm.Items.Item("Opt11").Specific;
//            oOption.GroupWith(("Opt12"));
//            oOption.DataBind.SetBound(true, "@PH_PY114A", "U_RETCHK");

//            oOption = oForm.Items.Item("Opt12").Specific;
//            oOption.DataBind.SetBound(true, "@PH_PY114A", "U_RETCHK");
...
//            //// 5.옵션버튼(1년미만자 포함여부)
//            oOption = oForm.Items.Item("Opt21").Specific;
//            oOption.GroupWith(("Opt22"));
//            oOption.DataBind.SetBound(true, "@PH_PY114A", "U_1YYCHK");

//            oOption = oForm.Items.Item("Opt22").Specific;
//            oOption.DataBind.SetBound(true, "@PH_PY114A", "U_1YYCHK");
...
//            oOption.Selected = true;
//            //// 6.옵션버튼(근속년수 기준)
//            oOption = oForm.Items.Item("Opt31").Specific;
//            oOption.GroupWith(("Opt32"));
//            oOption.DataBind.SetBound(true, "@PH_PY114A", "U_GNSGBN");

//            oOption = oForm.Items.Item("Opt32").Specific;
//            oOption.DataBind.SetBound(true, "@PH_PY114A", "U_GNSGBN");
...
//            //// 7.옵션버튼(분개생성 방법)
//            oOption = oForm.Items.Item("Opt41").Specific;
//            oOption.GroupWith(("Opt42"));
//            oOption.DataBind.SetBound(true, "@PH_PY114A", "U_BILCHK");

//            oOption = oForm.Items.Item("Opt42").Specific;
//            oOption.DataBind.SetBound(true, "@PH_PY114A", "U_BILCHK");
...
//            //// 8.옵션버튼(퇴사월 연차수당 처리)
//            oOption = oForm.Items.Item("Opt51").Specific;
//            oOption.GroupWith(("Opt52"));
//            oOption.DataBind.SetBound(true, "@PH_PY114A", "U_RETYCH");

//            oOption = oForm.Items.Item("Opt52").Specific;
//            oOption.DataBind.SetBound(true, "@PH_PY114A", "U_RETYCH");
...
//            for (i = 1; i <= 3; i++)
//            {
//                oFolder = oForm.Items.Item("Folder" + i).Specific;
...
//            //// 직위
//            oColumn = oMat2.Columns.Item("MSTSTP");
//            sQry = "SELECT posID,name FROM [OHPS] ORDER BY posID";
//            oRecordSet.DoQuery(sQry);
//            while (!(oRecordSet.EoF))
//            {
...
//            /// 귀속연월
//            //UPGRADE_WARNING: oForm.Items(Code).Specific.Value 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//            oForm.Items.Item("Code").Specific.Value = Microsoft.VisualBasic.Compatibility.VB6.Support.Format(DateAndTime.Now, "YYYY");

//            //// 누진계산사용유무
//            oCombo = oForm.Items.Item("RATUSE").Specific;
...
//            oRecordSet = null;
//            oForm.Freeze(false);
//            MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY114_CreateItems_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//            return functionReturnValue;
//        }
...
//            MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY114_EnableMenus_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//        }
...
//            MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY114_SetDocument_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//        }

//        public void PH_PY114_FormItemEnabled()
//        {
//            SAPbouiCOM.ComboBox oCombo = null;
...
//            oForm.Freeze(false);
//            MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY114_FormItemEnabled_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//        }
...
//                    ////2
//                    if (pVal.BeforeAction == true & pVal.CharPressed == 9 & pVal.FormMode != SAPbouiCOM.BoFormMode.fm_FIND_MODE)
//                    {
...
//                        if (pVal.ItemUID == "MEDACC")
//                        {
//                            //UPGRADE_WARNING: oForm.Items(MEDACC).Specific.String 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                            //UPGRADE_WARNING: oForm.Items().Specific.Value 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                            if (MDC_SetMod.Value_ChkYn("OACT", "FORMATCODE", "'" + oForm.Items.Item("MEDACC").Specific.Value + "'") == true | string.IsNullOrEmpty(oForm.Items.Item("MEDACC").Specific.String))
//                            {
//                                oForm.Items.Item("MEDACC").Click(SAPbouiCOM.BoCellClickType.ct_Regular);
...
//                        else if (pVal.ItemUID == "KUKACC")
//                        {
//                            //UPGRADE_WARNING: oForm.Items(KUKACC).Specific.String 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                            //UPGRADE_WARNING: oForm.Items().Specific.Value 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                            if (MDC_SetMod.Value_ChkYn("OACT", "FORMATCODE", "'" + oForm.Items.Item("KUKACC").Specific.Value + "'") == true | string.IsNullOrEmpty(oForm.Items.Item("KUKACC").Specific.String))
//                            {
//                                oForm.Items.Item("KUKACC").Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//                                MDC_Globals.Sbo_Application.ActivateMenuItem(("7425"));
//                                BubbleEvent = false;
...
//                        else if (pVal.ItemUID == "JUNACC")
//                        {
//                            //UPGRADE_WARNING: oForm.Items(JUNACC).Specific.String 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                            //UPGRADE_WARNING: oForm.Items().Specific.Value 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                            if (MDC_SetMod.Value_ChkYn("OACT", "FORMATCODE", "'" + oForm.Items.Item("JUNACC").Specific.Value + "'") == true | string.IsNullOrEmpty(oForm.Items.Item("JUNACC").Specific.String))
//                            {
//                                oForm.Items.Item("JUNACC").Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//                                MDC_Globals.Sbo_Application.ActivateMenuItem(("7425"));
//                                BubbleEvent = false;
...
//                        else if (pVal.ItemUID == "BH1ACC")
//                        {
//                            //UPGRADE_WARNING: oForm.Items(BH1ACC).Specific.String 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                            //UPGRADE_WARNING: oForm.Items().Specific.Value 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                            if (MDC_SetMod.Value_ChkYn("OACT", "FORMATCODE", "'" + oForm.Items.Item("BH1ACC").Specific.Value + "'") == true | string.IsNullOrEmpty(oForm.Items.Item("BH1ACC").Specific.String))
//                            {
//                                oForm.Items.Item("BH1ACC").Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//                                MDC_Globals.Sbo_Application.ActivateMenuItem(("7425"));
//                                BubbleEvent = false;
...
//                        else if (pVal.ItemUID == "BH2ACC")
//                        {
//                            //UPGRADE_WARNING: oForm.Items(BH2ACC).Specific.String 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                            //UPGRADE_WARNING: oForm.Items().Specific.Value 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                            if (MDC_SetMod.Value_ChkYn("OACT", "FORMATCODE", "'" + oForm.Items.Item("BH2ACC").Specific.Value + "'") == true | string.IsNullOrEmpty(oForm.Items.Item("BH2ACC").Specific.String))
//                            {
//                                oForm.Items.Item("BH2ACC").Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//                                MDC_Globals.Sbo_Application.ActivateMenuItem(("7425"));
//                                BubbleEvent = false;
...
//                        else if (pVal.ItemUID == "CSUACC")
//                        {
//                            //UPGRADE_WARNING: oForm.Items(CSUACC).Specific.String 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                            //UPGRADE_WARNING: oForm.Items().Specific.Value 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                            if (MDC_SetMod.Value_ChkYn("OACT", "FORMATCODE", "'" + oForm.Items.Item("CSUACC").Specific.Value + "'") == true | string.IsNullOrEmpty(oForm.Items.Item("CSUACC").Specific.String))
//                            {
//                                oForm.Items.Item("CSUACC").Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//                                MDC_Globals.Sbo_Application.ActivateMenuItem(("7425"));
//                                BubbleEvent = false;
...
//                        else if (pVal.ItemUID == "GONACC")
//                        {
//                            //UPGRADE_WARNING: oForm.Items(GONACC).Specific.String 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                            //UPGRADE_WARNING: oForm.Items().Specific.Value 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                            if (MDC_SetMod.Value_ChkYn("OACT", "FORMATCODE", "'" + oForm.Items.Item("GONACC").Specific.Value + "'") == true | string.IsNullOrEmpty(oForm.Items.Item("GONACC").Specific.String))
//                            {
//                                oForm.Items.Item("GONACC").Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//                                MDC_Globals.Sbo_Application.ActivateMenuItem(("7425"));
//                                BubbleEvent = false;
...
//                            oForm.Items.Item("FIXTYP").Update();
//                            Display_PH_PY114B();
//                            if (Strings.Left(oDS_PH_PY114A.GetValue("U_FIXTYP", 0), 1) == "M")
//                            {
//                                oDS_PH_PY114A.SetValue("U_ROUNDT", 0, "");
//                                oDS_PH_PY114A.SetValue("U_LENGTH", 0, "");
//                                oForm.Items.Item("ROUNDT").Enabled = false;
...
//                            if (pVal.Row == oMat2.RowCount & !string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY114C.GetValue("U_MSTSTP", pVal.Row - 1))))
//                            {
//                                PH_PY114_AddMatrixRow();
//                                oMat2.Columns.Item("Col2").Cells.Item(pVal.Row).Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//                            }
...
//                                oForm.DataSources.UserDataSources.Item(pVal.ItemUID).ValueEx = MDC_SetMod.Get_ReData("ACCTNAME", "FORMATCODE", "OACT", "'" + oDS_PH_PY114A.GetValue("U_" + pVal.ItemUID, 0) + "'");
//                            }
//                        }
//                    }
//                    break;
...
//                        //UPGRADE_NOTE: oForm 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//                        oForm = null;
//                        //UPGRADE_NOTE: oDS_PH_PY114A 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//                        oDS_PH_PY114A = null;
//                        //UPGRADE_NOTE: oDS_PH_PY114B 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//                        oDS_PH_PY114B = null;
//                        //UPGRADE_NOTE: oDS_PH_PY114C 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//                        oDS_PH_PY114C = null;
...
//            if (oMat2.VisualRowCount > 0)
//            {
//                if (!string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY114C.GetValue("U_MSTSTP", oRow - 1))))
//                {
//                    if (oDS_PH_PY114C.Size <= oMat2.VisualRowCount)
//                    {
//                        oDS_PH_PY114C.InsertRecord((oRow));
...
//            oForm.Freeze(false);
//            MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY114_AddMatrixRow_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//        }

//        public void PH_PY114_FormClear()
//        {
//            // ERROR: Not supported in C#: OnErrorStatement

//            string DocEntry = null;
//            //UPGRADE_WARNING: MDC_GetData.Get_ReData() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//            DocEntry = MDC_GetData.Get_ReData(ref "AutoKey", ref "ObjectCode", ref "ONNM", ref "'PH_PY114'", ref "");
//            if (Convert.ToDouble(DocEntry) == 0)
//            {
//                //UPGRADE_WARNING: oForm.Items().Specific.Value 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                oForm.Items.Item("DocEntry").Specific.Value = 1;
...
//            MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY114_FormClear_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//        }
...
//            switch (true)
//            {
//                case string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY114A.GetValue("Code", 0))):
//                    functionReturnValue = false;
//                    MDC_Globals.Sbo_Application.StatusBar.SetText("코드는 필수입니다. 입력하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Success);
//                    return functionReturnValue;
//                case string.IsNullOrEmpty(oDS_PH_PY114A.GetValue("U_FIXTYP", 0)):
...
//                    MDC_Globals.Sbo_Application.StatusBar.SetText("평균임금 산정방법은 필수입니다. 입력하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Success);
//                    return functionReturnValue;
//                case Strings.Left(oDS_PH_PY114A.GetValue("U_FIXTYP", 0), 1) == "D" & string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY114A.GetValue("U_ROUNDT", 0))):
//                    functionReturnValue = false;
//                    MDC_Globals.Sbo_Application.StatusBar.SetText("일할 끝전처리방법을 선택하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//                    return functionReturnValue;
//                case Strings.Left(oDS_PH_PY114A.GetValue("U_FIXTYP", 0), 1) == "D" & string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY114A.GetValue("U_LENGTH", 0))):
//                    functionReturnValue = false;
//                    MDC_Globals.Sbo_Application.StatusBar.SetText("일할 단위를 선택하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//                    return functionReturnValue;
//            }

//            DocNum = Exist_YN(ref oDS_PH_PY114A.GetValue("Code", 0));
//            if (!string.IsNullOrEmpty(Strings.Trim(DocNum)) & Strings.Trim(oDS_PH_PY114A.GetValue("Code", 0)) != Strings.Trim(DocNum))
//            {
//                MDC_Globals.Sbo_Application.StatusBar.SetText("기존의 데이터가 있습니다. 확인하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//                functionReturnValue = false;
//                return functionReturnValue;
//            }
...
//            {
//                oDS_PH_PY114B.Offset = i;
//                if (string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY114B.GetValue("U_CSUCOD", i))))
//                {
//                    MDC_Globals.Sbo_Application.StatusBar.SetText("코드는 필수입니다. 입력하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//                    oMat1.Columns.Item("Col4").Cells.Item(i + 1).Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//                    functionReturnValue = false;
//                    return functionReturnValue;
//                }
...
//                    //중복체크작업
//                    //ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
//                    Chk_Data = Strings.Trim(oDS_PH_PY114B.GetValue("U_CSUCOD", i));
//                    for (k = i + 1; k <= oMat1.VisualRowCount - 2; k++)
//                    {
//                        oDS_PH_PY114B.Offset = k;
//                        if (Strings.Trim(Chk_Data) == Strings.Trim(oDS_PH_PY114B.GetValue("U_CSUCOD", k)))
//                        {
//                            MDC_Globals.Sbo_Application.StatusBar.SetText("내용이 중복입력되었습니다. 확인하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//                            oMat1.Columns.Item("Col1").Cells.Item(i + 1).Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//                            functionReturnValue = false;
//                            return functionReturnValue;
//                        }
...
//                    {
//                        oDS_PH_PY114C.Offset = i;
//                        if (string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY114C.GetValue("U_MSTSTP", i))))
//                        {
//                            MDC_Globals.Sbo_Application.StatusBar.SetText("직위는 필수입니다. 입력하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//                            oMat2.Columns.Item("Col2").Cells.Item(i + 1).Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//                            functionReturnValue = false;
//                            return functionReturnValue;
//                        }
...
//                            //중복체크작업
//                            //ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
//                            Chk_Data = Strings.Trim(oDS_PH_PY114C.GetValue("U_MSTSTP", i));
//                            for (k = i + 1; k <= oMat2.VisualRowCount - 2; k++)
//                            {
//                                oDS_PH_PY114C.Offset = k;
//                                if (Strings.Trim(Chk_Data) == Strings.Trim(oDS_PH_PY114C.GetValue("U_MSTSTP", k)))
//                                {
//                                    MDC_Globals.Sbo_Application.StatusBar.SetText("임원누진 내용이 중복입력되었습니다. 확인하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//                                    oMat2.Columns.Item("Col2").Cells.Item(i + 1).Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//                                    functionReturnValue = false;
//                                    return functionReturnValue;
//                                }
...
//                    }
//                }
//                if (string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY114C.GetValue("U_MSTSTP", oDS_PH_PY114C.Size - 1))))
//                {
//                    oDS_PH_PY114C.RemoveRecord(oDS_PH_PY114C.Size - 1);
//                    //// Mat1에 마지막라인(빈라인) 삭제
//                }
...
//            oRecordSet = null;
//            functionReturnValue = false;
//            MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY114_DataValidCheck_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//            return functionReturnValue;
//        }


//        public bool PH_PY114_Validate(string ValidateType)
//        {
//            bool functionReturnValue = false;
//            // ERROR: Not supported in C#: OnErrorStatement
...
//            //UPGRADE_WARNING: oForm.Items().Specific.Value 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//            //UPGRADE_WARNING: MDC_Company_Common.GetValue(SELECT Canceled FROM [PH_PY114A] WHERE DocEntry = ' & oForm.Items(DocEntry).Specific.Value & ', 0, 1) 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//            if (MDC_Company_Common.GetValue("SELECT Canceled FROM [@PH_PY114A] WHERE DocEntry = '" + oForm.Items.Item("DocEntry").Specific.Value + "'", 0, 1) == "Y")
//            {
...
//            functionReturnValue = false;
//            MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY114_Validate_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//            return functionReturnValue;
//        }



//        private void PH_PY114_Print_Report01()
//        {
...
//            //UPGRADE_WARNING: oForm.Items().Specific.Value 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//            sQry = "EXEC PH_PY114_1 '" + oForm.Items.Item("8").Specific.Value + "'";
...
//            MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY114_Print_Report01_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//        }
...
//            {
//                //UPGRADE_WARNING: MDC_SetMod.Get_ReData() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                oForm.DataSources.UserDataSources.Item("MEDNAM").ValueEx = MDC_SetMod.Get_ReData("ACCTNAME", "FORMATCODE", "OACT", "'" + MEDACC + "'");
//            }
...
//            {
//                //UPGRADE_WARNING: MDC_SetMod.Get_ReData() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                oForm.DataSources.UserDataSources.Item("KUKNAM").ValueEx = MDC_SetMod.Get_ReData("ACCTNAME", "FORMATCODE", "OACT", "'" + KUKACC + "'");
//            }
...
//            {
//                //UPGRADE_WARNING: MDC_SetMod.Get_ReData() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                oForm.DataSources.UserDataSources.Item("JUNNAM").ValueEx = MDC_SetMod.Get_ReData("ACCTNAME", "FORMATCODE", "OACT", "'" + JUNACC + "'");
//            }
...
//            {
//                //UPGRADE_WARNING: MDC_SetMod.Get_ReData() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                oForm.DataSources.UserDataSources.Item("BH1NAM").ValueEx = MDC_SetMod.Get_ReData("ACCTNAME", "FORMATCODE", "OACT", "'" + BH1ACC + "'");
//            }
...
//            {
//                //UPGRADE_WARNING: MDC_SetMod.Get_ReData() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                oForm.DataSources.UserDataSources.Item("BH2NAM").ValueEx = MDC_SetMod.Get_ReData("ACCTNAME", "FORMATCODE", "OACT", "'" + BH2ACC + "'");
//            }
...
//            {
//                //UPGRADE_WARNING: MDC_SetMod.Get_ReData() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                oForm.DataSources.UserDataSources.Item("CSUNAM").ValueEx = MDC_SetMod.Get_ReData("ACCTNAME", "FORMATCODE", "OACT", "'" + CSUACC + "'");
//            }
...
//            {
//                //UPGRADE_WARNING: MDC_SetMod.Get_ReData() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                oForm.DataSources.UserDataSources.Item("GONNAM").ValueEx = MDC_SetMod.Get_ReData("ACCTNAME", "FORMATCODE", "OACT", "'" + GONACC + "'");
//            }
...
//            FIXTYP = oForm.Items.Item("FIXTYP").Specific.Selected.Value;
//            /// Question
//            if (MDC_Globals.Sbo_Application.MessageBox("기존 퇴직금 계산식을 초기 셋팅용 계산식으로 변경하시겠습니까?", 2, "&Yes!", "&No") == 2)
//            {
//                return;
//            }
...
//        Error_Message:
//            ///'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
//            MDC_Globals.Sbo_Application.StatusBar.SetText("Display_ZPY403 Error :" + Strings.Space(10) + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//        }



//        private string Exist_YN(ref string STDDAT)
//        {
...
//            sQry = "SELECT Top 1 T1.CODE FROM [@PH_PY114A] T1 where code = '" + Strings.Trim(STDDAT) + "'";
//            oRecordSet.DoQuery(sQry);
