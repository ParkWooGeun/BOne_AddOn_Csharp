    ...
    internal class PH_PY116 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFromDocEntry01)
        {
            ...
            try
            {
                ...
                PH_PY116_SetDocument(oFromDocEntry01);
                oForm.Update();
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <param name="oFromDocEntry01"></param>
        private void PH_PY116_SetDocument(string oFromDocEntry01)
        {
            PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
            try
            {
            ...
            try
            {
                ...
                if (oMat1.VisualRowCount > 0)
                {
                    if (!string.IsNullOrEmpty(oDS_PH_PY116B.GetValue("U_AcctCode", oRow - 1).ToString().Trim()))
                    {
                        ...
                        oDS_PH_PY116B.SetValue("U_Debit", oRow, Convert.ToString(0));
                        oDS_PH_PY116B.SetValue("U_Credit", oRow, Convert.ToString(0));
                    ...
                    else
                    {
                        ...
                        oDS_PH_PY116B.SetValue("U_Debit", oRow - 1, Convert.ToString(0));
                        oDS_PH_PY116B.SetValue("U_Credit", oRow - 1, Convert.ToString(0));
        ...
        private void DI_oJournalEntries()
        {
            ...
            try
            {
                ...
                ///// 분개장문서
                f_oJournalEntries = PSH_Globals.oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.oJournalVouchers);
        ...
        private bool Execution_Process()
        {
            ...
            try
            {
                ...
                while (!(oRecordSet.EoF))
                {
                    ...
                    oDS_PH_PY116B.SetValue("U_Col05", i, Microsoft.VisualBasic.Compatibility.VB6.Support.Format(oRecordSet.Fields.Item("Debit").Value, "#,###,###,##0"));
                    /// 총급여액
                    oDS_PH_PY116B.SetValue("U_Col06", i, Microsoft.VisualBasic.Compatibility.VB6.Support.Format(oRecordSet.Fields.Item("Credit").Value, "#,###,###,##0"));
...
//            oXmlDoc.load(MDC_Globals.SP_Path + "\\" + MDC_Globals.SP_Screen + "\\PH_PY116.srf");
...
//            SubMain.AddForms(this, oFormUniqueID, "PH_PY116");
...
//        private bool PH_PY116_CreateItems()
//        {
//            bool functionReturnValue = false;
...
//            oDS_PH_PY116A = oForm.DataSources.DBDataSources("@PH_PY116A");
//            ////헤더
//            oDS_PH_PY116B = oForm.DataSources.DBDataSources("@PH_PY116B");
//            ////라인
//            //
//            oMat1 = oForm.Items.Item("Mat1").Specific;
//            //
...
//            oEdit = null;
//            //UPGRADE_NOTE: oLink 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//            oLink = null;
...
//            oRecordSet = null;
//            oForm.Freeze(false);
//            PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY116_CreateItems_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//            return functionReturnValue;
//        }
...
//            PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY116_EnableMenus_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//        }
...
//            PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY116_SetDocument_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//        }

//        public void PH_PY116_FormItemEnabled()
//        {
//            SAPbouiCOM.ComboBox oCombo = null;
...
//                //// 지급일자
//                oDS_PH_PY116A.SetValue("U_STRDAT", 0, Microsoft.VisualBasic.Compatibility.VB6.Support.Format(DateAndTime.Today, "YYYYMM01"));
//                oDS_PH_PY116A.SetValue("U_STRDAT", 0, Microsoft.VisualBasic.Compatibility.VB6.Support.Format(DateAndTime.Today, "YYYYMMDD"));

//                //// 전기일자
//                oDS_PH_PY116A.SetValue("U_DOCDATE", 0, Microsoft.VisualBasic.Compatibility.VB6.Support.Format(DateAndTime.Today, "YYYYMMDD"));
...
//            oForm.Freeze(false);
//            PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY116_FormItemEnabled_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//        }
...
//            SAPbobsCOM.Recordset oRecordSet = null;
//            string STRDAT = null;
//            System.DateTime ENDDAT = default(System.DateTime);
...
//                            if (!string.IsNullOrEmpty(oDS_PH_PY116A.GetValue("DocEntry", 0)))
//                            {
//                                if (MDC_SetMod.Value_ChkYn("[@PH_PY116A]", "DocEntry", "'" + Strings.Trim(oDS_PH_PY116A.GetValue("DocEntry", 0)) + "'") == false)
//                                {
//                                    DI_oJournalEntries();
//                                }
//                                else
...
//                    if (pVal.BeforeAction == true & pVal.ColUID == "AcctCode" & pVal.CharPressed == 9)
//                    {
//                        //UPGRADE_WARNING: oMat1.Columns(pVal.ColUID).Cells(pVal.Row).Specific.String 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
...
//                        if (MDC_SetMod.Value_ChkYn(ref "[OACT]", ref "FormatCode", ref "'" + oMat1.Columns.Item(pVal.ColUID).Cells.Item(pVal.Row).Specific.String + "'", ref "") == true | string.IsNullOrEmpty(oMat1.Columns.Item(pVal.ColUID).Cells.Item(pVal.Row).Specific.String))
//                        {
//                            PSH_Globals.SBO_Application.ActivateMenuItem(("7425"));
//                            BubbleEvent = false;
//                        }
...
//                            if (oForm.Items.Item(pVal.ItemUID).Specific.Selected.Value == "R01")
//                            {
//                                oForm.DataSources.UserDataSources.Item("STRDAT").ValueEx = Microsoft.VisualBasic.Compatibility.VB6.Support.Format(DateAndTime.Now, "YYYYMM") + "01";
...
//                            else
//                            {
//                                oForm.DataSources.UserDataSources.Item("STRDAT").ValueEx = Microsoft.VisualBasic.Compatibility.VB6.Support.Format(DateAndTime.Now, "YYYYMMDD");
//                                oForm.DataSources.UserDataSources.Item("ENDDAT").ValueEx = Microsoft.VisualBasic.Compatibility.VB6.Support.Format(DateAndTime.Now, "YYYYMMDD");
//                            }
//                        }
//                    }
...
//                                oForm.Items.Item("MSTNAM").Specific.Value = MDC_SetMod.Get_ReData("U_FullName", "Code", "[@PH_PY001A]", "'" + Strings.Trim(oForm.Items.Item("MSTCOD").Specific.String) + "'");
//                            }
//                            oForm.Items.Item("MSTCOD").Update();
//                            oForm.Items.Item("MSTNAM").Update();
//                        }
...
//                            if (string.IsNullOrEmpty(oForm.Items.Item(pVal.ItemUID).Specific.String))
//                            {
//                                oDS_PH_PY116A.SetValue("U_STRDAT", 0, Microsoft.VisualBasic.Compatibility.VB6.Support.Format(DateAndTime.Now, "YYYYMMDD"));
//                                oDS_PH_PY116A.SetValue("U_ENDDAT", 0, Microsoft.VisualBasic.Compatibility.VB6.Support.Format(DateAndTime.Now, "YYYYMMDD"));
//                            }
//                            else if (pVal.ItemUID == "STRDAT")
//                            {
//                                //UPGRADE_WARNING: oForm.Items().Specific.Value 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
...
//                                        //UPGRADE_WARNING: oMat1.Columns().Cells().Specific.Value 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                                        //UPGRADE_WARNING: MDC_SetMod.Get_ReData() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                                        oDS_PH_PY116B.SetValue("U_AcctNam", pVal.Row - 1, MDC_SetMod.Get_ReData("AcctName", "AcctCode", "OACT", "'" + Strings.Trim(oMat1.Columns.Item("AcctCode").Cells.Item(pVal.Row).Specific.Value) + "'"));
//                                        break;
//                                    case "Debit":
//                                    case "Credit":
//                                        //UPGRADE_WARNING: oMat1.Columns().Cells().Specific.Value 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                                        oDS_PH_PY116B.SetValue("U_Debit", pVal.Row - 1, Microsoft.VisualBasic.Compatibility.VB6.Support.Format(oMat1.Columns.Item("Debit").Cells.Item(pVal.Row).Specific.Value, "#,###,###,##0"));
//                                        //UPGRADE_WARNING: oMat1.Columns().Cells().Specific.Value 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                                        oDS_PH_PY116B.SetValue("U_Credit", pVal.Row - 1, Microsoft.VisualBasic.Compatibility.VB6.Support.Format(oMat1.Columns.Item("Credit").Cells.Item(pVal.Row).Specific.Value, "#,###,###,##0"));
//                                        break;
//                                }
//                                oMat1.SetLineData(pVal.Row);
//                                TOTAL_AMT();
//                                oDS_PH_PY116B.Offset = pVal.Row - 1;
//                                if (pVal.Row == oMat1.RowCount & !string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY116B.GetValue("U_AcctCode", pVal.Row - 1))))
//                                {
//                                    PH_PY116_AddMatrixRow();
//                                    oMat1.Columns.Item("AcctCode").Cells.Item(pVal.Row).Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//                                }
...
//                        //UPGRADE_NOTE: oForm 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//                        oForm = null;
//                        //UPGRADE_NOTE: oDS_PH_PY116A 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//                        oDS_PH_PY116A = null;
//                        //UPGRADE_NOTE: oDS_PH_PY116B 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//                        oDS_PH_PY116B = null;
...
//            if (oMat1.VisualRowCount > 0)
//            {
//                if (!string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY116B.GetValue("U_AcctCode", oRow - 1))))
//                {
//                    if (oDS_PH_PY116B.Size <= oMat1.VisualRowCount)
//                    {
//                        oDS_PH_PY116B.InsertRecord((oRow));
...
//            oForm.Freeze(false);
//            PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY116_AddMatrixRow_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//        }

//        public void PH_PY116_FormClear()
//        {
//            // ERROR: Not supported in C#: OnErrorStatement

//            string DocEntry = null;
//            //UPGRADE_WARNING: MDC_GetData.Get_ReData() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//            DocEntry = MDC_GetData.Get_ReData(ref "AutoKey", ref "ObjectCode", ref "ONNM", ref "'PH_PY116'", ref "");
...
//            PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY116_FormClear_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//        }
...
//            switch (true)
//            {
//                case string.IsNullOrEmpty(Strings.Trim(oDocDate)):
//                    PSH_Globals.SBO_Application.StatusBar.SetText("전기일은 필수입니다. 입력하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//                    return functionReturnValue;
//                case Conversion.Val(oForm.Items.Item("TOTDEB").Specific.Value) == 0 & Conversion.Val(oForm.Items.Item("TOTCRE").Specific.Value) == 0:
//                    PSH_Globals.SBO_Application.StatusBar.SetText("금액이 0 입니다. 확인하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//                    return functionReturnValue;
//                case Conversion.Val(oForm.Items.Item("TOTDEB").Specific.Value) != Conversion.Val(oForm.Items.Item("TOTCRE").Specific.Value):
//                    PSH_Globals.SBO_Application.StatusBar.SetText("차변과 대변금액이 일치하지 않습니다. 확인하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//                    return functionReturnValue;
//                case Conversion.Val(oForm.Items.Item("TOTDEB").Specific.Value) != Conversion.Val(oForm.Items.Item("TOTPAY").Specific.Value):
//                    PSH_Globals.SBO_Application.StatusBar.SetText("차변과 총지급액이 일치하지 않습니다. 확인하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//                    return functionReturnValue;
//            }
...
//                {
//                    oDS_PH_PY116B.Offset = i;
//                    if (string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY116B.GetValue("U_AcctCode", i))) & (Conversion.Val(oDS_PH_PY116B.GetValue("U_Debit", i)) != 0 | Conversion.Val(oDS_PH_PY116B.GetValue("U_Credit", i)) != 0))
//                    {
//                        PSH_Globals.SBO_Application.StatusBar.SetText("계정 코드는 필수입니다. 입력하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//                        oMat1.Columns.Item("AcctCode").Cells.Item(i + 1).Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//                        return functionReturnValue;
//                    }
//                    else if (!string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY116B.GetValue("U_AcctCode", i))) & (Conversion.Val(oDS_PH_PY116B.GetValue("U_Debit", i)) == 0 & Conversion.Val(oDS_PH_PY116B.GetValue("U_Credit", i)) == 0))
//                    {
//                        PSH_Globals.SBO_Application.StatusBar.SetText("차변과 대변금액이 0 입니다. 확인하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//                        oMat1.Columns.Item("AcctCode").Cells.Item(i + 1).Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//                        return functionReturnValue;
...
//            functionReturnValue = false;
//            PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY116_DataValidCheck_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//            return functionReturnValue;
//        }


//        public bool PH_PY116_Validate(string ValidateType)
//        {
//            bool functionReturnValue = false;
//            // ERROR: Not supported in C#: OnErrorStatement
...
//            //UPGRADE_WARNING: oForm.Items().Specific.Value 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//            //UPGRADE_WARNING: MDC_Company_Common.GetValue(SELECT Canceled FROM [PH_PY116A] WHERE DocEntry = ' & oForm.Items(DocEntry).Specific.Value & ', 0, 1) 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//            if (MDC_Company_Common.GetValue("SELECT Canceled FROM [@PH_PY116A] WHERE DocEntry = '" + oForm.Items.Item("DocEntry").Specific.Value + "'", 0, 1) == "Y")
//            {
...
//            functionReturnValue = false;
//            PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY116_Validate_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//            return functionReturnValue;
//        }



//        private void PH_PY116_Print_Report01()
//        {
...
//            //UPGRADE_WARNING: oForm.Items().Specific.Value 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//            sQry = "EXEC PH_PY116_1 '" + oForm.Items.Item("8").Specific.Value + "'";
...
//            PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY116_Print_Report01_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//        }
...
//            SAPbobsCOM.JournalVouchers f_oJournalEntries = null;
//            SAPbobsCOM.Recordset oRecordSet = null;
//            string sQry = null;
//            int RetVal = 0;
//            int nErr = 0;
...
//            }
//            ///// 분개장문서
//            f_oJournalEntries = MDC_Globals.oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.oJournalVouchers);
//            oRecordSet = MDC_Globals.oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset);
...
//            {
//                oDS_PH_PY116B.Offset = k;
//                if (!string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY116B.GetValue("U_Col02", k))))
//                {
//                    if (i != 1)
//                    {
//                        _with1.JournalEntries.Lines.Add();
...
//                    shortCode = Strings.Trim(oDS_PH_PY116B.GetValue("U_Col04", k));
//                    Debit = Conversion.Val(Strings.Replace(oDS_PH_PY116B.GetValue("U_Col05", k), ",", ""));
//                    Credit = Conversion.Val(Strings.Replace(oDS_PH_PY116B.GetValue("U_Col06", k), ",", ""));
//                    LineMemo = Strings.Trim(oDS_PH_PY116B.GetValue("U_Col09", k));
//                    Project = Strings.Trim(oDS_PH_PY116B.GetValue("U_Col11", k));
//                    Dimenz1 = Strings.Trim(oDS_PH_PY116B.GetValue("U_Col07", k));
//                    Dimenz2 = Strings.Trim(oDS_PH_PY116B.GetValue("U_Col08", k));
//                    if (oDIM3 == "Y")
//                        Dimenz3 = Strings.Trim(oDS_PH_PY116B.GetValue("U_Col10", k));

//                    //  .Lines.SetCurrentLine (0)
//                    //UPGRADE_WARNING: MDC_SetMod.Get_ReData() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                    _with1.JournalEntries.Lines.AccountCode = MDC_SetMod.Get_ReData("AcctCode", "FormatCode", "[OACT]", "'" + Strings.Trim(AcctCode) + "'");
//                    if (MDC_SetMod.Value_ChkYn("[OACT]", "FormatCode", "'" + Strings.Trim(shortCode) + "'") == false)
//                    {
//                        //UPGRADE_WARNING: MDC_SetMod.Get_ReData() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                        _with1.JournalEntries.Lines.ShortName = MDC_SetMod.Get_ReData("AcctCode", "FormatCode", "[OACT]", "'" + Strings.Trim(shortCode) + "'");
//                    }
//                    else
//                    {
...
//                    //프로젝트
//                    _with1.JournalEntries.Lines.CostingCode = Strings.Trim(Dimenz1);
//                    //차원1
//                    _with1.JournalEntries.Lines.CostingCode2 = Strings.Trim(Dimenz2);
//                    //차원2
//                    _with1.JournalEntries.Lines.LineMemo = Strings.Trim(LineMemo);
//                    if (oDIM3 == "Y")
//                    {
//                        _with1.JournalEntries.Lines.CostingCode3 = Strings.Trim(Dimenz3);
//                        //차원3
//                    }
//                    i = i + 1;
//                }
...
//            if ((0 != RetVal))
//            {
//                MDC_Globals.oCompany.GetLastError(out nErr, out ErrMsg);
//                goto Error_Message;
//                ////저장시 에러 발생
//            }
//            MDC_Globals.oCompany.GetNewObjectCode(out oDocNum);

//            sQry = "EXEC ZPY309_INSERT '" + oDocNum + "', 'ZPY405', '" + Strings.Trim(oDocDate) + "', " + oTOTDEB + ", " + oTOTCRE + ", '" + Strings.Trim(oSTRDAT) + "', '" + Strings.Trim(oENDDAT) + "', '" + Strings.Trim(oJOBTYP) + "', '', '" + Strings.Trim(oCLTCOD) + "', '" + Strings.Trim(oMSTCOD) + "', '', ''";
//            oRecordSet.DoQuery(sQry);
...
//            //UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//            oRecordSet = null;
//            PSH_Globals.SBO_Application.StatusBar.SetText("oJournalEntries Error : " + Strings.Space(10) + nErr + "," + ErrMsg, SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//        }
//        private bool Execution_Process()
//        {
//            bool functionReturnValue = false;
...
//            if (string.IsNullOrEmpty(Strings.Trim(oMSTCOD)))
//                oMSTCOD = "%";

//            switch (true)
//            {
//                case string.IsNullOrEmpty(Strings.Trim(oSTRDAT)) | string.IsNullOrEmpty(Strings.Trim(oENDDAT)):
//                    ErrNum = 1;
//                    goto Error_Message;
//                    break;
//            }
...
//            sQry = "EXEC ZPY309_QUERY 'ZPY405', '" + Strings.Trim(oSTRDAT) + "', '" + Strings.Trim(oENDDAT) + "', '" + Strings.Trim(oJOBTYP) + "', '', '" + Strings.Trim(oCLTCOD) + "', '" + Strings.Trim(oMSTCOD) + "', '', '%'";
...
//            if (oJOBTYP == "R01")
//            {
//                sQry = " EXEC ZPY405_1 '" + Strings.Trim(oSTRDAT) + "', '" + Strings.Trim(oENDDAT) + "'," + "'" + Strings.Trim(oCLTCOD) + "', '" + Strings.Trim(oMSTCOD) + "'";
//            }
//            else
//            {
//                sQry = " EXEC ZPY405_2 '" + Strings.Trim(oSTRDAT) + "', '" + Strings.Trim(oENDDAT) + "'," + "'" + Strings.Trim(oCLTCOD) + "', '" + Strings.Trim(oMSTCOD) + "'";
//            }
//            oRecordSet.DoQuery(sQry);
//            if (oRecordSet.RecordCount == 0)
//            {
...
//            {
//                oDS_PH_PY116B.Offset = oRow - 1;
//                oTOTDEB = oTOTDEB + Conversion.Val(Strings.Replace(oDS_PH_PY116B.GetValue("U_Debit", oRow - 1), ",", ""));
//                oTOTCRE = oTOTCRE + Conversion.Val(Strings.Replace(oDS_PH_PY116B.GetValue("U_Credit", oRow - 1), ",", ""));
//            }
//            ///
//            //UPGRADE_WARNING: oForm.Items().Specific.Value 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//            oForm.Items.Item("TOTDEB").Specific.Value = oTOTDEB;
