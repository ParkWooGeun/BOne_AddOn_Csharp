    ...
    internal class PH_PY121 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFromDocEntry01)
        {
            ...
            try
            {
                ...
                PH_PY121_SetDocument(oFromDocEntry01);
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <param name="oFromDocEntry01"></param>
        private void PH_PY121_SetDocument(string oFromDocEntry01)
        {
            try
            {
            ...
            try
            {
                ...
                if (oMat1.VisualRowCount > 0)
                {
                    if (!string.IsNullOrEmpty(oDS_PH_PY121B.GetValue("U_MSTCOD", oRow - 1).Trim()))
                    {
                        ...
                        oDS_PH_PY121B.SetValue("U_Amt", oRow, Convert.ToString(0));
                        oMat1.LoadFromDataSource();
                    }
                    else
                    {
                        ...
                        oDS_PH_PY121B.SetValue("U_Amt", oRow - 1, Convert.ToString(0));
                        oMat1.LoadFromDataSource();
                    }
                }
        ...
        private void MSTCOD_Setting()
        {
            ...
            string YEAR_Renamed = string.Empty; // 년도
            string JIGTYP = string.Empty;       // 직원구분
            string CheckValue = string.Empty;

            SAPbobsCOM.Recordset oRecordSet = null;
            oRecordSet = PSH_Globals.oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset);
            SAPbouiCOM.ProgressBar ProgBar01 = PSH_Globals.SBO_Application.StatusBar.CreateProgressBar("데이터 읽는중...!", oRecordSet.RecordCount, false);
            ...
            try
            {
                ...
                YEAR_Renamed = oDS_PH_PY121A.GetValue("U_YEAR", 0).Trim();
                ...
                sQry = "EXEC PH_PY121_01 '" + CLTCOD + "','" + YEAR_Renamed + "','" + JIGTYP + "'";
...
//			oXmlDoc.load(MDC_Globals.SP_Path + "\\" + MDC_Globals.SP_Screen + "\\PH_PY121.srf");
...
//			SubMain.AddForms(this, oFormUniqueID, "PH_PY121");
...
//		private bool PH_PY121_CreateItems()
//		{
//			bool functionReturnValue = false;
...
//			oDS_PH_PY121A = oForm.DataSources.DBDataSources("@PH_PY121A");
//			////헤더
//			oDS_PH_PY121B = oForm.DataSources.DBDataSources("@PH_PY121B");
//			////라인
...
//			oColumn = oMat1.Columns.Item("UseYN");
...
//			oRecordSet = null;
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY121_CreateItems_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}
...
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY121_EnableMenus_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY121_SetDocument_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		public void PH_PY121_FormItemEnabled()
//		{
//			SAPbouiCOM.ComboBox oCombo = null;
...
//				oForm.Items.Item("YEAR").Specific.VALUE = Microsoft.VisualBasic.Compatibility.VB6.Support.Format(DateAndTime.Now, "YYYY");
...
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY121_FormItemEnabled_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//						//UPGRADE_NOTE: oForm 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//						oForm = null;
//						//UPGRADE_NOTE: oDS_PH_PY121A 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//						oDS_PH_PY121A = null;
//						//UPGRADE_NOTE: oDS_PH_PY121B 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//						oDS_PH_PY121B = null;
...
//					case "1290":
//					case "1291":
//						MDC_SetMod.AuthorityCheck(ref oForm, ref "CLTCOD", ref "@PH_PY121A", ref "Code");
//						////접속자 권한에 따른 사업장 보기
//						break;
//				}
//			} else if ((pval.BeforeAction == false)) {
...
//		public void PH_PY121_AddMatrixRow()
//		{
//			int oRow = 0;
...
//			if (oMat1.VisualRowCount > 0) {
//				if (!string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY121B.GetValue("U_MSTCOD", oRow - 1)))) {
//					if (oDS_PH_PY121B.Size <= oMat1.VisualRowCount) {
//						oDS_PH_PY121B.InsertRecord((oRow));
//					}
//					oDS_PH_PY121B.Offset = oRow;
...
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY121_AddMatrixRow_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		public void PH_PY121_FormClear()
//		{
//			 // ERROR: Not supported in C#: OnErrorStatement

//			string DocEntry = null;
//			//UPGRADE_WARNING: MDC_GetData.Get_ReData() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			DocEntry = MDC_GetData.Get_ReData(ref "AutoKey", ref "ObjectCode", ref "ONNM", ref "'PH_PY121'", ref "");
...
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY121_FormClear_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		public bool PH_PY121_DataValidCheck()
//		{
//			bool functionReturnValue = false;
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			////----------------------------------------------------------------------------------
//			//// 헤더
//			if (string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY121A.GetValue("U_CLTCOD", 0)))) {
//				MDC_Globals.Sbo_Application.SetStatusBarMessage("사업장은 필수입니다.", SAPbouiCOM.BoMessageTime.bmt_Short, true);
//				oForm.Items.Item("CLTCOD").Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//				return functionReturnValue;
//			}

//			if (string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY121A.GetValue("U_YEAR", 0)))) {
//				MDC_Globals.Sbo_Application.SetStatusBarMessage("전문직평가 년도는 필수입니다.", SAPbouiCOM.BoMessageTime.bmt_Short, true);
//				oForm.Items.Item("YEAR").Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//				return functionReturnValue;
//			}

//			if (string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY121A.GetValue("U_YMFROM", 0)))) {
//				MDC_Globals.Sbo_Application.SetStatusBarMessage("평가가급액 지급 시작월 필수입니다.", SAPbouiCOM.BoMessageTime.bmt_Short, true);
//				oForm.Items.Item("YMFROM").Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//				return functionReturnValue;
//			}

//			if (string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY121A.GetValue("U_YMTO", 0)))) {
//				MDC_Globals.Sbo_Application.SetStatusBarMessage("평가가급액 지급종료월은 필수입니다.", SAPbouiCOM.BoMessageTime.bmt_Short, true);
//				oForm.Items.Item("YMTO").Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//				return functionReturnValue;
//			}
...
//					////중복체크
//					for (k = i + 1; k <= oMat1.VisualRowCount - 2; k++) {
//						if (Strings.Trim(oDS_PH_PY121B.GetValue("U_MSTCOD", i)) == Strings.Trim(oDS_PH_PY121B.GetValue("U_MSTCOD", k))) {
...
//			SCode = Strings.Trim(oDS_PH_PY121A.GetValue("U_YEAR", 0)) + Strings.Trim(oDS_PH_PY121A.GetValue("U_CLTCOD", 0)) + Strings.Trim(oDS_PH_PY121A.GetValue("U_JIGTYP", 0));
...
//			////데이터 중복 체크
//			//UPGRADE_WARNING: MDC_SetMod.Get_ReData(Code, Code, [PH_PY121A], ' & sCode & ') 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			if (!string.IsNullOrEmpty(MDC_SetMod.Get_ReData("Code", "Code", "[@PH_PY121A]", "'" + "sCode" + "'"))) {
...
//			oRecordSet = null;
//			functionReturnValue = false;
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY121_DataValidCheck_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}


//		public bool PH_PY121_Validate(string ValidateType)
//		{
//			bool functionReturnValue = false;
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			//UPGRADE_WARNING: MDC_Company_Common.GetValue(SELECT Canceled FROM [PH_PY121A] WHERE DocEntry = ' & oForm.Items(DocEntry).Specific.VALUE & ', 0, 1) 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			if (MDC_Company_Common.GetValue("SELECT Canceled FROM [@PH_PY121A] WHERE DocEntry = '" + oForm.Items.Item("DocEntry").Specific.VALUE + "'", 0, 1) == "Y") {
...
//			functionReturnValue = false;
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY121_Validate_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}
...
//			CLTCOD = Strings.Trim(oDS_PH_PY121A.GetValue("U_CLTCOD", 0));
//			YEAR_Renamed = Strings.Trim(oDS_PH_PY121A.GetValue("U_YEAR", 0));
//			JIGTYP = Strings.Trim(oDS_PH_PY121A.GetValue("U_JIGTYP", 0));
//			if (string.IsNullOrEmpty(YEAR_Renamed)) {
//				ErrNum = 1;
//				goto Error_Message;
//			}
...
//				oDS_PH_PY121B.Offset = oRow;
//				oDS_PH_PY121B.SetValue("U_LineNum", oRow, Convert.ToString(oRow + 1));
//				oDS_PH_PY121B.SetValue("U_MSTCOD", oRow, Strings.Trim(oRecordSet.Fields.Item("MSTCOD").Value));
//				//사원번호
//				oDS_PH_PY121B.SetValue("U_MSTNAM", oRow, Strings.Trim(oRecordSet.Fields.Item("MSTNAM").Value));
//				//성명
//				oDS_PH_PY121B.SetValue("U_TeamCode", oRow, Strings.Trim(oRecordSet.Fields.Item("TeamCode").Value));
//				//부서
//				oDS_PH_PY121B.SetValue("U_TeamName", oRow, Strings.Trim(oRecordSet.Fields.Item("TeamName").Value));
//				//부서명
//				oDS_PH_PY121B.SetValue("U_RspCode", oRow, Strings.Trim(oRecordSet.Fields.Item("RspCode").Value));
//				//담당
//				oDS_PH_PY121B.SetValue("U_RspName", oRow, Strings.Trim(oRecordSet.Fields.Item("RspName").Value));
//				//담당명
//				oDS_PH_PY121B.SetValue("U_Grade", oRow, Strings.Trim(oRecordSet.Fields.Item("Grade").Value));
//				oDS_PH_PY121B.SetValue("U_Amt", oRow, Strings.Trim(oRecordSet.Fields.Item("Amt").Value));
//				oDS_PH_PY121B.SetValue("U_UseYN", oRow, Strings.Trim(oRecordSet.Fields.Item("UseYN").Value));
//				oRow = oRow + 1;
...
//			Error_Message:
//			if (ErrNum == 1) {
//				MDC_Globals.Sbo_Application.StatusBar.SetText("평가년도은 필수입니다. 입력하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//			} else if (ErrNum == 2) {
...
//			} else if (ErrNum == 4) {
//				MDC_Globals.Sbo_Application.StatusBar.SetText("직원구분은 필수입니다. 확인하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//			} else {
