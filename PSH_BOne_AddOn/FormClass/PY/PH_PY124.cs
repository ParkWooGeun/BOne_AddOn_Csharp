...
//{
//    internal class PH_PY124
//    {
//        ////********************************************************************************
//        ////  File           : PH_PY124.cls
//        ////  Module         : 급여관리 > 급여관리 > 급여계산
//        ////  Desc           : 베네피아 금액등록
//        ////********************************************************************************
...
//            oXmlDoc.load(MDC_Globals.SP_Path + "\\" + MDC_Globals.SP_Screen + "\\PH_PY124.srf");
...
//                oXmlDoc.selectNodes("Application/forms/action/form/items/action/item/specific/@cellHeight")[i - 1].nodeValue = 16;
//            }
//            oFormUniqueID = "PH_PY124_" + GetTotalFormsCount();
//            SubMain.AddForms(this, oFormUniqueID, "PH_PY124");
...
//        private bool PH_PY124_CreateItems()
//        {
//            bool functionReturnValue = false;
...
//            oDS_PH_PY124A = oForm.DataSources.DBDataSources("@PH_PY124A");
//            oDS_PH_PY124B = oForm.DataSources.DBDataSources("@PH_PY124B");
...
//            //Set oCombo = oForm.Items("FieldCo").Specific
//            //oForm.Items("FieldCo").DisplayDesc = True

//            oForm.DataSources.UserDataSources.Add("Test", SAPbouiCOM.BoDataType.dt_SHORT_TEXT, 10);
...
//            oForm.Items.Item("Test").Specific.DataBind.SetBound(true, "", "Test");
...
//            oRecordSet = null;
//            oForm.Freeze(false);
//            MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY124_CreateItems_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//            return functionReturnValue;
//        }
...
//            return;
//        PH_PY124_EnableMenus_Error:

//            MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY124_EnableMenus_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//        }
...
//            }
//            return;
//        PH_PY124_SetDocument_Error:

//            MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY124_SetDocument_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//        }

//        public void PH_PY124_FormItemEnabled()
//        {
//            SAPbouiCOM.ComboBox oCombo = null;
...
//                //UPGRADE_WARNING: oForm.Items(StatYN).Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                if (oForm.Items.Item("StatYN").Specific.VALUE == "Y")
//                {
//                    oForm.Items.Item("FieldCo").Enabled = false;
//                    oForm.Items.Item("Mat1").Enabled = false;
...
//            oForm.Freeze(false);
//            return;
//        PH_PY124_FormItemEnabled_Error:

//            oForm.Freeze(false);
//            MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY124_FormItemEnabled_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//        }
...
//                                if (CheckDataApply == true)
//                                {
//                                    PH_PY124_DataApply(ref CLTCOD, ref YM);
//                                    CheckDataApply = false;
//                                }
//                                PH_PY124_FormItemEnabled();
//                                PH_PY124_AddMatrixRow();
...
//                        if (pVal.ItemUID == "Btn_Cancel")
//                        {
//                            PH_PY124_DataCancel(ref CLTCOD, ref YM);
//                        }
//                        if (pVal.ItemUID == "Btn_Apply")
//                        {
//                            CLTCOD = Strings.Trim(oDS_PH_PY124A.GetValue("U_CLTCOD", 0));
//                            YM = Strings.Trim(oDS_PH_PY124A.GetValue("U_YM", 0));
//                            if (oMat1.RowCount > 1)
//                            {
//                                if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE | oForm.Mode == SAPbouiCOM.BoFormMode.fm_UPDATE_MODE)
//                                {
...
//                            else
//                            {
//                                MDC_Globals.Sbo_Application.SetStatusBarMessage("베네피아 자료가 없습니다.", SAPbouiCOM.BoMessageTime.bmt_Short, true);
//                            }
//                        }
//                    }
//                    break;
...
//                                CLTCOD = Strings.Trim(oDS_PH_PY124A.GetValue("U_CLTCOD", 0));
//                                YM = Strings.Trim(Strings.Right(oDS_PH_PY124A.GetValue("U_YM", 0), 4));

//                                if (object.ReferenceEquals(Strings.Trim(oDS_PH_PY124A.GetValue("U_FieldCo", 0)), System.DBNull.Value.ToString()))
//                                {
//                                    FieldCo = " = '" + Strings.Trim(oDS_PH_PY124A.GetValue("U_FieldCo", 0));
//                                }
//                                else
//                                {
//                                    FieldCo = " like '%";
...
//                                if ((oRecordSet.RecordCount == 0))
//                                {
//                                    MDC_Globals.Sbo_Application.SetStatusBarMessage("급상여변동자료 입력은 필수입니다.", SAPbouiCOM.BoMessageTime.bmt_Short, true);
//                                    //UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                                    oForm.Items.Item("YM").Specific.VALUE = "";
//                                    //급상여변동자료가 없을경우 YM 초기화
//                                }
//                                else
//                                {
//                                    oCombo = oForm.Items.Item("FieldCo").Specific;
//                                    sQry = "select distinct U_Sequence,U_PDName from [@PH_PY109Z] where code ='" + CLTCOD + YM + "111' and u_sequence" + FieldCo + "' order by 1";
//                                    MDC_SetMod.SetReDataCombo(oForm, sQry, oCombo);
//                                    oCombo.Select(0, SAPbouiCOM.BoSearchKey.psk_Index);
//                                }
...
//                        //UPGRADE_NOTE: oForm 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//                        oForm = null;
//                        //UPGRADE_NOTE: oDS_PH_PY124A 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//                        oDS_PH_PY124A = null;
//                        //UPGRADE_NOTE: oDS_PH_PY124B 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//                        oDS_PH_PY124B = null;
...
//                    case "1290":
//                    case "1291":
//                        MDC_SetMod.AuthorityCheck(ref oForm, ref "CLTCOD", ref "@PH_PY124A", ref "Code");
//                        ////접속자 권한에 따른 사업장 보기
//                        PH_PY124_FormItemEnabled();
//                        break;
//                }
...
//                        MDC_SetMod.SetReDataCombo(oForm, sQry, oCombo);
//                        //UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                        oCombo.Select(Strings.Trim(Convert.ToString(oForm.Items.Item("FieldCo").Specific.VALUE - 1)), SAPbouiCOM.BoSearchKey.psk_Index);
//                        break;

//                    case "1293":
//                        //// 행삭제
//                        Raise_EVENT_ROW_DELETE(ref FormUID, ref pVal, ref BubbleEvent, ref oMat1, ref oDS_PH_PY124B, ref "U_JIGCOD");
//                        PH_PY124_AddMatrixRow();
//                        break;
//                }
//            }
...
//            if (oMat1.VisualRowCount > 0)
//            {
//                if (!string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY124B.GetValue("U_Seq", oRow - 1))))
//                {
//                    if (oDS_PH_PY124B.Size <= oMat1.VisualRowCount)
//                    {
//                        oDS_PH_PY124B.InsertRecord((oRow));
...
//            oForm.Freeze(false);
//            return;
//        PH_PY124_AddMatrixRow_Error:
//            oForm.Freeze(false);
//            MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY124_AddMatrixRow_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//        }
...
//            DocEntry = MDC_GetData.Get_ReData(ref "AutoKey", ref "ObjectCode", ref "ONNM", ref "'PH_PY124'", ref "");
//            if (Convert.ToDouble(DocEntry) == 0)
//            {
//                //UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                oForm.Items.Item("DocEntry").Specific.VALUE = 1;
...
//            }
//            return;
//        PH_PY124_FormClear_Error:
//            MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY124_FormClear_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//        }
...
//            //// 헤더 ---------------------------
//            ////사업장
//            if (string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY124A.GetValue("U_CLTCOD", 0))))
//            {
...
//            ////적용시작월
//            if (string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY124A.GetValue("U_YM", 0))))
//            {
...
//            //// Code & Name 생성
//            oDS_PH_PY124A.SetValue("Code", 0, Strings.Trim(oDS_PH_PY124A.GetValue("U_CLTCOD", 0)) + Strings.Trim(oDS_PH_PY124A.GetValue("U_YM", 0)));
//            oDS_PH_PY124A.SetValue("NAME", 0, Strings.Trim(oDS_PH_PY124A.GetValue("U_CLTCOD", 0)) + Strings.Trim(oDS_PH_PY124A.GetValue("U_YM", 0)));

//            if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
//            {
//                //UPGRADE_WARNING: MDC_SetMod.Get_ReData(Code, Code, [PH_PY124A], ' & oDS_PH_PY124A.GetValue(Code, 0) & ') 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                if (!string.IsNullOrEmpty(MDC_SetMod.Get_ReData("Code", "Code", "[@PH_PY124A]", "'" + oDS_PH_PY124A.GetValue("Code", 0) + "'")))
//                {
...
//            oRecordSet = null;
//            functionReturnValue = false;
//            MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY124_DataValidCheck_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//            return functionReturnValue;
//        }
...
//            oRecordSet = null;
//            oForm.Freeze(false);
//            MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY124_MTX01_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//        }

//        public bool PH_PY124_Validate(string ValidateType)
//        {
//            bool functionReturnValue = false;
//            // ERROR: Not supported in C#: OnErrorStatement
...
//            //UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//            //UPGRADE_WARNING: MDC_Company_Common.GetValue(SELECT Canceled FROM [PH_PY124A] WHERE DocEntry = ' & oForm.Items(DocEntry).Specific.VALUE & ', 0, 1) 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//            if (MDC_Company_Common.GetValue("SELECT Canceled FROM [@PH_PY124A] WHERE DocEntry = '" + oForm.Items.Item("DocEntry").Specific.VALUE + "'", 0, 1) == "Y")
//            {
...
//            oRecordSet = null;
//            return functionReturnValue;
//        PH_PY124_Validate_Exit:
//            //UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//            oRecordSet = null;
//            return functionReturnValue;
//        PH_PY124_Validate_Error:
//            functionReturnValue = false;
//            MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY124_Validate_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//            return functionReturnValue;
//        }
...
//                {
//                    oDS_PH_PY124A.SetValue("U_Comments", 0, sFile);
//                }
//                else
//                {
...
//            if (xlsh.Cells._Default(1, 1).VALUE != "일련번호")
//            {
//                MDC_Globals.Sbo_Application.StatusBar.SetText("A열 첫번째 행 타이틀은 일련번호", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//                xlwb.Close();
...
//            if (xlsh.Cells._Default(1, 2).VALUE != "사번")
//            {
//                MDC_Globals.Sbo_Application.StatusBar.SetText("B열 두번째 행 타이틀은 사번", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//                xlwb.Close();
//                //UPGRADE_NOTE: xlwb 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//                xlwb = null;
//                //UPGRADE_NOTE: xl 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
...
//            if (xlsh.Cells._Default(1, 3).VALUE != "이름")
//            {
//                MDC_Globals.Sbo_Application.StatusBar.SetText("C열 세번째 행 타이틀은 이름", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//                xlwb.Close();
//                //UPGRADE_NOTE: xlwb 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//                xlwb = null;
//                //UPGRADE_NOTE: xl 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
...
//            if (xlsh.Cells._Default(1, 4).VALUE != "베네피아")
//            {
//                MDC_Globals.Sbo_Application.StatusBar.SetText("D열 세번째 행 타이틀은 베네피아", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//                xlwb.Close();
//                //UPGRADE_NOTE: xlwb 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//                xlwb = null;
//                //UPGRADE_NOTE: xl 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
...
//            if (xlsh.Cells._Default(1, 5).VALUE != "영수증")
//            {
//                MDC_Globals.Sbo_Application.StatusBar.SetText("E열 세번째 행 타이틀은 영수증", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//                xlwb.Close();
//                //UPGRADE_NOTE: xlwb 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//                xlwb = null;
//                //UPGRADE_NOTE: xl 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
...
//            if (xlsh.Cells._Default(1, 6).VALUE != "복지카드(국내)")
//            {
//                MDC_Globals.Sbo_Application.StatusBar.SetText("F열 세번째 행 타이틀은 복지카드(국내)", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//                xlwb.Close();
//                //UPGRADE_NOTE: xlwb 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//                xlwb = null;
//                //UPGRADE_NOTE: xl 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
...
//            if (xlsh.Cells._Default(1, 7).VALUE != "총합계(원)")
//            {
//                MDC_Globals.Sbo_Application.StatusBar.SetText("G열 세번째 행 타이틀은 총합계(원)", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//                xlwb.Close();
//                //UPGRADE_NOTE: xlwb 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//                xlwb = null;
//                //UPGRADE_NOTE: xl 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
...
//                sQry = "EXEC PH_PY124 '" + xlsh.Cells._Default(i, 1) + "','" + xlsh.Cells._Default(i, 2) + "','" + xlsh.Cells._Default(i, 3) + "','" + xlsh.Cells._Default(i, 4) + "','" + xlsh.Cells._Default(i, 5) + "','";
...
//                //UPGRADE_WARNING: xlsh.Cells() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//                sQry = sQry + xlsh.Cells._Default(i, 6) + "','" + xlsh.Cells._Default(i, 7) + "'";
...
//            //// 임시데이터 데이타 검색
//            sQry = "SELECT * FROM PH_PY124_TEMP ";
//            oRecordSet.DoQuery(sQry);
...
//                    oDS_PH_PY124B.Offset = i;
//                    oDS_PH_PY124B.SetValue("U_LineNum", i, Convert.ToString(i + 1));
//                    oDS_PH_PY124B.SetValue("U_Seq", i, oRecordSet.Fields.Item(0).Value);
//                    oDS_PH_PY124B.SetValue("U_MSTCOD", i, oRecordSet.Fields.Item(1).Value);
//                    oDS_PH_PY124B.SetValue("U_MSTNAM", i, oRecordSet.Fields.Item(2).Value);
//                    oDS_PH_PY124B.SetValue("U_BeneAmt", i, oRecordSet.Fields.Item(3).Value);
//                    oDS_PH_PY124B.SetValue("U_BillAmt", i, oRecordSet.Fields.Item(4).Value);
//                    oDS_PH_PY124B.SetValue("U_CardAmt", i, oRecordSet.Fields.Item(5).Value);
//                    oDS_PH_PY124B.SetValue("U_TotAmt", i, oRecordSet.Fields.Item(6).Value);
//                    oRecordSet.MoveNext();
//                }
...
//        private bool PH_PY124_DataApply(ref string CLTCOD, ref string YM)
//        {
//            bool functionReturnValue = false;
//            string sQry = null;
//            SAPbobsCOM.Recordset oRecordSet = null;
...
//            sQry = sQry + " set U_AMT" + AMTLen + "=isnull(U_AMT" + AMTLen + ",0)  + isnull(b.U_TotAmt,0)";
//            sQry = sQry + " from [@PH_PY109B] a left join [@PH_PY124B] b on left(a.code,1) = left(b.code,1) and SUBSTRING(a.code,2,4) = right(b.code,4) and a.U_MSTCOD  = b.U_MSTCOD";
//            sQry = sQry + " where a.code ='" + CLTCOD + Strings.Right(YM, 4) + "111'";

//            oRecordSet.DoQuery(sQry);

//            sQry = "";
//            //UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//            sQry = sQry + " update [@PH_PY124A] set U_statYN = 'Y' where U_NaviDoc ='" + Strings.Trim(oForm.Items.Item("CLTCOD").Specific.VALUE) + Strings.Trim(oForm.Items.Item("YM").Specific.VALUE) + "'";
...
//            MDC_Globals.Sbo_Application.StatusBar.SetText("급상여변동 자료에 금액이 적용 되었습니다.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Success);
//            //UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//            oRecordSet = null;
//            return functionReturnValue;
