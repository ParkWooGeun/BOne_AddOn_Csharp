    ...
    internal class PH_PY125 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFormDocEntry)
        {
            ...
            try
            {
                ...
                PH_PY125_SetDocument(oFormDocEntry);
            }
            catch (Exception ex)
            {
                oForm.Freeze(false);
        ...
        /// </summary>
        /// <param name="oFormDocEntry"></param>
        private void PH_PY125_SetDocument(string oFormDocEntry)
        {
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        private bool PH_PY125_DataValidCheck(string ChkYN)
        {
        ...
        /// 매트릭스 행 추가
        /// </summary>
        private void PH_PY125_AddMatrixRow()
        {
            int oRow;
