    ...
    internal class PH_PY134 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFormDocEntry01)
        {
            ...
            try
            {
                ...
                PH_PY134_SetDocument(oFormDocEntry01);
                PSH_Globals.ExecuteEventFilter(typeof(PH_PY134));
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <param name="oFormDocEntry01"></param>
        private void PH_PY134_SetDocument(string oFormDocEntry01)
        {
            try
            {
        ...
        /// 매트릭스 행 추가
        /// </summary>
        private void PH_PY134_AddMatrixRow()
        {
            int oRow;
            try
            {
                ...
                else if (pVal.BeforeAction == false)
                {
                    if (pVal.ItemChanged == true)
                    {
                        if (pVal.ColUID == "MSTCOD")
                        {
                            ...
                            sQry += " and a.Code = '" + oDS_PH_PY134B.GetValue("U_MSTCOD", pVal.Row - 1).ToString().Trim() + "'";
