    ...
    internal class PH_PY303 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFromDocEntry01)
        {
            ...
            try
            {
                ...
                PH_PY303_SetDocument(oFromDocEntry01);
        ...
        /// </summary>
        /// <param name="oFromDocEntry01"></param>
        private void PH_PY303_SetDocument(string oFromDocEntry01)
        {
            try
            {
                if (string.IsNullOrEmpty(oFromDocEntry01))
                {
                    ...
                    //Call PH_PY303_AddMatrixRow(0, True) '//UDO방식일때
                }
                else
                {
        ...
        private void Raise_EVENT_CHOOSE_FROM_LIST(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
        {
            ...
            try
            {
                ...
                else if (pVal.Before_Action == false)
                {
                    ...
                    //  Call MDC_GP_CF_DBDatasourceReturn(pval, pval.FormUID, "@PH_PY303A", "U_CardCode,U_CardName")
                    //End If
                }
            }
            catch (Exception ex)
...
//		private SAPbouiCOM.DBDataSource oDS_PH_PY303A;
//		private SAPbouiCOM.DBDataSource oDS_PH_PY303B;
...
//			oXmlDoc.load(MDC_Globals.SP_Path + "\\" + MDC_Globals.SP_Screen + "\\PH_PY303.srf");
...
//			SubMain.AddForms(this, oFormUniqueID, "PH_PY303");
...
//		private bool PH_PY303_CreateItems()
//		{
//			bool functionReturnValue = false;
...
//			oDS_PH_PY303B = oForm.DataSources.DBDataSources("@PS_USERDS01");
...
//			oRecordSet = null;
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY303_CreateItems_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}
...
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY303_EnableMenus_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY303_SetDocument_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		public void PH_PY303_FormItemEnabled()
//		{
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY303_FormItemEnabled_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//									PH_PY303_PY109_Update();
//								} else {
//									MDC_Globals.Sbo_Application.SetStatusBarMessage("급여변동자료에 적용할 학자금자료가 없습니다.", SAPbouiCOM.BoMessageTime.bmt_Short, true);
//								}
...
//						//UPGRADE_NOTE: oForm 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//						oForm = null;
//						//UPGRADE_NOTE: oDS_PH_PY303A 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//						oDS_PH_PY303A = null;
//						//UPGRADE_NOTE: oDS_PH_PY303B 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//						oDS_PH_PY303B = null;
...
//		public void PH_PY303_AddMatrixRow()
//		{
//			int oRow = 0;
...
//				if (!string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY303B.GetValue("U_LineNum", oRow - 1)))) {
//					if (oDS_PH_PY303B.Size <= oMat1.VisualRowCount) {
//						oDS_PH_PY303B.InsertRecord((oRow));
//					}
//					oDS_PH_PY303B.Offset = oRow;
//					oDS_PH_PY303B.SetValue("U_LineNum", oRow, Convert.ToString(oRow + 1));
...
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY303_AddMatrixRow_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		public void PH_PY303_FormClear()
//		{
//			 // ERROR: Not supported in C#: OnErrorStatement

//			string DocEntry = null;
//			//UPGRADE_WARNING: MDC_GetData.Get_ReData() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			DocEntry = MDC_GetData.Get_ReData(ref "AutoKey", ref "ObjectCode", ref "ONNM", ref "'PH_PY303'", ref "");
...
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY303_FormClear_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//			oRecordSet = null;
//			functionReturnValue = false;
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY303_DataValidCheck_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}
...
//			oRecordSet = null;
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY303_MTX01_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
//		private void PH_PY303_PY109_Update()
//		{
...
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			Param05 = oForm.Items.Item("YM").Specific.VALUE;
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			Param06 = Strings.Trim(oForm.Items.Item("JOBTYP").Specific.VALUE);
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			Param07 = Strings.Trim(oForm.Items.Item("JOBGBN").Specific.VALUE);
...
//				MDC_Globals.Sbo_Application.SetStatusBarMessage("급여변동자료에 학자금자료를 업로드 실패했습니다.", SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			} else {
//				if (Conversion.Val(oRecordSet.Fields.Item(0).Value) == -1) {
//					MDC_Globals.Sbo_Application.MessageBox("급여변동자료가 없습니다. 확인바랍니다");
//				} else if (Conversion.Val(oRecordSet.Fields.Item(0).Value) == 0) {
//					MDC_Globals.Sbo_Application.MessageBox("급여변동자료에 학자금자료를 업로드 하지 못했습니다.확인바랍니다");
//				} else if (Conversion.Val(oRecordSet.Fields.Item(0).Value) > 0) {
//					MDC_Globals.Sbo_Application.MessageBox("학자금자료를 업로드 했습니다. 급여변동자료를 확인하세요");
//				}
//			}
...
//			oRecordSet = null;
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY303_PY109_Update_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		public bool PH_PY303_Validate(string ValidateType)
//		{
//			bool functionReturnValue = false;
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			//UPGRADE_WARNING: MDC_Company_Common.GetValue(SELECT Canceled FROM [PH_PY303A] WHERE DocEntry = ' & oForm.Items(DocEntry).Specific.VALUE & ', 0, 1) 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			if (MDC_Company_Common.GetValue("SELECT Canceled FROM [@PH_PY303A] WHERE DocEntry = '" + oForm.Items.Item("DocEntry").Specific.VALUE + "'", 0, 1) == "Y") {
...
//			functionReturnValue = false;
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY303_Validate_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}
//	}
//}
