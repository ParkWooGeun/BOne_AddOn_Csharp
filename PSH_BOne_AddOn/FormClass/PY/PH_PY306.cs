...
namespace PSH_BOne_AddOn
{
    ...
    internal class PH_PY306 : PSH_BaseClass
    {
        ...
        //private SAPbouiCOM.DBDataSource oDS_PH_PY306A; //등록헤더
        ...
        public override void LoadForm(string oFromDocEntry01)
        {
            ...
            try
            {
                ...
                PH_PY306_SetDocument(oFromDocEntry01);
        ...
        /// </summary>
        /// <param name="oFromDocEntry01"></param>
        private void PH_PY306_SetDocument(string oFromDocEntry01)
        {
            try
            {
                if (string.IsNullOrEmpty(oFromDocEntry01))
                {
                    ...
                    //Call PH_PY306_AddMatrixRow(0, True) '//UDO방식일때
                }
                else
                {
        ...
        /// </summary>
        /// <returns></returns>
        public bool PH_PY306_DataValidCheck()
        {
        ...
        private void Raise_EVENT_CHOOSE_FROM_LIST(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
        {
            ...
            try
            {
                ...
                else if (pVal.Before_Action == false)
                {
                    ...
                    //  Call MDC_GP_CF_DBDatasourceReturn(pval, pval.FormUID, "@PH_PY306A", "U_CardCode,U_CardName")
                    //End If
                }
            }
            catch (Exception ex)
...
//		private SAPbouiCOM.DBDataSource oDS_PH_PY306A;
//		private SAPbouiCOM.DBDataSource oDS_PH_PY306B;
...
//			oXmlDoc.load(MDC_Globals.SP_Path + "\\" + MDC_Globals.SP_Screen + "\\PH_PY306.srf");
...
//			SubMain.AddForms(this, oFormUniqueID, "PH_PY306");
...
//		private bool PH_PY306_CreateItems()
//		{
//			bool functionReturnValue = false;
...
//			oDS_PH_PY306B = oForm.DataSources.DBDataSources("@PS_USERDS01");
...
//			oRecordSet = null;
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY306_CreateItems_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}
...
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY306_EnableMenus_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY306_SetDocument_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		public void PH_PY306_FormItemEnabled()
//		{
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY306_FormItemEnabled_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//							if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE) {
//								if (PH_PY306_DataValidCheck() == false) {
//									BubbleEvent = false;
//									return;
//								}
//								//
...
//						//UPGRADE_NOTE: oForm 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//						oForm = null;
//						//UPGRADE_NOTE: oDS_PH_PY306A 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//						oDS_PH_PY306A = null;
//						//UPGRADE_NOTE: oDS_PH_PY306B 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//						oDS_PH_PY306B = null;
...
//								if (string.IsNullOrEmpty(oDS_PH_PY306B.GetValue("U_LineNum", i))) {
...
//							for (i = 0; i <= oDS_PH_PY306B.Size; i++) {
//								oDS_PH_PY306B.SetValue("U_LineNum", i, Convert.ToString(i + 1));
//							}
...
//		public void PH_PY306_AddMatrixRow()
//		{
//			int oRow = 0;
...
//				if (!string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY306B.GetValue("U_Name", oRow - 1)))) {
//					if (oDS_PH_PY306B.Size <= oMat1.VisualRowCount) {
//						oDS_PH_PY306B.InsertRecord((oRow));
//					}
//					oDS_PH_PY306B.Offset = oRow;
//					oDS_PH_PY306B.SetValue("U_LineNum", oRow, Convert.ToString(oRow + 1));
...
//					oDS_PH_PY306B.SetValue("U_LineNum", oRow - 1, Convert.ToString(oRow));
...
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY306_AddMatrixRow_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		public void PH_PY306_FormClear()
//		{
//			 // ERROR: Not supported in C#: OnErrorStatement

//			string DocEntry = null;
//			//UPGRADE_WARNING: MDC_GetData.Get_ReData() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			DocEntry = MDC_GetData.Get_ReData(ref "AutoKey", ref "ObjectCode", ref "ONNM", ref "'PH_PY306'", ref "");
...
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY306_FormClear_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//			//사원번호
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			if (string.IsNullOrEmpty(Strings.Trim(oForm.Items.Item("SCode").Specific.VALUE))) {
...
//			oRecordSet = null;
//			functionReturnValue = false;
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY306_DataValidCheck_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}
...
//			sQry = "EXEC PH_PY306_01 '" + Param01 + "','" + Param02 + "'";
//			//,'" & Param03 & "','" & Param04 & "'"
//			oRecordSet.DoQuery(sQry);

//			//UPGRADE_WARNING: oForm.Items(Team).Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
...
//			//신청인-성명
//			//UPGRADE_WARNING: oForm.Items(startDat).Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			//UPGRADE_WARNING: oRecordSet.Fields().VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			oForm.Items.Item("startDat").Specific.VALUE = oRecordSet.Fields.Item("StartDate").Value;
//			//신청인-입사일자
...
//				oDS_PH_PY306B.Offset = i;
//				oDS_PH_PY306B.SetValue("U_LineNum", i, Convert.ToString(i + 1));
//				oDS_PH_PY306B.SetValue("U_ColReg01", i, oRecordSet.Fields.Item("Name").Value);
//				oDS_PH_PY306B.SetValue("U_ColReg02", i, oRecordSet.Fields.Item("StdYear").Value);
//				oDS_PH_PY306B.SetValue("U_ColReg03", i, oRecordSet.Fields.Item("SchCls").Value);
//				oDS_PH_PY306B.SetValue("U_ColReg04", i, oRecordSet.Fields.Item("Grade").Value);
//				oDS_PH_PY306B.SetValue("U_ColSum01", i, oRecordSet.Fields.Item("Quarter1").Value);
//				oDS_PH_PY306B.SetValue("U_ColSum02", i, oRecordSet.Fields.Item("Quarter2").Value);
//				oDS_PH_PY306B.SetValue("U_ColSum03", i, oRecordSet.Fields.Item("Quarter3").Value);
//				oDS_PH_PY306B.SetValue("U_ColSum04", i, oRecordSet.Fields.Item("Quarter4").Value);
...
//			oRecordSet = null;
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY306_MTX01_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		public bool PH_PY306_Validate(string ValidateType)
//		{
//			bool functionReturnValue = false;
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			//UPGRADE_WARNING: MDC_Company_Common.GetValue(SELECT Canceled FROM [PH_PY306A] WHERE DocEntry = ' & oForm.Items(DocEntry).Specific.VALUE & ', 0, 1) 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			if (MDC_Company_Common.GetValue("SELECT Canceled FROM [@PH_PY306A] WHERE DocEntry = '" + oForm.Items.Item("DocEntry").Specific.VALUE + "'", 0, 1) == "Y") {
...
//			functionReturnValue = false;
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY306_Validate_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}
...
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			sCode = Strings.Trim(oForm.Items.Item("SCode").Specific.VALUE);
...
//				//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//				oRecordSet = null;
//				MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY306_Print_Report01_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			}
