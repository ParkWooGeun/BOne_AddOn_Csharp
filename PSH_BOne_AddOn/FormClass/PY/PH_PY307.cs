    ...
    internal class PH_PY307 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFormDocEntry)
        {
            ...
            try
            {
                ...
                PH_PY307_SetDocument(oFormDocEntry);
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <param name="oFormDocEntry"></param>
        private void PH_PY307_SetDocument(string oFormDocEntry)
        {
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        private bool PH_PY307_DataValidCheck()
        {
        ...
        private void Raise_EVENT_FORM_UNLOAD(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
        {
            try
            {
                ...
                else if (pVal.Before_Action == false)
                {
                    ...
                    System.Runtime.InteropServices.Marshal.ReleaseComObject(oDS_PH_PY307B);
                }
            }
            catch (Exception ex)
            {
