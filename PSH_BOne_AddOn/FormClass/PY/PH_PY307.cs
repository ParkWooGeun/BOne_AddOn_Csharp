    ...
    internal class PH_PY307 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFromDocEntry01)
        {
            ...
            try
            {
                ...
                PH_PY307_SetDocument(oFromDocEntry01);
        ...
        /// </summary>
        /// <param name="oFromDocEntry01"></param>
        private void PH_PY307_SetDocument(string oFromDocEntry01)
        {
            try
            {
...
//		private SAPbouiCOM.DBDataSource oDS_PH_PY307A;
//		private SAPbouiCOM.DBDataSource oDS_PH_PY307B;
//		private SAPbouiCOM.DBDataSource oDS_PH_PY307C;
...
//			oXmlDoc.load(MDC_Globals.SP_Path + "\\" + MDC_Globals.SP_Screen + "\\PH_PY307.srf");
...
//				oXmlDoc.selectNodes("Application/forms/action/form/items/action/item/specific/@cellHeight")[i - 1].nodeValue = 16;
//			}
//			oFormUniqueID = "PH_PY307_" + GetTotalFormsCount();
//			SubMain.AddForms(this, oFormUniqueID, "PH_PY307");
...
//		private bool PH_PY307_CreateItems()
//		{
//			bool functionReturnValue = false;
...
//			//    Set oDS_PH_PY307A = oForm.DataSources.DBDataSources("@PH_PY307A")
//			oDS_PH_PY307B = oForm.DataSources.DBDataSources("@PS_USERDS01");
//			//    Set oDS_PH_PY307C = oForm.DataSources.DBDataSources("@PS_USERDS02")
...
//			//회차
//			oCombo = oForm.Items.Item("Count").Specific;
//			oCombo.ValidValues.Add("", "");
...
//			//입학금포함여부
//			oCombo = oForm.Items.Item("EntFeeYN").Specific;
//			//    oCombo.ValidValues.Add "", ""
...
//			oRecordSet = null;
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY307_CreateItems_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}
...
//			return;
//			PH_PY307_EnableMenus_Error:

//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY307_EnableMenus_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//			}
//			return;
//			PH_PY307_SetDocument_Error:

//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY307_SetDocument_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		public void PH_PY307_FormItemEnabled()
//		{
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//				//폼 DocEntry 세팅
//				//        Call PH_PY307_FormClear

//				//// 접속자에 따른 권한별 사업장 콤보박스세팅
//				MDC_SetMod.CLTCOD_Select(oForm, "CLTCOD");

//				//년도 세팅
//				//        Call oDS_PH_PY307A.setValue("U_StdYear", 0, Format(Date, "YYYY"))
...
//			oForm.Freeze(false);
//			return;
//			PH_PY307_FormItemEnabled_Error:

//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY307_FormItemEnabled_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//						//                        If PH_PY307_DataValidCheck = False Then
//						//                            BubbleEvent = False
//						//                        End If
//						//
//						//                        '//해야할일 작업
...
//							if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE) {
//								if (PH_PY307_DataValidCheck() == false) {
//									BubbleEvent = false;
//									return;
//								}
//								//
...
//							//UPGRADE_WARNING: oForm.Items(SCode).Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
...
//								case "SCode":
//									//Call oDS_PH_PY307A.setValue("U_CntcName", 0, MDC_GetData.Get_ReData("U_FullName", "Code", "[@PH_PY001A]", "'" & oForm.Items(pval.ItemUID).Specific.Value & "'"))

//									//UPGRADE_WARNING: oForm.Items(SName).Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//									//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
...
//						//UPGRADE_NOTE: oForm 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//						oForm = null;
//						//UPGRADE_NOTE: oDS_PH_PY307A 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//						oDS_PH_PY307A = null;
//						//UPGRADE_NOTE: oDS_PH_PY307B 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//						oDS_PH_PY307B = null;
//						//UPGRADE_NOTE: oDS_PH_PY307C 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//						oDS_PH_PY307C = null;
...
//						//                    Call MDC_CF_DBDatasourceReturn(pval, pval.FormUID, "@PH_PY307A", "Code")
//						//                End If
//					}
//					break;
...
//						PH_PY307_AddMatrixRow1();
//						PH_PY307_AddMatrixRow2();
//						break;
...
//							while ((i <= oDS_PH_PY307B.Size - 1)) {
//								if (string.IsNullOrEmpty(oDS_PH_PY307B.GetValue("U_LineNum", i))) {
//									oDS_PH_PY307B.RemoveRecord((i));
//									i = 0;
//								} else {
//									i = i + 1;
//								}
...
//							for (i = 0; i <= oDS_PH_PY307B.Size; i++) {
//								oDS_PH_PY307B.SetValue("U_LineNum", i, Convert.ToString(i + 1));
//							}
...
//						oDS_PH_PY307C.RemoveRecord(oDS_PH_PY307C.Size - 1);
...
//		public void PH_PY307_AddMatrixRow1()
//		{
//			int oRow = 0;
...
//				if (!string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY307B.GetValue("U_LineNum", oRow - 1)))) {
//					if (oDS_PH_PY307B.Size <= oMat1.VisualRowCount) {
//						oDS_PH_PY307B.InsertRecord((oRow));
//					}
//					oDS_PH_PY307B.Offset = oRow;
//					oDS_PH_PY307B.SetValue("U_LineNum", oRow, Convert.ToString(oRow + 1));
//					oDS_PH_PY307B.SetValue("U_ColReg01", oRow, "");
//					//신청인부서
//					oDS_PH_PY307B.SetValue("U_ColReg02", oRow, "");
//					//신청인성명
//					oDS_PH_PY307B.SetValue("U_ColReg03", oRow, "");
//					//자녀성명고등
//					oDS_PH_PY307B.SetValue("U_ColDt01", oRow, "");
//					//자녀생년월일고등
//					oDS_PH_PY307B.SetValue("U_ColReg04", oRow, "");
//					//자녀학년고등
//					oDS_PH_PY307B.SetValue("U_ColSum01", oRow, "");
//					//자녀학자금고등
//					oDS_PH_PY307B.SetValue("U_ColReg05", oRow, "");
//					//자녀성명전문대
//					oDS_PH_PY307B.SetValue("U_ColDt02", oRow, "");
//					//자녀생년월일전문대
//					oDS_PH_PY307B.SetValue("U_ColReg06", oRow, "");
//					//자녀학년전문대
//					oDS_PH_PY307B.SetValue("U_ColSum02", oRow, "");
//					//자녀학자금전문대
//					oDS_PH_PY307B.SetValue("U_ColReg07", oRow, "");
//					//회차
//					oDS_PH_PY307B.SetValue("U_ColReg08", oRow, "");
//					//자녀성명대학
//					oDS_PH_PY307B.SetValue("U_ColDt03", oRow, "");
//					//자녀생년월일대학
//					oDS_PH_PY307B.SetValue("U_ColReg09", oRow, "");
//					//자녀학년대학
//					oDS_PH_PY307B.SetValue("U_ColSum03", oRow, "");
//					//자녀학자금대학
//					oDS_PH_PY307B.SetValue("U_ColReg10", oRow, "");
//					//회차
//					oDS_PH_PY307B.SetValue("U_ColReg04", oRow, "");
//					//계
...
//					oMat1.LoadFromDataSource();
//				} else {
//					oDS_PH_PY307B.Offset = oRow - 1;
//					oDS_PH_PY307B.SetValue("U_LineNum", oRow - 1, Convert.ToString(oRow));
//					oDS_PH_PY307B.SetValue("U_ColReg01", oRow - 1, "");
//					//신청인부서
//					oDS_PH_PY307B.SetValue("U_ColReg02", oRow - 1, "");
//					//신청인성명
//					oDS_PH_PY307B.SetValue("U_ColReg03", oRow - 1, "");
//					//자녀성명고등
//					oDS_PH_PY307B.SetValue("U_ColDt01", oRow - 1, "");
//					//자녀생년월일고등
//					oDS_PH_PY307B.SetValue("U_ColReg04", oRow - 1, "");
//					//자녀학년고등
//					oDS_PH_PY307B.SetValue("U_ColSum01", oRow - 1, "");
//					//자녀학자금고등
//					oDS_PH_PY307B.SetValue("U_ColReg05", oRow - 1, "");
//					//자녀성명전문대
//					oDS_PH_PY307B.SetValue("U_ColDt02", oRow - 1, "");
//					//자녀생년월일전문대
//					oDS_PH_PY307B.SetValue("U_ColReg06", oRow - 1, "");
//					//자녀학년전문대
//					oDS_PH_PY307B.SetValue("U_ColSum02", oRow - 1, "");
//					//자녀학자금전문대
//					oDS_PH_PY307B.SetValue("U_ColReg07", oRow - 1, "");
//					//회차
//					oDS_PH_PY307B.SetValue("U_ColReg08", oRow - 1, "");
//					//자녀성명대학
//					oDS_PH_PY307B.SetValue("U_ColDt03", oRow - 1, "");
//					//자녀생년월일대학
//					oDS_PH_PY307B.SetValue("U_ColReg09", oRow - 1, "");
//					//자녀학년대학
//					oDS_PH_PY307B.SetValue("U_ColSum03", oRow - 1, "");
//					//자녀학자금대학
//					oDS_PH_PY307B.SetValue("U_ColReg10", oRow - 1, "");
//					//회차
//					oDS_PH_PY307B.SetValue("U_ColReg04", oRow - 1, "");
//					//계
...
//			oForm.Freeze(false);
//			return;
//			PH_PY307_AddMatrixRow1_Error:
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY307_AddMatrixRow1_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		public void PH_PY307_AddMatrixRow2()
//		{
//			int oRow = 0;
...
//				if (!string.IsNullOrEmpty(Strings.Trim(oDS_PH_PY307C.GetValue("U_LineNum", oRow - 1)))) {
//					if (oDS_PH_PY307C.Size <= oMat2.VisualRowCount) {
//						oDS_PH_PY307C.InsertRecord((oRow));
//					}
//					oDS_PH_PY307C.Offset = oRow;
//					oDS_PH_PY307C.SetValue("U_LineNum", oRow, Convert.ToString(oRow + 1));
//					oDS_PH_PY307C.SetValue("U_ColReg01", oRow, "");
//					//부서/담당명
//					oDS_PH_PY307C.SetValue("U_ColReg02", oRow, "");
//					//고등인원
//					oDS_PH_PY307C.SetValue("U_ColSum01", oRow, "");
//					//고등학자금
//					oDS_PH_PY307C.SetValue("U_ColReg03", oRow, "");
//					//전문대인원
//					oDS_PH_PY307C.SetValue("U_ColSum02", oRow, "");
//					//전문대학자금
//					oDS_PH_PY307C.SetValue("U_ColReg04", oRow, "");
//					//대학인원
//					oDS_PH_PY307C.SetValue("U_ColSum03", oRow, "");
//					//대학학자금
//					oDS_PH_PY307C.SetValue("U_ColSum04", oRow, "");
//					//계

//					oMat2.LoadFromDataSource();
//				} else {
//					oDS_PH_PY307C.Offset = oRow - 1;
//					oDS_PH_PY307C.SetValue("U_LineNum", oRow - 1, Convert.ToString(oRow));
//					oDS_PH_PY307C.SetValue("U_ColReg01", oRow - 1, "");
//					//부서/담당명
//					oDS_PH_PY307C.SetValue("U_ColReg02", oRow - 1, "");
//					//고등인원
//					oDS_PH_PY307C.SetValue("U_ColSum01", oRow - 1, "");
//					//고등학자금
//					oDS_PH_PY307C.SetValue("U_ColReg03", oRow - 1, "");
//					//전문대인원
//					oDS_PH_PY307C.SetValue("U_ColSum02", oRow - 1, "");
//					//전문대학자금
//					oDS_PH_PY307C.SetValue("U_ColReg04", oRow - 1, "");
//					//대학인원
//					oDS_PH_PY307C.SetValue("U_ColSum03", oRow - 1, "");
//					//대학학자금
//					oDS_PH_PY307C.SetValue("U_ColSum04", oRow - 1, "");
//					//계
...
//			oForm.Freeze(false);
//			return;
//			PH_PY307_AddMatrixRow2_Error:
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY307_AddMatrixRow2_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		public void PH_PY307_FormClear()
//		{
//			 // ERROR: Not supported in C#: OnErrorStatement

//			string DocEntry = null;
//			//UPGRADE_WARNING: MDC_GetData.Get_ReData() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			DocEntry = MDC_GetData.Get_ReData(ref "AutoKey", ref "ObjectCode", ref "ONNM", ref "'PH_PY307'", ref "");
...
//			}
//			return;
//			PH_PY307_FormClear_Error:
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY307_FormClear_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		private void PH_PY307_FormResize()
//		{
//			//******************************************************************************
//			//Function ID : PH_PY307_FormResize()
//			//해당모듈 : PH_PY307
...
//			return;
//			PH_PY307_FormResize_Error:

//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY307_FormResize_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//				MDC_Globals.Sbo_Application.SetStatusBarMessage("분기는 필수입니다.", SAPbouiCOM.BoMessageTime.bmt_Short, true);
//				oForm.Items.Item("Quarter").Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//				functionReturnValue = false;
//				return functionReturnValue;
//			}
...
//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			PH_PY307_DataValidCheck_Error:


//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			functionReturnValue = false;
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY307_DataValidCheck_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}
...
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			Param02 = Strings.Trim(oForm.Items.Item("StdYear").Specific.VALUE);
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			Param03 = Strings.Trim(oForm.Items.Item("Quarter").Specific.VALUE);
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			Param04 = Strings.Trim(oForm.Items.Item("Count").Specific.VALUE);
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			Param05 = Strings.Trim(oForm.Items.Item("TeamCode").Specific.VALUE);
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			Param06 = Strings.Trim(oForm.Items.Item("EntFeeYN").Specific.VALUE);

//			SAPbouiCOM.ProgressBar ProgressBar01 = null;
//			ProgressBar01 = MDC_Globals.Sbo_Application.StatusBar.CreateProgressBar("조회시작!", oRecordSet.RecordCount, false);

//			sQry = "EXEC PH_PY307_01 '" + Param01 + "','" + Param02 + "','" + Param03 + "','" + Param04 + "','" + Param05 + "','" + Param06 + "'";
//			oRecordSet.DoQuery(sQry);
...
//				oDS_PH_PY307B.Offset = i;
//				oDS_PH_PY307B.SetValue("U_LineNum", i, Convert.ToString(i + 1));
//				oDS_PH_PY307B.SetValue("U_ColReg01", i, oRecordSet.Fields.Item("Team").Value);
//				//신청인부서
//				oDS_PH_PY307B.SetValue("U_ColReg02", i, oRecordSet.Fields.Item("Rsp").Value);
//				//담당
//				oDS_PH_PY307B.SetValue("U_ColReg16", i, oRecordSet.Fields.Item("Cls").Value);
//				//반추가(2017.02.06 송명규, 최용석 요청)
//				oDS_PH_PY307B.SetValue("U_ColReg03", i, oRecordSet.Fields.Item("CntcCode").Value);
//				//사번
//				oDS_PH_PY307B.SetValue("U_ColReg04", i, oRecordSet.Fields.Item("CntcName").Value);
//				//신청인성명
//				oDS_PH_PY307B.SetValue("U_ColReg05", i, oRecordSet.Fields.Item("Name1").Value);
//				//자녀성명고등
//				oDS_PH_PY307B.SetValue("U_ColReg06", i, oRecordSet.Fields.Item("BirDat1").Value);
//				//자녀생년월일고등
//				oDS_PH_PY307B.SetValue("U_ColReg07", i, oRecordSet.Fields.Item("Grade1").Value);
//				//자녀학년고등
//				oDS_PH_PY307B.SetValue("U_ColSum01", i, oRecordSet.Fields.Item("Amt1").Value);
//				//자녀학자금고등
//				oDS_PH_PY307B.SetValue("U_ColReg08", i, oRecordSet.Fields.Item("Name2").Value);
//				//자녀성명전문대
//				oDS_PH_PY307B.SetValue("U_ColReg09", i, oRecordSet.Fields.Item("BirDat2").Value);
//				//자녀생년월일전문대
//				oDS_PH_PY307B.SetValue("U_ColReg10", i, oRecordSet.Fields.Item("Grade2").Value);
//				//자녀학년전문대
//				oDS_PH_PY307B.SetValue("U_ColSum02", i, oRecordSet.Fields.Item("Amt2").Value);
//				//자녀학자금전문대
//				oDS_PH_PY307B.SetValue("U_ColReg11", i, oRecordSet.Fields.Item("Count2").Value);
//				//회차
//				oDS_PH_PY307B.SetValue("U_ColReg12", i, oRecordSet.Fields.Item("Name3").Value);
//				//자녀성명대학
//				oDS_PH_PY307B.SetValue("U_ColReg13", i, oRecordSet.Fields.Item("BirDat3").Value);
//				//자녀생년월일대학
//				oDS_PH_PY307B.SetValue("U_ColReg14", i, oRecordSet.Fields.Item("Grade3").Value);
//				//자녀학년대학
//				oDS_PH_PY307B.SetValue("U_ColSum03", i, oRecordSet.Fields.Item("Amt3").Value);
//				//자녀학자금대학
//				oDS_PH_PY307B.SetValue("U_ColReg15", i, oRecordSet.Fields.Item("Count3").Value);
//				//회차
//				//        Call oDS_PH_PY307B.setValue("U_ColSum04", i, oRecordSet.Fields("Total").VALUE) '계
...
//			oRecordSet = null;
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY307_MTX01_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		private void PH_PY307_MTX02()
//		{
...
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			Param03 = oForm.Items.Item("Quarter").Specific.VALUE;
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			Param04 = oForm.Items.Item("Count").Specific.VALUE;

//			SAPbouiCOM.ProgressBar ProgressBar01 = null;
//			ProgressBar01 = MDC_Globals.Sbo_Application.StatusBar.CreateProgressBar("조회시작!", oRecordSet.RecordCount, false);

//			sQry = "EXEC PH_PY307_02 '" + Param01 + "','" + Param02 + "','" + Param03 + "','" + Param04 + "'";
//			oRecordSet.DoQuery(sQry);
...
//			if ((oRecordSet.RecordCount == 0)) {
//				oMat2.Clear();
//				goto PH_PY307_MTX02_Exit;
//			}

//			for (i = 0; i <= oRecordSet.RecordCount - 1; i++) {
//				if (i != 0) {
//					oDS_PH_PY307C.InsertRecord((i));
//				}
//				oDS_PH_PY307C.Offset = i;
//				oDS_PH_PY307C.SetValue("U_LineNum", i, Convert.ToString(i + 1));
//				oDS_PH_PY307C.SetValue("U_ColReg01", i, oRecordSet.Fields.Item("Team").Value);
//				//부서/담당명
//				oDS_PH_PY307C.SetValue("U_ColReg02", i, oRecordSet.Fields.Item("ManCnt1").Value);
//				//고등인원
//				oDS_PH_PY307C.SetValue("U_ColSum01", i, oRecordSet.Fields.Item("Amt1").Value);
//				//고등학자금
//				oDS_PH_PY307C.SetValue("U_ColReg03", i, oRecordSet.Fields.Item("ManCnt2").Value);
//				//전문대인원
//				oDS_PH_PY307C.SetValue("U_ColSum02", i, oRecordSet.Fields.Item("Amt2").Value);
//				//전문대학자금
//				oDS_PH_PY307C.SetValue("U_ColReg04", i, oRecordSet.Fields.Item("ManCnt3").Value);
//				//대학인원
//				oDS_PH_PY307C.SetValue("U_ColSum03", i, oRecordSet.Fields.Item("Amt3").Value);
//				//대학학자금
//				oDS_PH_PY307C.SetValue("U_ColSum04", i, oRecordSet.Fields.Item("Total").Value);
//				//계
...
//			oRecordSet = null;
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY307_MTX02_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		public bool PH_PY307_Validate(string ValidateType)
//		{
//			bool functionReturnValue = false;
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			//UPGRADE_WARNING: MDC_Company_Common.GetValue(SELECT Canceled FROM [PH_PY307A] WHERE DocEntry = ' & oForm.Items(DocEntry).Specific.VALUE & ', 0, 1) 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			if (MDC_Company_Common.GetValue("SELECT Canceled FROM [@PH_PY307A] WHERE DocEntry = '" + oForm.Items.Item("DocEntry").Specific.VALUE + "'", 0, 1) == "Y") {
...
//			oRecordSet = null;
//			return functionReturnValue;
//			PH_PY307_Validate_Exit:
//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			return functionReturnValue;
//			PH_PY307_Validate_Error:
//			functionReturnValue = false;
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY307_Validate_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}
...
//				goto PH_PY307_Print_Report01_Error;
//			}
...
//			Param04 = oForm.Items.Item("Count").Specific.VALUE;
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			Param05 = oForm.Items.Item("TeamCode").Specific.VALUE;
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			Param06 = oForm.Items.Item("EntFeeYN").Specific.VALUE;
...
//			//사업장
//			sQry = "SELECT U_CodeNm FROM [@PS_HR200L] WHERE Code = 'P144' AND U_UseYN= 'Y' AND U_Code = '" + Param01 + "'";
//			oRecordSet.DoQuery(sQry);
...
//			MDC_Globals.gRpt_Formula[2] = "YYYY";
//			//년도
//			MDC_Globals.gRpt_Formula_Value[2] = Param02;
//			//oRecordSet.Fields(0).VALUE

//			MDC_Globals.gRpt_Formula[3] = "BUNGI";
//			//분기
//			if (Param03 == "01") {
//				MDC_Globals.gRpt_Formula_Value[3] = "1/4 혹은 1학기";
//			} else if (Param03 == "02") {
//				MDC_Globals.gRpt_Formula_Value[3] = "2/4";
//			} else if (Param03 == "03") {
//				MDC_Globals.gRpt_Formula_Value[3] = "3/4 혹은 2학기";
//			} else if (Param03 == "04") {
//				MDC_Globals.gRpt_Formula_Value[3] = "4/4";
//			}

//			MDC_Globals.gRpt_Formula[4] = "CHASU";
//			//회차
//			if (Param04 == "01") {
//				MDC_Globals.gRpt_Formula_Value[4] = "1차";
//			} else if (Param04 == "02") {
//				MDC_Globals.gRpt_Formula_Value[4] = "2차";
//			} else {
//				MDC_Globals.gRpt_Formula_Value[4] = "전체";
//			}
...
//			if (MDC_SetMod.gCryReport_Action(WinTitle, ReportName, "N", sQry, "1", "Y", "V", , 2) == false) {
...
//				//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//				oRecordSet = null;
//				MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY307_Print_Report01_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			}
