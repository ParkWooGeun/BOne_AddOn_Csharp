...
{ 
    ...
    internal class PH_PY312 : PSH_BaseClass
    {
        ...
        private void PH_PY312_UPDATE()
        {
            ...
            string IsNew = string.Empty; //신규여부
                ...
                for (i = 1; i <= oMat2.VisualRowCount; i++)
                {
                    if (!string.IsNullOrEmpty(oMat2.Columns.Item("MSTCOD").Cells.Item(i).Specific.Value.ToString().Trim()))
                    {
                        ...
                        if (IsNew == "N")
                        {
                            ...
                            sQry = sQry + " SET     Amt1 = " + Amt1 + ",";
                            sQry = sQry + "         Amt2 = " + Amt2;
                            sQry = sQry + " WHERE   MSTCOD = '" + MSTCOD + "'";
        ...
        private void PH_PY312_APPLY()
        {
            ...
            try
            {
                ProgressBar01 = PSH_Globals.SBO_Application.StatusBar.CreateProgressBar("조회시작!", oMat1.VisualRowCount, false);
                ...
                else
                {
                    for (i = 1; i <= oMat1.VisualRowCount; i++) //기존일자에 Update
                    {
                        ...
                        sQry = "        UPDATE  YPH_PY312A";
                        sQry = sQry + " SET     Amt1 = " + InAmt1 + ",";
                        sQry = sQry + "         Amt2 = " + InAmt2;
                        sQry = sQry + " WHERE   MSTCOD = '" + MSTCOD + "'";
                        sQry = sQry + "         AND DocDate = '" + DocDate + "'";
                        oRecordSet02.DoQuery(sQry);
	   ...
	   /// <summary>
        ...
        #region 백업소스코드
        //		public void PH_PY312_FormClear()
        //		{
        //			 // ERROR: Not supported in C#: OnErrorStatement

        //			string DocEntry = null;
        //			//UPGRADE_WARNING: MDC_GetData.Get_ReData() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        //			DocEntry = MDC_GetData.Get_ReData(ref "AutoKey", ref "ObjectCode", ref "ONNM", ref "'PH_PY312'", ref "");
        ...
        //			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY312_FormClear_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
        //		}

        //		public bool PH_PY312_Validate(string ValidateType)
        //		{
        ...
        //			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        //			//UPGRADE_WARNING: MDC_Company_Common.GetValue(SELECT Canceled FROM [PH_PY312A] WHERE DocEntry = ' & oForm.Items(DocEntry).Specific.VALUE & ', 0, 1) 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        //			if (MDC_Company_Common.GetValue("SELECT Canceled FROM [@PH_PY312A] WHERE DocEntry = '" + oForm.Items.Item("DocEntry").Specific.VALUE + "'", 0, 1) == "Y") {
        ...
        //			functionReturnValue = false;
        //			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY312_Validate_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
        //			return functionReturnValue;
        //		}
        #endregion
