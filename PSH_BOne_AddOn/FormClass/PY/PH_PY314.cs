    ...
    internal class PH_PY314 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFormDocEntry)
        {
            ...
            try
            {
                ...
                PH_PY314_SetDocument(oFormDocEntry);
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <param name="oFormDocEntry"></param>
        private void PH_PY314_SetDocument(string oFormDocEntry)
        {
            try
            {
        ...
        /// 매트릭스 행 추가
        /// </summary>
        private void PH_PY314_AddMatrixRow()
        {
            int oRow;
        ...
        private void PH_PY314_MTX01()
        {
            ...
            try
            {
                ...
                for (i = 0; i <= oRecordSet01.RecordCount - 1; i++)
                {
                    ...
                    Total += oRecordSet01.Fields.Item("RpmtTot").Value;
                ...
                if (pVal.BeforeAction == true)
                {
                    switch (pVal.MenuUID)
                    {
                        ...
                        case "1291":
                            break;
                        case "7169": //엑셀 내보내기
                            PH_PY314_AddMatrixRow(); //엑셀 내보내기 실행 시 매트릭스의 제일 마지막 행에 빈 행 추가
                            break;
                    }
                }
                else if (pVal.BeforeAction == false)
