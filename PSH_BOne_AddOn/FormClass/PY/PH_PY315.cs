    ...
    internal class PH_PY315 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFormDocEntry)
        {
            ...
            try
            {
                ...
                PH_PY315_SetDocument(oFormDocEntry);
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <param name="oFormDocEntry"></param>
        private void PH_PY315_SetDocument(string oFormDocEntry)
        {
            try
            {
                if (string.IsNullOrEmpty(oFormDocEntry))
                {
                    ...
                    //Call PH_PY315_AddMatrixRow(0, True) '
                }
                else
                {
        ...
        /// </summary>
        /// <returns></returns>
        private bool PH_PY315_DataValidCheck()
        {
        ...
        private void Raise_EVENT_FORM_UNLOAD(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
        {
            try
            {
                ...
                else if (pVal.Before_Action == false)
                {
                    ...
                    System.Runtime.InteropServices.Marshal.ReleaseComObject(oDS_PH_PY315B);
                }
            }
            catch (Exception ex)
            {
