    ...
    internal class PH_PY676 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFormDocEntry01)
        {
            ...
            try
            {
                ...
                PH_PY676_SetDocument(oFormDocEntry01);
                PSH_Globals.ExecuteEventFilter(typeof(PH_PY676));
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <param name="oFormDocEntry01"></param>
        private void PH_PY676_SetDocument(string oFormDocEntry01)
        {
            try
            {
        ...
        /// 매트릭스 행 추가
        /// </summary>
        private void PH_PY676_AddMatrixRow()
        {
            int oRow;
            ...
            try
            {
                ...
                if (pVal.BeforeAction == true)
                {
                    switch (pVal.MenuUID)
                    {
                        ...
                        case "7169": //엑셀 내보내기
                            PH_PY676_AddMatrixRow(); //엑셀 내보내기 실행 시 매트릭스의 제일 마지막 행에 빈 행 추가
                            break;
