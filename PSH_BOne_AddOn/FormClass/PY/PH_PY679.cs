...
namespace PSH_BOne_AddOn
{
    ...
    /// 개인별근태자료집계
    /// </summary>
    internal class PH_PY679 : PSH_BaseClass
    {
        public string oFormUniqueID01;

        //'// 그리드 사용시
        public SAPbouiCOM.Grid oGrid1;
        public SAPbouiCOM.DataTable oDS_PH_PY679;
        ...
        public override void LoadForm(string oFromDocEntry01)
        {
            ...
            try
            {
                oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PH_PY679.srf");
                ...
                oFormUniqueID01 = "PH_PY679_" + SubMain.Get_TotalFormsCount();
                SubMain.Add_Forms(this, oFormUniqueID01, "PH_PY679");
                ...
                oForm.Freeze(true);
                PH_PY679_CreateItems();
                PH_PY679_FormItemEnabled();
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <returns></returns>
        private void PH_PY679_CreateItems()
        {
            try
            {
                oGrid1 = oForm.Items.Item("Grid01").Specific;
                oForm.DataSources.DataTables.Add("PH_PY679");

                oGrid1.DataTable = oForm.DataSources.DataTables.Item("PH_PY679");
                oDS_PH_PY679 = oForm.DataSources.DataTables.Item("PH_PY679");
                ...
                oForm.Items.Item("Div").Specific.ValidValues.Add("1", "현재소속부서기준");
                oForm.Items.Item("Div").Specific.ValidValues.Add("2", "근무부서기준");
            ...
            {
                PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY679_CreateItems_Error:" + ex.Message, SAPbouiCOM.BoMessageTime.bmt_Short, true);
            }
            finally
            {
                oForm.Freeze(false);
        ...
        /// 화면의 아이템 Enable 설정
        /// </summary>
        public void PH_PY679_FormItemEnabled()
        {
            ...
            {
                PSH_Globals.SBO_Application.StatusBar.SetText("PH_PY679_FormItemEnabled_Error : " + ex.Message, BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Error);
            }
            finally
            {
                oForm.Freeze(false);
        ...
        private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
        {
            try
            {
                if (pVal.BeforeAction == true)
                {
                    ...
                    {
                        if (PH_PY679_DataValidCheck() == true)
                        {
                            PH_PY679_DataFind();
                        }
                        else
        ...
        /// </summary>
        /// <returns></returns>
        public bool PH_PY679_DataValidCheck()
        {
            ...
            {
                PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY679_DataValidCheck_Error:" + ex.Message, SAPbouiCOM.BoMessageTime.bmt_Short, true);
            }
            finally
            {
        ...
        /// </summary>
        /// <returns></returns>
        private void PH_PY679_DataFind()
        {
            string sQry = string.Empty;
            ...
            try
            {
                ...
                oDS_PH_PY679.ExecuteQuery(sQry);
            }
            catch (Exception ex)
            {
                PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY679_DataFind_Error:" + ex.Message, SAPbouiCOM.BoMessageTime.bmt_Short, true);
            }
            finally
            {
                oForm.Freeze(false);
