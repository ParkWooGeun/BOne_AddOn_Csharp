...
//{
//	internal class PH_PY679
//	{
//////********************************************************************************
//////  File           : PH_PY679.cls
//////  Module         : 인사관리 > 근태관리
//////  Desc           : 개인별근태자료 집계(N.G.Y)
//////********************************************************************************
...
//			oXmlDoc.load(MDC_Globals.SP_Path + "\\" + MDC_Globals.SP_Screen + "\\PH_PY679.srf");
...
//				oXmlDoc.selectNodes("Application/forms/action/form/items/action/item/specific/@cellHeight")[i - 1].nodeValue = 16;
//			}
//			oFormUniqueID = "PH_PY679_" + GetTotalFormsCount();
//			SubMain.AddForms(this, oFormUniqueID, "PH_PY679");
...
//			oForm.Freeze(true);
//			PH_PY679_CreateItems();
//			PH_PY679_EnableMenus();
//			PH_PY679_SetDocument(oFromDocEntry01);
//			//    Call PH_PY679_FormResize
...
//		private bool PH_PY679_CreateItems()
//		{
//			bool functionReturnValue = false;
...
//			//    oForm.DataSources.DataTables.Item("PH_PY679").Columns.Add "구분", ft_AlphaNumeric
//			//    oForm.DataSources.DataTables.Item("PH_PY679").Columns.Add "부서", ft_AlphaNumeric
//			//    oForm.DataSources.DataTables.Item("PH_PY679").Columns.Add "담당", ft_AlphaNumeric
//			//    oForm.DataSources.DataTables.Item("PH_PY679").Columns.Add "사번", ft_AlphaNumeric
//			//    oForm.DataSources.DataTables.Item("PH_PY679").Columns.Add "성명", ft_AlphaNumeric
//			//    oForm.DataSources.DataTables.Item("PH_PY679").Columns.Add "횟수", ft_AlphaNumeric
//			//    oForm.DataSources.DataTables.Item("PH_PY679").Columns.Add "교통비", ft_AlphaNumeric
...
//			oCombo.ValidValues.Add("1", "현재소속부서기준");
//			oCombo.ValidValues.Add("2", "근무부서기준");
...
//			oRecordSet = null;
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY679_CreateItems_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}

//		private void PH_PY679_EnableMenus()
//		{
...
//			return;
//			PH_PY679_EnableMenus_Error:

//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY679_EnableMenus_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		private void PH_PY679_SetDocument(string oFromDocEntry01)
//		{
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			}
//			return;
//			PH_PY679_SetDocument_Error:

//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY679_SetDocument_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//			oForm.Freeze(false);
//			return;
//			PH_PY679_FormItemEnabled_Error:

//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY679_FormItemEnabled_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//						//UPGRADE_NOTE: oForm 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//						oForm = null;
//						//UPGRADE_NOTE: oDS_PH_PY679 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//						oDS_PH_PY679 = null;
...
//		public void PH_PY679_FormClear()
//		{
//			 // ERROR: Not supported in C#: OnErrorStatement

//			string DocEntry = null;
//			//UPGRADE_WARNING: MDC_GetData.Get_ReData() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			DocEntry = MDC_GetData.Get_ReData(ref "AutoKey", ref "ObjectCode", ref "ONNM", ref "'PH_PY679'", ref "");
...
//			}
//			return;
//			PH_PY679_FormClear_Error:
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY679_FormClear_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			PH_PY679_DataValidCheck_Error:


//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			functionReturnValue = false;
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY679_DataValidCheck_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}


//		public bool PH_PY679_Validate(string ValidateType)
//		{
//			bool functionReturnValue = false;
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			//UPGRADE_WARNING: MDC_Company_Common.GetValue(SELECT Canceled FROM [PH_PY679A] WHERE DocEntry = ' & oForm.Items(DocEntry).Specific.VALUE & ', 0, 1) 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			if (MDC_Company_Common.GetValue("SELECT Canceled FROM [@PH_PY679A] WHERE DocEntry = '" + oForm.Items.Item("DocEntry").Specific.VALUE + "'", 0, 1) == "Y") {
...
//			oRecordSet = null;
//			return functionReturnValue;
//			PH_PY679_Validate_Exit:
//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			return functionReturnValue;
//			PH_PY679_Validate_Error:
//			functionReturnValue = false;
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY679_Validate_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}
...
//			sQry = "Exec PH_PY679_01 '" + CLTCOD + "','" + DocDateFr + "','" + DocDateTo + "', '" + TeamCode + "', '" + RspCode + "', '" + Div + "'";
//			//    If Div = "1" Then
//			//       sQry = "Exec PH_PY679_01 '" & CLTCOD & "','" & DocDateFr & "','" & DocDateTo & "'"
//			//    ElseIf Div = "2" Then
//			//       sQry = "Exec PH_PY679_02 '" & CLTCOD & "','" & DocDateFr & "','" & DocDateTo & "'"
//			//    ElseIf Div = "3" Then
//			//       sQry = "Exec PH_PY679_03 '" & CLTCOD & "','" & DocDateFr & "','" & DocDateTo & "'"
//			//    ElseIf Div = "4" Then
//			//       sQry = "Exec PH_PY679_04 '" & CLTCOD & "','" & DocDateFr & "','" & DocDateTo & "'"
//			//    End If
...
//			// Call PH_PY679_TitleSetting(iRow)

//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			return;
//			PH_PY679_DataFind_Error:

//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY679_DataFind_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		private bool PH_PY679_DataSave()
//		{
//			bool functionReturnValue = false;
//			int i = 0;
...
//					//            oDS_PH_PY679.Columns.Item("Code").Cells(i).Value

//					sQry = " UPDATE [@PH_PY001A] SET U_Activity = '" + oDS_PH_PY679.Columns.Item("Activity").Cells.Item(i).Value + "'";
//					sQry = sQry + " WHERE Code = '" + oDS_PH_PY679.Columns.Item("MSTCOD").Cells.Item(i).Value + "'";
//					oRecordSet.DoQuery(sQry);
...
//			oRecordSet = null;
//			return functionReturnValue;
//			PH_PY679_DataSave_Error:

//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			functionReturnValue = false;
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY679_DataSave_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}

////Private Sub PH_PY679_TitleSetting(iRow As Long)
////    Dim i               As Long
////    Dim j               As Long
////    Dim sQry            As String
////
...
////    oForm.Freeze False
////    Set oColumn = Nothing
////    Sbo_Application.SetStatusBarMessage "PH_PY679_TitleSetting Error : " & Space(10) & Err.Description, bmt_Short, True
////End Sub

//		private void PH_PY679_Print_Report01()
//		{
...
//			//    Dim oRecordSet      As SAPbobsCOM.Recordset
//			//
//			//    On Error GoTo PH_PY679_Print_Report01_Error
//			//
...
//			//        GoTo PH_PY679_Print_Report01_Error
//			//    End If
//			//
//			//
//			//    '//인자 MOVE , Trim 시키기..
...
//			//    '/ Crystal /~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~/
//			//    If Div = "1" Then
//			//       WinTitle = "[PH_PY679] 개인별교통비지급대장"
//			//       ReportName = "PH_PY679_01.rpt"
//			//    ElseIf Div = "2" Then
//			//       WinTitle = "[PH_PY679] 개인별근태월보(교통비확인용)"
//			//       ReportName = "PH_PY679_02.rpt"
//			//    ElseIf Div = "3" Then
//			//       WinTitle = "[PH_PY679] 통근버스휴일운행현황"
//			//       ReportName = "PH_PY679_03.rpt"
//			//    End If
//			//
//			//
//			//    '/ Formula 수식필드
...
//			//    '/ Procedure 실행"
//			//    If Div = "1" Then
//			//       sQry = "EXEC [PH_PY679_01] '" & CLTCOD & "', '" & DocDateFr & "',  '" & DocDateTo & "',  '" & MSTCOD & "'"
//			//    ElseIf Div = "2" Then
//			//       sQry = "EXEC [PH_PY679_02] '" & CLTCOD & "', '" & DocDateFr & "',  '" & DocDateTo & "',  '" & MSTCOD & "'"
//			//    ElseIf Div = "3" Then
//			//       sQry = "EXEC [PH_PY679_03] '" & CLTCOD & "', '" & DocDateFr & "',  '" & DocDateTo & "'"
//			//    End If
//			//
...
//			//PH_PY679_Print_Report01_Error:
//			//    If ErrNum = 1 Then
//			//        Set oRecordSet = Nothing
//			//        MDC_Com.MDC_GF_Message "출력할 데이터가 없습니다. 확인해 주세요.", "E"
//			//    Else
//			//    Set oRecordSet = Nothing
//			//    Sbo_Application.SetStatusBarMessage "PH_PY679_Print_Report01_Error: " & Err.Number & " - " & Err.Description, bmt_Short, True
//			//    End If
