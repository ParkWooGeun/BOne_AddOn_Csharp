...
namespace PSH_BOne_AddOn
{
    ...
    internal class PH_PY695 : PSH_BaseClass
    {
        ...
        ///// 화면의 아이템 Enable 설정
        ///// </summary>
        public void PH_PY695_FormItemEnabled()
        {
            PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
            try
            {
        ...
        private void PH_PY695_Print_Report01()
        {
            ...
            string HR_Pic_Path = string.Empty;
            ...
            // "\\191.1.1.221\인사급여_Project\HR_PIC\" '"\\191.1.1.220\HR_Pic\"
...
////Public oDS_PH_PY695     As SAPbouiCOM.DataTable
////
////'// 매트릭스 사용시
////Public oMat1 As SAPbouiCOM.Matrix
////Private oDS_PH_PY695A As SAPbouiCOM.DBDataSource
////Private oDS_PH_PY695B As SAPbouiCOM.DBDataSource
...
//			oXmlDoc.load(MDC_Globals.SP_Path + "\\" + MDC_Globals.SP_Screen + "\\PH_PY695.srf");
...
//				oXmlDoc.selectNodes("Application/forms/action/form/items/action/item/specific/@cellHeight")[i - 1].nodeValue = 16;
//			}
//			oFormUniqueID = "PH_PY695_" + GetTotalFormsCount();
//			SubMain.AddForms(this, oFormUniqueID, "PH_PY695");
...
//			oForm.Freeze(true);
//			PH_PY695_CreateItems();
//			PH_PY695_EnableMenus();
//			PH_PY695_SetDocument(oFromDocEntry01);
//			//    Call PH_PY695_FormResize
...
//		private bool PH_PY695_CreateItems()
//		{
...
//			oRecordSet = null;
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY695_CreateItems_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}

//		private void PH_PY695_EnableMenus()
//		{
...
//			return;
//			PH_PY695_EnableMenus_Error:

//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY695_EnableMenus_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		private void PH_PY695_SetDocument(string oFromDocEntry01)
//		{
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			}
//			return;
//			PH_PY695_SetDocument_Error:

//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY695_SetDocument_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//			oForm.Freeze(false);
//			return;
//			PH_PY695_FormItemEnabled_Error:

//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY695_FormItemEnabled_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//						MDC_PS_Common.ActiveUserDefineValue(ref oForm, ref pval, ref BubbleEvent, "Code", "");
...
//									////사원명 찿아서 화면 표시 하기
//									//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//									sQry = "SELECT U_FullName FROM [@PH_PY001A] WHERE Code =  '" + Strings.Trim(oForm.Items.Item("Code").Specific.VALUE) + "'";
//									oRecordSet.DoQuery(sQry);
//									//UPGRADE_WARNING: oForm.Items(CodeName).Specific.String 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//									oForm.Items.Item("CodeName").Specific.String = Strings.Trim(oRecordSet.Fields.Item("U_FullName").Value);
//									break;
//							}
//						}
//					}
...
//						//UPGRADE_NOTE: oForm 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//						oForm = null;
//						//                Set oDS_PH_PY695A = Nothing
//						//                Set oDS_PH_PY695B = Nothing
...
//						//
//						//                    While (i <= oDS_PH_PY695B.Size - 1)
//						//                        If oDS_PH_PY695B.GetValue("U_FILD01", i) = "" Then
//						//                            oDS_PH_PY695B.RemoveRecord (i)
//						//                            i = 0
//						//                        Else
//						//                            i = i + 1
//						//                        End If
//						//                    Wend
//						//
//						//                    For i = 0 To oDS_PH_PY695B.Size
//						//                        Call oDS_PH_PY695B.setValue("U_LineNum", i, i + 1)
//						//                    Next i
//						//
//						//                    oMat1.LoadFromDataSource
//						//End If
...
//		public void PH_PY695_AddMatrixRow()
//		{
//			int oRow = 0;
...
//			//        If Trim(oDS_PH_PY695B.GetValue("U_FILD01", oRow - 1)) <> "" Then
//			//            If oDS_PH_PY695B.Size <= oMat1.VisualRowCount Then
//			//                oDS_PH_PY695B.InsertRecord (oRow)
//			//            End If
//			//            oDS_PH_PY695B.Offset = oRow
//			//            oDS_PH_PY695B.setValue "U_LineNum", oRow, oRow + 1
//			//            oDS_PH_PY695B.setValue "U_FILD01", oRow, ""
//			//            oDS_PH_PY695B.setValue "U_FILD02", oRow, ""
//			//            oDS_PH_PY695B.setValue "U_FILD03", oRow, 0
//			//            oMat1.LoadFromDataSource
//			//        Else
//			//            oDS_PH_PY695B.Offset = oRow - 1
//			//            oDS_PH_PY695B.setValue "U_LineNum", oRow - 1, oRow
//			//            oDS_PH_PY695B.setValue "U_FILD01", oRow - 1, ""
//			//            oDS_PH_PY695B.setValue "U_FILD02", oRow - 1, ""
//			//            oDS_PH_PY695B.setValue "U_FILD03", oRow - 1, 0
//			//            oMat1.LoadFromDataSource
//			//        End If
...
//			oForm.Freeze(false);
//			return;
//			PH_PY695_AddMatrixRow_Error:
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY695_AddMatrixRow_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		public void PH_PY695_FormClear()
//		{
//			 // ERROR: Not supported in C#: OnErrorStatement

//			string DocEntry = null;
//			//UPGRADE_WARNING: MDC_GetData.Get_ReData() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			DocEntry = MDC_GetData.Get_ReData(ref "AutoKey", ref "ObjectCode", ref "ONNM", ref "'PH_PY695'", ref "");
...
//			}
//			return;
//			PH_PY695_FormClear_Error:
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY695_FormClear_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		public bool PH_PY695_DataValidCheck()
//		{
//			bool functionReturnValue = false;
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			//    '//필수 체크
//			//    '//----------------------------------------------------------------------------------
//			//    If Trim(oDS_PH_PY695A.GetValue("Code", 0)) = "" Then
//			//        Sbo_Application.SetStatusBarMessage "사원번호는 필수입니다.", bmt_Short, True
//			//        oForm.Items("Code").CLICK ct_Regular
//			//        PH_PY695_DataValidCheck = False
//			//        Exit Function
//			//    End If
//			//
//			//    oMat1.FlushToDataSource
//			//    '// Matrix 마지막 행 삭제(DB 저장시)
//			//    If oDS_PH_PY695B.Size > 1 Then oDS_PH_PY695B.RemoveRecord (oDS_PH_PY695B.Size - 1)
//			//    oMat1.LoadFromDataSource
...
//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			PH_PY695_DataValidCheck_Error:


//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			functionReturnValue = false;
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY695_DataValidCheck_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}


//		public bool PH_PY695_Validate(string ValidateType)
//		{
//			bool functionReturnValue = false;
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			//UPGRADE_WARNING: MDC_Company_Common.GetValue(SELECT Canceled FROM [PH_PY695A] WHERE DocEntry = ' & oForm.Items(DocEntry).Specific.VALUE & ', 0, 1) 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			if (MDC_Company_Common.GetValue("SELECT Canceled FROM [@PH_PY695A] WHERE DocEntry = '" + oForm.Items.Item("DocEntry").Specific.VALUE + "'", 0, 1) == "Y") {
...
//			oRecordSet = null;
//			return functionReturnValue;
//			PH_PY695_Validate_Exit:
//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			return functionReturnValue;
//			PH_PY695_Validate_Error:
//			functionReturnValue = false;
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY695_Validate_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}
...
//				goto PH_PY695_Print_Report01_Error;
//			}
...
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			Code = Strings.Trim(oForm.Items.Item("Code").Specific.VALUE);

//			string strid = null;
//			object fs = null;
//			string HR_Pic_Path = null;
...
//			//UPGRADE_WARNING: fs.FileExists 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			if (fs.FileExists(HR_Pic_Path + Code + ".bmp") == true) {

//				//UPGRADE_WARNING: fs.FileExists 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//				if (fs.FileExists(HR_Pic_Path + "PIC.bmp") == true) {
//					FileSystem.Kill(HR_Pic_Path + "PIC.bmp");
//					//UPGRADE_WARNING: fs.CopyFile 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//					fs.CopyFile(HR_Pic_Path + Code + ".bmp", HR_Pic_Path + "PIC.bmp");
//				} else {
//					//UPGRADE_WARNING: fs.CopyFile 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//					fs.CopyFile(HR_Pic_Path + Code + ".bmp", HR_Pic_Path + "PIC.bmp");
//				}
...
//				FileSystem.Kill(HR_Pic_Path + "PIC.bmp");
//				//UPGRADE_WARNING: fs.CopyFile 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//				fs.CopyFile(HR_Pic_Path + "NULL.bmp", HR_Pic_Path + "PIC.bmp");
//			}
...
//			MDC_Globals.gRpt_SRptSqry = new string[9];
//			MDC_Globals.gRpt_SRptName = new string[9];
//			MDC_Globals.gRpt_SFormula = new string[9, 2];
//			MDC_Globals.gRpt_SFormula_Value = new string[9, 2];

//			/// SubReport


//			sQry = "EXEC [PH_PY695_02] '" + Code + "'";
//			MDC_Globals.gRpt_SRptSqry[1] = sQry;
//			MDC_Globals.gRpt_SRptName[1] = "PH_PY695_SUB1";

//			sQry = "EXEC [PH_PY695_03] '" + Code + "'";
//			MDC_Globals.gRpt_SRptSqry[2] = sQry;
//			MDC_Globals.gRpt_SRptName[2] = "PH_PY695_SUB2";

//			sQry = "EXEC [PH_PY695_04] '" + Code + "'";
//			MDC_Globals.gRpt_SRptSqry[3] = sQry;
//			MDC_Globals.gRpt_SRptName[3] = "PH_PY695_SUB3";

//			sQry = "EXEC [PH_PY695_05] '" + Code + "'";
//			MDC_Globals.gRpt_SRptSqry[4] = sQry;
//			MDC_Globals.gRpt_SRptName[4] = "PH_PY695_SUB4";

//			sQry = "EXEC [PH_PY695_06] '" + Code + "'";
//			MDC_Globals.gRpt_SRptSqry[5] = sQry;
//			MDC_Globals.gRpt_SRptName[5] = "PH_PY695_SUB5";

//			sQry = "EXEC [PH_PY695_07] '" + Code + "'";
//			MDC_Globals.gRpt_SRptSqry[6] = sQry;
//			MDC_Globals.gRpt_SRptName[6] = "PH_PY695_SUB6";

//			sQry = "EXEC [PH_PY695_08] '" + Code + "'";
//			MDC_Globals.gRpt_SRptSqry[7] = sQry;
//			MDC_Globals.gRpt_SRptName[7] = "PH_PY695_SUB7";

//			sQry = "EXEC [PH_PY695_09] '" + Code + "'";
//			MDC_Globals.gRpt_SRptSqry[8] = sQry;
//			MDC_Globals.gRpt_SRptName[8] = "PH_PY695_SUB8";

//			/// Procedure 실행"
//			sQry = "EXEC [PH_PY695_01] '" + CLTCOD + "', '" + Code + "'";
...
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY695_Print_Report01_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
