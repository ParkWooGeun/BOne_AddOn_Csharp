...
namespace PSH_BOne_AddOn
{
    ...
    /// 급여지급대장
    /// </summary>
    internal class PH_PY700 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFromDocEntry01)
        {
            ...
            try
            {
                oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PH_PY700.srf");
                ...
                oFormUniqueID01 = "PH_PY700_" + SubMain.Get_TotalFormsCount();
                SubMain.Add_Forms(this, oFormUniqueID01, "PH_PY700");
                ...
                oForm.Freeze(true);
                PH_PY700_CreateItems();
                PH_PY700_FormItemEnabled();
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <returns></returns>
        private void PH_PY700_CreateItems()
        {
            ...
            {
                PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY700_CreateItems_Error:" + ex.Message, SAPbouiCOM.BoMessageTime.bmt_Short, true);
            }
            finally
            {
                oForm.Freeze(false);
        ...
        /// 화면의 아이템 Enable 설정
        /// </summary>
        public void PH_PY700_FormItemEnabled()
        {
            PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
            try
            {
            ...
            {
                PSH_Globals.SBO_Application.StatusBar.SetText("PH_PY700_FormItemEnabled_Error : " + ex.Message, BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Error);
            }
            finally
            {
                oForm.Freeze(false);
        ...
        private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
        {
            try
            {
                if (pVal.BeforeAction == true)
                {
                    ...
                    {
                        System.Threading.Thread thread = new System.Threading.Thread(PH_PY700_Print_Report01);
        ...
        /// </summary>
        [STAThread]
        private void PH_PY700_Print_Report01()
        {
            ...
            try
            {
                WinTitle = "[PH_PY700] 급여지급대장";
                ReportName = "PH_PY700_01.rpt";
            ...
            {
                PSH_Globals.SBO_Application.StatusBar.SetText("PH_PY700_Print_Report01_Error : " + ex.Message, BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Error);
            }
            finally
            {
            }
...
////Public oDS_PH_PY700     As SAPbouiCOM.DataTable
////
////'// 매트릭스 사용시
////Public oMat1 As SAPbouiCOM.Matrix
////Private oDS_PH_PY700A As SAPbouiCOM.DBDataSource
////Private oDS_PH_PY700B As SAPbouiCOM.DBDataSource
...
//			oXmlDoc.load(MDC_Globals.SP_Path + "\\" + MDC_Globals.SP_Screen + "\\PH_PY700.srf");
...
//			oFormUniqueID = "PH_PY700_" + GetTotalFormsCount();
//			SubMain.AddForms(this, oFormUniqueID, "PH_PY700");
...
//			oForm.Freeze(true);
//			PH_PY700_CreateItems();
//			PH_PY700_EnableMenus();
//			PH_PY700_SetDocument(oFromDocEntry01);
//			//    Call PH_PY700_FormResize
...
//		private bool PH_PY700_CreateItems()
//		{
...
//			oRecordSet = null;
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY700_CreateItems_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}

//		private void PH_PY700_EnableMenus()
//		{
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			return;
//			PH_PY700_EnableMenus_Error:

//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY700_EnableMenus_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		private void PH_PY700_SetDocument(string oFromDocEntry01)
//		{
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			}
//			return;
//			PH_PY700_SetDocument_Error:

//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY700_SetDocument_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//			oForm.Freeze(false);
//			return;
//			PH_PY700_FormItemEnabled_Error:

//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY700_FormItemEnabled_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//					if (pVal.BeforeAction == true) {
//						if (pVal.ItemUID == "Btn01") {
//							if (PH_PY700_DataValidCheck() == true) {
//								PH_PY700_Print_Report01();
//							}
...
//						//UPGRADE_NOTE: oForm 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//						oForm = null;
//						//                Set oDS_PH_PY700A = Nothing
//						//                Set oDS_PH_PY700B = Nothing
...
//						//
//						//                    While (i <= oDS_PH_PY700B.Size - 1)
//						//                        If oDS_PH_PY700B.GetValue("U_FILD01", i) = "" Then
//						//                            oDS_PH_PY700B.RemoveRecord (i)
//						//                            i = 0
//						//                        Else
//						//                            i = i + 1
//						//                        End If
//						//                    Wend
//						//
//						//                    For i = 0 To oDS_PH_PY700B.Size
//						//                        Call oDS_PH_PY700B.setValue("U_LineNum", i, i + 1)
//						//                    Next i
//						//
//						//                    oMat1.LoadFromDataSource
//						//End If
...
//		public void PH_PY700_AddMatrixRow()
//		{
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			//        If Trim(oDS_PH_PY700B.GetValue("U_FILD01", oRow - 1)) <> "" Then
//			//            If oDS_PH_PY700B.Size <= oMat1.VisualRowCount Then
//			//                oDS_PH_PY700B.InsertRecord (oRow)
//			//            End If
//			//            oDS_PH_PY700B.Offset = oRow
//			//            oDS_PH_PY700B.setValue "U_LineNum", oRow, oRow + 1
//			//            oDS_PH_PY700B.setValue "U_FILD01", oRow, ""
//			//            oDS_PH_PY700B.setValue "U_FILD02", oRow, ""
//			//            oDS_PH_PY700B.setValue "U_FILD03", oRow, 0
//			//            oMat1.LoadFromDataSource
//			//        Else
//			//            oDS_PH_PY700B.Offset = oRow - 1
//			//            oDS_PH_PY700B.setValue "U_LineNum", oRow - 1, oRow
//			//            oDS_PH_PY700B.setValue "U_FILD01", oRow - 1, ""
//			//            oDS_PH_PY700B.setValue "U_FILD02", oRow - 1, ""
//			//            oDS_PH_PY700B.setValue "U_FILD03", oRow - 1, 0
//			//            oMat1.LoadFromDataSource
//			//        End If
...
//			oForm.Freeze(false);
//			return;
//			PH_PY700_AddMatrixRow_Error:
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY700_AddMatrixRow_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		public void PH_PY700_FormClear()
//		{
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			DocEntry = MDC_GetData.Get_ReData(ref "AutoKey", ref "ObjectCode", ref "ONNM", ref "'PH_PY700'", ref "");
...
//			}
//			return;
//			PH_PY700_FormClear_Error:
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY700_FormClear_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		public bool PH_PY700_DataValidCheck()
//		{
//			bool functionReturnValue = false;
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			if (string.IsNullOrEmpty( oForm.Items.Item("JOBGBN").Specific.VALUE))) {
...
//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			PH_PY700_DataValidCheck_Error:

//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			functionReturnValue = false;
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY700_DataValidCheck_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}

//		public bool PH_PY700_Validate(string ValidateType)
//		{
//			bool functionReturnValue = false;
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			//UPGRADE_WARNING: MDC_Company_Common.GetValue(SELECT Canceled FROM [PH_PY700A] WHERE DocEntry = ' & oForm.Items(DocEntry).Specific.VALUE & ', 0, 1) 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			if (MDC_Company_Common.GetValue("SELECT Canceled FROM [@PH_PY700A] WHERE DocEntry = '" + oForm.Items.Item("DocEntry").Specific.VALUE + "'", 0, 1) == "Y") {
...
//			oRecordSet = null;
//			return functionReturnValue;
//			PH_PY700_Validate_Exit:
//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			return functionReturnValue;
//			PH_PY700_Validate_Error:
//			functionReturnValue = false;
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY700_Validate_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}
...
//				goto PH_PY700_Print_Report01_Error;
//			}
...
//			/// Procedure 실행"
//			sQry = "EXEC [PH_PY700_01] '" + CLTCOD + "', '" + JOBGBN + "',  '" + YM + "',  '" + JIGBIL + "', '" + PAYTYP + "', '" + TeamCode + "', '" + RspCode + "', '" + MSTCOD + "'";
...
//			} else {
//				MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY700_Print_Report01_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			}
