...
namespace PSH_BOne_AddOn
{
    ...
    internal class PH_PY705 : PSH_BaseClass
    {
        ...
        private SAPbouiCOM.DataTable oDS_PH_PY705;
        ...
        public override void LoadForm(string oFormDocEntry01)
        {
            ...
            try
            {
                ...
                PH_PY705_SetDocument(oFormDocEntry01);
                PSH_Globals.ExecuteEventFilter(typeof(PH_PY705));
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <param name="oFormDocEntry01"></param>
        private void PH_PY705_SetDocument(string oFormDocEntry01)
        {
            try
            {
