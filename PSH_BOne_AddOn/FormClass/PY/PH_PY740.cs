...
namespace PSH_BOne_AddOn
{
    ...
    internal class PH_PY740 : PSH_BaseClass
    {
        ...
        /// 화면의 아이템 Enable 설정
        /// </summary>
        public void PH_PY740_FormItemEnabled()
        {
            PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
            try
            {
        ...
        private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
        {
            try
            {
                if (pVal.BeforeAction == true)
                {
                    ...
                    {
                        if (PH_PY740_DataValidCheck() == false)    // 필수 아이템Check후 실행
                        {
        ...
        /// <summary>
        /// PH_PY740_DataValidCheck
        /// </summary>
        /// <returns></returns>
        private bool PH_PY740_DataValidCheck()
        {
            ...
            {
                PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY740_DataValidCheck_Error:" + ex.Message, SAPbouiCOM.BoMessageTime.bmt_Short, true);
            }
            finally
            {
