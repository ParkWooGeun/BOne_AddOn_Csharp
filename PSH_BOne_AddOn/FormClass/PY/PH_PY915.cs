...
namespace PSH_BOne_AddOn
{
    ...
    /// 근로소득원천징수부출력
    /// </summary>
    internal class PH_PY915 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFromDocEntry01)
        {
            ...
            try
            {
                oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PH_PY915.srf");
                ...
                oFormUniqueID01 = "PH_PY915_" + SubMain.Get_TotalFormsCount();
                SubMain.Add_Forms(this, oFormUniqueID01, "PH_PY915");
                ...
                oForm.Freeze(true);
                PH_PY915_CreateItems();
                PH_PY915_FormItemEnabled();
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <returns></returns>
        private void PH_PY915_CreateItems()
        {
            ...
            {
                PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY915_CreateItems_Error:" + ex.Message, SAPbouiCOM.BoMessageTime.bmt_Short, true);
            }
            finally
            {
                oForm.Freeze(false);
        ...
        ///  화면의 아이템 Enable 설정
        ///  </summary>
        public void PH_PY915_FormItemEnabled()
        {
            PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
            try
            {
            ...
            {
                PSH_Globals.SBO_Application.StatusBar.SetText("PH_PY915_FormItemEnabled_Error : " + ex.Message, BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Error);
            }
            finally
            {
                oForm.Freeze(false);
        ...
        private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
        {
            try
            {
                if (pVal.BeforeAction == true)
                {
                    ...
                    {
                        System.Threading.Thread thread = new System.Threading.Thread(PH_PY915_Print_Report01);
        ...
        /// </summary>
        [STAThread]
        private void PH_PY915_Print_Report01()
        {
            ...
            try
            {
                WinTitle = "[PH_PY915] 근로소득원천징수부출력";
                ReportName = "PH_PY915_01.rpt";
                ...
                //SubReport Parameter
                dataPackSubReportParameter.Add(new PSH_DataPackClass("@saup", CLTCOD, "PH_PY915_SUB1"));
                dataPackSubReportParameter.Add(new PSH_DataPackClass("@yyyy", YYYY, "PH_PY915_SUB1"));
                dataPackSubReportParameter.Add(new PSH_DataPackClass("@TeamCode", TeamCode, "PH_PY915_SUB1"));
                dataPackSubReportParameter.Add(new PSH_DataPackClass("@RspCode", RspCode, "PH_PY915_SUB1"));
                dataPackSubReportParameter.Add(new PSH_DataPackClass("@ClsCode", ClsCode, "PH_PY915_SUB1"));
                dataPackSubReportParameter.Add(new PSH_DataPackClass("@sabun", MSTCOD, "PH_PY915_SUB1"));

                dataPackSubReportParameter.Add(new PSH_DataPackClass("@saup", CLTCOD, "PH_PY915_SUB2"));
                dataPackSubReportParameter.Add(new PSH_DataPackClass("@yyyy", YYYY, "PH_PY915_SUB2"));
                dataPackSubReportParameter.Add(new PSH_DataPackClass("@TeamCode", TeamCode, "PH_PY915_SUB2"));
                dataPackSubReportParameter.Add(new PSH_DataPackClass("@RspCode", RspCode, "PH_PY915_SUB2"));
                dataPackSubReportParameter.Add(new PSH_DataPackClass("@ClsCode", ClsCode, "PH_PY915_SUB2"));
                dataPackSubReportParameter.Add(new PSH_DataPackClass("@sabun", MSTCOD, "PH_PY915_SUB2"));

                dataPackSubReportParameter.Add(new PSH_DataPackClass("@saup", CLTCOD, "PH_PY915_SUB3"));
                dataPackSubReportParameter.Add(new PSH_DataPackClass("@yyyy", YYYY, "PH_PY915_SUB3"));
                dataPackSubReportParameter.Add(new PSH_DataPackClass("@TeamCode", TeamCode, "PH_PY915_SUB3"));
                dataPackSubReportParameter.Add(new PSH_DataPackClass("@RspCode", RspCode, "PH_PY915_SUB3"));
                dataPackSubReportParameter.Add(new PSH_DataPackClass("@ClsCode", ClsCode, "PH_PY915_SUB3"));
                dataPackSubReportParameter.Add(new PSH_DataPackClass("@sabun", MSTCOD, "PH_PY915_SUB3"));
            ...
            {
                PSH_Globals.SBO_Application.StatusBar.SetText("PH_PY915_Print_Report01_Error : " + ex.Message, BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Error);
            }
            finally
            {
            }
...
////Public oDS_PH_PY915     As SAPbouiCOM.DataTable
////
////'// 매트릭스 사용시
////Public oMat1 As SAPbouiCOM.Matrix
////Private oDS_PH_PY915A As SAPbouiCOM.DBDataSource
////Private oDS_PH_PY915B As SAPbouiCOM.DBDataSource
...
//			oXmlDoc.load(MDC_Globals.SP_Path + "\\" + MDC_Globals.SP_Screen + "\\PH_PY915.srf");
...
//				oXmlDoc.selectNodes("Application/forms/action/form/items/action/item/specific/@cellHeight")[i - 1].nodeValue = 16;
//			}
//			oFormUniqueID = "PH_PY915_" + GetTotalFormsCount();
//			SubMain.AddForms(this, oFormUniqueID, "PH_PY915");
...
//			oForm.Freeze(true);
//			PH_PY915_CreateItems();
//			PH_PY915_EnableMenus();
//			PH_PY915_SetDocument(oFromDocEntry01);
//			//    Call PH_PY915_FormResize
...
//		private bool PH_PY915_CreateItems()
//		{
...
//			oRecordSet = null;
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY915_CreateItems_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}

//		private void PH_PY915_EnableMenus()
//		{
...
//			return;
//			PH_PY915_EnableMenus_Error:

//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY915_EnableMenus_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		private void PH_PY915_SetDocument(string oFromDocEntry01)
//		{
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			}
//			return;
//			PH_PY915_SetDocument_Error:

//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY915_SetDocument_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//			oForm.Freeze(false);
//			return;
//			PH_PY915_FormItemEnabled_Error:

//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY915_FormItemEnabled_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//					if (pval.BeforeAction == true) {
//						if (pval.ItemUID == "Btn01") {
//							PH_PY915_DataValidCheck();
//							PH_PY915_Print_Report01();
//						}
//					} else if (pval.BeforeAction == false) {
...
//						//UPGRADE_NOTE: oForm 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//						oForm = null;
//						//                Set oDS_PH_PY915A = Nothing
//						//                Set oDS_PH_PY915B = Nothing
...
//						//
//						//                    While (i <= oDS_PH_PY915B.Size - 1)
//						//                        If oDS_PH_PY915B.GetValue("U_FILD01", i) = "" Then
//						//                            oDS_PH_PY915B.RemoveRecord (i)
//						//                            i = 0
//						//                        Else
//						//                            i = i + 1
//						//                        End If
//						//                    Wend
//						//
//						//                    For i = 0 To oDS_PH_PY915B.Size
//						//                        Call oDS_PH_PY915B.setValue("U_LineNum", i, i + 1)
//						//                    Next i
//						//
//						//                    oMat1.LoadFromDataSource
//						//End If
...
//		public void PH_PY915_AddMatrixRow()
//		{
//			int oRow = 0;
...
//			//        If Trim(oDS_PH_PY915B.GetValue("U_FILD01", oRow - 1)) <> "" Then
//			//            If oDS_PH_PY915B.Size <= oMat1.VisualRowCount Then
//			//                oDS_PH_PY915B.InsertRecord (oRow)
//			//            End If
//			//            oDS_PH_PY915B.Offset = oRow
//			//            oDS_PH_PY915B.setValue "U_LineNum", oRow, oRow + 1
//			//            oDS_PH_PY915B.setValue "U_FILD01", oRow, ""
//			//            oDS_PH_PY915B.setValue "U_FILD02", oRow, ""
//			//            oDS_PH_PY915B.setValue "U_FILD03", oRow, 0
//			//            oMat1.LoadFromDataSource
//			//        Else
//			//            oDS_PH_PY915B.Offset = oRow - 1
//			//            oDS_PH_PY915B.setValue "U_LineNum", oRow - 1, oRow
//			//            oDS_PH_PY915B.setValue "U_FILD01", oRow - 1, ""
//			//            oDS_PH_PY915B.setValue "U_FILD02", oRow - 1, ""
//			//            oDS_PH_PY915B.setValue "U_FILD03", oRow - 1, 0
//			//            oMat1.LoadFromDataSource
//			//        End If
...
//			oForm.Freeze(false);
//			return;
//			PH_PY915_AddMatrixRow_Error:
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY915_AddMatrixRow_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		public void PH_PY915_FormClear()
//		{
//			 // ERROR: Not supported in C#: OnErrorStatement

//			string DocEntry = null;
//			//UPGRADE_WARNING: MDC_GetData.Get_ReData() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			DocEntry = MDC_GetData.Get_ReData(ref "AutoKey", ref "ObjectCode", ref "ONNM", ref "'PH_PY915'", ref "");
...
//			}
//			return;
//			PH_PY915_FormClear_Error:
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY915_FormClear_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		public bool PH_PY915_DataValidCheck()
//		{
//			bool functionReturnValue = false;
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			//        PH_PY915_DataValidCheck = False
//			//        Exit Function
//			//    End If
//			//
//			//    oMat1.FlushToDataSource
//			//    '// Matrix 마지막 행 삭제(DB 저장시)
//			//    If oDS_PH_PY915B.Size > 1 Then oDS_PH_PY915B.RemoveRecord (oDS_PH_PY915B.Size - 1)
//			//    oMat1.LoadFromDataSource
...
//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			PH_PY915_DataValidCheck_Error:


//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			functionReturnValue = false;
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY915_DataValidCheck_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}


//		public bool PH_PY915_Validate(string ValidateType)
//		{
//			bool functionReturnValue = false;
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			//UPGRADE_WARNING: MDC_Company_Common.GetValue(SELECT Canceled FROM [PH_PY915A] WHERE DocEntry = ' & oForm.Items(DocEntry).Specific.VALUE & ', 0, 1) 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			if (MDC_Company_Common.GetValue("SELECT Canceled FROM [@PH_PY915A] WHERE DocEntry = '" + oForm.Items.Item("DocEntry").Specific.VALUE + "'", 0, 1) == "Y") {
...
//			oRecordSet = null;
//			return functionReturnValue;
//			PH_PY915_Validate_Exit:
//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			return functionReturnValue;
//			PH_PY915_Validate_Error:
//			functionReturnValue = false;
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY915_Validate_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}
...
//				goto PH_PY915_Print_Report01_Error;
//			}
...
//			sQry = "EXEC [PH_PY915_02] '" + CLTCOD + "', '" + yyyy + "',  '" + TeamCode + "', '" + RspCode + "', '" + ClsCode + "', '" + MSTCOD + "'";
//			MDC_Globals.gRpt_SRptSqry[1] = sQry;
//			MDC_Globals.gRpt_SRptName[1] = "PH_PY915_SUB1";

//			sQry = "EXEC [PH_PY915_03] '" + CLTCOD + "', '" + yyyy + "',  '" + TeamCode + "', '" + RspCode + "', '" + ClsCode + "', '" + MSTCOD + "'";
//			MDC_Globals.gRpt_SRptSqry[2] = sQry;
//			MDC_Globals.gRpt_SRptName[2] = "PH_PY915_SUB2";

//			sQry = "EXEC [PH_PY915_04] '" + CLTCOD + "', '" + yyyy + "',  '" + TeamCode + "', '" + RspCode + "', '" + ClsCode + "', '" + MSTCOD + "'";
//			MDC_Globals.gRpt_SRptSqry[3] = sQry;
//			MDC_Globals.gRpt_SRptName[3] = "PH_PY915_SUB3";


//			/// Procedure 실행"
//			sQry = "EXEC [PH_PY915_01] '" + CLTCOD + "', '" + yyyy + "',  '" + TeamCode + "', '" + RspCode + "', '" + ClsCode + "', '" + MSTCOD + "'";
...
//				//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//				oRecordSet = null;
//				MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY915_Print_Report01_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			}
