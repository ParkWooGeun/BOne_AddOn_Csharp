...
namespace PSH_BOne_AddOn
{
    ...
    internal class PH_PY920 : PSH_BaseClass
    {
        ...
        ///  화면의 아이템 Enable 설정
        ///  </summary>
        public void PH_PY920_FormItemEnabled()
        {
            PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
            try
            {
...
////Public oDS_PH_PY920     As SAPbouiCOM.DataTable
////
////'// 매트릭스 사용시
////Public oMat1 As SAPbouiCOM.Matrix
////Private oDS_PH_PY920A As SAPbouiCOM.DBDataSource
////Private oDS_PH_PY920B As SAPbouiCOM.DBDataSource
...
//			oXmlDoc.load(MDC_Globals.SP_Path + "\\" + MDC_Globals.SP_Screen + "\\PH_PY920.srf");
...
//				oXmlDoc.selectNodes("Application/forms/action/form/items/action/item/specific/@cellHeight")[i - 1].nodeValue = 16;
//			}
//			oFormUniqueID = "PH_PY920_" + GetTotalFormsCount();
//			SubMain.AddForms(this, oFormUniqueID, "PH_PY920");
...
//			oForm.Freeze(true);
//			PH_PY920_CreateItems();
//			PH_PY920_EnableMenus();
//			PH_PY920_SetDocument(oFromDocEntry01);
//			//    Call PH_PY920_FormResize
...
//		private bool PH_PY920_CreateItems()
//		{
...
//			oCombo.ValidValues.Add("1", "소득자보관용");
//			oCombo.ValidValues.Add("2", "발행자보관용");
//			oCombo.ValidValues.Add("3", "발행자보고용");
//			oCombo.Select(0, SAPbouiCOM.BoSearchKey.psk_Index);

//			////재직구분
//			oCombo = oForm.Items.Item("Div1").Specific;
...
//			oRecordSet = null;
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY920_CreateItems_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}

//		private void PH_PY920_EnableMenus()
//		{
...
//			return;
//			PH_PY920_EnableMenus_Error:

//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY920_EnableMenus_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		private void PH_PY920_SetDocument(string oFromDocEntry01)
//		{
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			}
//			return;
//			PH_PY920_SetDocument_Error:

//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY920_SetDocument_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//			oForm.Freeze(false);
//			return;
//			PH_PY920_FormItemEnabled_Error:

//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY920_FormItemEnabled_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//					if (pval.BeforeAction == true) {
//						if (pval.ItemUID == "Btn01") {
//							PH_PY920_DataValidCheck();
//							PH_PY920_Print_Report01();
//						}
//					} else if (pval.BeforeAction == false) {
...
//						//UPGRADE_NOTE: oForm 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//						oForm = null;
//						//                Set oDS_PH_PY920A = Nothing
//						//                Set oDS_PH_PY920B = Nothing
...
//						//
//						//                    While (i <= oDS_PH_PY920B.Size - 1)
//						//                        If oDS_PH_PY920B.GetValue("U_FILD01", i) = "" Then
//						//                            oDS_PH_PY920B.RemoveRecord (i)
//						//                            i = 0
//						//                        Else
//						//                            i = i + 1
//						//                        End If
//						//                    Wend
//						//
//						//                    For i = 0 To oDS_PH_PY920B.Size
//						//                        Call oDS_PH_PY920B.setValue("U_LineNum", i, i + 1)
//						//                    Next i
//						//
//						//                    oMat1.LoadFromDataSource
//						//End If
...
//		public void PH_PY920_AddMatrixRow()
//		{
//			int oRow = 0;
...
//			//        If Trim(oDS_PH_PY920B.GetValue("U_FILD01", oRow - 1)) <> "" Then
//			//            If oDS_PH_PY920B.Size <= oMat1.VisualRowCount Then
//			//                oDS_PH_PY920B.InsertRecord (oRow)
//			//            End If
//			//            oDS_PH_PY920B.Offset = oRow
//			//            oDS_PH_PY920B.setValue "U_LineNum", oRow, oRow + 1
//			//            oDS_PH_PY920B.setValue "U_FILD01", oRow, ""
//			//            oDS_PH_PY920B.setValue "U_FILD02", oRow, ""
//			//            oDS_PH_PY920B.setValue "U_FILD03", oRow, 0
//			//            oMat1.LoadFromDataSource
//			//        Else
//			//            oDS_PH_PY920B.Offset = oRow - 1
//			//            oDS_PH_PY920B.setValue "U_LineNum", oRow - 1, oRow
//			//            oDS_PH_PY920B.setValue "U_FILD01", oRow - 1, ""
//			//            oDS_PH_PY920B.setValue "U_FILD02", oRow - 1, ""
//			//            oDS_PH_PY920B.setValue "U_FILD03", oRow - 1, 0
//			//            oMat1.LoadFromDataSource
//			//        End If
...
//			oForm.Freeze(false);
//			return;
//			PH_PY920_AddMatrixRow_Error:
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY920_AddMatrixRow_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		public void PH_PY920_FormClear()
//		{
//			 // ERROR: Not supported in C#: OnErrorStatement

//			string DocEntry = null;
//			//UPGRADE_WARNING: MDC_GetData.Get_ReData() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			DocEntry = MDC_GetData.Get_ReData(ref "AutoKey", ref "ObjectCode", ref "ONNM", ref "'PH_PY920'", ref "");
...
//			}
//			return;
//			PH_PY920_FormClear_Error:
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY920_FormClear_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		public bool PH_PY920_DataValidCheck()
//		{
//			bool functionReturnValue = false;
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			//        PH_PY920_DataValidCheck = False
//			//        Exit Function
//			//    End If
//			//
//			//    oMat1.FlushToDataSource
//			//    '// Matrix 마지막 행 삭제(DB 저장시)
//			//    If oDS_PH_PY920B.Size > 1 Then oDS_PH_PY920B.RemoveRecord (oDS_PH_PY920B.Size - 1)
//			//    oMat1.LoadFromDataSource
...
//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			PH_PY920_DataValidCheck_Error:


//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			functionReturnValue = false;
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY920_DataValidCheck_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}


//		public bool PH_PY920_Validate(string ValidateType)
//		{
//			bool functionReturnValue = false;
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			//UPGRADE_WARNING: MDC_Company_Common.GetValue(SELECT Canceled FROM [PH_PY920A] WHERE DocEntry = ' & oForm.Items(DocEntry).Specific.VALUE & ', 0, 1) 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			if (MDC_Company_Common.GetValue("SELECT Canceled FROM [@PH_PY920A] WHERE DocEntry = '" + oForm.Items.Item("DocEntry").Specific.VALUE + "'", 0, 1) == "Y") {
...
//			oRecordSet = null;
//			return functionReturnValue;
//			PH_PY920_Validate_Exit:
//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			return functionReturnValue;
//			PH_PY920_Validate_Error:
//			functionReturnValue = false;
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY920_Validate_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}
...
//				goto PH_PY920_Print_Report01_Error;
//			}
...
//			Gubun = oForm.DataSources.UserDataSources.Item("OptionDS").Value;
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			Div1 = Strings.Trim(oForm.Items.Item("Div1").Specific.VALUE);
...
//				MDC_Globals.gRpt_SRptSqry = new string[8];
//				MDC_Globals.gRpt_SRptName = new string[8];
//				MDC_Globals.gRpt_SFormula = new string[8, 2];
//				MDC_Globals.gRpt_SFormula_Value = new string[8, 2];
...
//					sQry = "EXEC [PH_PY920_17_02] '" + CLTCOD + "', '" + yyyy + "',  '" + TeamCode + "', '" + RspCode + "', '" + ClsCode + "', '" + MSTCOD + "'";
//					MDC_Globals.gRpt_SRptSqry[1] = sQry;
//					MDC_Globals.gRpt_SRptName[1] = "PH_PY920_SUB1";

//					sQry = "EXEC [PH_PY920_17_03] '" + CLTCOD + "', '" + yyyy + "',  '" + TeamCode + "', '" + RspCode + "', '" + ClsCode + "', '" + MSTCOD + "'";
//					MDC_Globals.gRpt_SRptSqry[2] = sQry;
//					MDC_Globals.gRpt_SRptName[2] = "PH_PY920_SUB2";

//					sQry = "EXEC [PH_PY920_17_04] '" + CLTCOD + "', '" + yyyy + "',  '" + TeamCode + "', '" + RspCode + "', '" + ClsCode + "', '" + MSTCOD + "'";
//					MDC_Globals.gRpt_SRptSqry[3] = sQry;
//					MDC_Globals.gRpt_SRptName[3] = "PH_PY920_SUB3";

//					sQry = "EXEC [PH_PY920_17_05] '" + CLTCOD + "', '" + yyyy + "',  '" + TeamCode + "', '" + RspCode + "', '" + ClsCode + "', '" + MSTCOD + "'";
//					MDC_Globals.gRpt_SRptSqry[4] = sQry;
//					MDC_Globals.gRpt_SRptName[4] = "PH_PY920_SUB4";

//					sQry = "EXEC [PH_PY920_17_06] '" + CLTCOD + "', '" + yyyy + "',  '" + TeamCode + "', '" + RspCode + "', '" + ClsCode + "', '" + MSTCOD + "'";
//					MDC_Globals.gRpt_SRptSqry[5] = sQry;
//					MDC_Globals.gRpt_SRptName[5] = "PH_PY920_SUB5";

//					sQry = "EXEC [PH_PY920_17_061] '" + CLTCOD + "', '" + yyyy + "',  '" + TeamCode + "', '" + RspCode + "', '" + ClsCode + "', '" + MSTCOD + "'";
//					MDC_Globals.gRpt_SRptSqry[6] = sQry;
//					MDC_Globals.gRpt_SRptName[6] = "PH_PY920_SUB51";

//					sQry = "EXEC [PH_PY920_17_07] '" + CLTCOD + "', '" + yyyy + "',  '" + TeamCode + "', '" + RspCode + "', '" + ClsCode + "', '" + MSTCOD + "'";
//					MDC_Globals.gRpt_SRptSqry[7] = sQry;
//					MDC_Globals.gRpt_SRptName[7] = "PH_PY920_SUB6";


//					/// Procedure 실행"
//					sQry = "EXEC [PH_PY920_17_01] '" + CLTCOD + "', '" + yyyy + "',  '" + TeamCode + "', '" + RspCode + "', '" + ClsCode + "', '" + MSTCOD + "', '" + Div1 + "'";
...
//				MDC_Globals.gRpt_Formula[2] = "Div";
//				MDC_Globals.gRpt_Formula_Value[2] = Div;
//				MDC_Globals.gRpt_SRptSqry = new string[11];
//				MDC_Globals.gRpt_SRptName = new string[11];
//				MDC_Globals.gRpt_SFormula = new string[11, 2];
//				MDC_Globals.gRpt_SFormula_Value = new string[11, 2];
...
//					sQry = "EXEC [PH_PY920_18_02] '" + CLTCOD + "', '" + yyyy + "',  '" + TeamCode + "', '" + RspCode + "', '" + ClsCode + "', '" + MSTCOD + "'";
//					MDC_Globals.gRpt_SRptSqry[1] = sQry;
//					MDC_Globals.gRpt_SRptName[1] = "PH_PY920_SUB1";

//					sQry = "EXEC [PH_PY920_18_021] '" + CLTCOD + "', '" + yyyy + "',  '" + TeamCode + "', '" + RspCode + "', '" + ClsCode + "', '" + MSTCOD + "'";
//					MDC_Globals.gRpt_SRptSqry[2] = sQry;
//					MDC_Globals.gRpt_SRptName[2] = "PH_PY920_SUB11";

//					sQry = "EXEC [PH_PY920_18_03] '" + CLTCOD + "', '" + yyyy + "',  '" + TeamCode + "', '" + RspCode + "', '" + ClsCode + "', '" + MSTCOD + "'";
//					MDC_Globals.gRpt_SRptSqry[3] = sQry;
//					MDC_Globals.gRpt_SRptName[3] = "PH_PY920_SUB2";

//					sQry = "EXEC [PH_PY920_18_031] '" + CLTCOD + "', '" + yyyy + "',  '" + TeamCode + "', '" + RspCode + "', '" + ClsCode + "', '" + MSTCOD + "'";
//					MDC_Globals.gRpt_SRptSqry[4] = sQry;
//					MDC_Globals.gRpt_SRptName[4] = "PH_PY920_SUB21";

//					sQry = "EXEC [PH_PY920_18_04] '" + CLTCOD + "', '" + yyyy + "',  '" + TeamCode + "', '" + RspCode + "', '" + ClsCode + "', '" + MSTCOD + "'";
//					MDC_Globals.gRpt_SRptSqry[5] = sQry;
//					MDC_Globals.gRpt_SRptName[5] = "PH_PY920_SUB3";

//					sQry = "EXEC [PH_PY920_18_05] '" + CLTCOD + "', '" + yyyy + "',  '" + TeamCode + "', '" + RspCode + "', '" + ClsCode + "', '" + MSTCOD + "'";
//					MDC_Globals.gRpt_SRptSqry[6] = sQry;
//					MDC_Globals.gRpt_SRptName[6] = "PH_PY920_SUB4";

//					sQry = "EXEC [PH_PY920_18_06] '" + CLTCOD + "', '" + yyyy + "',  '" + TeamCode + "', '" + RspCode + "', '" + ClsCode + "', '" + MSTCOD + "'";
//					MDC_Globals.gRpt_SRptSqry[7] = sQry;
//					MDC_Globals.gRpt_SRptName[7] = "PH_PY920_SUB5";

//					sQry = "EXEC [PH_PY920_18_061] '" + CLTCOD + "', '" + yyyy + "',  '" + TeamCode + "', '" + RspCode + "', '" + ClsCode + "', '" + MSTCOD + "'";
//					MDC_Globals.gRpt_SRptSqry[8] = sQry;
//					MDC_Globals.gRpt_SRptName[8] = "PH_PY920_SUB51";

//					sQry = "EXEC [PH_PY920_18_062] '" + CLTCOD + "', '" + yyyy + "',  '" + TeamCode + "', '" + RspCode + "', '" + ClsCode + "', '" + MSTCOD + "'";
//					MDC_Globals.gRpt_SRptSqry[9] = sQry;
//					MDC_Globals.gRpt_SRptName[9] = "PH_PY920_SUB52";

//					sQry = "EXEC [PH_PY920_18_07] '" + CLTCOD + "', '" + yyyy + "',  '" + TeamCode + "', '" + RspCode + "', '" + ClsCode + "', '" + MSTCOD + "'";
//					MDC_Globals.gRpt_SRptSqry[10] = sQry;
//					MDC_Globals.gRpt_SRptName[10] = "PH_PY920_SUB6";


//					/// Procedure 실행"
//					sQry = "EXEC [PH_PY920_18_01] '" + CLTCOD + "', '" + yyyy + "',  '" + TeamCode + "', '" + RspCode + "', '" + ClsCode + "', '" + MSTCOD + "', '" + Div1 + "'";
...
//				//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//				oRecordSet = null;
//				MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY920_Print_Report01_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			}
