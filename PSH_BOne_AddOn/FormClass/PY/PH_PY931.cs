...
namespace PSH_BOne_AddOn
{
    ...
    internal class PH_PY931 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFromDocEntry01)
        {
            ...
            try
            {
                oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PH_PY931.srf");
                ...
                oFormUniqueID01 = "PH_PY931_" + SubMain.Get_TotalFormsCount();
                SubMain.Add_Forms(this, oFormUniqueID01, "PH_PY931");
                ...
                PH_PY931_SetDocument(oFromDocEntry01);
                //PH_PY931_FormResize();
            }
            catch (Exception ex)
            {
        ...
        /// 화면 Item 생성
        /// </summary>
        private void PH_PY931_CreateItems()
        {
            try
            {
                oForm.Freeze(true);
                ...
                oForm.DataSources.DataTables.Add("PH_PY931");

                oGrid1.DataTable = oForm.DataSources.DataTables.Item("PH_PY931");
                oDS_PH_PY931 = oForm.DataSources.DataTables.Item("PH_PY931");
            ...
            {
                PSH_Globals.SBO_Application.StatusBar.SetText("PH_PY931_CreateItems_Error : " + ex.Message, BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Error);
            }
            finally
            {
                oForm.Freeze(false);
        ...
        /// 메뉴 아이콘 Enable
        /// </summary>
        private void PH_PY931_EnableMenus()
        {
            try
            {
            ...
            {
                PSH_Globals.SBO_Application.StatusBar.SetText("PH_PY931_EnableMenus_Error : " + ex.Message, BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Error);
            }
        }
        ...
        /// </summary>
        /// <param name="oFromDocEntry01"></param>
        private void PH_PY931_SetDocument(string oFromDocEntry01)
        {
            try
            {
            ...
            {
                PSH_Globals.SBO_Application.StatusBar.SetText("PH_PY931_SetDocument_Error : " + ex.Message, BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Error);
            }
            finally
            {
            }
        ...
        /// 화면의 아이템 Enable 설정
        /// </summary>
        private void PH_PY931_FormItemEnabled()
        {
            ...
            {
                PSH_Globals.SBO_Application.StatusBar.SetText("PH_PY931_FormItemEnabled_Error : " + ex.Message, BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Error);
            }
            finally
            {
                oForm.Freeze(false);
        ...
        /// </summary>
        /// <returns></returns>
        private bool PH_PY931_DataValidCheck()
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    PSH_Globals.SBO_Application.StatusBar.SetText("PH_PY931_DataValidCheck_Error : " + ex.Message, BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Error);
                }
            }
            finally
            {
        ...
        /// DataFind : 자료 조회
        /// </summary>
        private void PH_PY931_DataFind()
        {
            string sQry = string.Empty;
            ...
            try
            {
                ...
                sQry = "Exec PH_PY931_01 '" + CLTCOD + "','" + YY + "'";

                oDS_PH_PY931.ExecuteQuery(sQry);
        ...
        private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
        {
            try
            {
                if (pVal.BeforeAction == true)
                {
                    ...
                    {
                        if (PH_PY931_DataValidCheck() == true)
                        {
                            PH_PY931_DataFind();
                        }
                        else
                    ...
                    else if (pVal.ItemUID == "BtnPrt01")
                    {
                        //if (PH_PY931_DataValidCheck() == true)
                        //{
                        //    System.Threading.Thread thread = new System.Threading.Thread(PH_PY931_Print_Report01);
        ...
        private void Raise_EVENT_FORM_UNLOAD(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
        {
            try
            {
                ...
                else if (pVal.Before_Action == false)
                {
                    ...
                    System.Runtime.InteropServices.Marshal.ReleaseComObject(oDS_PH_PY931);
