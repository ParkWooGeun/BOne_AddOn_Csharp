...
namespace PSH_BOne_AddOn
{
    ...
    /// 정기승호현황
    /// </summary>
    internal class PH_PY935 : PSH_BaseClass
    {
        ...
        public override void LoadForm(string oFromDocEntry01)
        {
            ...
            try
            {
                ...
                oForm.Freeze(true);
                PH_PY935_CreateItems();
                PH_PY935_FormItemEnabled();
            }
            catch (Exception ex)
            {
        ...
        private void PH_PY935_CreateItems()
        {
            ...
            {
                PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY935_CreateItems_Error:" + ex.Message, SAPbouiCOM.BoMessageTime.bmt_Short, true);
            }
            finally
            {
                oForm.Freeze(false);
        ...
        /// 화면의 아이템 Enable 설정
        /// </summary>
        public void PH_PY935_FormItemEnabled()
        {
            PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
            try
            {
            ...
            {
                PSH_Globals.SBO_Application.StatusBar.SetText("PH_PY935_FormItemEnabled_Error : " + ex.Message, BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Error);
            }
            finally
            {
                oForm.Freeze(false);
        ...
        private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
        {
            try
            {
                if (pVal.BeforeAction == true)
                {
                    ...
                    {
                        if (PH_PY935_DataValidCheck() == false)    // 필수 아이템Check후 실행
                        {
                            System.Threading.Thread thread = new System.Threading.Thread(PH_PY935_Print_Report01);
        ...
        private bool PH_PY935_DataValidCheck()
        {
            ...
            {
                PSH_Globals.SBO_Application.SetStatusBarMessage("PH_PY935_DataValidCheck_Error:" + ex.Message, SAPbouiCOM.BoMessageTime.bmt_Short, true);
            }
            finally
            {
        ...
        private void PH_PY935_Print_Report01()
        {
            ...
            try
            {
                WinTitle = "[PH_PY935] 정기승호현황";
                ReportName = "PH_PY935_01.rpt";
            ...
            {
                PSH_Globals.SBO_Application.StatusBar.SetText("PH_PY935_Print_Report01_Error : " + ex.Message, BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Error);
            }
            finally
            {
            }
...
////Public oDS_PH_PY935     As SAPbouiCOM.DataTable
////
////'// 매트릭스 사용시
////Public oMat1 As SAPbouiCOM.Matrix
////Private oDS_PH_PY935A As SAPbouiCOM.DBDataSource
////Private oDS_PH_PY935B As SAPbouiCOM.DBDataSource
...
//			oXmlDoc.load(MDC_Globals.SP_Path + "\\" + MDC_Globals.SP_Screen + "\\PH_PY935.srf");
...
//				oXmlDoc.selectNodes("Application/forms/action/form/items/action/item/specific/@cellHeight")[i - 1].nodeValue = 16;
//			}
//			oFormUniqueID = "PH_PY935_" + GetTotalFormsCount();
//			SubMain.AddForms(this, oFormUniqueID, "PH_PY935");
...
//			oForm.Freeze(true);
//			PH_PY935_CreateItems();
//			PH_PY935_EnableMenus();
//			PH_PY935_SetDocument(oFromDocEntry01);
//			//    Call PH_PY935_FormResize
...
//		private bool PH_PY935_CreateItems()
//		{
//			bool functionReturnValue = false;
...
//			oRecordSet = null;
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY935_CreateItems_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}

//		private void PH_PY935_EnableMenus()
//		{
...
//			return;
//			PH_PY935_EnableMenus_Error:

//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY935_EnableMenus_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		private void PH_PY935_SetDocument(string oFromDocEntry01)
//		{
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			}
//			return;
//			PH_PY935_SetDocument_Error:

//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY935_SetDocument_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//			oForm.Freeze(false);
//			return;
//			PH_PY935_FormItemEnabled_Error:

//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY935_FormItemEnabled_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}
...
//						//UPGRADE_NOTE: oForm 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//						oForm = null;
//						//                Set oDS_PH_PY935A = Nothing
//						//                Set oDS_PH_PY935B = Nothing
...
//						//
//						//                    While (i <= oDS_PH_PY935B.Size - 1)
//						//                        If oDS_PH_PY935B.GetValue("U_FILD01", i) = "" Then
//						//                            oDS_PH_PY935B.RemoveRecord (i)
//						//                            i = 0
//						//                        Else
//						//                            i = i + 1
//						//                        End If
//						//                    Wend
//						//
//						//                    For i = 0 To oDS_PH_PY935B.Size
//						//                        Call oDS_PH_PY935B.setValue("U_LineNum", i, i + 1)
//						//                    Next i
//						//
//						//                    oMat1.LoadFromDataSource
//						//End If
...
//		public void PH_PY935_AddMatrixRow()
//		{
//			int oRow = 0;
...
//			//        If Trim(oDS_PH_PY935B.GetValue("U_FILD01", oRow - 1)) <> "" Then
//			//            If oDS_PH_PY935B.Size <= oMat1.VisualRowCount Then
//			//                oDS_PH_PY935B.InsertRecord (oRow)
//			//            End If
//			//            oDS_PH_PY935B.Offset = oRow
//			//            oDS_PH_PY935B.setValue "U_LineNum", oRow, oRow + 1
//			//            oDS_PH_PY935B.setValue "U_FILD01", oRow, ""
//			//            oDS_PH_PY935B.setValue "U_FILD02", oRow, ""
//			//            oDS_PH_PY935B.setValue "U_FILD03", oRow, 0
//			//            oMat1.LoadFromDataSource
//			//        Else
//			//            oDS_PH_PY935B.Offset = oRow - 1
//			//            oDS_PH_PY935B.setValue "U_LineNum", oRow - 1, oRow
//			//            oDS_PH_PY935B.setValue "U_FILD01", oRow - 1, ""
//			//            oDS_PH_PY935B.setValue "U_FILD02", oRow - 1, ""
//			//            oDS_PH_PY935B.setValue "U_FILD03", oRow - 1, 0
//			//            oMat1.LoadFromDataSource
//			//        End If
...
//			oForm.Freeze(false);
//			return;
//			PH_PY935_AddMatrixRow_Error:
//			oForm.Freeze(false);
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY935_AddMatrixRow_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		public void PH_PY935_FormClear()
//		{
//			 // ERROR: Not supported in C#: OnErrorStatement

//			string DocEntry = null;
//			//UPGRADE_WARNING: MDC_GetData.Get_ReData() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			DocEntry = MDC_GetData.Get_ReData(ref "AutoKey", ref "ObjectCode", ref "ONNM", ref "'PH_PY935'", ref "");
...
//			}
//			return;
//			PH_PY935_FormClear_Error:
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY935_FormClear_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//		}

//		public bool PH_PY935_DataValidCheck()
//		{
//			bool functionReturnValue = false;
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			//    '//필수 체크
//			//    '//----------------------------------------------------------------------------------
//			//    If Trim(oDS_PH_PY935A.GetValue("Code", 0)) = "" Then
//			//        Sbo_Application.SetStatusBarMessage "사원번호는 필수입니다.", bmt_Short, True
//			//        oForm.Items("Code").CLICK ct_Regular
//			//        PH_PY935_DataValidCheck = False
//			//        Exit Function
//			//    End If
//			//
//			//    oMat1.FlushToDataSource
//			//    '// Matrix 마지막 행 삭제(DB 저장시)
//			//    If oDS_PH_PY935B.Size > 1 Then oDS_PH_PY935B.RemoveRecord (oDS_PH_PY935B.Size - 1)
//			//    oMat1.LoadFromDataSource
...
//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			PH_PY935_DataValidCheck_Error:


//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			functionReturnValue = false;
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY935_DataValidCheck_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}


//		public bool PH_PY935_Validate(string ValidateType)
//		{
//			bool functionReturnValue = false;
//			 // ERROR: Not supported in C#: OnErrorStatement
...
//			//UPGRADE_WARNING: oForm.Items().Specific.VALUE 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			//UPGRADE_WARNING: MDC_Company_Common.GetValue(SELECT Canceled FROM [PH_PY935A] WHERE DocEntry = ' & oForm.Items(DocEntry).Specific.VALUE & ', 0, 1) 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			if (MDC_Company_Common.GetValue("SELECT Canceled FROM [@PH_PY935A] WHERE DocEntry = '" + oForm.Items.Item("DocEntry").Specific.VALUE + "'", 0, 1) == "Y") {
...
//			oRecordSet = null;
//			return functionReturnValue;
//			PH_PY935_Validate_Exit:
//			//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//			oRecordSet = null;
//			return functionReturnValue;
//			PH_PY935_Validate_Error:
//			functionReturnValue = false;
//			MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY935_Validate_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			return functionReturnValue;
//		}
...
//				goto PH_PY935_Print_Report01_Error;
//			}
...
//			/// Procedure 실행"
//			sQry = "EXEC [PH_PY935_01] '" + CLTCOD + "', '" + YM + "', '" + JIGTYP + "'";
...
//				//UPGRADE_NOTE: oRecordSet 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//				oRecordSet = null;
//				MDC_Globals.Sbo_Application.SetStatusBarMessage("PH_PY935_Print_Report01_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
//			}
