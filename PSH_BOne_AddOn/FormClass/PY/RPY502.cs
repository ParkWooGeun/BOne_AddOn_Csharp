...
//{
//	[System.Runtime.InteropServices.ProgId("RPY502_NET.RPY502")]
//	public class RPY502
//	{
...
//			/// 조회조건문 /
//			sQry = "Exec RPY502 " + "'" + Strings.Trim(JSNYER) + "', '" + Strings.Trim(CLTCOD) + "', " + "'" + Strings.Trim(MSTDPT) + "', '" + Strings.Trim(MSTCOD) + "'";
...
//			} else if (ErrNum == 1) {
//				MDC_Globals.Sbo_Application.StatusBar.SetText("자사 코드를 확인하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//			} else {
...
//			oXmlDoc.load(MDC_Globals.SP_Path + "\\" + MDC_Globals.SP_Screen + "\\RPY502.srf");
...
//			oFormUniqueID = "RPY502_" + GetTotalFormsCount();
...
//			//ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
//			SubMain.AddForms(this, oFormUniqueID, "RPY502");
