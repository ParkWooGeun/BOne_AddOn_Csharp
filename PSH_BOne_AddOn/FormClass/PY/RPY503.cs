...
//{
//	[System.Runtime.InteropServices.ProgId("RPY503_NET.RPY503")]
//	public class RPY503
//	{
...
//			WinTitle = "근로소득원천징수부";
//			if (JSNYER >= "2010") {
//				ReportName = "RPY503(2010).rpt";
//			} else {
//				ReportName = "RPY503.rpt";
//			}
...
//			MDC_Globals.gRpt_Formula_Value[2] = JSNYER;

//			WinTitle = "[RPY503] : " + WinTitle;
...
//			/// 조회조건문 /
//			sQry = "Exec RPY503 " + "'" + Strings.Trim(JSNYER) + "', '" + Strings.Trim(STRMON) + "', " + "'" + Strings.Trim(ENDMON) + "', '" + Strings.Trim(JOBGBN) + "', " + "'" + Strings.Trim(CLTCOD) + "','" + Strings.Trim(MSTDPT) + "', " + "'" + Strings.Trim(MSTCOD) + "'";
...
//			oRecordSet = null;
//			if (ErrNum == 1) {
//				MDC_Globals.Sbo_Application.StatusBar.SetText("기준 연월을 확인하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//			} else if (ErrNum == 2) {
...
//			} else if (ErrNum == 3) {
//				MDC_Globals.Sbo_Application.StatusBar.SetText("자사 코드를 선택하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//			} else {
...
//			oXmlDoc.load(MDC_Globals.SP_Path + "\\" + MDC_Globals.SP_Screen + "\\RPY503.srf");
...
//			oFormUniqueID = "RPY503_" + GetTotalFormsCount();
...
//			//ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
//			SubMain.AddForms(this, oFormUniqueID, "RPY503");
