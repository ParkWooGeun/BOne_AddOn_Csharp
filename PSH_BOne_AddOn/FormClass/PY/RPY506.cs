...
//{
//	[System.Runtime.InteropServices.ProgId("RPY506_NET.RPY506")]
//	public class RPY506
//	{
...
//			MDC_Globals.gRpt_Formula[1] = "JSNYER";
//			MDC_Globals.gRpt_Formula_Value[1] = JSNYER;
...
//			/// 조회조건문 /
//			sQry = "Exec RPY506 " + "'" + Strings.Trim(JSNYER) + "', '" + Strings.Trim(STRMON) + "', " + "'" + Strings.Trim(ENDMON) + "', '" + Strings.Trim(JOBGBN) + "', " + "'" + Strings.Trim(CLTCOD) + "', " + "'" + Strings.Trim(MSTDPT) + "', '" + Strings.Trim(MSTCOD) + "'";

//			/// Action /
//			if (MDC_SetMod.gCryReport_Action(WinTitle, ReportName, "N", sQry, Convert.ToString(1), "Y", "V", "", Convert.ToInt32(Strings.Trim(PRTGBN))) == false) {
...
//			oXmlDoc.load(MDC_Globals.SP_Path + "\\" + MDC_Globals.SP_Screen + "\\RPY506.srf");
...
//			//ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
//			SubMain.AddForms(this, oFormUniqueID, "RPY506");
...
//			oForm.DataSources.UserDataSources.Add("PRTGBN", SAPbouiCOM.BoDataType.dt_SHORT_TEXT, 1);
...
//			//// 출력구분
//			oCombo = oForm.Items.Item("PRTGBN").Specific;
//			oCombo.ValidValues.Add("1", "정산징수환급대장(세로)");
//			oCombo.ValidValues.Add("2", "정산징수환급대장(가로)");
//			oForm.DataSources.UserDataSources.Item("PRTGBN").ValueEx = "1";
//			///
