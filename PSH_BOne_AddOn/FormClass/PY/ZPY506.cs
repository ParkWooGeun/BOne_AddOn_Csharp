...
//{
//	[System.Runtime.InteropServices.ProgId("ZPY506_NET.ZPY506")]
//	public class ZPY506
//	{
...
//			//시스템코드 헤더
//		private SAPbouiCOM.DBDataSource oDS_ZPY506H;
//			//시스템코드 라인
//		private SAPbouiCOM.DBDataSource oDS_ZPY506L;
...
//				//UPGRADE_WARNING: MDC_SetMod.Get_ReData(U_ENDCHK, U_JOBYER, [ZPY509L], ' & oDS_ZPY506H.GetValue(U_JSNYER, 0) & ',  AND Code = ' & oDS_ZPY506H.GetValue(U_CLTCOD, 0) & ') 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//				if (MDC_SetMod.Get_ReData(ref "U_ENDCHK", ref "U_JOBYER", ref "[@ZPY509L]", ref "'" + oDS_ZPY506H.GetValue("U_JSNYER", 0) + "'", ref " AND Code = '" + oDS_ZPY506H.GetValue("U_CLTCOD", 0) + "'") == "Y") {
...
//				oDS_ZPY506H.SetValue("U_JSNYER", 0, JSNYER);
//				oDS_ZPY506H.SetValue("U_MSTCOD", 0, MSTCOD);
//				oDS_ZPY506H.SetValue("U_CLTCOD", 0, CLTCOD);
...
//			DocNum = MDC_SetMod.Get_ReData(ref "AutoKey", ref "ObjectCode", ref "ONNM", ref "'ZPY506'", ref "");
...
//			oRecordSet.DoQuery(sQry);
//			if (oRecordSet.RecordCount > 0) {
//				oDS_ZPY506L.SetValue("U_INTGBN", sRow, oRecordSet.Fields.Item("INTGBN").Value);
//				oDS_ZPY506L.SetValue("U_PERNBR", sRow, oRecordSet.Fields.Item("PERNBR").Value);
//				oDS_ZPY506L.SetValue("U_GWANGE", sRow, oRecordSet.Fields.Item("GWANGE").Value);
//			}
...
//					} else {
//						oDS_ZPY506H.SetValue("U_JSNYER", 0, MDC_Globals.ZPAY_GBL_JSNYER.Value);
//					}
...
//					} else {
//						//UPGRADE_WARNING: oForm.Items().Specific.String 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//						oDS_ZPY506H.SetValue("U_MSTCOD", 0, Strings.UCase(oForm.Items.Item(oUID).Specific.String));
//						//UPGRADE_WARNING: oForm.Items().Specific.String 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//						//UPGRADE_WARNING: oMast 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
...
//						TOTCNT = TOTCNT + Conversion.Val(oDS_ZPY506L.GetValue("U_MEDCNT", i - 1));
//						TOTAMT = TOTAMT + Conversion.Val(oDS_ZPY506L.GetValue("U_MEDAMT", i - 1));
//					}

//					oDS_ZPY506H.SetValue("U_TOTCNT", 0, Convert.ToString(TOTCNT));
//					oDS_ZPY506H.SetValue("U_TOTAMT", 0, Convert.ToString(TOTAMT));
...
//					oDS_ZPY506L.SetValue("U_FAMNAM", oRow - 1, oMat1.Columns.Item(oUID).Cells.Item(oRow).Specific.Value);
...
//				oMat1.FlushToDataSource();
//				if (oRow == oMat1.RowCount & Conversion.Val(oDS_ZPY506L.GetValue("U_MEDAMT", oRow - 1)) != 0) {
//					Matrix_AddRow(oRow);
//					oMat1.Columns.Item("Col4").Cells.Item(oRow).Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//				}
//			}
//		}
...
//			/// 헤더부분 체크
//			switch (true) {
//				case Strings.Len(Strings.Trim(oDS_ZPY506H.GetValue("U_JSNYER", 0))) != 4:
//					ErrNum = 8;
//					goto Error_Message;
//					break;
//				case string.IsNullOrEmpty(oDS_ZPY506H.GetValue("U_MSTCOD", 0)):
//					ErrNum = 5;
//					goto Error_Message;
//					break;
//				case string.IsNullOrEmpty(oDS_ZPY506H.GetValue("U_CLTCOD", 0)):
//					ErrNum = 12;
//					goto Error_Message;
//					break;
...
//			/// 주민번호체크유무
//			//UPGRADE_WARNING: MDC_SetMod.Get_ReData() 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//			GovidChk = MDC_SetMod.Get_ReData(ref "ISNULL(T0.U_GovIDChk,'N')", ref "T1.U_MSTCOD", ref "[@PH_PY005A] T0 INNER JOIN [@PH_PY001A] T1 ON T0.CODE = T1.U_CLTCOD", ref "'" + Strings.Trim(oDS_ZPY506H.GetValue("U_MSTCOD", 0)) + "'", ref "");
...
//				//// 의료비기관명은 생략가능함.
//				///
//				if (Strings.Trim(oDS_ZPY506L.GetValue("U_MEDCOD", iRow)) != "1" & string.IsNullOrEmpty(Strings.Trim(oDS_ZPY506L.GetValue("U_MEDNBR", iRow)))) {
//					ErrNum = 6;
//					oMat1.Columns.Item("Col1").Cells.Item(iRow + 1).Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//					goto Error_Message;
//				} else if (Strings.Trim(oDS_ZPY506L.GetValue("U_MEDCOD", iRow)) != "1" & Conversion.Val(oDS_ZPY506L.GetValue("U_MEDCNT", iRow)) + Conversion.Val(oDS_ZPY506L.GetValue("U_MEDCNT2", iRow)) == 0) {
//					ErrNum = 4;
//					oMat1.Columns.Item("Col3").Cells.Item(iRow + 1).Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//					goto Error_Message;
//				} else if (Conversion.Val(oDS_ZPY506L.GetValue("U_MEDAMT", iRow)) + Conversion.Val(oDS_ZPY506L.GetValue("U_MEDAMT2", iRow)) == 0) {
//					ErrNum = 5;
//					oMat1.Columns.Item("Col4").Cells.Item(iRow + 1).Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//					goto Error_Message;
//				} else if (string.IsNullOrEmpty(Strings.Trim(oDS_ZPY506L.GetValue("U_PERNBR", iRow)))) {
//					ErrNum = 7;
//					oMat1.Columns.Item("Col6").Cells.Item(iRow + 1).Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//					goto Error_Message;
//				/// 해당여부
//				} else if (string.IsNullOrEmpty(Strings.Trim(oDS_ZPY506L.GetValue("U_DAECHK", iRow)))) {
//					ErrNum = 10;
//					oMat1.Columns.Item("Col6").Cells.Item(iRow + 1).Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//					goto Error_Message;
//				} else {
//					//// 6.주민번호 오류 체크
//					if (Strings.Trim(GovidChk) == "Y" & Strings.Len(oDS_ZPY506L.GetValue("U_PERNBR", iRow)) > 0) {
//						if (MDC_Com.GovIDCheck(ref oDS_ZPY506L.GetValue("U_PERNBR", iRow)) == false) {
//							ErrNum = 11;
//							oMat1.Columns.Item("Col6").Cells.Item(iRow + 1).Click(SAPbouiCOM.BoCellClickType.ct_Regular);
//							goto Error_Message;
//						}
...
//			//ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
//			oDS_ZPY506L.RemoveRecord(oDS_ZPY506L.Size - 1);
//			//// Mat1에 마지막라인(빈라인) 삭제
...
//			} else if (ErrNum == 2) {
//				MDC_Globals.Sbo_Application.StatusBar.SetText("지급처상호는 필수입니다. 입력하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//			} else if (ErrNum == 3) {
//				MDC_Globals.Sbo_Application.StatusBar.SetText("의료비대상자의 지급처가 중복입력되었습니다. 대상자의 지급처별 집계하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//			} else if (ErrNum == 4) {
//				MDC_Globals.Sbo_Application.StatusBar.SetText("지급건수가 0건입니다. 확인하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//			} else if (ErrNum == 5) {
...
//			} else if (ErrNum == 6) {
//				MDC_Globals.Sbo_Application.StatusBar.SetText("지급처사업자번호는 필수입니다. 입력하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//			} else if (ErrNum == 7) {
//				MDC_Globals.Sbo_Application.StatusBar.SetText("의료비지급대상자의 주민등록번호는 필수입니다. 입력하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//			} else if (ErrNum == 8) {
...
//			} else if (ErrNum == 9) {
//				MDC_Globals.Sbo_Application.StatusBar.SetText("관계코드는 필수입니다. 선택하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//			} else if (ErrNum == 10) {
//				MDC_Globals.Sbo_Application.StatusBar.SetText("해당여부는 필수입니다. 선택하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//			} else if (ErrNum == 11) {
...
//									//UPGRADE_WARNING: oForm.Items().Specific.String 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//									if (MDC_SetMod.Value_ChkYn(ref "[@ZPY506H]", ref "U_JSNYER", ref "'" + oForm.Items.Item("JSNYER").Specific.String + "'", ref " AND U_MSTCOD = '" + oForm.Items.Item("MSTCOD").Specific.String + "'") == false) {
...
//									}
//								}
//								if (Strings.Trim(oDS_ZPY506H.GetValue("U_ENDCHK", 0)) == "Y" & Strings.Trim(oOLDCHK) == "Y") {
...
//					} else if (pval.BeforeAction == false & pval.ItemChanged == true & pval.ItemUID == "Mat1" & (pval.ColUID == "Col3" | pval.ColUID == "Col4" | pval.ColUID == "Col1" | pval.ColUID == "Col2" | pval.ColUID == "Col11")) {
...
//							/// 사업자번호 체크
//							//UPGRADE_WARNING: oMat1.Columns().Cells().Specific.String 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//							if (!string.IsNullOrEmpty(Strings.Trim(oMat1.Columns.Item(pval.ColUID).Cells.Item(pval.Row).Specific.String)) & Strings.Len(oMat1.Columns.Item(pval.ColUID).Cells.Item(pval.Row).Specific.String) <= 12) {
//								//UPGRADE_WARNING: oMat1.Columns().Cells().Specific.String 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
...
//							}
//						}
//					} else if (pval.BeforeAction == true & pval.ColUID == "Col6" & pval.CharPressed == 9) {
//						//UPGRADE_WARNING: oMat1.Columns().Cells().Specific.String 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//						if (string.IsNullOrEmpty(Strings.Trim(oMat1.Columns.Item(pval.ColUID).Cells.Item(pval.Row).Specific.String))) {
//							MDC_Globals.Sbo_Application.StatusBar.SetText("대상자 주민등록번호는 필수입니다. 입력하세요.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//							BubbleEvent = false;
//						} else {
//							/// 주민등록번호 체크
//							//UPGRADE_WARNING: oMat1.Columns().Cells().Specific.String 개체의 기본 속성을 확인할 수 없습니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
//							if (MDC_Com.GovIDCheck(ref oMat1.Columns.Item(pval.ColUID).Cells.Item(pval.Row).Specific.String) == false) {
//								MDC_Globals.Sbo_Application.StatusBar.SetText("주민등록번호가 틀립니다. 확인하세요.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//								BubbleEvent = false;
//							}
//						}
//					}
...
//						oForm = null;
//						//UPGRADE_NOTE: oDS_ZPY506H 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//						oDS_ZPY506H = null;
//						//UPGRADE_NOTE: oDS_ZPY506L 개체는 가비지가 수집되어야 소멸됩니다. 자세한 내용은 다음을 참조하십시오. 'ms-help://MS.VSExpressCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
//						oDS_ZPY506L = null;
...
//			oDS_ZPY506L.SetValue("U_LineNum", oRow, Convert.ToString(oRow + 1));
...
//					case "1283":
//						/// 제거
//						if (Strings.Trim(oDS_ZPY506H.GetValue("U_ENDCHK", 0)) == "Y") {
//							MDC_Globals.Sbo_Application.StatusBar.SetText("잠금 자료입니다. 확인하여 주십시오.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
//							BubbleEvent = false;
//							return;
//						} else {
...
//					case "1290":
//					case "1291":
//						MDC_SetMod.AuthorityCheck(ref oForm, ref "CLTCOD", ref "@ZPY506H", ref "DocNum");
//						////접속자 권한에 따른 사업장 보기
//						break;
...
//			oXmlDoc.load(MDC_Globals.SP_Path + "\\" + MDC_Globals.SP_Screen + "\\ZPY506.srf");
...
//			//ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
//			SubMain.AddForms(this, oFormUniqueID, "ZPY506");
...
//			////디비데이터 소스 개체 할당
//			oDS_ZPY506H = oForm.DataSources.DBDataSources("@ZPY506H");
//			oDS_ZPY506L = oForm.DataSources.DBDataSources("@ZPY506L");
...
//			//// 증빙코드
//			oColumn = oMat1.Columns.Item("Col12");
...
//			oMat1.Columns.Item("Col9").Visible = false;
