...
namespace PSH_BOne_AddOn
{
	...
	/// 고개불만관리대장
	/// </summary>
	internal class PS_QM012 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_QM012.srf");
				...
				oFormUniqueID = "PS_QM012_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_QM012");
				...
				oForm.Freeze(true);
				PS_QM012_CreateItems();
				PS_QM012_ComboBox_Setting();
		...
		/// PS_QM012_CreateItems
		/// </summary>
		private void PS_QM012_CreateItems()
		{
			try
			{
		...
		/// PS_QM012_ComboBox_Setting
		/// </summary>
		private void PS_QM012_ComboBox_Setting()
		{
			string sQry;
		...
		/// <summary>
		/// PS_QM012_FlushToItemValue
		/// </summary>
		/// <param name="oUID"></param>
		private void PS_QM012_FlushToItemValue(string oUID)
		{
			string sQry;
			SAPbobsCOM.Recordset oRecordSet = PSH_Globals.oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset);
		...
		/// </summary>
		[STAThread]
		private void PS_QM012_Print_Query()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				WinTitle = "고개불만관리대장[PS_QM012_01]";
				ReportName = "PS_QM012_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_QM012_Print_Query);
		...
		private void Raise_EVENT_VALIDATE(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				...
				if (pVal.Before_Action == true)
				{
					if (pVal.ItemUID == "ItmBsort")
					{
						PS_QM012_FlushToItemValue(pVal.ItemUID);
					}
				}
