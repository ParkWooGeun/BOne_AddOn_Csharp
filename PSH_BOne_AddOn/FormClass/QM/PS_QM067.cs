...
namespace PSH_BOne_AddOn
{
	...
	/// KPI일자별납기준수현황
	/// </summary>
	internal class PS_QM067 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_QM067.srf");
				...
				oFormUniqueID = "PS_QM067_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_QM067");
				...
				PS_QM067_CreateItems();
				PS_QM067_ComboBox_Setting();
			}
			catch (Exception ex)
			{
		...
		/// PS_QM067_CreateItems
		/// </summary>
		private void PS_QM067_CreateItems()
		{
			try
			{
		...
		/// PS_QM067_ComboBox_Setting
		/// </summary>
		private void PS_QM067_ComboBox_Setting()
		{
		...
		private void PS_QM067_MTX01()
		{
			...
			try
			{
				...
				sQry = "EXEC PS_QM067_01 '" + Param01 + "','" + Param02 + "','" + Param03 + "'";
