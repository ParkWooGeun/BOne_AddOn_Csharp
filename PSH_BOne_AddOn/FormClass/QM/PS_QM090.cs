...
namespace PSH_BOne_AddOn
{
	...
	/// 제품별불량현황
	/// </summary>
	internal class PS_QM090 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_QM090.srf");
				...
				oFormUniqueID = "PS_QM090_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_QM090");
				...
				oForm.Freeze(true);
				PS_QM090_CreateItems();
				PS_QM090_ComboBox_Setting();
		...
		/// PS_QM090_CreateItems
		/// </summary>
		private void PS_QM090_CreateItems()
		{
			try
			{
		...
		/// PS_QM090_ComboBox_Setting
		/// </summary>
		private void PS_QM090_ComboBox_Setting()
		{
			string sQry;
		...
		/// <summary>
		/// PS_QM090_FlushToItemValue
		/// </summary>
		/// <param name="oUID"></param>
		private void PS_QM090_FlushToItemValue(string oUID)
		{
			string sQry;
			SAPbobsCOM.Recordset oRecordSet = PSH_Globals.oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset);
		...
		/// <summary>
		/// PS_QM090_Print_Query
		/// </summary>
		[STAThread]
		private void PS_QM090_Print_Query()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				WinTitle = "제품별불량현황[PS_QM090_01]";
				ReportName = "PS_QM090_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_QM090_Print_Query);
		...
		private void Raise_EVENT_VALIDATE(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.Before_Action == true)
				{
					if (pVal.ItemUID == "ItmBsort")
					{
						PS_QM090_FlushToItemValue(pVal.ItemUID);
					}
				}
				else if (pVal.Before_Action == false)
				{
