...
namespace PSH_BOne_AddOn
{
	...
	/// MG생산불량실패비용
	/// </summary>
	internal class PS_QM120 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_QM120.srf");
				...
				oFormUniqueID = "PS_QM120_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_QM120");
				...
				oForm.Freeze(true);
				PS_QM120_CreateItems();
				PS_QM120_ComboBox_Setting();
		...
		/// PS_QM120_CreateItems
		/// </summary>
		private void PS_QM120_CreateItems()
		{
			try
			{
		...
		/// PS_QM120_ComboBox_Setting
		/// </summary>
		private void PS_QM120_ComboBox_Setting()
		{
			string sQry;
		...
		/// <summary>
		/// PS_QM120_Print_Query
		/// </summary>
		[STAThread]
		private void PS_QM120_Print_Query()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				WinTitle = "[PS_QM120_01] MG생산불량실패비용";
				ReportName = "PS_QM120_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_QM120_Print_Query);
