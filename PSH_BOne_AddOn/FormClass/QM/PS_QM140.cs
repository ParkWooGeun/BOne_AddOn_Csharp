...
namespace PSH_BOne_AddOn
{
	...
	/// 품질실패비용현황
	/// </summary>
	internal class PS_QM140 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_QM140.srf");
				...
				oFormUniqueID = "PS_QM140_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_QM140");
				...
				oForm.Freeze(true);
				PS_QM140_CreateItems();
				PS_QM140_ComboBox_Setting();
		...
		/// PS_QM140_CreateItems
		/// </summary>
		private void PS_QM140_CreateItems()
		{
			try
			{
		...
		/// PS_QM140_ComboBox_Setting
		/// </summary>
		private void PS_QM140_ComboBox_Setting()
		{
			string sQry;
		...
		/// <summary>
		/// PS_QM140_Print_Query
		/// </summary>
		[STAThread]
		private void PS_QM140_Print_Query()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				WinTitle = "[PS_QM140_01] 품질실패비용현황";
				ReportName = "PS_QM140_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_QM140_Print_Query);
