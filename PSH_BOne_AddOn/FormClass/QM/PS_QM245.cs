...
namespace PSH_BOne_AddOn
{
	...
	/// 방산절단품입출고현황
	/// </summary>
	internal class PS_QM245 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_QM245.srf");
				...
				oFormUniqueID = "PS_QM245_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_QM245");
		...
		/// PS_QM245_CreateItems
		/// </summary>
		private void PS_QM245_CreateItems()
		{
			try
			{
		...
		/// <summary>
		/// PS_QM245_FlushToItemValue
		/// </summary>
		/// <param name="oUID"></param>
		private void PS_QM245_FlushToItemValue(string oUID)
		{
			string sQry;
		...
		/// <summary>
		/// PS_QM245_Print_Query
		/// </summary>
		[STAThread]
		private void PS_QM245_Print_Query()
		{
			string WinTitle;
			string ReportName;
			string DocDateFr;
			...
			try
			{
				...
				WinTitle = "[PS_QM245_01] 방산절단품입출고현황";
				ReportName = "PS_QM245_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_QM245_Print_Query);
		...
		private void Raise_EVENT_VALIDATE(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				...
				if (pVal.Before_Action == true)
				{
					...
					{
						PS_QM245_FlushToItemValue(pVal.ItemUID);
					}
				}
