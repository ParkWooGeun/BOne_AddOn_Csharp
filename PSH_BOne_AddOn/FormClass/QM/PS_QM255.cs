...
namespace PSH_BOne_AddOn
{
	...
	/// 방산소재입고현황
	/// </summary>
	internal class PS_QM255 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_QM255.srf");
				...
				oFormUniqueID = "PS_QM255_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_QM255");
		...
		/// PS_QM255_CreateItems
		/// </summary>
		private void PS_QM255_CreateItems()
		{
			try
			{
		...
		/// <summary>
		/// PS_QM255_Print_Query
		/// </summary>
		[STAThread]
		private void PS_QM255_Print_Query()
		{
			string WinTitle;
			string ReportName;
			string DocDateFr;
			...
			try
			{
				...
				WinTitle = "[PS_QM255_01] 방산소재입고현황";
				ReportName = "PS_QM255_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_QM255_Print_Query);
