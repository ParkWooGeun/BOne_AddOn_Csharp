...
namespace PSH_BOne_AddOn
{
	...
	/// 방산부품불량현황
	/// </summary>
	internal class PS_QM270 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_QM270.srf");
				...
				oFormUniqueID = "PS_QM270_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_QM270");
				...
				oForm.Freeze(true);
				PS_QM270_CreateItems();
				PS_QM270_ComboBox_Setting();
		...
		/// PS_QM270_CreateItems
		/// </summary>
		private void PS_QM270_CreateItems()
		{
			try
			{
		...
		/// PS_QM270_ComboBox_Setting
		/// </summary>
		private void PS_QM270_ComboBox_Setting()
		{
			string sQry;
		...
		/// <summary>
		/// PS_QM255_PS_QM270_Print_Query
		/// </summary>
		[STAThread]
		private void PS_QM270_Print_Query()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				WinTitle = "[PS_QM270_01] 방산부품불량현황";
				ReportName = "PS_QM270_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_QM270_Print_Query);
