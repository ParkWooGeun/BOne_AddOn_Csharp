...
namespace PSH_BOne_AddOn
{
	...
	/// M/G원소재수입검사현황
	/// </summary>
	internal class PS_QM310 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_QM310.srf");
				...
				oFormUniqueID = "PS_QM310_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_QM310");
		...
		/// PS_QM310_CreateItems
		/// </summary>
		private void PS_QM310_CreateItems()
		{
			try
			{
		...
		/// </summary>
		[STAThread]
		private void PS_QM310_Print_Query()
		{
			string WinTitle;
			string ReportName;
			string DocDateFr;
			...
			try
			{
				...
				WinTitle = "[PS_QM310_01] M/G원소재수입검사현황";
				ReportName = "PS_QM310_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_QM310_Print_Query);
