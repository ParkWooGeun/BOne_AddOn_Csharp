...
namespace PSH_BOne_AddOn
{
	...
	/// 금속분말품질지표
	/// </summary>
	internal class PS_QM460 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_QM460.srf");
				...
				oFormUniqueID = "PS_QM460_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_QM460");
		...
		/// PS_QM460_CreateItems
		/// </summary>
		private void PS_QM460_CreateItems()
		{
			try
			{
				...
				oForm.DataSources.UserDataSources.Item("FromDate").Value = DateTime.Now.ToString("yyyyMM") + "01";
		...
		/// <summary>
		/// PS_QM460_Print_Query
		/// </summary>
		[STAThread]
		private void PS_QM460_Print_Query()
		{
			string WinTitle;
			string ReportName;
			string FromDate;
			...
			try
			{
				...
				WinTitle = "[PS_QM460] 금속분말품질지표";
				ReportName = "PS_QM460_01.RPT";
				...
				// Formula 수식필드
				dataPackFormula.Add(new PSH_DataPackClass("@FrDate", FromDate.Substring(0, 4) + "-" + FromDate.Substring(4, 2) + "-" + FromDate.Substring(6, 2)));
				...
				//SubReport Parameter
				dataPackSubReportParameter.Add(new PSH_DataPackClass("@FromDate", FromDate, "PS_QM460_SUB1"));
				dataPackSubReportParameter.Add(new PSH_DataPackClass("@ToDate", ToDate, "PS_QM460_SUB1"));
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_QM460_Print_Query);
