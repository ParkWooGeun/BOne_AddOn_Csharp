...
namespace PSH_BOne_AddOn
{
	...
	/// 분말제품검사사양서출력
	/// </summary>
	internal class PS_QM470 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_QM470.srf");
				...
				oFormUniqueID = "PS_QM470_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_QM470");
		...
		/// PS_QM470_ComboBox_Setting
		/// </summary>
		private void PS_QM470_ComboBox_Setting()
		{
			string sQry;
		...
		/// <summary>
		/// PS_QM470_FlushToItemValue
		/// </summary>
		/// <param name="oUID"></param>
		private void PS_QM470_FlushToItemValue(string oUID)
		{
			string sQry;
			SAPbobsCOM.Recordset oRecordSet = PSH_Globals.oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset);
		...
		/// <summary>
		/// PS_QM470_Print_Query
		/// </summary>
		[STAThread]
		private void PS_QM470_Print_Query()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				WinTitle = "[PS_QM470_01] 분말제품검사사양서출력";
				ReportName = "PS_QM470_01.RPT";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						System.Threading.Thread thread = new System.Threading.Thread(PS_QM470_Print_Query);
		...
		private void Raise_EVENT_VALIDATE(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				...
				if (pVal.Before_Action == true)
				{
					...
					{
						PS_QM470_FlushToItemValue(pVal.ItemUID);
					}
				}
