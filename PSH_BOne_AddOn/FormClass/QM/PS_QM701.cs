...
namespace PSH_BOne_AddOn
{
    ...
    internal class PS_QM701 : PSH_BaseClass
    {
        ...
        /// PS_QM701_etBaseForm
        /// </summary>
        private void PS_QM701_SaveAttach()
        {
            ...
            try
            {
                sFileFullPath = PS_QM701_OpenFileSelectDialog();//OpenFileDialog를 쓰레드로 실행
                ...
                oDS_PS_QM701H.SetValue("U_Comments", 0, SaveFolders + "\\" + sFileName); //첨부파일 경로 등록
        ...
        /// </summary>
        [STAThread]
        private string PS_QM701_OpenFileSelectDialog()
        {
            string returnFileName = string.Empty;
        ...
        /// PS_QM701_etBaseForm
        /// </summary>
        private void PS_QM701_OpenAttach()
        {
            string AttachPath;
            string errMessage = string.Empty;
            ...
            try
            {
                AttachPath = oDS_PS_QM701H.GetValue("U_Comments", 0).ToString().Trim();
