...
namespace PSH_BOne_AddOn
{
    ...
    internal class PS_QM704 : PSH_BaseClass
    {
        ...
        private SAPbouiCOM.DataTable oDS_PS_QM704A;
        ...
        private void PS_QM704_CreateItems()
        {
            try
            {
                ...
                oForm.DataSources.DataTables.Add("PS_QM704A");
                oGrid01.DataTable = oForm.DataSources.DataTables.Item("PS_QM704A");
                oDS_PS_QM704A = oForm.DataSources.DataTables.Item("PS_QM704A");
        ...
        private void PS_QM704_MTX01()
        {
            ...
            try
            {
                ...
                Query01 = "EXEC PS_QM704_01 '" + BPLId + "','" + DocDateFr + "','" + DocDateTo + "'";
                oGrid01.DataTable.Clear();

                oDS_PS_QM704A.ExecuteQuery(Query01);
        ...
        private void Raise_EVENT_FORM_UNLOAD(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
        {
            try
            {
                ...
                else if (pVal.Before_Action == false)
                {
                    ...
                    System.Runtime.InteropServices.Marshal.ReleaseComObject(oDS_PS_QM704A);
                }
            }
            catch (Exception ex)
            {
