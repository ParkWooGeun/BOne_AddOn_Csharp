...
namespace PSH_BOne_AddOn
{
	...
	/// 검사일자조회
	/// </summary>
	internal class PS_QM800 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_QM800.srf");
				...
				oFormUniqueID = "PS_QM800_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_QM800");
				...
				oForm.Freeze(true);
				PS_QM800_CreateItems();
				PS_QM800_ComboBox_Setting();

				// 시작일자 포커스
				oForm.Items.Item("DocDatefr").Click();
			}
			catch (Exception ex)
			{
		...
		/// PS_QM800_CreateItems
		/// </summary>
		private void PS_QM800_CreateItems()
		{
			try
			{
		...
		/// PS_QM800_ComboBox_Setting
		/// </summary>
		private void PS_QM800_ComboBox_Setting()
		{
		...
		private void PS_QM800_MTX01()
		{
			...
			try
			{
				...
				Param04 = oForm.Items.Item("Gubun").Specific.Selected.Value.ToString().Trim();
				Param05 = oForm.Items.Item("ItmBsort").Specific.Value.ToString().Trim();

				sQry = "EXEC PS_QM800_01 '" + Param01 + "','" + Param02 + "','" + Param03 + "','" + Param04 + "','" + Param05 + "'";
		...
		/// <summary>
		/// PS_QM800_DataValidCheck
		/// </summary>
		/// <returns></returns>
		private bool PS_QM800_DataValidCheck()
		{
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						if (PS_QM800_DataValidCheck() == false)
						{
							BubbleEvent = false;
							return;
						}
