	...
	internal class PS_SD012 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				...
				oFormUniqueID = "PS_SD012_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_SD012");
		...
		/// PS_SD012_CreateItems
		/// </summary>
		private void PS_SD012_CreateItems()
		{
			try
			{
		...
		/// <summary>
		/// PS_SD012_CheckDataValid
		/// </summary>
		/// <returns></returns>
		private bool PS_SD012_CheckDataValid()
		{
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "BtnPrint")
					{
						...
						{
							if (PS_SD012_CheckDataValid() == false)
							{
								BubbleEvent = false;
								return;
							}
							...
							{
								System.Threading.Thread thread = new System.Threading.Thread(PS_SD012_Print_Report);
