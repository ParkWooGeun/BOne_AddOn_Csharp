...
//		private SAPbouiCOM.DBDataSource oDS_PS_SD022H; //등록헤더
//		private SAPbouiCOM.DBDataSource oDS_PS_SD022L; //등록라인
//		private string oLastItemUID01; //클래스에서 선택한 마지막 아이템 Uid값
//		private string oLastColUID01; //마지막아이템이 메트릭스일경우에 마지막 선택된 Col의 Uid값
//		private int oLastColRow01; //마지막아이템이 메트릭스일경우에 마지막 선택된 Row값

//		public void LoadForm(string oFormDocEntry = "")
//		{
...
//			oFormUniqueID = "PS_SD022_" + GetTotalFormsCount();
//			SubMain.AddForms(this, oFormUniqueID);
//			////폼추가
//			SubMain.Sbo_Application.LoadBatchActions(out (oXmlDoc01.xml));
//			//폼 할당

//			oForm = SubMain.Sbo_Application.Forms.Item(oFormUniqueID);
...
//			PS_SD022_ComboBox_Setting();
//			//    Call PS_SD022_CF_ChooseFromList
//			//    Call PS_SD022_EnableMenus
//			//    Call PS_SD022_SetDocument(oFormDocEntry)
...
////		public void PS_SD022_Add_MatrixRow(int oRow, ref bool RowIserted = false)
////		{
////			 // ERROR: Not supported in C#: OnErrorStatement
...
////			//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////			MDC_Com.MDC_GF_Message(ref "PS_SD022_Add_MatrixRow_Error:" + Err().Number + " - " + Err().Description, ref "E");
////		}
...
////		private bool PS_SD022_CreateItems()
////		{
...
////			//    Set oDS_PS_SD022H = oForm.DataSources.DBDataSources("@PS_SD022H")
////			oDS_PS_SD022L = oForm.DataSources.DBDataSources("@PS_USERDS01");
...
////			oRecordSet01 = null;
////			oForm.Freeze(false);
////			SubMain.Sbo_Application.SetStatusBarMessage("PS_SD022_CreateItems_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
////			return functionReturnValue;
////		}

////		public void PS_SD022_ComboBox_Setting()
////		{
////			 // ERROR: Not supported in C#: OnErrorStatement
...
////			MDC_SetMod.Set_ComboList(ref oCombo, ref "SELECT BPLId, BPLName FROM OBPL order by BPLId", ref "1", ref false, ref false);
...
////			oForm.Freeze(false);
////			SubMain.Sbo_Application.SetStatusBarMessage("PS_SD022_ComboBox_Setting_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
////		}

////		public void PS_SD022_CF_ChooseFromList()
////		{
////			 // ERROR: Not supported in C#: OnErrorStatement
...
////			SubMain.Sbo_Application.SetStatusBarMessage("PS_SD022_CF_ChooseFromList_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
////		}


////		private void PS_SD022_FormResize()
////		{
////			 // ERROR: Not supported in C#: OnErrorStatement
...
////			SubMain.Sbo_Application.SetStatusBarMessage("PS_SD022_FormResize_Error: " + Err().Number + " - " + Err().Description, SAPbouiCOM.BoMessageTime.bmt_Short, true);
////		}
