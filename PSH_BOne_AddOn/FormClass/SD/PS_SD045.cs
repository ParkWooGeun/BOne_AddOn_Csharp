	...
	internal class PS_SD045 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				...
				PS_SD045_CF_ChooseFromList();
				PS_SD045_EnableMenus();
				PS_SD045_SetDocument(oFormDocEntry);
			}
			catch (Exception ex)
			{
        ...
        private void PS_SD045_CreateItems()
        {
            ...
            try
            {
                ...
                //담당자
                oDS_PS_SD045H.SetValue("U_CntcCode", 0, dataHelpClass.User_MSTCOD());
                oDS_PS_SD045H.SetValue("U_CntcName", 0, dataHelpClass.GetValue("SELECT LastName + FirstName FROM [OHEM] WHERE U_MSTCOD = '" + oForm.Items.Item("CntcCode").Specific.Value + "'", 0, 1));
            }
            catch(Exception ex)
            {
                PSH_Globals.SBO_Application.StatusBar.SetText(System.Reflection.MethodBase.GetCurrentMethod().Name + "_Error : " + ex.Message, BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Error);
        ...
        private void PS_SD045_SetComboBox()
        {
            ...
            try
            {
                dataHelpClass.Combo_ValidValues_SetValueItem(oForm.Items.Item("DocType").Specific, "PS_PS_SD045", "DocType", false);
                dataHelpClass.Combo_ValidValues_SetValueItem(oForm.Items.Item("TrType").Specific, "PS_PS_SD045", "TrType", false);
                ...
                dataHelpClass.Combo_ValidValues_SetValueColumn(oMat01.Columns.Item("Status"), "PS_SD045", "Mat01", "Status", false);
                dataHelpClass.Combo_ValidValues_SetValueItem(oForm.Items.Item("ProgStat").Specific, "PS_PS_SD045", "ProgStat", false);
                dataHelpClass.Combo_ValidValues_SetValueColumn(oMat01.Columns.Item("TrType"), "PS_SD045", "Mat01", "TrType", false);
        ...
        /// ChooseFromList 설정
        /// </summary>
        private void PS_SD045_CF_ChooseFromList()
        {
        ...
        /// 메뉴설정
        /// </summary>
        private void PS_SD045_EnableMenus()
        {
            PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
        ...
        /// </summary>
        /// <param name="oFormDocEntry"></param>
        private void PS_SD045_SetDocument(string oFormDocEntry)
        {
            try
            {
        ...
        private void PS_SD045_FormItemEnabled()
        {
            ...
            try
            {
                ...
                if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
                {
                    ...
                    oForm.Items.Item("R3POCopy").Enabled = false;
                ...
                else if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_FIND_MODE)
                {
                    ...
                    oForm.Items.Item("DocDate").Enabled = true;
                    oForm.Items.Item("DueDate").Enabled = true;
                    oForm.Items.Item("POLoad").Enabled = false;
                    oMat01.Columns.Item("SD030Num").Visible = true;
                    oMat01.Columns.Item("PackNo").Visible = true;
                    oMat01.Columns.Item("OrderNum").Visible = true;
                ...
                else if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_OK_MODE)
                {
                    ...
                    else if (oForm.Items.Item("Opt02").Specific.Selected == true)
                    {
                        oForm.Items.Item("Button03").Enabled = false;
                        oForm.Items.Item("PriChange").Enabled = false;
                        if (string.IsNullOrEmpty(oForm.Items.Item("INFCYN").Specific.Value))
                        {
                            oForm.Items.Item("R3POCopy").Enabled = true;
                            oForm.Items.Item("Button04").Enabled = true;
                            oMat01.Columns.Item("R3PONum").Editable = true;
                            oForm.Items.Item("POLoad").Enabled = true;
        ...
        /// DocEntry 초기화
        /// </summary>
        private void PS_SD045_R3POCopy()
        {
            int i;
            ...
            {
                oForm.Freeze(true);
                for(i = 2; i < oMat01.RowCount; i++)
                {
                    oMat01.Columns.Item("R3PONum").Cells.Item(i).Specific.Value = oMat01.Columns.Item("R3PONum").Cells.Item(1).Specific.Value;
                }
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <returns></returns>
        private bool PS_SD045_CheckDataValid()
        {
            ...
            try
            {
                ...
                if (oForm.Items.Item("CardCode").Specific.Value != "12532") //풍산은 체크안함
                {
                    ...
                    {
                        if (PS_SD045_ValidateCreditLine() == false)
                        {
                            errMessage = " ";
                            throw new Exception();
                        }
        ...
        /// </summary>
        /// <returns></returns>
        private bool PS_SD045_ValidateCreditLine()
        {
            bool returnValue = false;
            string query;
            string errMessage = string.Empty;
        ...
        /// PS_PP095_Set_DOList
        /// </summary>
        private bool PS_SD045_R3Set_POList()
        {
            bool returnValue = false;
            string sQry;
            string r3ItemCode;
            ...
            try
            {
                ...
                sQry += " where b.U_batchnum = '" + oDS_PS_SD045L.GetValue("U_CoilNo", 0).ToString().Trim() + "' and a.U_docdate between dateadd(year, -9,'"+ oDS_PS_SD045H.GetValue("U_DocDate", 0)  + "') and '" + oDS_PS_SD045H.GetValue("U_DocDate", 0)  + "'";
                ...
                oFunction.SetValue("I_YYMM", codeHelpClass.Left(oDS_PS_SD045H.GetValue("U_DocDate", 0),6)); //입고일자
                ...
                {
                    sQry = "DELETE from Z_PS_SD045_POList"; //해당 일자 DoList 삭제
                    oRecordSet01.DoQuery(sQry);
                    ...
                    {
                        sQry = "insert into Z_PS_SD045_POList select '" + row.GetValue("PONO").ToString();
                        sQry += "','" + row.GetValue("MATNR").ToString();
                        sQry += "','" + row.GetValue("MAKTX").ToString();
                        sQry += "','" + row.GetValue("KGNET").ToString();
                        sQry += "','" + row.GetValue("ZMGRSU").ToString();
                        sQry += "','" + row.GetValue("ZPROWE").ToString();
                        sQry += "','" + row.GetValue("ZALLOY").ToString();
                        sQry += "','" + row.GetValue("ZTKOSD").ToString();
                        sQry += "','" + row.GetValue("ZWIDTK").ToString();
                ...
                PSH_Globals.SBO_Application.MessageBox("P/O정보 로드 완료");
                returnValue = true;
            }
            catch (Exception ex)
            {
        ...
        /// <returns></returns>
        private bool PS_SD045_Validate(string ValidateType)
        {
            bool returnValue = false;
            string errMessage = string.Empty;
            PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
            ...
            try
            {
                if (dataHelpClass.GetValue("SELECT Canceled FROM [@PS_SD045H] WHERE DocEntry = '" + oForm.Items.Item("DocEntry").Specific.Value + "'", 0, 1) == "Y")
                {
        ...
        private bool PS_SD045_CheckDate(string pBaseEntry)
        {
            bool returnValue = false;
            string query;
            string BaseEntry;
        ...
        /// </summary>
        /// <returns></returns>
        private void PS_SD045_InterfaceB1toR3()
        {
            ...
            try
            {
                ...
                {
                    if (oDS_PS_SD045L.GetValue("U_TransYN", i).ToString().Trim() != "Y")
                    {
                        //SetValue 매개변수용 변수(변수Type이 맞지 않으면 매개변수 전달시 SetValue 메소드 오류발생, 아래와 같이 매개변수에 값 저장후 SetValue에 전달)
                        string coilNo = oDS_PS_SD045L.GetValue("U_CoilNo", i).ToString().Trim();
                        string docDate = oDS_PS_SD045H.GetValue("U_DocDate", 0).ToString().Trim();
                        string R3PONum = oDS_PS_SD045L.GetValue("U_R3PONum", i).ToString().Trim();
                        double weight = Convert.ToDouble(oDS_PS_SD045L.GetValue("U_Weight", i).ToString().Trim());
                        double packWgt = Convert.ToDouble(oDS_PS_SD045L.GetValue("U_PackWgt", i).ToString().Trim());
                        double totalWgt = Convert.ToDouble(oDS_PS_SD045L.GetValue("U_Weight", i)) + Convert.ToDouble(oDS_PS_SD045L.GetValue("U_PackWgt", i));
                        ...
                        if (oMat01.VisualRowCount == i + 2) //마지막에 실행
                        {
                            ...
                            {
                                sQry = "Update [@PS_SD045L] set U_TransYN ='E' where DocEntry ='" + oDS_PS_SD045L.GetValue("DocEntry", i).ToString().Trim() + "' and U_PackNo ='"+ oDS_PS_SD045L.GetValue("U_PackNo", i).ToString().Trim() + "'";
                                oRecordSet01.DoQuery(sQry);

                                PSH_Globals.SBO_Application.MessageBox("패킹번호 [" + oDS_PS_SD045L.GetValue("U_PackNo", i).ToString().Trim() + "] 오류 :" + errMessage);
                            }
                            else
                            {
                                sQry = "Update [@PS_SD045L] set U_TransYN ='Y' where DocEntry ='" + oDS_PS_SD045L.GetValue("DocEntry", i).ToString().Trim() + "' and U_PackNo ='" + oDS_PS_SD045L.GetValue("U_PackNo", i).ToString().Trim() + "'";
                                oRecordSet01.DoQuery(sQry);
                            }
                        }
                        else if (oDS_PS_SD045L.GetValue("U_PackNo", i).ToString().Trim() != oDS_PS_SD045L.GetValue("U_PackNo", i + 1).ToString().Trim())
                        {
                            errCode = "2"; //SAP Function 실행 오류가 발생했을 때 에러코드로 처리하기 위해 이 위치에서 "2"를 대입
                            oFunction.Invoke(rfcDest); //Function 실행
                            ...
                            else
                            {
                                ...
                                sQry = "Update [@PS_SD045H] set U_INFCYN ='Y' where DocEntry ='" + oDS_PS_SD045L.GetValue("DocEntry", i).ToString().Trim() +"'";
                                oRecordSet01.DoQuery(sQry);
                            }
                            oTable.Clear();
                            oTable.Insert();
        ...
        /// </summary>
        /// <returns></returns>
        private bool PS_SD045_DI_API_01()
        {
            bool returnValue = false;
            string errCode = string.Empty;
            ...
            try
            {
                ...
                for (i = 0; i < itemInfoList.Count; i++)
                {
                    ...
                    oDIObject.Lines.UserFields.Fields.Item("U_BaseType").Value = "PS_SD045";
                    ...
                    for (j = i; j < itemInfoList.Count; j++)
                    {
                        ...
                        else if ((oForm.Items.Item("TrType").Specific.Value == "2") || oForm.Items.Item("Opt03").Specific.Selected == true) //임가공, 분말일때
                        {
                            if (dataHelpClass.GetItem_ManBtchNum(itemInfoList[j].ItemCode) == "Y")
                            {
                                ...
                                Query01 = "EXEC PS_SD045_03 '" + itemInfoList[j].ItemCode + "','" + itemInfoList[j].BatchNum + "','" + itemInfoList[j].WhsCode + "'";
                ...
                if (RetVal == 0)
                {
                    ...
                    for (i = 0; i < itemInfoList.Count; i++)
                    {
                        oDS_PS_SD045L.SetValue("U_ODLNNum", i, Convert.ToString(afterDIDocNum));
                        oDS_PS_SD045L.SetValue("U_DLN1Num", i, Convert.ToString(itemInfoList[i].DLN1Num));
                    }
        ...
        /// </summary>
        /// <returns></returns>
        private bool PS_SD045_DI_API_02()
        {
            bool returnValue = false;
            string errCode = string.Empty;
            string errDIMsg = string.Empty;
        ...
        /// </summary>
        /// <returns></returns>
        private bool PS_SD045_DI_API_03()
        {
            bool returnValue = false;
            ...
            try
            {
                ...
                {
                    PSH_Globals.oCompany.GetNewObjectCode(out string afterDIDocNum);
                    dataHelpClass.DoQuery("UPDATE [@PS_SD045H] SET U_ProgStat = '4', Canceled ='Y', Status = 'C' WHERE DocEntry = '" + oForm.Items.Item("DocEntry").Specific.Value + "'");

                    //납품문서번호 업데이트
                    for (i = 1; i < oMat01.VisualRowCount; i++)
                    {
                        Query01 = "  UPDATE [@PS_SD045L]";
        ...
        /// </summary>
        [STAThread]
        private void PS_SD045_Print_Report01()
        {
            string WinTitle;
            string ReportName;
            string sQry;
            ...
            try
            {
                ...
                sQry = "SELECT COUNT(*) AS COUNT FROM [@PS_SD045L] WHERE DocEntry = '" + oForm.Items.Item("DocEntry").Specific.Value + "'";
                oRecordSet01.DoQuery(sQry);
        ...
        [STAThread]
        private void PS_SD045_Print_Report02(string Chk)
        {
            string WinTitle;
            string ReportName;
            string sQry;
        ...
        /// </summary>
        [STAThread]
        private void PS_SD045_Print_Report03()
        {
            string WinTitle;
            string ReportName;
            string errMessage = string.Empty;
        ...
        /// </summary>
        [STAThread]
        private void PS_SD045_Print_Report03_1()
        {
            string WinTitle;
            string ReportName;
            string errMessage = string.Empty;
            ...
            try
            {
                if (pVal.BeforeAction == true)
                {
                    if (pVal.ItemUID == "1")
                    {
                        if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
                        {
                            if (PS_SD045_CheckDataValid() == false)
                            {
                                BubbleEvent = false;
                                return;
                            }
                            ...
                            if (oForm.Items.Item("Opt01").Specific.Selected == true)
                            {
                                if (PS_SD045_DI_API_01() == false) //납품생성
                                {
                            ...
                            {
                                if (PS_SD045_DI_API_02() == false) //멀티게이지납품생성
                                {
                                    PS_SD045_AddMatrixRow(oMat01.RowCount, false);
                                    BubbleEvent = false;
                                    return;
                            ...
                            {
                                if (PS_SD045_DI_API_01() == false) //분말 납품생성
                                {
                                    PS_SD045_AddMatrixRow(oMat01.RowCount, false);
                                    BubbleEvent = false;
                                    return;
                    ...
                    else if (pVal.ItemUID == "Button01") //거래명세서
                    {
                        ...
                        {
                            System.Threading.Thread thread = new System.Threading.Thread(PS_SD045_Print_Report01);
                    ...
                    else if (pVal.ItemUID == "Button02") //출고증(수량)
                    {
                        ...
                        else if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_OK_MODE)
                        {
                            ...
                            {
                                System.Threading.Thread thread = new System.Threading.Thread(PS_SD045_Print_Report03);
                                thread.SetApartmentState(System.Threading.ApartmentState.STA);
                                thread.Start();
                            }
                            else
                            {
                                System.Threading.Thread thread = new System.Threading.Thread(() => PS_SD045_Print_Report02("N"));
                                thread.SetApartmentState(System.Threading.ApartmentState.STA);
                                thread.Start();
                            }
                        }
                    ...
                    else if (pVal.ItemUID == "Button04") //B1 to R3 데이터 인터페이스
                    {
                        ...
                        else if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_OK_MODE)
                        {
                            ...
                            {
                                PS_SD045_InterfaceB1toR3();
                            }
                        }
                    }
                    else if (pVal.ItemUID == "POLoad")
                    {
                        if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_OK_MODE)
                        {
                            if (PS_SD045_R3Set_POList() == false)
                            {
                                PSH_Globals.SBO_Application.MessageBox("Delivery order(P/O) data loading failure!");
                            }
                        }
                    }
                    else if (pVal.ItemUID == "R3POCopy") //B1 to R3 데이터 인터페이스
                    {
                        if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
                        {
                        }
                    ...
                    else if (pVal.ItemUID == "Button02_1") //출고증(금액)
                    {
                        ...
                        {
                            System.Threading.Thread thread = new System.Threading.Thread(PS_SD045_Print_Report03_1);
                            thread.SetApartmentState(System.Threading.ApartmentState.STA);
                            thread.Start();
                            PS_SD0040_ChangePrice();
                        }
                    ...
                    if (pVal.ItemUID == "Button03")
                    {
                        ...
                        else if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_OK_MODE) //TODO : PS_MM004 구현 필요
                        {
                            ...
                            tempForm.LoadForm("PS_SD045", oForm.Items.Item("DocEntry").Specific.Value);
                            BubbleEvent = false;
                        }
                    }
                }
                    ...
                    if (pVal.ItemChanged == true)
                    {
                        if (pVal.ItemUID == "Mat01")
                        {
                            if (pVal.ColUID == "SD030Num")
                            {
                                ...
                                Query01 = "EXEC PS_SD045_01 '" + oMat01.Columns.Item("SD030Num").Cells.Item(pVal.Row).Specific.Value + "'";
                                RecordSet01.DoQuery(Query01);
                                for (i = 0; i <= RecordSet01.RecordCount - 1; i++)
                                {
                                    oDS_PS_SD045L.SetValue("U_SD030Num", pVal.Row - 1, RecordSet01.Fields.Item("SD030Num").Value);
                                    oDS_PS_SD045L.SetValue("U_OrderNum", pVal.Row - 1, RecordSet01.Fields.Item("OrderNum").Value);
                                    oDS_PS_SD045L.SetValue("U_ItemCode", pVal.Row - 1, RecordSet01.Fields.Item("ItemCode").Value);
                                    oDS_PS_SD045L.SetValue("U_ItemName", pVal.Row - 1, RecordSet01.Fields.Item("ItemName").Value);
                                    oDS_PS_SD045L.SetValue("U_ItemGpCd", pVal.Row - 1, RecordSet01.Fields.Item("ItemGpCd").Value);
                                    oDS_PS_SD045L.SetValue("U_ItmBsort", pVal.Row - 1, RecordSet01.Fields.Item("ItmBsort").Value);
                                    oDS_PS_SD045L.SetValue("U_ItmMsort", pVal.Row - 1, RecordSet01.Fields.Item("ItmMsort").Value);
                                    oDS_PS_SD045L.SetValue("U_Unit1", pVal.Row - 1, RecordSet01.Fields.Item("Unit1").Value);
                                    oDS_PS_SD045L.SetValue("U_Size", pVal.Row - 1, RecordSet01.Fields.Item("Size").Value);
                                    oDS_PS_SD045L.SetValue("U_ItemType", pVal.Row - 1, RecordSet01.Fields.Item("ItemType").Value);
                                    oDS_PS_SD045L.SetValue("U_Quality", pVal.Row - 1, RecordSet01.Fields.Item("Quality").Value);
                                    oDS_PS_SD045L.SetValue("U_Mark", pVal.Row - 1, RecordSet01.Fields.Item("Mark").Value);
                                    oDS_PS_SD045L.SetValue("U_SbasUnit", pVal.Row - 1, RecordSet01.Fields.Item("SbasUnit").Value);
                                    oDS_PS_SD045L.SetValue("U_LotNo", pVal.Row - 1, RecordSet01.Fields.Item("LotNo").Value);
                                    oDS_PS_SD045L.SetValue("U_SjQty", pVal.Row - 1, RecordSet01.Fields.Item("SjQty").Value);
                                    oDS_PS_SD045L.SetValue("U_SjWeight", pVal.Row - 1, RecordSet01.Fields.Item("SjWeight").Value);
                                    oDS_PS_SD045L.SetValue("U_Qty", pVal.Row - 1, RecordSet01.Fields.Item("Qty").Value);
                                    oDS_PS_SD045L.SetValue("U_UnWeight", pVal.Row - 1, RecordSet01.Fields.Item("UnWeight").Value);
                                    oDS_PS_SD045L.SetValue("U_Weight", pVal.Row - 1, RecordSet01.Fields.Item("Weight").Value);
                                    oDS_PS_SD045L.SetValue("U_Currency", pVal.Row - 1, RecordSet01.Fields.Item("Currency").Value);
                                    oDS_PS_SD045L.SetValue("U_Price", pVal.Row - 1, RecordSet01.Fields.Item("Price").Value);
                                    oDS_PS_SD045L.SetValue("U_LinTotal", pVal.Row - 1, RecordSet01.Fields.Item("LinTotal").Value);
                                    oDS_PS_SD045L.SetValue("U_WhsCode", pVal.Row - 1, RecordSet01.Fields.Item("WhsCode").Value);
                                    oDS_PS_SD045L.SetValue("U_WhsName", pVal.Row - 1, RecordSet01.Fields.Item("WhsName").Value);
                                    oDS_PS_SD045L.SetValue("U_Comments", pVal.Row - 1, RecordSet01.Fields.Item("Comments").Value);
                                    oDS_PS_SD045L.SetValue("U_SD030H", pVal.Row - 1, RecordSet01.Fields.Item("SD030H").Value);
                                    oDS_PS_SD045L.SetValue("U_SD030L", pVal.Row - 1, RecordSet01.Fields.Item("SD030L").Value);
                                    oDS_PS_SD045L.SetValue("U_TrType", pVal.Row - 1, RecordSet01.Fields.Item("TrType").Value);
                                    oDS_PS_SD045L.SetValue("U_ORDRNum", pVal.Row - 1, RecordSet01.Fields.Item("ORDRNum").Value);
                                    oDS_PS_SD045L.SetValue("U_RDR1Num", pVal.Row - 1, RecordSet01.Fields.Item("RDR1Num").Value);
                                    oDS_PS_SD045L.SetValue("U_Status", pVal.Row - 1, RecordSet01.Fields.Item("Status").Value);
                                    oDS_PS_SD045L.SetValue("U_LineId", pVal.Row - 1, RecordSet01.Fields.Item("LineId").Value);
                                    RecordSet01.MoveNext();
                                }
                                if (oMat01.RowCount == pVal.Row && !string.IsNullOrEmpty(oDS_PS_SD045L.GetValue("U_SD030Num", pVal.Row - 1).ToString().Trim()))
                                {
                                    PS_SD045_AddMatrixRow(pVal.Row, false);
                                }
                            ...
                            else if (pVal.ColUID == "PackNo")
                            {
                                ...
                                Query01 = "EXEC PS_SD045_06 '" + oMat01.Columns.Item("PackNo").Cells.Item(pVal.Row).Specific.Value + "', '" + Work01 + "', '" + oForm.Items.Item("CardCode").Specific.String + "'";
                                RecordSet01.DoQuery(Query01);
                                ...
                                else //해당 포장번호로 재고유무확인
                                {
                                    ...
                                    Query01 = "EXEC PS_SD045_07 '" + oMat01.Columns.Item("PackNo").Cells.Item(pVal.Row).Specific.Value + "'";
                                ...
                                for (i = 0; i <= RecordSet01.RecordCount - 1; i++)
                                {
                                    oDS_PS_SD045L.SetValue("U_PackNo", pVal.Row - 1 + i, RecordSet01.Fields.Item("PackNo").Value);
                                    if (Work01 == "3")
                                    {
                                        oDS_PS_SD045L.SetValue("U_SD030Num", pVal.Row - 1 + i, RecordSet01.Fields.Item("SD030Num").Value);
                                        oDS_PS_SD045L.SetValue("U_OrderNum", pVal.Row - 1 + i, RecordSet01.Fields.Item("OrderNum").Value);
                                        oDS_PS_SD045L.SetValue("U_SD030H", pVal.Row - 1 + i, RecordSet01.Fields.Item("SD030H").Value);
                                        oDS_PS_SD045L.SetValue("U_SD030L", pVal.Row - 1 + i, RecordSet01.Fields.Item("SD030L").Value);
                                        oDS_PS_SD045L.SetValue("U_ORDRNum", pVal.Row - 1 + i, RecordSet01.Fields.Item("ORDRNum").Value);
                                        oDS_PS_SD045L.SetValue("U_RDR1Num", pVal.Row - 1 + i, RecordSet01.Fields.Item("RDR1Num").Value);
                                    }
                                    oDS_PS_SD045L.SetValue("U_ItemCode", pVal.Row - 1 + i, RecordSet01.Fields.Item("ItemCode").Value);
                                    oDS_PS_SD045L.SetValue("U_ItemName", pVal.Row - 1 + i, RecordSet01.Fields.Item("ItemName").Value);
                                    oDS_PS_SD045L.SetValue("U_ItemGpCd", pVal.Row - 1 + i, RecordSet01.Fields.Item("ItemGpCd").Value);
                                    oDS_PS_SD045L.SetValue("U_ItmBsort", pVal.Row - 1 + i, RecordSet01.Fields.Item("ItmBsort").Value);
                                    oDS_PS_SD045L.SetValue("U_ItmMsort", pVal.Row - 1 + i, RecordSet01.Fields.Item("ItmMsort").Value);
                                    oDS_PS_SD045L.SetValue("U_Unit1", pVal.Row - 1 + i, RecordSet01.Fields.Item("Unit1").Value);
                                    oDS_PS_SD045L.SetValue("U_Size", pVal.Row - 1 + i, RecordSet01.Fields.Item("Size").Value);
                                    oDS_PS_SD045L.SetValue("U_ItemType", pVal.Row - 1 + i, RecordSet01.Fields.Item("ItemType").Value);
                                    oDS_PS_SD045L.SetValue("U_Quality", pVal.Row - 1 + i, RecordSet01.Fields.Item("Quality").Value);
                                    oDS_PS_SD045L.SetValue("U_Mark", pVal.Row - 1 + i, RecordSet01.Fields.Item("Mark").Value);
                                    oDS_PS_SD045L.SetValue("U_SbasUnit", pVal.Row - 1 + i, RecordSet01.Fields.Item("SbasUnit").Value);
                                    oDS_PS_SD045L.SetValue("U_LotNo", pVal.Row - 1 + i, RecordSet01.Fields.Item("LotNo").Value);
                                    oDS_PS_SD045L.SetValue("U_CoilNo", pVal.Row - 1 + i, RecordSet01.Fields.Item("CoilNo").Value);
                                    oDS_PS_SD045L.SetValue("U_R3PONum", pVal.Row - 1 + i, RecordSet01.Fields.Item("R3PONum").Value);
                                    oDS_PS_SD045L.SetValue("U_PackWgt", pVal.Row - 1 + i, RecordSet01.Fields.Item("PackWgt").Value);
                                    oDS_PS_SD045L.SetValue("U_SjQty", pVal.Row - 1 + i, RecordSet01.Fields.Item("SjQty").Value);
                                    oDS_PS_SD045L.SetValue("U_SjWeight", pVal.Row - 1 + i, RecordSet01.Fields.Item("SjWeight").Value);
                                    oDS_PS_SD045L.SetValue("U_Qty", pVal.Row - 1 + i, RecordSet01.Fields.Item("Qty").Value);
                                    oDS_PS_SD045L.SetValue("U_Weight", pVal.Row - 1 + i, RecordSet01.Fields.Item("Weight").Value);
                                    oDS_PS_SD045L.SetValue("U_Currency", pVal.Row - 1 + i, RecordSet01.Fields.Item("Currency").Value);
                                    oDS_PS_SD045L.SetValue("U_Price", pVal.Row - 1 + i, RecordSet01.Fields.Item("Price").Value);
                                    oDS_PS_SD045L.SetValue("U_LinTotal", pVal.Row - 1 + i, RecordSet01.Fields.Item("LinTotal").Value);
                                    oDS_PS_SD045L.SetValue("U_WhsCode", pVal.Row - 1 + i, RecordSet01.Fields.Item("WhsCode").Value);
                                    oDS_PS_SD045L.SetValue("U_WhsName", pVal.Row - 1 + i, RecordSet01.Fields.Item("WhsName").Value);
                                    oDS_PS_SD045L.SetValue("U_Status", pVal.Row - 1 + i, RecordSet01.Fields.Item("Status").Value);
                                    oDS_PS_SD045L.SetValue("U_LineId", pVal.Row - 1 + i, RecordSet01.Fields.Item("LineId").Value);
                                    PS_SD045_AddMatrixRow(pVal.Row + i, false);
                                    RecordSet01.MoveNext();
                                }
                            ...
                            else if (pVal.ColUID == "Qty")
                            {
                                ...
                                {
                                    oDS_PS_SD045L.SetValue("U_" + pVal.ColUID, pVal.Row - 1, "0");
                                    oDS_PS_SD045L.SetValue("U_Weight", pVal.Row - 1, "0");
                                    oDS_PS_SD045L.SetValue("U_LinTotal", pVal.Row - 1, "0");
                                }
                                else
                                {
                                    ItemCode01 = oDS_PS_SD045L.GetValue("U_ItemCode", pVal.Row - 1);

                                    if (dataHelpClass.GetItem_SbasUnit(ItemCode01) == "101") //EA자체품
                                    {
                                        oDS_PS_SD045L.SetValue("U_Weight", pVal.Row - 1, oMat01.Columns.Item("Qty").Cells.Item(pVal.Row).Specific.Value);
                                    }
                                    else if (dataHelpClass.GetItem_SbasUnit(ItemCode01) == "102") //EAUOM
                                    {
                                        oDS_PS_SD045L.SetValue("U_Weight", pVal.Row - 1, Convert.ToString(Convert.ToDouble(oMat01.Columns.Item("Qty").Cells.Item(pVal.Row).Specific.Value) * Convert.ToDouble(dataHelpClass.GetItem_Unit1(ItemCode01))));
                                    }
                                    else if (dataHelpClass.GetItem_SbasUnit(ItemCode01) == "201") //KGSPEC
                                    {
                                        oDS_PS_SD045L.SetValue("U_Weight", pVal.Row - 1, Convert.ToString((Convert.ToDouble(dataHelpClass.GetItem_Spec1(ItemCode01)) - Convert.ToDouble(dataHelpClass.GetItem_Spec2(ItemCode01))) * Convert.ToDouble(dataHelpClass.GetItem_Spec2(ItemCode01)) * 0.02808 * (Convert.ToDouble(dataHelpClass.GetItem_Spec3(ItemCode01)) / 1000) * Convert.ToDouble(oMat01.Columns.Item("Qty").Cells.Item(pVal.Row).Specific.Value)));
                                    }
                                    else if (dataHelpClass.GetItem_SbasUnit(ItemCode01) == "202") //KG단중
                                    {
                                        oDS_PS_SD045L.SetValue("U_Weight", pVal.Row - 1, Convert.ToString(System.Math.Round(Convert.ToDouble(oMat01.Columns.Item("Qty").Cells.Item(pVal.Row).Specific.Value) * Convert.ToDouble(dataHelpClass.GetItem_UnWeight(ItemCode01)) / 1000, 0)));
                                    }
                                    else if (dataHelpClass.GetItem_SbasUnit(ItemCode01) == "203") //KG선택
                                    {
                                    }
                                    oDS_PS_SD045L.SetValue("U_LinTotal", pVal.Row - 1, Convert.ToString(Convert.ToDouble(oDS_PS_SD045L.GetValue("U_Weight", pVal.Row - 1).ToString().Trim()) * Convert.ToDouble(oDS_PS_SD045L.GetValue("U_Price", pVal.Row - 1).ToString().Trim())));
                                    oDS_PS_SD045L.SetValue("U_" + pVal.ColUID, pVal.Row - 1, oMat01.Columns.Item(pVal.ColUID).Cells.Item(pVal.Row).Specific.Value);
                                }
                            ...
                            else if (pVal.ColUID == "Weight")
                            {
                                if (Convert.ToDouble(oMat01.Columns.Item(pVal.ColUID).Cells.Item(pVal.Row).Specific.Value) <= 0)
                                {
                                    oDS_PS_SD045L.SetValue("U_Qty", pVal.Row - 1, "0");
                                    oDS_PS_SD045L.SetValue("U_" + pVal.ColUID, pVal.Row - 1, "0");
                                    oDS_PS_SD045L.SetValue("U_LinTotal", pVal.Row - 1, "0");
                                }
                                else
                                {
                                    ItemCode01 = oDS_PS_SD045L.GetValue("U_ItemCode", pVal.Row - 1).ToString().Trim();
                            ...
                            else if (pVal.ColUID == "Price")
                            {
                                ...
                                {
                                    oDS_PS_SD045L.SetValue("U_" + pVal.ColUID, pVal.Row - 1, oMat01.Columns.Item(pVal.ColUID).Cells.Item(pVal.Row).Specific.Value);
                                    oDS_PS_SD045L.SetValue("U_LinTotal", pVal.Row - 1, Convert.ToString(Convert.ToDouble(oMat01.Columns.Item(pVal.ColUID).Cells.Item(pVal.Row).Specific.Value) * Convert.ToDouble(oMat01.Columns.Item("Weight").Cells.Item(pVal.Row).Specific.Value)));
                                }
                            }
                            else
                            {
                        ...
                        else
                        {
                            ...
                            {
                                oDS_PS_SD045H.SetValue(pVal.ItemUID, 0, oForm.Items.Item(pVal.ItemUID).Specific.Value);
                            }
                            else if (pVal.ItemUID == "CntcCode")
                            {
                                oDS_PS_SD045H.SetValue("U_" + pVal.ItemUID, 0, oForm.Items.Item(pVal.ItemUID).Specific.Value);
                                oDS_PS_SD045H.SetValue("U_CntcName", 0, dataHelpClass.GetValue("SELECT LastName + FirstName FROM [OHEM] WHERE U_MSTCOD = '" + oForm.Items.Item(pVal.ItemUID).Specific.Value + "'", 0, 1));
                            }
                        }
                    }
                }
        ...
        private void Raise_EVENT_MATRIX_LOAD(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
        {
            ...
            try
            {
                ...
                {
                    PS_SD045_FormItemEnabled();
                    PS_SD045_AddMatrixRow(oMat01.VisualRowCount, false);
        ...
        private void Raise_EVENT_CHOOSE_FROM_LIST(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
        {
            ...
            try
            {
                ...
                else if (pVal.Before_Action == false)
                {
                    ...
                    {
                        dataHelpClass.PSH_CF_DBDatasourceReturn(pVal, pVal.FormUID, "@PS_SD045H", "U_DCardCod,U_DCardNam", "", 0, "", "", "");
                    }
                    else if (pVal.ItemUID == "Mat01")
                    {
                        if (pVal.ColUID == "WhsCode")
                        {
                            if (((SAPbouiCOM.ChooseFromListEvent)pVal).SelectedObjects != null)
                            {
                                ...
                                oDS_PS_SD045L.SetValue("U_WhsCode", pVal.Row - 1, oDataTable01.Columns.Item("WhsCode").Cells.Item(0).Value);
                                oDS_PS_SD045L.SetValue("U_WhsName", pVal.Row - 1, oDataTable01.Columns.Item("WhsName").Cells.Item(0).Value);
            ...
            try
            {
                if (oLastColRow01 > 0)
                {
                    if (pVal.BeforeAction == true)
                    {
                        ...
                        {
                            for (i = 0; i <= oDS_PS_SD045L.Size - 1; i++)
                            {
                                if (i == oDS_PS_SD045L.Size - 1)
                                {
                                    break;
                                }

                                if (oDS_PS_SD045L.GetValue("U_PackNo", i) == oDS_PS_SD045L.GetValue("U_PackNo", oLastColRow01 - 1)) //선택된행과 같은값을 가지는 모든행
                                {
                                    oDS_PS_SD045L.RemoveRecord(i);
                                    i -= 1;
                                }
                            }
                            ...
                            {
                                PS_SD045_AddMatrixRow(0, false);
                            }
                            else
                            {
                                if (!string.IsNullOrEmpty(oDS_PS_SD045L.GetValue("U_SD030Num", oMat01.RowCount - 1).ToString().Trim()))
                                {
                                    PS_SD045_AddMatrixRow(oMat01.RowCount, false);
                                }
                            }
                ...
                else if (pVal.BeforeAction == false)
                {
                    switch (pVal.MenuUID)
                    {
                        ...
                        case "1282": //추가
                            PS_SD045_FormItemEnabled();
                            PS_SD045_AddMatrixRow(0, true);
                            oDS_PS_SD045H.SetValue("U_CntcCode", 0, dataHelpClass.User_MSTCOD()); //담당자
                            oDS_PS_SD045H.SetValue("U_CntcName", 0, dataHelpClass.GetValue("SELECT LastName + FirstName FROM [OHEM] WHERE U_MSTCOD = '" + oForm.Items.Item("CntcCode").Specific.Value + "'", 0, 1));
                            break;
                        case "1288":
                        case "1289":
