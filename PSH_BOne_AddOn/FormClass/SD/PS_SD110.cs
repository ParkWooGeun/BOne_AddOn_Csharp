	...
	internal class PS_SD110 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry01)
		{
			...
			try
			{
				...
				PS_SD110_ComboBox_Setting();
				PS_SD110_Initial_Setting();
			}
			catch (Exception ex)
			{
		...
		/// PS_SD110_ComboBox_Setting
		/// </summary>
		public void PS_SD110_ComboBox_Setting()
		{
		...
		/// PS_SD110_Initial_Setting
		/// </summary>
		public void PS_SD110_Initial_Setting()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
			...
			try
			{
				if (pval.BeforeAction == true)
				{
					if (pval.ItemUID == "Btn01")
					{
						...
						{
							if (PS_SD110_DataValidCheck() == false)
							{
								BubbleEvent = false;
								return;
							}
		...
		/// <summary>
		/// PS_SD110_DataValidCheck
		/// </summary>
		/// <returns></returns>
		public bool PS_SD110_DataValidCheck()
		{
