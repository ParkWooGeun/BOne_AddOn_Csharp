...
namespace PSH_BOne_AddOn
{
	...
	///출고요청/출고비교현황
	/// </summary>
	internal class PS_SD150 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_SD150.srf");
				...
				oFormUniqueID = "PS_SD150_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_SD150");
		...
		private void Print_Query()
		{
			...
			try
			{
				...
				WinTitle = "[PS_SD150] 출고요청/출고비교현황";
				ReportName = "PS_SD150_01.RPT";
