...
namespace PSH_BOne_AddOn
{
	...
	internal class PS_SD160 : PSH_BaseClass
	{
		...
		/// PS_SD160_SetComboBox
		/// </summary>
		private void PS_SD160_SetComboBox()
		{
		...
		/// PS_SD160_Initialize
		/// </summary>
		private void PS_SD160_Initialize()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
		...
		/// <summary>
		/// PS_SD160_CheckDataValid
		/// </summary>
		/// <returns></returns>
		private bool PS_SD160_CheckDataValid()
		{
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_SD160_CheckDataValid() == false)
							{
								BubbleEvent = false;
								return;
							}
