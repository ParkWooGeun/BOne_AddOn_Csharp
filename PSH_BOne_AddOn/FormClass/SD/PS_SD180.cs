...
namespace PSH_BOne_AddOn
{
	...
	internal class PS_SD180 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_SD180.srf");
				...
				oFormUniqueID = "PS_SD180_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_SD180");
		...
		/// PS_SD180_CreateItems
		/// </summary>
		private void PS_SD180_CreateItems()
		{
			try
			{
				oForm.Freeze(true);
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
						{
							System.Threading.Thread thread = new System.Threading.Thread(PS_SD180_Print_Report01);
