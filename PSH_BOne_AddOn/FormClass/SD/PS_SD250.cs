...
namespace PSH_BOne_AddOn
{
	...
	internal class PS_SD250 : PSH_BaseClass
	{
		...
		/// PS_SD250_SetComboBox
		/// </summary>
		private void PS_SD250_SetComboBox()
		{
		...
		/// PS_SD250_Initialize
		/// </summary>
		private void PS_SD250_Initialize()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
		...
		/// <summary>
		/// PS_SD250_CheckDataValid
		/// </summary>
		/// <returns></returns>
		private bool PS_SD250_CheckDataValid()
		{
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_SD250_CheckDataValid() == false)
							{
								BubbleEvent = false;
								return;
							}
