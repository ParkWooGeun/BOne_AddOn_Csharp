...
namespace PSH_BOne_AddOn
{
	...
	/// 제품재고현황
	/// </summary>
	internal class PS_SD250 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry01)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_SD250.srf");
				...
				oFormUniqueID = "PS_SD250_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_SD250");
				...
				oForm.Freeze(true);
				PS_SD250_CreateItems();
				PS_SD250_ComboBox_Setting();
				PS_SD250_Initial_Setting();
			}
			catch (Exception ex)
			{
		...
		/// PS_SD250_CreateItems
		/// </summary>
		private void PS_SD250_CreateItems()
		{
			try
			{
				oForm.Freeze(true);
		...
		/// PS_SD250_ComboBox_Setting
		/// </summary>
		public void PS_SD250_ComboBox_Setting()
		{
		...
		/// PS_SD250_Initial_Setting
		/// </summary>
		public void PS_SD250_Initial_Setting()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_SD250_DataValidCheck() == false)
							{
								BubbleEvent = false;
								return;
							}
						...
						if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
						{
							System.Threading.Thread thread = new System.Threading.Thread(PS_SD250_Print_Report01);
		...
		/// <summary>
		/// PS_SD250_DataValidCheck
		/// </summary>
		/// <returns></returns>
		public bool PS_SD250_DataValidCheck()
		{
			...
			catch (Exception ex)
			{
				if (ErrNum == 1)
				{
					PSH_Globals.SBO_Application.SetStatusBarMessage("일자는 필수입니다.", SAPbouiCOM.BoMessageTime.bmt_Short, true);
		...
		/// <summary>
		/// PS_SD250_Print_Report01
		/// </summary>
		[STAThread]
		private void PS_SD250_Print_Report01()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				WinTitle = "제품재고현황[PS_SD250]";
				ReportName = "PS_SD250.rpt";
