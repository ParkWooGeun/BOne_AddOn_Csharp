...
namespace PSH_BOne_AddOn
{
	...
	/// 판매미확정현황
	/// </summary>
	internal class PS_SD270 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry01)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_SD270.srf");
				...
				oFormUniqueID = "PS_SD270_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_SD270");
				...
				oForm.Freeze(true);
				PS_SD270_CreateItems();
				PS_SD270_ComboBox_Setting();
				PS_SD270_Initial_Setting();
			}
			catch (Exception ex)
			{
		...
		/// PS_SD270_CreateItems
		/// </summary>
		private void PS_SD270_CreateItems()
		{
			try
			{
				oForm.Freeze(true);
		...
		/// PS_SD270_ComboBox_Setting
		/// </summary>
		public void PS_SD270_ComboBox_Setting()
		{
			...
			try
			{
				...
				oForm.Items.Item("BPLId").Specific.ValidValues.Add("", "전체사업장");
		...
		/// PS_SD270_Initial_Setting
		/// </summary>
		public void PS_SD270_Initial_Setting()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_SD270_DataValidCheck() == false)
							{
								BubbleEvent = false;
								return;
							}
						...
						if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
						{
							System.Threading.Thread thread = new System.Threading.Thread(PS_SD270_Print_Report01);
		...
		/// <summary>
		/// PS_SD270_DataValidCheck
		/// </summary>
		/// <returns></returns>
		public bool PS_SD270_DataValidCheck()
		{
		...
		/// <summary>
		/// PS_SD270_Print_Report01
		/// </summary>
		[STAThread]
		private void PS_SD270_Print_Report01()
		{
			string WinTitle;
			string ReportName;
			string BPLName;
			...
			try
			{
				...
				WinTitle = "판매 미확정 현황 [PS_SD270]";
				ReportName = "PS_SD270.rpt";
