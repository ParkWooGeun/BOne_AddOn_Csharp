...
namespace PSH_BOne_AddOn
{
	...
	internal class PS_SD270 : PSH_BaseClass
	{
		...
		/// PS_SD270_SetComboBox
		/// </summary>
		private void PS_SD270_SetComboBox()
		{
		...
		/// PS_SD270_Initialize
		/// </summary>
		private void PS_SD270_Initialize()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
		...
		/// <summary>
		/// PS_SD270_CheckDataValid
		/// </summary>
		/// <returns></returns>
		private bool PS_SD270_CheckDataValid()
		{
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_SD270_CheckDataValid() == false)
							{
								BubbleEvent = false;
								return;
							}
