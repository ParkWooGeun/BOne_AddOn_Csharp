...
namespace PSH_BOne_AddOn
{
	...
	/// 판매실적(납품처별)
	/// </summary>
	internal class PS_SD310 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry01)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_SD310.srf");
				...
				oFormUniqueID = "PS_SD310_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_SD310");
				...
				oForm.Freeze(true);
				PS_SD310_CreateItems();
				PS_SD310_ComboBox_Setting();
				PS_SD310_Initial_Setting();
			}
			catch (Exception ex)
			{
		...
		/// PS_SD310_CreateItems
		/// </summary>
		private void PS_SD310_CreateItems()
		{
			try
			{
				oForm.Freeze(true);
		...
		/// PS_SD310_ComboBox_Setting
		/// </summary>
		public void PS_SD310_ComboBox_Setting()
		{
		...
		/// PS_SD310_Initial_Setting
		/// </summary>
		public void PS_SD310_Initial_Setting()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_SD310_DataValidCheck() == false)
							{
								BubbleEvent = false;
								return;
							}
						...
						if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
						{
							System.Threading.Thread thread = new System.Threading.Thread(PS_SD310_Print_Report01);
		...
		/// <summary>
		/// PS_SD310_DataValidCheck
		/// </summary>
		/// <returns></returns>
		public bool PS_SD310_DataValidCheck()
		{
		...
		/// <summary>
		/// PS_SD310_Print_Report01
		/// </summary>
		[STAThread]
		private void PS_SD310_Print_Report01()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				WinTitle = "[PS_SD310] 레포트";
				ReportName = "PS_SD310.rpt";
				...
				dataPackParameter.Add(new PSH_DataPackClass("@StrDate", DocDateFr));
				dataPackParameter.Add(new PSH_DataPackClass("@EndDate", DocDateTo));
