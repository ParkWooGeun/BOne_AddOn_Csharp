...
namespace PSH_BOne_AddOn
{
	...
	internal class PS_SD310 : PSH_BaseClass
	{
		...
		/// PS_SD310_SetComboBox
		/// </summary>
		private void PS_SD310_SetComboBox()
		{
		...
		/// PS_SD310_Initialize
		/// </summary>
		private void PS_SD310_Initialize()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
		...
		/// <summary>
		/// PS_SD310_CheckDataValid
		/// </summary>
		/// <returns></returns>
		private bool PS_SD310_CheckDataValid()
		{
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_SD310_CheckDataValid() == false)
							{
								BubbleEvent = false;
								return;
							}
