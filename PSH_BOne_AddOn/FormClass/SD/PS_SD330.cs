...
namespace PSH_BOne_AddOn
{
	...
	internal class PS_SD330 : PSH_BaseClass
	{
		...
		/// PS_SD330_SetComboBox
		/// </summary>
		private void PS_SD330_SetComboBox()
		{
		...
		/// PS_SD330_Initialize
		/// </summary>
		private void PS_SD330_Initialize()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
		...
		/// <summary>
		/// PS_SD330_CheckDataValid
		/// </summary>
		/// <returns></returns>
		private bool PS_SD330_CheckDataValid()
		{
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_SD330_CheckDataValid() == false)
							{
								BubbleEvent = false;
								return;
							}
