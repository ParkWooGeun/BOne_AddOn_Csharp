...
namespace PSH_BOne_AddOn
{
	...
	internal class PS_SD400 : PSH_BaseClass
	{
		...
		/// PS_SD400_SetComboBox
		/// </summary>
		private void PS_SD400_SetComboBox()
		{
		...
		/// PS_SD400_Initialize
		/// </summary>
		private void PS_SD400_Initialize()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
		...
		/// <summary>
		/// PS_SD400_CheckDataValid
		/// </summary>
		/// <returns></returns>
		private bool PS_SD400_CheckDataValid()
		{
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_SD400_CheckDataValid() == false)
							{
								BubbleEvent = false;
								return;
							}
