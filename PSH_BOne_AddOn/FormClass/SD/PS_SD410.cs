...
namespace PSH_BOne_AddOn
{
	...
	/// 제품재고이동등록대장
	/// </summary>
	internal class PS_SD410 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry01)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_SD410.srf");
				...
				oFormUniqueID = "PS_SD410_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_SD410");
		...
		private void Print_Query()
		{
			...
			try
			{
				...
				WinTitle = "제품재고이동등록대장[PS_SD410_01]";
				ReportName = "PS_SD410_01.RPT";
