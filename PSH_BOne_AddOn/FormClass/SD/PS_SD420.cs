...
namespace PSH_BOne_AddOn
{
	...
	/// 미출하현황
	/// </summary>
	internal class PS_SD420 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry01)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_SD420.srf");
				...
				oFormUniqueID = "PS_SD420_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_SD420");
		...
		private void ComboBox_Setting()
		{
			...
			try
			{
				...
				oRecordSet.DoQuery(sQry);
				oForm.Items.Item("ItmGrp").Specific.ValidValues.Add("%", "전체");
				while (!(oRecordSet.EoF))
				{
		...
		private void Print_Query()
		{
			...
			try
			{
				...
				if (string.IsNullOrEmpty(ItmGrp))
				{
					ItmGrp = "%";
				}

				WinTitle = "미출하현황[PS_SD420_01] ";
				ReportName = "PS_SD420_01.RPT";
