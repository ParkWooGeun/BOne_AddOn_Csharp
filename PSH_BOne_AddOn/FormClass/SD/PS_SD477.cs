...
namespace PSH_BOne_AddOn
{
	...
	/// 품목별판매집계현황
	/// </summary>
	internal class PS_SD477 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_SD477.srf");
				...
				oFormUniqueID = "PS_SD477_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_SD477");
				...
				oForm.Freeze(true);
				PS_SD477_CreateItems();
				PS_SD477_ComboBox_Setting();
				PS_SD477_Initial_Setting();
			}
			catch (Exception ex)
			{
		...
		/// PS_SD477_CreateItems
		/// </summary>
		private void PS_SD477_CreateItems()
		{
			try
			{
				oForm.Freeze(true);
		...
		/// PS_SD477_ComboBox_Setting
		/// </summary>
		private void PS_SD477_ComboBox_Setting()
		{
		...
		/// PS_SD477_Initial_Setting
		/// </summary>
		private void PS_SD477_Initial_Setting()
		{
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_SD477_DataValidCheck() == false)
							{
								BubbleEvent = false;
								return;
							}
						...
						if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
						{
							System.Threading.Thread thread = new System.Threading.Thread(PS_SD477_Print_Report01);
		...
		/// <summary>
		/// PS_SD477_DataValidCheck
		/// </summary>
		/// <returns></returns>
		public bool PS_SD477_DataValidCheck()
		{
		...
		/// <summary>
		/// PS_SD477_Print_Report01
		/// </summary>
		[STAThread]
		private void PS_SD477_Print_Report01()
		{
			string sQry;
			string WinTitle;
			string ReportName;
			...
			try
			{
				...
				WinTitle = "판매현황(거래처별) [PS_SD477_01]";
