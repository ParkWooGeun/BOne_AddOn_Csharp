...
namespace PSH_BOne_AddOn
{
	...
	internal class PS_SD477 : PSH_BaseClass
	{
		...
		/// PS_SD477_SetComboBox
		/// </summary>
		private void PS_SD477_SetComboBox()
		{
		...
		/// PS_SD477_Initialize
		/// </summary>
		private void PS_SD477_Initialize()
		{
		...
		/// <summary>
		/// PS_SD477_CheckDataValid
		/// </summary>
		/// <returns></returns>
		private bool PS_SD477_CheckDataValid()
		{
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_SD477_CheckDataValid() == false)
							{
								BubbleEvent = false;
								return;
							}
