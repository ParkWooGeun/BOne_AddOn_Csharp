...
namespace PSH_BOne_AddOn
{
	...
	internal class PS_SD486 : PSH_BaseClass
	{
		...
		/// PS_SD486_SetComboBox
		/// </summary>
		private void PS_SD486_SetComboBox()
		{
		...
		/// PS_SD486_Initialize
		/// </summary>
		private void PS_SD486_Initialize()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
		...
		/// <summary>
		/// PS_SD486_CheckDataValid
		/// </summary>
		/// <returns></returns>
		private bool PS_SD486_CheckDataValid()
		{
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_SD486_CheckDataValid() == false)
							{
								BubbleEvent = false;
								return;
							}
