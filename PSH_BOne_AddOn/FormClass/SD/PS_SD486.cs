...
namespace PSH_BOne_AddOn
{
	...
	/// 품목별판매현황
	/// </summary>
	internal class PS_SD486 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_SD486.srf");
				...
				oFormUniqueID = "PS_SD486_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_SD486");
				...
				oForm.Freeze(true);
				PS_SD486_CreateItems();
				PS_SD486_ComboBox_Setting();
				PS_SD486_Initial_Setting();
			}
			catch (Exception ex)
			{
		...
		/// PS_SD486_CreateItems
		/// </summary>
		private void PS_SD486_CreateItems()
		{
			try
			{
				oForm.Freeze(true);
		...
		/// PS_SD486_ComboBox_Setting
		/// </summary>
		private void PS_SD486_ComboBox_Setting()
		{
		...
		/// PS_SD486_Initial_Setting
		/// </summary>
		private void PS_SD486_Initial_Setting()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_SD486_DataValidCheck() == false)
							{
								BubbleEvent = false;
								return;
							}
						...
						if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
						{
							System.Threading.Thread thread = new System.Threading.Thread(PS_SD486_Print_Report01);
		...
		/// <summary>
		/// PS_SD486_DataValidCheck
		/// </summary>
		/// <returns></returns>
		public bool PS_SD486_DataValidCheck()
		{
			...
			catch (Exception ex)
			{
				if (ErrNum == 1)
				{
					PSH_Globals.SBO_Application.SetStatusBarMessage("거래처코드는 필수입니다.", SAPbouiCOM.BoMessageTime.bmt_Short, true);
		...
		/// <summary>
		/// PS_SD486_Print_Report01
		/// </summary>
		[STAThread]
		private void PS_SD486_Print_Report01()
		{
			string sQry;
			string WinTitle;
			string ReportName;
			...
			try
			{
				...
				dataPackFormula.Add(new PSH_DataPackClass("@CardCode", CardCode));
