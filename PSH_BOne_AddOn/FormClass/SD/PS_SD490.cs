...
namespace PSH_BOne_AddOn
{
	...
	///휘팅출하요청대비출하현황(월별)
	/// </summary>
	internal class PS_SD490 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry01)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_SD490.srf");
				...
				oFormUniqueID = "PS_SD490_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_SD490");
		...
		public void ComboBox_Setting()
		{
			...
			try
			{
				...
				oForm.Items.Item("BPLId").Specific.ValidValues.Add("101", "창원공장");
				oForm.Items.Item("BPLId").Specific.ValidValues.Add("104", "구로영업소");
		...
		private void Print_Query()
		{
			...
			try
			{
				...
				dataPackParameter.Add(new PSH_DataPackClass("@ItmGrp", Gbn01));
