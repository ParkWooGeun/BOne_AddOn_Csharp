...
namespace PSH_BOne_AddOn
{
	...
	internal class PS_SD510 : PSH_BaseClass
	{
		...
		/// PS_SD510_SetComboBox
		/// </summary>
		private void PS_SD510_SetComboBox()
		{
		...
		/// PS_SD510_Initialize
		/// </summary>
		private void PS_SD510_Initialize()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
		...
		/// <summary>
		/// PS_SD510_CheckDataValid
		/// </summary>
		/// <returns></returns>
		private bool PS_SD510_CheckDataValid()
		{
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_SD510_CheckDataValid() == false)
							{
								BubbleEvent = false;
								return;
							}
