...
namespace PSH_BOne_AddOn
{
	...
	/// 기성매출제품입고현황
	/// </summary>
	internal class PS_SD520 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry01)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_SD520.srf");
				...
				oFormUniqueID = "PS_SD520_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_SD520");
				...
				oForm.Freeze(true);
				PS_SD520_CreateItems();
				PS_SD520_ComboBox_Setting();
				PS_SD520_Initial_Setting();
			}
			catch (Exception ex)
			{
		...
		/// PS_SD520_CreateItems
		/// </summary>
		private void PS_SD520_CreateItems()
		{
			try
			{
				oForm.Freeze(true);
		...
		/// PS_SD520_ComboBox_Setting
		/// </summary>
		public void PS_SD520_ComboBox_Setting()
		{
		...
		/// PS_SD520_Initial_Setting
		/// </summary>
		public void PS_SD520_Initial_Setting()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_SD520_DataValidCheck() == false)
							{
								BubbleEvent = false;
								return;
							}
						...
						if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
						{
							System.Threading.Thread thread = new System.Threading.Thread(PS_SD520_Print_Report01);
		...
		/// <summary>
		/// PS_SD520_DataValidCheck
		/// </summary>
		/// <returns></returns>
		public bool PS_SD520_DataValidCheck()
		{
		...
		/// <summary>
		/// PS_SD520_Print_Report01
		/// </summary>
		[STAThread]
		private void PS_SD520_Print_Report01()
		{
			string sQry;
			string WinTitle;
			string ReportName;
			...
			try
			{
				...
				WinTitle = "기성매출제품입고현황 [PS_SD520]";
				ReportName = "PS_SD520_01.rpt";
