...
namespace PSH_BOne_AddOn
{
	...
	/// 출하대비 출하요청현황(거래처별)
	/// </summary>
	internal class PS_SD903 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry01)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_SD903.srf");
				...
				oFormUniqueID = "PS_SD903_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_SD903");
		...
		private void Print_Query()
		{
			...
			try
			{
				...
				WinTitle = "출하요청대비출하현황[PS_SD903_01] ";
				ReportName = "PS_SD903_01.RPT";
