...
namespace PSH_BOne_AddOn
{
	...
	/// 출하대비 출하요청현황(거래처별)
	/// </summary>
	internal class PS_SD906 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry01)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_SD906.srf");
				...
				oFormUniqueID = "PS_SD906_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_SD906");
		...
		public void ComboBox_Setting()
		{
			...
			try
			{
				...
				dataHelpClass.Set_ComboList(oForm.Items.Item("ItmMSort").Specific, "SELECT U_Code, U_CodeName FROM [@PSH_ITMMSORT] Where U_rCode = '101' ORDER BY U_Code", "", false, false);
		...
		private void Print_Query()
		{
			...
			try
			{
				...
				WinTitle = "[PS_SD906_01] 생산P/O현황";
				ReportName = "PS_SD906_01.RPT";
