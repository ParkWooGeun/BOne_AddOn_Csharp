...
namespace PSH_BOne_AddOn
{
	...
	/// Size별 휘팅 생산현황
	/// </summary>
	internal class PS_SD909 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_SD909.srf");
				...
				oFormUniqueID = "PS_SD909_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_SD909");
		...
		private void ComboBox_Setting()
		{
			try
			{
				oForm.Items.Item("Gbn01").Specific.ValidValues.Add("1", "집계");
				oForm.Items.Item("Gbn01").Specific.ValidValues.Add("2", "년간");
		...
		private void Print_Query()
		{
			...
			try
			{
				...
				if (Gbn01 == "1")
				{
					WinTitle = "Size별 휘팅 생산현황[PS_SD909_02]";
					ReportName = "PS_SD909_02.RPT";
				}
				else
				{
					WinTitle = "Size별 휘팅 생산현황[PS_SD909_01]";
					ReportName = "PS_SD909_01.RPT";
				}
