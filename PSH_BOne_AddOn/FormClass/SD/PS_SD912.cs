	...
	internal class PS_SD912 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				...
				oForm.Freeze(true);
				PS_SD912_CreateItems();
				PS_SD912_SetComboBox();
		...
		/// PS_SD912_CreateItems
		/// </summary>
		private void PS_SD912_CreateItems()
		{
			try
			{
		...
		/// PS_SD912_SetComboBox
		/// </summary>
		private void PS_SD912_SetComboBox()
		{
			string sQry;
		...
		/// <summary>
		/// PS_SD912_PrintReport
		/// </summary>
		[STAThread]
		private void PS_SD912_PrintReport()
		{
			string sQry;
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						if (PS_SD912_CheckDataValid() == false)
						{
							BubbleEvent = false;
							return;
						}
						...
						{
							System.Threading.Thread thread = new System.Threading.Thread(PS_SD912_PrintReport);
