...
namespace PSH_BOne_AddOn
{
	...
	/// 판매미확정대장
	/// </summary>
	internal class PS_SD913 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_SD913.srf");
				...
				oFormUniqueID = "PS_SD913_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_SD913");
		...
		private void Print_Query()
		{
			...
			try
			{
				...
				WinTitle = "[PS_SD913] 판매 미확정 대장";
				ReportName = "PS_SD913_01.RPT";
