...
namespace PSH_BOne_AddOn
{
	...
	/// 업체별 미수현황
	/// </summary>
	internal class PS_SD916 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry01)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_SD916.srf");
				...
				oFormUniqueID = "PS_SD916_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_SD916");
		...
		public void ComboBox_Setting()
		{
			...
			try
			{
				...
				oForm.Items.Item("BPLId").Specific.Select(4, SAPbouiCOM.BoSearchKey.psk_Index);
		...
		private void Raise_EVENT_KEY_DOWN(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					dataHelpClass.ActiveUserDefineValue(ref oForm, ref pVal, ref BubbleEvent, "ECardCode", "");
				}
				else if (pVal.BeforeAction == false)
				{
				}
		...
		/// </summary>
		/// <returns></returns>
		public bool HeaderSpaceLineDel()
		{
		...
		private void Print_Query()
		{
			...
			try
			{
				...
				WinTitle = "[PS_SD916] 업체별 미수현황";
				ReportName = "PS_SD916_01.RPT";
