...
namespace PSH_BOne_AddOn
{
	...
	internal class PS_SD956_02 : PSH_BaseClass
	{
		...
		public override void LoadForm(string pItemCode = "")
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_SD956_02.srf");
				...
				oFormUniqueID = "PS_SD956_02_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_SD956_02");
				...
				PS_SD956_02_CreateItems();
				PS_SD956_02_ComboBox_Setting();
				PS_SD956_02_MTX01(pItemCode);
			}
			catch (Exception ex)
			{
		...
		/// PS_SD956_02_CreateItems
		/// </summary>
		private void PS_SD956_02_CreateItems()
		{
			try
			{
				oForm.Freeze(true);
				...
				oForm.DataSources.DataTables.Add("PS_SD956_02A");
				oGrid.DataTable = oForm.DataSources.DataTables.Item("PS_SD956_02A");
				oDS_PS_SD956_02A = oForm.DataSources.DataTables.Item("PS_SD956_02A");
			}
			catch (Exception ex)
			{
				PSH_Globals.SBO_Application.StatusBar.SetText(System.Reflection.MethodBase.GetCurrentMethod().Name + "_Error : " + ex.Message, BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Error);
		...
		/// </summary>
		/// <param name="pItemCode"></param>
		private void PS_SD956_02_MTX01(string pItemCode)
		{
			int ErrNum = 0;
			string sQry;
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
			...
			try
			{
				...
				sQry = "  EXEC PS_SD956_02_01 '";
				sQry += pItemCode + "'";

				oGrid.DataTable.Clear();
				oDS_PS_SD956_02A.ExecuteQuery(sQry);
		...
		private void Raise_EVENT_FORM_UNLOAD(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				...
				else if (pVal.BeforeAction == false)
				{
					...
					System.Runtime.InteropServices.Marshal.ReleaseComObject(oDS_PS_SD956_02A);
				}
			}
			catch (Exception ex)
			{
		...
		/// PS_SD956_02_FormResize
		/// </summary>
		private void PS_SD956_02_FormResize()
		{
			try
			{
