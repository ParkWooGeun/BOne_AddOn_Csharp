	...
	internal class PS_SD957 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				...
				PS_SD957_ComboBox_Setting();
				PS_SD957_Initial_Setting();
			}
			catch (Exception ex)
			{
		...
		/// PS_SD957_ComboBox_Setting
		/// </summary>
		private void PS_SD957_ComboBox_Setting()
		{
		...
		/// PS_SD957_Initial_Setting
		/// </summary>
		private void PS_SD957_Initial_Setting()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_SD957_DataValidCheck() == false)
							{
								BubbleEvent = false;
								return;
							}
		...
		/// <summary>
		/// PS_SD957_DataValidCheck
		/// </summary>
		/// <returns></returns>
		public bool PS_SD957_DataValidCheck()
		{
