...
namespace PSH_BOne_AddOn
{
	...
	/// 거래처별 세분화별 수주실적(관계3사)
	/// </summary>
	internal class PS_SD958 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_SD958.srf");
				...
				oFormUniqueID = "PS_SD958_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_SD958");
				...
				oForm.Freeze(true);
				PS_SD958_CreateItems();
				PS_SD958_SetComboBox();
				PS_SD958_Initialize();
			}
			catch (Exception ex)
			{
		...
		/// PS_SD958_CreateItems
		/// </summary>
		private void PS_SD958_CreateItems()
		{
			try
			{
				oForm.Freeze(true);
		...
		/// PS_SD958_SetComboBox
		/// </summary>
		private void PS_SD958_SetComboBox()
		{
		...
		/// PS_SD958_Initialize
		/// </summary>
		private void PS_SD958_Initialize()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
		...
		/// <summary>
		/// PS_SD958_CheckDataValid
		/// </summary>
		/// <returns></returns>
		private bool PS_SD958_CheckDataValid()
		{
		...
		/// <summary>
		/// PS_SD958_Print_Report01
		/// </summary>
		[STAThread]
		private void PS_SD958_Print_Report01()
		{
			string WinTitle;
			string ReportName;
			string BPLId;
			...
			try
			{
				...
				WinTitle = "[PS_SD958] 수주/견적 비교 현황(건별)";
				ReportName = "PS_SD958.rpt";
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_SD958_CheckDataValid() == false)
							{
								BubbleEvent = false;
								return;
							}
							...
							{
								System.Threading.Thread thread = new System.Threading.Thread(PS_SD958_Print_Report01);
