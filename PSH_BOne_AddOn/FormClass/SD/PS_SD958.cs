	...
	internal class PS_SD958 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				...
				PS_SD958_ComboBox_Setting();
				PS_SD958_Initial_Setting();
			}
			catch (Exception ex)
			{
		...
		/// PS_SD958_ComboBox_Setting
		/// </summary>
		private void PS_SD958_ComboBox_Setting()
		{
		...
		/// PS_SD958_Initial_Setting
		/// </summary>
		private void PS_SD958_Initial_Setting()
		{
			PSH_DataHelpClass dataHelpClass = new PSH_DataHelpClass();
			...
			try
			{
				if (pVal.BeforeAction == true)
				{
					if (pVal.ItemUID == "Btn01")
					{
						...
						{
							if (PS_SD958_DataValidCheck() == false)
							{
								BubbleEvent = false;
								return;
							}
		...
		/// <summary>
		/// PS_SD958_DataValidCheck
		/// </summary>
		/// <returns></returns>
		public bool PS_SD958_DataValidCheck()
		{
