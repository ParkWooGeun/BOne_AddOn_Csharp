...
namespace PSH_BOne_AddOn
{
	...
	/// 재고전기리스트
	/// </summary>
	internal class PS_SM040 : PSH_BaseClass
	{
		...
		public override void LoadForm(string oFormDocEntry)
		{
			...
			try
			{
				oXmlDoc.load(PSH_Globals.SP_Path + "\\" + PSH_Globals.Screen + "\\PS_SM040.srf");
				...
				oFormUniqueID = "PS_SM040_" + SubMain.Get_TotalFormsCount();
				SubMain.Add_Forms(this, oFormUniqueID, "PS_SM040");
				...
				oForm.Freeze(true);
				PS_SM040_CreateItems();
				PS_SM040_ComboBox_Setting();
			}
			catch (Exception ex)
			{
		...
		/// PS_SM040_CreateItems
		/// </summary>
		private void PS_SM040_CreateItems()
		{
			try
			{
				...
				oForm.Items.Item("DocDateFr").Specific.Value = DateTime.Now.AddYears(-1).ToString("yyyyMMdd"); //일년전
		...
		/// PS_SM040_ComboBox_Setting
		/// </summary>
		private void PS_SM040_ComboBox_Setting()
		{
		...
		/// <summary>
		/// PS_SM040_HeaderSpaceLineDel
		/// </summary>
		/// <returns></returns>
		private bool PS_SM040_HeaderSpaceLineDel()
		{
			...
			try
			{
				...
				{
					errMessage = "품목코드는 필수사항입니다. 확인하여 주십시오.";
					throw new Exception();
				}
				ReturnValue = true;
			}
		...
		private void PS_SM040_MTX01()
		{
			...
			try
			{
				...
				sQry = "EXEC PS_SM040_01 '" + BPLId + "','" + DocDateFr + "','" + DocDateTo + "','" + ItemCode + "'";
		...
		private void Raise_EVENT_ITEM_PRESSED(string FormUID, ref SAPbouiCOM.ItemEvent pVal, ref bool BubbleEvent)
		{
			try
			{
				if (pVal.BeforeAction == true)
				{
					...
					{
						if (PS_SM040_HeaderSpaceLineDel() == false)
						{
							BubbleEvent = false;
							return;
						}
